...
![Github Repo Size](https://img.shields.io/github/repo-size/mdn/content?style=for-the-badge&color=black)
<p align="center">
<img width="500" src="https://user-images.githubusercontent.com/10350960/166113119-629295f6-c282-42c9-9379-af2de5ad4338.png" /></p>
...
- Alongside detailed reference documentation, we ```provide extensive learning resources``` for students and beginners getting started with the web development.

## MDN's mission

- To provide a blueprint for a better internet and empower a new generation of developers and content creators to build it.
...
- To find out how to get started, see the [Contributing Guidelines](CONTRIBUTING.md) of this repository.
