...
The most common Unicode character encoding on the Web is {{Glossary("UTF-8")}}. Other encodings exist, like {{glossary("UTF-16")}} or the obsolete UCS-2, but UTF-8 is recommended.
