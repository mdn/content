...
The diagram illustrates how inline-level content is laid out inside a block container. The _root inline box_ is an anonymous box generated by the block container to hold all its inline-level content, including text and descendant inline boxes. To learn more about concepts in this diagram, such as _line boxes_, _inline box fragmentation_, and _floats_, read the CSS [Inline formatting context](/en-US/docs/Web/CSS/Guides/Inline_layout/Inline_formatting_context) guide.
