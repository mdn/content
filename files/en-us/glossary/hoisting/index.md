...
JavaScript **Hoisting** refers to the process whereby the _declaration_ of functions, variables, classes, or imports appears to move to the top of their scope during the [`compilation`](/en-US/docs/Glossary/Compile), prior to execution of the code.
