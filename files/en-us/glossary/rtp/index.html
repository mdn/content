...
tags:
  ...
  - RTP
---
<p>The <strong>Real-time Transport Protocol</strong> (<strong>RTP</strong>) is a network protocol which described how to transmit various media (audio, video) from one endpoint to another in a real-time fashion. RTP is suitable for video-streaming application, telephony over {{glossary("IP")}} like Skype and conference technologies.</p>
...
<p>RTP is rarely used alone; instead, it is used in conjunction with other protocols like {{glossary("RTSP")}} and {{glossary("SDP")}}.</p>

<h2 id="see_also">See also</h2>

<ul>
 <li><a href="/en-US/docs/Web/API/WebRTC_API/Intro_to_RTP">Introduction to the Real-time Transport Protocol</a></li>
 <li>{{Interwiki("wikipedia", "Real-time_Transport_Protocol","RTP")}} on Wikipedia</li>
 <li>{{RFC(3550)}} (one of the documents that specify precisely how the protocol works)</li>
</ul>
