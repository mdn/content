...
Internationalization includes support for multiple character sets (usually via [Unicode](https://www.techtarget.com/whatis/definition/Unicode)), units of measure ([currency](/en-US/docs/Web/API/PaymentRequest/show), °C/°F, km/miles, etc.), date and time formats, keyboard layouts, and layout and text directions.
