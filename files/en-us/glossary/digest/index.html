...
tags:
  ...
  - Security
---
<p>A <strong>digest</strong> is a small value generated by a {{glossary("cryptographic hash function", "hash function")}} from a whole message. Ideally, a digest is quick to calculate, irreversible, and unpredictable, and therefore indicates whether someone has tampered with a given message.</p>
...
<ul>
 ...
 <li>generate {{glossary("key","keys")}}</li>
</ul>
...
<ul>
 <li>See {{glossary("Cryptographic hash function")}}</li>
 <li>{{interwiki("wikipedia", "Cryptographic_hash_function", "Hash function")}} on Wikipedia</li>
</ul>
