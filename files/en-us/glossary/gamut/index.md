...
Developers can define different sets of colors for devices supporting larger gamuts using the {{cssxref("@media/color-gamut")}} [media feature](/en-US/docs/Web/CSS/Guides/Media_queries/Using). They can describe colors outside the RGB gamut using specific CSS functions like {{cssxref("color_value/lch")}} for the LCH cylindrical coordinate system, or {{cssxref("color_value/lab")}} for the Lab coordinate system.
