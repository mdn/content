...
<p>For example, {{cssxref("background")}} shorthand property values are made up of several <code>background-*</code> longhand properties. The canonical order of those longhand values is defined as</p>
...
<p>Furthermore, its syntax defines, that if a value for the {{cssxref("background-size")}} is given, it <strong>must</strong> be specified <strong>after</strong> the value for the {{cssxref("background-position")}}, separated by a slash. Other values may appear in any order.</p>
