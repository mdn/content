...
tags:
  - CSS Grids
---
<p>In a <a href="/en-US/docs/Web/CSS/CSS_Grid_Layout">CSS Grid Layout</a>, a <strong>grid cell</strong> is the smallest unit you can have on your CSS grid. It is the space between four intersecting {{glossary("grid lines")}} and conceptually much like a table cell.</p>
