...
Ink overflow is the overflow of painting effects such as [box shadows](/en-US/docs/Web/CSS/Reference/Properties/box-shadow), [border images](/en-US/docs/Web/CSS/Guides/Backgrounds_and_borders), [text decoration](/en-US/docs/Web/CSS/Guides/Text_decoration), [outlines](/en-US/docs/Web/CSS/Reference/Properties/outline), etc. that do not affect layout or otherwise extend the scrollable overflow area. Ink overflow is also the overhanging of glyphs, such as ascenders and descenders extending outside the em box.
