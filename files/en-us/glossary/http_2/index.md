...
The primary goals for HTTP/2 are to reduce {{glossary("latency")}} and round-trips by enabling full request and response multiplexing, minimize protocol overhead via efficient compression of HTTP header fields (HPACK), and support for request prioritization.
