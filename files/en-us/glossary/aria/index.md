...
**ARIA** (_{{Glossary("Accessible")}} Rich {{glossary("Internet")}} Applications_) is a {{Glossary("W3C")}} specification developed by {{Glossary("WAI")}} to make Web content and Web applications more accessible to people with disabilities. It especially helps with dynamic content and advanced user interface controls developed with HTML, JavaScript, and related technologies.
