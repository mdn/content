...
- {{domxref("Window.btoa()")}} and {{domxref("WorkerGlobalScope.btoa()")}}: creates a Base64-encoded ASCII string from a string of binary data ("btoa" should be read as "binary to ASCII").
- {{domxref("Window.atob()")}} and {{domxref("WorkerGlobalScope.atob()")}}: decodes a Base64-encoded string ("atob" should be read as "ASCII to binary").
...
- JavaScript APIs:
  - {{domxref("Window.atob()")}} and {{domxref("WorkerGlobalScope.atob()")}}
  - {{domxref("Window.btoa()")}} and {{domxref("WorkerGlobalScope.btoa()")}}
