...
The following example demonstrates a closure. The inner function maintains access to the `count` variable even after `createCounter()` has finished executing.
