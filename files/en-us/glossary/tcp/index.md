...
TCP's role is to ensure the packets are reliably delivered, error free. TCP has [concurrency control](https://en.wikipedia.org/wiki/Concurrency_control), which means the correct results for concurrent operations are generated, while getting those results as quickly as possible.
