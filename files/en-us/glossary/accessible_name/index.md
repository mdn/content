...
For some elements like {{HTMLElement("img")}}, the accessible name comes from their attributes; for example the `alt` attribute in the case of `<img>`. Given `<img src="grape.jpg" alt="banana"/>`, the image's accessible name is "banana."
