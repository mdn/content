...
<dl>
 <dt>technical</dt>
 <dd>Tag the content using semantic {{Glossary("HTML")}}. When exploring the website, crawlers should only find the content you want indexed.</dd>
 <dt>copywriting</dt>
 <dd>Write content using your visitors' vocabulary. Use text as well as images so that crawlers can understand the subject.</dd>
 <dt>popularity</dt>
 <dd>You get most traffic when other established sites link to your site.</dd>
</dl>
