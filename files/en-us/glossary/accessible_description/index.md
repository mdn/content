...
4. If none of the above provides a description, the [`title`](/en-US/docs/Web/HTML/Global_attributes/title) attribute is used, if the `title` is not the {{glossary("accessible name")}} for that element.
