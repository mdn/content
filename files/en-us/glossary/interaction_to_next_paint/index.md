...
It was designed by Google as one of the [Core Web Vital](https://web.dev/articles/web-vitals) metrics and replaced [First Input Delay (FID)](/en-US/docs/Glossary/First_input_delay) as a Core Web Vitals in May 2024. There are two key differences between FID and INP, that make INP a better measure of a page's responsiveness:
