...
> [!NOTE]
> The above behavior of block layout changes if the containing block's {{cssxref("writing-mode")}} is set to value other than [the default value](/en-US/docs/Web/CSS/Reference/Properties/writing-mode#formal_definition).
