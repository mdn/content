...
The **layout viewport** is the {{glossary("viewport")}} into which the browser draws a web page. Essentially, it represents what is available to be seen, while the {{Glossary("visual viewport")}} represents what is visible on the user's display device; the currently visible portion of the layout viewport.
