...
tags:
  ...
  - viewport
---
<p>The <strong>layout viewport</strong> is the viewport into which the browser draws a web page. Essentially, it represents what is available to be seen, while the {{Glossary("visual viewport")}} represents what is currently visible on the user's display device.</p>
...
<ul>
 ...
 <li>{{Glossary("Viewport")}} in the MDN Glossary</li>
 <li>{{Glossary("Visual viewport")}} in the MDN Glossary</li>
</ul>
