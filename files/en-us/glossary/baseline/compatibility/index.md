...
A Baseline feature - such as an API, a set of CSS properties, or a JavaScript syntax - is known to work consistently across two or more major versions of all of several well-known browsers (Chrome, Edge, Firefox, and Safari).
