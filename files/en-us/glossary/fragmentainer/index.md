...
Fragmented contexts are found in [CSS paged media](/en-US/docs/Web/CSS/CSS_paged_media), where the fragmentainer would be the box that defines a page. In [CSS multiple-column layout](/en-US/docs/Web/CSS/Guides/Multicol_layout), the fragmentainer is the column box created when columns are defined on a multicol container.
