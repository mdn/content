...
<p>The portion of the viewport that is currently visible is called the <strong>{{Glossary("visual viewport")}}</strong>. This can be smaller than the layout viewport, such as when the user has pinched-zoomed. The {{Glossary("layout viewport")}} remains the same, but the visual viewport became smaller.</p>
