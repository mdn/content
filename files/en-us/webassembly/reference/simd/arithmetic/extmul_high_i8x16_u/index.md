...
The **`extmul_high_i8x16_u`** [SIMD arithmetic instruction](/en-US/docs/WebAssembly/Reference/SIMD/arithmetic) takes lanes 8–15 of two unsigned [`v128`](/en-US/docs/WebAssembly/Reference/Value_types/v128) `i8x16` value interpretations, multiplies the values in the corresponding lanes, and outputs the result of those operations into an `i16x8` value interpretation.
