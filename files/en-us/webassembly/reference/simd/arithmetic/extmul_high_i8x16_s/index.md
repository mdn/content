...
The **`extmul_high_i8x16_s`** [SIMD arithmetic instruction](/en-US/docs/WebAssembly/Reference/SIMD/arithmetic) takes lanes 8–15 of two signed [`v128`](/en-US/docs/WebAssembly/Reference/Types/v128) `i8x16` value interpretations, multiplies the equivalent lanes of each value together, and outputs the products of those operations into an `i16x8` value interpretation.
...
The `extmul_high_i8x16_s` instruction is a more performant equivalent to passing the results of two [`extend_high_i8x16_s`](/en-US/docs/WebAssembly/Reference/SIMD/conversion/extend_high_i8x16_s) instructions into a [`mul`](/en-US/docs/WebAssembly/Reference/Numeric/mul) instruction.
