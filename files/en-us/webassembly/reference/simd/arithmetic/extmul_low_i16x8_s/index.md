...
The **`extmul_low_i16x8_s`** [SIMD arithmetic instruction](/en-US/docs/WebAssembly/Reference/SIMD/arithmetic) takes lanes 0–3 of two signed [`v128`](/en-US/docs/WebAssembly/Reference/Types/v128) `i16x8` value interpretations, multiplies the equivalent lanes of each value together, and outputs the products of those operations into an `i32x4` value interpretation.
...
The `extmul_low_i16x8_s` instruction is a more performant equivalent to passing the results of two [`extend_low_i16x8_s`](/en-US/docs/WebAssembly/Reference/SIMD/conversion/extend_low_i16x8_s) instructions into a [`mul`](/en-US/docs/WebAssembly/Reference/Numeric/mul) instruction.
