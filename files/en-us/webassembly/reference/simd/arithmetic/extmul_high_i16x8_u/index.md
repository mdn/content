...
The **`extmul_high_i16x8_u`** [SIMD arithmetic instruction](/en-US/docs/WebAssembly/Reference/SIMD/arithmetic) takes lanes 4–7 of two unsigned [`v128`](/en-US/docs/WebAssembly/Reference/Types/v128) `i16x8` value interpretations, multiplies the equivalent lanes of each value together, and outputs the products of those operations into an `i32x4` value interpretation.
...
The `extmul_high_i16x8_u` instruction is a more performant equivalent to passing the results of two [`extend_high_i16x8_u`](/en-US/docs/WebAssembly/Reference/SIMD/conversion/extend_high_i16x8_u) instructions into a [`mul`](/en-US/docs/WebAssembly/Reference/Numeric/mul) instruction.
...
- `i32x4.extmul_high_i16x8_u`
  - : The `i32x4.extmul_high_i16x8_u` instruction.
