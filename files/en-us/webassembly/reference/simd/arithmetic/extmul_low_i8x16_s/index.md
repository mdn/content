...
The **`extmul_low_i8x16_s`** [SIMD arithmetic instruction](/en-US/docs/WebAssembly/Reference/SIMD/arithmetic) takes lanes 0–7 of two signed [`v128`](/en-US/docs/WebAssembly/Reference/Types/v128) `i8x16` value interpretations, multiplies the equivalent lanes of each value together, and outputs the products of those operations into an `i16x8` value interpretation.
...
The `extmul_low_i8x16_s` instruction is a more performant equivalent to passing the results of two [`extend_low_i8x16_s`](/en-US/docs/WebAssembly/Reference/SIMD/conversion/extend_low_i8x16_s) instructions into a [`mul`](/en-US/docs/WebAssembly/Reference/Numeric/mul) instruction.
...
- `i16x8.extmul_low_i8x16_s`
  - : The `i16x8.extmul_low_i8x16_s` instruction.
