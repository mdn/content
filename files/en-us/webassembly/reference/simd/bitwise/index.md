...
WebAssembly SIMD bitwise instructions.

- [`shl`](/en-US/docs/WebAssembly/Reference/SIMD/bitwise/shl)
  - : Arithmetic left shift. Shifts the bits in each lane of a `v128` value interpretation to the left by the same specified amount.
