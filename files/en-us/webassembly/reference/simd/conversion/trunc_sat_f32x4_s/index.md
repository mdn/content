...
The **`trunc_sat_f32x4_s`** [SIMD conversion instruction](/en-US/docs/WebAssembly/Reference/SIMD/conversion) performs a saturating conversion of the lanes of a `v128` `f32x4` value interpretation into a signed `i32x4` value interpretation.
...
| ------------------------- | ----------------- | --------------------------------------------- |
| `i32x4.trunc_sat_f32x4_s` | `0xfd 0xf8 0x01`  | `i32x4.trunc_sat_f32x4_s` => `0xfd 0xf8 0x01` |
