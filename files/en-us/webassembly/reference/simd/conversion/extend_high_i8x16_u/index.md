...
The **`extend_high_i8x16_u`** [SIMD conversion instruction](/en-US/docs/WebAssembly/Reference/SIMD/conversion) converts lanes 8–15 of an unsigned [`v128`](/en-US/docs/WebAssembly/Reference/Value_types/v128) `i8x16` value interpretation into an `i16x8` value interpretation.
...
- `i16x8.extend_high_i8x16_u`
  - : The `i16x8.extend_high_i8x16_u` instruction.
