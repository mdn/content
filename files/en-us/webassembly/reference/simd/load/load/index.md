...
The **`load`** [SIMD load instruction](/en-US/docs/WebAssembly/Reference/SIMD/load) loads a [`v128`](/en-US/docs/WebAssembly/Reference/Types/v128) value interpretation from a given heap address.
