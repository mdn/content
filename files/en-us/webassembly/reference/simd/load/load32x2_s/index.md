...
The **`load32x2_s`** [SIMD load instruction](/en-US/docs/WebAssembly/Reference/SIMD/load) loads two 32-bit integers from a given memory address and sign extends each one to a 64-bit lane, outputting a [`v128`](/en-US/docs/WebAssembly/Reference/Types/v128) type `i64x2` value interpretation.
