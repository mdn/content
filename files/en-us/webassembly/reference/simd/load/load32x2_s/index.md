...
The **`load32x2_s`** [SIMD load instruction](/en-US/docs/WebAssembly/Reference/SIMD/load) loads two 32-bit integers from a given heap address and sign extends each one to a 64-bit lane, outputting a `v128` `i64x2` value interpretation.
...
| ----------------- | ----------------- | -------------------------------- |
| `v128.load32x2_s` | `0xFD 5:u32`      | `v128.load32x2_s` => `0xfd 0x05` |
