...
The **`load8x8_u`** [SIMD load instruction](/en-US/docs/WebAssembly/Reference/SIMD/load) loads eight 8-bit integers from a given memory address and zero extends each one to a 16-bit lane, outputting a [`v128`](/en-US/docs/WebAssembly/Reference/Types/v128) type `i16x8` value interpretation.
...
- `v128.load8x8_u`
  - : The `v128.load8x8_u` instruction.
