...
For a [SIMD](/en-US/docs/WebAssembly/Reference/SIMD) `shr_s`, the `input` and `output` will be [`v128`](/en-US/docs/WebAssembly/Reference/Types/v128) value interpretations, for example `i32x4 2 30 86 120`.
...
| `i8x16.shr_s` | `0xfd 108:u32` | `i8x16.shr_s` => `0xfd 0x6c 0x01` |
