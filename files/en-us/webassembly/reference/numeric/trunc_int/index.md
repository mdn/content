...
There's another [**`trunc`**](/en-US/docs/WebAssembly/Reference/Numeric/trunc) instruction that truncates the fractional part of a floating point without converting it to an integer.
