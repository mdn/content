---
title: trunc (float to float)
slug: WebAssembly/Reference/Numeric/trunc_float_to_float
...
There's another [**`trunc`**](/en-US/docs/WebAssembly/Reference/Numeric/trunc_float_to_int) instruction that truncates the fractional part of a floating point and converts it to an integer.
