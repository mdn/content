---
title: truc (float to int)
slug: WebAssembly/Reference/Numeric/trunc_float_to_int
...
There's another [**`trunc`**](/en-US/docs/WebAssembly/Reference/Numeric/trunc_float_to_float) instruction that truncates the fractional part of a floating point without converting it to an integer.
