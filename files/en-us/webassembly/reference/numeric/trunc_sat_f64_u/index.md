...
Unlike [`trunc_f64_u`](/en-US/docs/WebAssembly/Reference/Numeric/trunc_f64_u), this instruction will not trap on [`NaN`](/en-US/docs/Web/JavaScript/Reference/Global_Objects/NaN), [`infinity`](/en-US/docs/Web/JavaScript/Reference/Global_Objects/Infinity), or `input` values outside the `output` value's range.
