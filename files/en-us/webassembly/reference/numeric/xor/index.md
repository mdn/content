...
For a [SIMD](/en-US/docs/WebAssembly/Reference/SIMD) `xor`, these will be [`v128`](/en-US/docs/WebAssembly/Reference/Types/v128) value interpretations, for example `i32x4 9 4 -16 100`.
