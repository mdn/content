...
The **`mul_wide_s`** [numeric instruction](/en-US/docs/WebAssembly/Reference/Numeric) multiplies two signed 64-bit integers to produce a 128-bit result represented by two 64-bit integers.
...
```plain
i64.mul_wide_s <input1> <input2> <output1> <output2>
```
