...
For a [SIMD](/en-US/docs/WebAssembly/Reference/SIMD) `le_u`, the inputs will be [`v128`](/en-US/docs/WebAssembly/Reference/Types/v128) value interpretations, for example `i32x4 2 30 86 120`. Each lane of the output pushed to the stack is a `1` or `0` indicating whether the corresponding lane of the first input value is less than or equal to the corresponding lane of the second input value.
