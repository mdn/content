...
For a non-SIMD `gt`, the inputs will be basic numeric values such as `3.0` or `3.5`.

For a [SIMD](/en-US/docs/WebAssembly/Reference/SIMD) `gt`, the inputs will be [`v128`](/en-US/docs/WebAssembly/Reference/Types/v128) value interpretations, for example `f32x4 2.0 30 86.9 120`.
