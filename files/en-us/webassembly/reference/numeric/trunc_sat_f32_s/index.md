...
Unlike [`trunc_f32_s`](/en-US/docs/WebAssembly/Reference/Numeric/trunc_f32_s), this instruction will not trap on [`NaN`](/en-US/docs/Web/JavaScript/Reference/Global_Objects/NaN), [`infinity`](/en-US/docs/Web/JavaScript/Reference/Global_Objects/Infinity), or `input` values outside the `output` value's range.
