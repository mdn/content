...
short-title: func
slug: WebAssembly/Reference/Types/func
...
A function type maps a sequence of parameter [value types](/en-US/docs/WebAssembly/Reference/Types) to a sequence of result value types. Either list may be empty.
...
- **Indirect calls.** [`call_indirect`](/en-US/docs/WebAssembly/Reference/Control_flow) takes a function type and dispatches through a [`table`](/en-US/docs/WebAssembly/Reference/Definitions/table) of [`funcref`](/en-US/docs/WebAssembly/Reference/Types/funcref) values. The engine checks at runtime that the indexed function's type matches the declared type and traps otherwise.
...
- [`funcref`](/en-US/docs/WebAssembly/Reference/Types/funcref) value type
