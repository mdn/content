...
You can find full documentation on Emscripten at [emscripten.org](https://emscripten.org/), and a guide to implementing the toolchain and compiling your own C/C++ app across to Wasm at [Compiling from C/C++ to WebAssembly](/en-US/docs/WebAssembly/Guides/C_to_Wasm).
...
- [Loading and running WebAssembly code](/en-US/docs/WebAssembly/Guides/Loading_and_running) — find out how to load your own WebAssembly module into a web page.
- [Using the WebAssembly JavaScript API](/en-US/docs/WebAssembly/Guides/Using_the_JavaScript_API) — find out how to use the other major features of the WebAssembly JavaScript API.
