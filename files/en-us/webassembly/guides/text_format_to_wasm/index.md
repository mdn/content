...
- [Understanding WebAssembly text format](/en-US/docs/WebAssembly/Guides/Understanding_the_text_format) — a detailed explanation of the text format syntax.
- [Compiling from C/C++ to WebAssembly](/en-US/docs/WebAssembly/Guides/C_to_Wasm) — tools like Binaryen/Emscripten both compile your source code to Wasm, and create the API code needed to run the module in a JavaScript context. Find out more about how to use them.
- [Using the WebAssembly JavaScript API](/en-US/docs/WebAssembly/Guides/Using_the_JavaScript_API) — read this if you want to find out more about how the WebAssembly API code works.
