...
2. Now add `html_template/shell_minimal.html` with <i>{<i>{<i>{ SCRIPT }</i>}</i>}</i> as content into this new directory too, just for convenience (you'd obviously put this in a central place in your real dev environment).
