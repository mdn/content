...
If we convert our module to binary now (see [Converting WebAssembly text format to Wasm](/en-US/docs/WebAssembly/Text_format_to_Wasm)), we'll see just the 8 byte module header described in the [binary format]([https://webassembly.github.io/spec/core/binary/index.html#high-level-structure](https://webassembly.github.io/spec/core/bikeshed/#modules%E2%91%A0%E2%93%AA)):
