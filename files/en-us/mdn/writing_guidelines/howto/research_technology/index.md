...
Some of the code examples for MDN Web Docs are held in separate repositories (most notably, these are interactive examples at the top of pages and larger demo code needed for guides). If you do need to add to or amend one of these repos, it's a good idea to make a note of it in your list. This [article](/en-us/docs/MDN/Writing_guidelines/Page_structures/Code_examples) describes the different types of code examples we use on MDN Web Docs.
