...
To achieve this you can hide any code blocks which are note relevant with the `hidden` class. Also, omit the `### HTML/CSS/JavaScript` headings for the hidden code blocks.
