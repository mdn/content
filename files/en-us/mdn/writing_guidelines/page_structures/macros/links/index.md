---
title: Link macros
slug: MDN/Writing_guidelines/Macros/Links
page-type: mdn-writing-guide
---

{{MDNSidebar}}

MDN provides numerous macros that enable adding links to the main content and sidebars of a page. This article describes how to use macros to include always-up-to-date and maintained links within your content.

In this guide, you will learn about cross-reference macros to add links to other pages and macros to add lists of links to pages and subpages.
