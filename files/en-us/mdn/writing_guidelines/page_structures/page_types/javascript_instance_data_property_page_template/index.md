---
title: JavaScript instance data property page template
...
>
> - **title**
>   - : Title heading displayed at the top of the page. Instance data properties are either installed on each instance or on `Constructor.prototype`. You need to format the first case as `Constructor: nameOfTheProperty` and the second case as `Constructor.prototype.nameOfTheProperty`. For example, the [`length`](/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array/length) property of the [`Array`](/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array) class has a _title_ of `Array: length`, while the [`name`](/en-US/docs/Web/JavaScript/Reference/Global_Objects/Error/name) property of the [`Error`](/en-US/docs/Web/JavaScript/Reference/Global_Objects/Error) class has a _title_ of `Error.prototype.name`. Do check the spec to be precise.
> - **short-title**
>   - : A short title used in breadcrumbs and sidebars. Format as `nameOfTheProperty`. For example, the [`length`](/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array/length) property has a _short-title_ of `length`.
> - **slug**
...
> - **page-type**
>   - : The `page-type` key for JavaScript instance data properties is `javascript-instance-data-property`.
> - **status**
...
> - **sidebar**
>   - : This is `jsref` for JavaScript instance data property pages.
...
The **`nameOfTheProperty`** data property of a \\{{jsxref("Constructor")}} instance contains something. If the property is installed on `Constructor.prototype`, say "The **`nameOfTheProperty`** data property of `Constructor.prototype` is shared by all \\{{jsxref("Constructor")}} instances. It contains something." This should ideally be 1 or 2 short sentences. Keep this in sync with the constructor's landing page — for example, the landing page should contain lines like this:
...
For example, "a non-negative integer less than ... that represents the number of elements in the array".
...
Most of the description of the property should go here. Be as comprehensive as possible. If there are many pages that share the same description, consider adding a new section to the class's landing page and linking to it from here. For example, [Array methods and empty slots](/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array#array_methods_and_empty_slots) is linked to from every array method page.
...
Each example must have an H3 heading naming the example. The heading should be descriptive of what the example is doing. For example, "A simple example" does not say anything about the example and therefore, not a good heading. The heading should be concise. For a longer description, use the paragraph after the heading. The first example may be called "Using nameOfTheProperty".
...
- [Polyfill of `nameOfTheProperty` in `core-js`](https://github.com/zloirock/core-js#anchor)
- [es-shims polyfill of `nameOfTheProperty`](https://www.npmjs.com/package/es-aggregate-error)
- link1
- link2
- external_link (year)
