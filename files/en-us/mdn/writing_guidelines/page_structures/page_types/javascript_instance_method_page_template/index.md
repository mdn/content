---
title: JavaScript instance method page template
...
>
> - **title**
>   - : Title heading displayed at the top of the page. Format as `Constructor.prototype.nameOfTheMethod()`. For example, the [`at()`](/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array/at) method of the [`Array`](/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array) class has a _title_ of `Array.prototype.at()`.
> - **short-title**
>   - : A short title used in breadcrumbs and sidebars. Format as `nameOfTheMethod()`. For example, the [`at()`](/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array/at) method has a _short-title_ of `at()`.
> - **slug**
...
> - **page-type**
>   - : The `page-type` key for JavaScript instance methods is `javascript-instance-method`.
> - **status**
...
> - **sidebar**
>   - : This is `jsref` for JavaScript instance method pages.
...
The **`nameOfTheMethod()`** method of \\{{jsxref("Constructor")}} instances does something. This should ideally be 1 or 2 short sentences. Keep this in sync with the constructor's landing page — for example, the landing page should contain lines like this:
...
If the method returns a promise, use the format "A {{jsxref("Promise")}} asynchronously fulfilled with a {{jsxref("Number")}} representing something". Rejected promises go into the "Exceptions" section.
...
- [Polyfill of `Constructor.prototype.nameOfTheMethod` in `core-js`](https://github.com/zloirock/core-js#anchor)
- [es-shims polyfill of `Constructor.prototype.nameOfTheMethod`](https://www.npmjs.com/package/es-aggregate-error)
- link1
- link2
- external_link (year)
