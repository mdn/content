...
This section is for interactive example, which gets adding by calling the macro `\{{EmbedInteractiveExample}}`. See the [Interactive example demo](/en-US/docs/MDN/Writing_guidelines/Page_structures/Code_examples#interactive_example_demo) section in our writing guidelines for more information.
