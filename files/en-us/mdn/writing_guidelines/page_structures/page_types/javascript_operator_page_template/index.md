---
title: JavaScript operator page template
...
> **Page front matter:**
>
> The front matter at the top of the page is used to define "page metadata". The values should be updated appropriately for the particular operator.
>
> ```md
> ---
...
>
> - **title**
>   - : Title heading displayed at the top of the page. Format as `Operator (symbol)`. For example, the [Addition (`+`)](/en-US/docs/Web/JavaScript/Reference/Operators/Addition) operator has a _title_ of `Addition (+)`.
> - **slug**
>   - : The end of the URL path after `https://developer.mozilla.org/en-US/docs/`. This should be formatted like `Web/JavaScript/Reference/Operators/Operator`.
> - **page-type**
>   - : The `page-type` key for JavaScript operators is `javascript-operator`.
> - **status**
...
> - **browser-compat**
>   - : Replace the placeholder value `javascript.operators.operator` with the query string for the operator in the [Browser compat data repo](https://github.com/mdn/browser-compat-data).
...
>
>     Note that you may first need to create/update an entry for the operator in our [Browser compat data repo](https://github.com/mdn/browser-compat-data), and the entry for the API will need to include specification information.
>     See our [guide on how to do this](/en-US/docs/MDN/Writing_guidelines/Page_structures/Compatibility_tables).
> - **sidebar**
>   - : This is `jssidebar` for JavaScript operator pages.
...
The **operator (`symbol`)** operator does something. This should ideally be 1 or 2 short sentences. Generally, don't write more than a single paragraph with more than a few sentences: significant detail goes into the description.

Write an [interactive example](/en-US/docs/MDN/Writing_guidelines/Page_structures/Code_examples#interactive_examples) that demonstrates important aspects of the operator.
...
- `x`
  - : Describe the left operand as an expression, including the types it can evaluate to.
- `y`
  - : Describe the right operand as an expression, including the types it can evaluate to.

## Description

Most of the description of the operator should go here. Describe what the expression evaluates to, any type coercion, and the conditions under which it throws an exception. Be as comprehensive as possible. Readers should be able to understand the API in its entirety from this section without reading the examples section below. Examples presented in this section, should they be necessary, should be concise and do not have to be real-world-relevant.
...
Each example must have an H3 heading naming the example. The heading should be descriptive of what the example is doing. For example, "A simple example" does not say anything about the example and therefore, not a good heading. The heading should be concise. For a longer description, use the paragraph after the heading. The first example may be called "Using the [operator name] operator".
...
Include links to reference pages and guides related to the current operator. For more guidelines, see the [See also section](/en-US/docs/MDN/Writing_guidelines/Writing_style_guide#see_also_section) in the _Writing style guide_.
