...
>     For example, the [`<video>`](/en-US/docs/Web/HTML/Reference/Element/video) element has a _title_ of: **'\<video>: The Video Embed element'**.
> - **slug**
>   - : The end of the URL path after `https://developer.mozilla.org/en-US/docs/`.
>     This will be formatted like `Web/HTML/Element/NameOfTheElement`, where the element name is in _lower case_.
>     For example, the [`<video>`](/en-US/docs/Web/HTML/Reference/Element/video) element has a _slug_ of `Web/HTML/Element/video`.
> - **page-type**
>   - : Always `html-element`.
> - **status**
