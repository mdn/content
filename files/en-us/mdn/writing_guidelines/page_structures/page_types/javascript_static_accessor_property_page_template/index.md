---
title: JavaScript static accessor property page template
...
> - **short-title**
>   - : A short title used in breadcrumbs and sidebars. Format as `nameOfTheProperty`. For example, the [`RegExp.input`](/en-US/docs/Web/JavaScript/Reference/Global_Objects/RegExp/input) property has a _short-title_ of `input ($_)`.
> - **slug**
...
> - **page-type**
>   - : The `page-type` key for JavaScript static accessor property pages is `javascript-static-accessor-property`.
> - **status**
...
> - **sidebar**
>   - : This is `jsref` for JavaScript static accessor property pages.
...
The **`Constructor.nameOfTheProperty`** static accessor property returns something. This should ideally be 1 or 2 short sentences. Keep this in sync with the class or namespace landing page — for example, the landing page should contain lines like this:
