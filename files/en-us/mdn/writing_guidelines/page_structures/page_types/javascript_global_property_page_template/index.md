---
title: JavaScript global property page template
...
>
> - **title**
>   - : Title heading displayed at the top of the page. Format as `nameOfTheProperty`.
> - **slug**
>   - : The end of the URL path after `https://developer.mozilla.org/en-US/docs/`. This will be formatted like `Web/JavaScript/Reference/Global_Objects/nameOfTheProperty`.
> - **page-type**
>   - : The `page-type` key for JavaScript global property pages is `javascript-global-property`.
> - **status**
...
> - **browser-compat**
>   - : Replace the placeholder value `javascript.builtins.nameOfTheProperty` with the query string for the property in the [Browser compat data repo](https://github.com/mdn/browser-compat-data).
...
> - **sidebar**
>   - : This is `jssidebar` for JavaScript global property pages.
...
The **`nameOfTheProperty`** global property represents something. This should ideally be 1 or 2 short sentences.
...
Most of the description of the property should go here. Be as comprehensive as possible.
