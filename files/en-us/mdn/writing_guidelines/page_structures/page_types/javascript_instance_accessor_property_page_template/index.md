---
title: JavaScript instance accessor property page template
...
>
> - **title**
>   - : Title heading displayed at the top of the page. Format as `Constructor.prototype.nameOfTheProperty`. For example, the [`byteLength`](/en-US/docs/Web/JavaScript/Reference/Global_Objects/ArrayBuffer/byteLength) property of the [`ArrayBuffer`](/en-US/docs/Web/JavaScript/Reference/Global_Objects/ArrayBuffer) class has a _title_ of `ArrayBuffer.prototype.byteLength`.
>
>     It's almost always the case that accessor properties are installed on `Constructor.prototype`. However, if it's installed on each instance instead, use `Constructor: nameOfTheProperty`. Do check the spec to be precise.
> - **short-title**
>   - : A short title used in breadcrumbs and sidebars. Format as `nameOfTheProperty`. For example, the [`byteLength`](/en-US/docs/Web/JavaScript/Reference/Global_Objects/ArrayBuffer/byteLength) property has a _short-title_ of `byteLength`.
> - **slug**
...
> - **page-type**
>   - : The `page-type` key for JavaScript instance accessor properties is `javascript-instance-accessor-property`.
> - **status**
...
> - **sidebar**
>   - : This is `jsref` for JavaScript instance accessor property pages.
...
The **`nameOfTheProperty`** accessor property of \\{{jsxref("Constructor")}} instances returns something. This should ideally be 1 or 2 short sentences. Keep this in sync with the constructor's landing page — for example, the landing page should contain lines like this:
...
For a getter-only property, add the following paragraph:

> There is no setter for `nameOfTheProperty`, so you cannot change this property's value using assignment.

For a property with a setter, describe the values it accepts and the effect of assigning a value.
...
- [Polyfill of `Constructor.prototype.nameOfTheProperty` in `core-js`](https://github.com/zloirock/core-js#anchor)
- [es-shims polyfill of `Constructor.prototype.nameOfTheProperty`](https://www.npmjs.com/package/es-aggregate-error)
- link1
- link2
- external_link (year)
