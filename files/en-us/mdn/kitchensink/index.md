...
<div class="notecard warning">
  <p><strong>Warning:</strong> Don't delete this page. It's used by
...
<div class="notecard note">
  <p><strong>Note:</strong> Here's a block indicator note.</p>
</div>

<div class="notecard warning">
  <p><strong>Warning:</strong> Here's a block indicator warning.</p>
</div>
...
<table class="standard-table">
  ...
  <tbody>
   <tr>
    <td>{{SpecName("HTML WHATWG", "#link-type-dns-prefetch", "dns-prefetch")}}</td>
...
<h2>Every macro under the sun</h2>

<p><strong>Well, almost every macro. Hopefully only the ones that are in active use.</strong></p>
...
<p>Listening for mouse movement is even easier than listening for key
  presses: all we need is the listener for the {{event("mousemove")}} event.
  ...just below the <code>keyup event</code>:
</p>
