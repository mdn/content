...
1. Familiarize yourself with the [MDN Code example guidelines](../../how-to-write/writing-style-guide/code-example-guidelines/index.md) and make sure that code examples follow the guidelines. You’ll get used to them eventually, and we are intending to automatically lint against our guidelines at some point in the future.
1. Familiarize yourself with the [MDN Writing style guide](../../how-to-write/writing-style-guide/index.md), and use it to inform your reviews of new text content.
