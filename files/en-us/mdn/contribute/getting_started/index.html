...
<p>Every part of MDN (docs, demos, and the site itself) is created by an open community of developers. Please, join us!</p>

<h2 id="4_simple_steps_to_MDN">4 simple steps to MDN</h2>

<p>MDN is an open source resource where <strong>anyone</strong> can add and edit content. You don't need to be a programmer or know a lot about technologies. There are plenty of things that need to be done, from the simple (proofreading and correcting typos) to the complex (writing API documentation).</p>
...
<p>Now that you are logged in, read the descriptions of the different task types available on the <a href="/en-US/docs/MDN/Contribute">main Contribute page</a>, and decide which one most appeals to you. You can pick any task you like and begin your contribution.</p>
...
<h3 id="Step_4_Ask_for_help">Step 4: Ask for help</h3>

<p>If you are not sure what to do at any point, then you are more than welcome to ask for help. There are a few different help options:</p>

<ul>
 <li>If you want to talk to us synchronously and ask questions about MDN itself, join the discussion on the <a href="https://chat.mozilla.org/#/room/#mdn:mozilla.org">MDN Web Docs chat room</a> on <a href="https://wiki.mozilla.org/Matrix">Matrix</a>.</li>
 <li>You can also drop us an email at <a href="mailto:mdn-admins@mozilla.org">mdn-admins@mozilla.org</a>.</li>
 <li>If you are learning web development and are stuck on a coding problem, we have <a href="https://discourse.mozilla.org/c/mdn/learn/250">active forums</a> where you can ask questions and get help.</li>
</ul>
