...
>
> At the moment JavaScript, CSS and Web API documentation are in Markdown, so this page applies to those parts of the site. For other parts of the site, write documentation in HTML.
