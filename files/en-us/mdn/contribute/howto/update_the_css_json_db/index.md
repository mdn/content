...
You can use the macros [\\{{cssxref}}](https://github.com/mdn/kumascript/blob/master/macros/cssxref.ejs) and [\\{{SVGElement}}](https://github.com/mdn/kumascript/blob/master/macros/SVGElement.ejs) within translations to refer to other parts of MDN.
