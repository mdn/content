...
<p>There are a number of types of pages that are used repeatedly on MDN. This article describes these page types, their purpose, and gives examples of each and templates to use when creating a new page.</p>

<p>There are three broad categories of page types on MDN, though some page types fall into more than one category.</p>

<ul>
 <li><strong>Reference</strong> pages describe the details of something, and are organized according to the structure of the thing described.</li>
 <li><strong>Guide</strong> pages describe how to do something or use something, and are organized based on the goals of the reader.</li>
 <li><strong>Navigation</strong> pages exist primarily to provide links to other pages, usually about related topics.</li>
</ul>

<h2 id="Creating_a_new_page">Creating a new page</h2>

<p>To create new pages on MDN, you need to use GitHub — have a look at our <a href="https://github.com/mdn/content#adding-a-new-document">content repo README</a> for more instructions.</p>

<h2 id="How_to_use_the_templates">How to use the templates</h2>

<p>When creating a new page you can ensure that you've used the right page structure/contents by referring to one of our page templates — see the sections below. You can find the exact source code of each template (if you want to copy it) by following the "Source on <strong>GitHub</strong>" link at the bottom of each one. These page templates don't make much sense as published pages, but if you view their source code you'll see that they contain a lot of helpful comments, placeholders, and hints detailing how to fill in the missing information and create your page.</p>
...
<h2 id="Old-style_page_layouts">Old-style page layouts</h2>
...
<p>If you want to get a team together to work on an update, or you just want to report or discuss some content needing an update, feel free to <a href="https://github.com/mdn/content/issues">file a content issue</a> or <a href="/en-US/docs/MDN/Contribute/Getting_started#step_4_ask_for_help">ask us for help</a>.</p>

<h2 id="API_landing_page">API landing page</h2>
...
<ul>
 <li><a href="/en-US/docs/MDN/Structures/Page_types/API_landing_page_template">API landing page template</a></li>
</ul>

<h2 id="API_reference_page">API reference page</h2>

<div class="note">
<p><strong>Note:</strong> Also known as an <em>Interface landing page</em>.</p>
</div>
...
<ul>
 <li><a href="/en-US/docs/Web/API/Request">Request interface</a> of the <a href="/en-US/docs/Web/API/Fetch_API">Fetch API</a>.</li>
</ul>

<h3 id="Templates_2">Templates</h3>

<ul>
 <li><a href="/en-US/docs/MDN/Structures/Page_types/API_reference_page_template">API reference page template</a></li>
</ul>

<h2 id="API_reference_subpage">API reference subpage</h2>
...
<ul>
 <li><a href="/en-US/docs/Web/API/IDBIndex/count"><code>count()</code> method</a> of the <a href="/en-US/docs/Web/API/IDBIndex">IDBIndex</a> interface (part of the <a href="/en-US/docs/Web/API/IndexedDB_API">IndexedDB API</a>)</li>
 <li><a href="/en-US/docs/Web/API/VRDisplay/capabilities">capabilities property</a> of the <a href="/en-US/docs/Web/API/VRDisplay">VRDisplay</a> interface (part of the <a href="/en-US/docs/Web/API/WebVR_API">WebVR API</a>)</li>
 <li><a href="/en-US/docs/Web/API/Request/Request">Request() constructor</a> of the <a href="/en-US/docs/Web/API/Request">Request</a> interface (part of the <a href="/en-US/docs/Web/API/Fetch_API">Fetch API</a>)</li>
 <li><a href="/en-US/docs/Web/API/Window/vrdisplaypresentchange_event">vrdisplaypresentchange event</a> (part of the <a href="/en-US/docs/Web/API/WebVR_API">WebVR API</a>, hangs off the <a href="/en-US/docs/Web/API/Window">Window</a>) interface</li>
 <li><a href="/en-US/docs/Web/API/Window/onvrdisplaypresentchange">onvrdisplaypresentchange event handler</a> (part of the <a href="/en-US/docs/Web/API/WebVR_API">WebVR API</a>, hangs off the <a href="/en-US/docs/Web/API/Window">Window</a>) interface</li>
</ul>

<h3 id="Templates_3">Templates</h3>

<ul>
 <li><a href="/en-US/docs/MDN/Structures/Page_types/API_method_subpage_template">API method subpage template</a></li>
 <li><a href="/en-US/docs/MDN/Structures/Page_types/API_property_subpage_template">API property subpage template</a></li>
 <li><a href="/en-US/docs/MDN/Structures/Page_types/API_constructor_subpage_template">API constructor subpage template</a></li>
 <li><a href="/en-US/docs/MDN/Structures/Page_types/API_event_subpage_template">API event subpage template</a></li>
 <li><a href="/en-US/docs/MDN/Structures/Page_types/API_event_handler_subpage_template">API event handler subpage template</a></li>
</ul>

<h2 id="HTML_element_reference_page">HTML element reference page</h2>
...
<ul>
 <li><a href="/en-US/docs/Web/HTML/Element/video"><code>&lt;video&gt;</code> element</a></li>
</ul>

<h3 id="Templates_4">Templates</h3>

<ul>
 <li><a href="/en-US/docs/MDN/Structures/Page_types/HTML_element_page_template">HTML element page template</a></li>
</ul>

<h2 id="SVG_element_reference_page">SVG element reference page</h2>
...
<ul>
 <li><a href="/en-US/docs/Web/SVG/Element/g">&lt;g&gt; element</a></li>
</ul>

<h3 id="Templates_5">Templates</h3>

<ul>
 <li><a href="/en-US/docs/MDN/Structures/Page_types/SVG_element_page_template">SVG element page template</a></li>
</ul>

<h2 id="CSS_feature_reference_page">CSS feature reference page</h2>
...
<ul>
 <li><a href="/en-US/docs/Web/CSS/background-color">background-color property</a></li>
 <li><a href="/en-US/docs/Web/CSS/:hover">:hover pseudo-class</a></li>
 <li><a href="/en-US/docs/Web/CSS/@media">@media at-rule</a></li>
</ul>

<h3 id="Templates_6">Templates</h3>

<ul>
 <li><a href="/en-US/docs/MDN/Structures/Page_types/CSS_property_page_template">CSS property page template</a></li>
 <li><a href="/en-US/docs/MDN/Structures/Page_types/CSS_selector_page_template">CSS selector page template</a></li>
</ul>

<h2 id="HTTP_header_reference_page">HTTP header reference page</h2>
...
<ul>
 <li><a href="/en-US/docs/Web/HTTP/Headers/Cache-Control">Cache-Control header</a></li>
</ul>

<h3 id="Templates_7">Templates</h3>

<ul>
 <li><a href="/en-US/docs/MDN/Structures/Page_types/HTTP_header_page_template">HTTP header page template</a></li>
</ul>

<h2 id="Conceptual_page">Conceptual page</h2>
...
<ul>
 ...
 <li><a href="/en-US/docs/Learn/CSS/Building_blocks/Cascade_and_inheritance">Cascade and inheritance in CSS</a></li>
</ul>

<h2 id="Glossary_page">Glossary page</h2>

<p>A <strong>glossary page</strong> contains a brief explanation of a term, topic, or concept. The first paragraph should be a simple, self-contained description of the term, no more than a couple sentences. This can be followed by links to further information in the <strong>Learn more</strong> section. If the page grows to more than a screenful or so, it's too long and should be converted to a conceptual page. See <a href="/en-US/docs/MDN/Contribute/Howto/Write_a_new_entry_in_the_Glossary">How to write and reference an entry in the glossary</a> for more details.</p>

<h3 id="Examples_4">Examples</h3>

<ul>
 <li><a href="/en-US/docs/Glossary/DOM">DOM</a></li>
 <li><a href="/en-US/docs/Glossary/Exception">Exception</a></li>
 <li><a href="/en-US/docs/Glossary/Hyperlink">Hyperlink</a></li>
</ul>

<h3 id="Templates_8">Templates</h3>

<ul>
 <li><a href="/en-US/docs/MDN/Structures/Page_types/Glossary_page_template">Glossary page template</a></li>
</ul>
...
<ul>
 ...
 <li><a href="/en-US/docs/Learn">Learning area</a></li>
