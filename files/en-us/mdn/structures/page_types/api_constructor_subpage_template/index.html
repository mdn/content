...
<p>Include a description of the constructor's return value, including data type and what it represents. This is normally just "An instance of the {{domxref("<em>Name</em>Of<em>TheParentInterface</em>")}} object."</p>

<h3 id="Exceptions">Exceptions</h3>

<dl>
	<dt>Exception1</dt>
	<dd>Include a list of all the exceptions that the constructor can raise, along with descriptions of how that exception is raised. Include one term and definition for each exception.</dd>
	<dt>Exception2</dt>
	<dd>etc.</dd>
</dl>
...
<p>Fill in a simple example that nicely shows a typical usage of the constructor, then perhaps some more complex examples (see our guide on how to add <a href="/en-US/docs/MDN/Structures/Code_examples">code examples</a> for more information).</p>
