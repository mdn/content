...
<p class="summary">The summary paragraph — start by naming the event handler, saying what interface it is part of, and saying what it does. This should ideally be 1 or 2 short sentences. You could copy most of this from the property's summary on the corresponding API reference page.</p>
...
<p>Fill in a simple example that nicely shows a typical usage of the event handler, then perhaps some more complex examples (see our guide on how to add <a href="/en-US/docs/MDN/Structures/Code_examples">code examples</a> for more information).</p>
