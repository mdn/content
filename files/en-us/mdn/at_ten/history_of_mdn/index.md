...
<pre class="brush: css hidden">body{margin-top:8px;}
</pre>
</div>

<p>{{ EmbedLiveSample('audio', '100%', '70px', '', '', 'no-buttons') }}</p>

<img alt="The Berlin Office" src="11073502_781006205281080_8135317797319228200_o-600x400.jpg">
<p>The <a href="https://blog.mozilla.org/community/2015/04/17/a-highly-productive-hack-on-mdn-weekend-in-berlin/">2015 Berlin "Hack on MDN"</a>, where this talk was recorded.</p>

<h2 id="Topics">Topics</h2>

<p>Here's an overview of what was discussed, with timestamps and some additional details:</p>

<h3 id="What_is_MDN_and_who_is_it_for_A_place_for_the_Open_Web_community">What is MDN and who is it for?<br>
 <small>A place for the Open Web community</small></h3>

<p><em>0:00:00 - 0:07:15</em></p>
...
<h3 id="The_history_of_MDN_Pre-wiki_era_–_Netscape_DevEdge">The history of MDN<br>
 <small>Pre-wiki era – Netscape DevEdge</small></h3>

<p><em>0:07:15 - 0:08:17</em></p>
...
<p><a href="https://web.archive.org/web/20020819120942/http://devedge.netscape.com/"><img alt="Netscape DevEdge" src="devedge.png"> </a></p>
...
<h3 id="MediaWiki_The_first_wiki_engine">MediaWiki<br>
 <small>The first wiki engine</small></h3>

<p><em>0:08:17 - 0:14:55</em></p>
...
<p><a href="https://web.archive.org/web/20051226031957/https://developer.mozilla.org/en/docs/Main_Page"><img alt="MDC MediaWiki" src="mediawiki.png"> </a></p>

<h3 id="DekiWiki_The_second_wiki_engine">DekiWiki<br>
 <small>The second wiki engine</small></h3>

<p><em>0:14:55 - 0:26:08</em></p>

<p>In August 2008, the Mozilla Developer Center switched to <a href="https://sourceforge.net/projects/dekiwiki/">MindTouch DekiWiki</a>, a powerful and new content management system and wiki system for technical documentation. This platform change was quite controversial in the community that was used to MediaWiki from 2005 on and built tools around it. During this phase, we started Doc Sprints to re-engage with the community.</p>

<p><a href="https://web.archive.org/web/20080907231611/https://developer.mozilla.org/en"><img alt="MDC DekiWiki" src="screenshot_2018-07-24_16.06.55.png"> </a></p>

<h3 id="Kuma_The_third_and_current_wiki_engine">Kuma<br>
 <small>The third and current wiki engine</small></h3>

<p><em>0:26:08 - 0:31:50</em><br>
 <em>0:43:52 - 0:51:35</em></p>

<p><a href="https://github.com/mozilla/kuma">Kuma</a>, forked from <a href="https://github.com/mozilla/kitsune">Kitsune</a> in early 2011 and launched on August 3, 2012, is a Mozilla-built wiki platform based on Django with its own <a href="/en-US/docs/MDN/Tools/KumaScript">KumaScript</a> macro system which uses Node.js.</p>
...
<p><a href="https://web.archive.org/web/20121003233220/https://developer.mozilla.org/en-US/"><img alt="MDN KUMA" src="kuma.png"> </a></p>

<h3 id="Redesigning_MDN_Kuma_with_the_refreshed_design">Redesigning MDN<br>
 <small>Kuma with the refreshed design</small></h3>

<p><em>0:31:50 - 0:32:22</em><br>
 <em>0:51:35 - 0:58:05</em></p>
...
<p><img alt="Waffle flag" src="waffle-flag.jpg"></p>

<h3 id="Community_around_Open_Web_docs_Community-driven_browser-agnostic_Open_Web_documentation">Community around Open Web docs<br>
 <small>Community-driven, browser-agnostic Open Web documentation</small></h3>

<p><em>0:32:22 - 0:36:55</em></p>
...
<h3 id="Localization_communities_MDN_serves_a_global_audience_in_many_languages">Localization communities<br>
 <small>MDN serves a global audience in many languages</small></h3>

<p><em>0:36:55 - 0:43:52</em></p>
...
<h3 id="Learning_Area">Learning Area</h3>

<p><em>0:58:05 - 1:02:46</em></p>

<p>The MDN <a href="/en-US/docs/Learn">Learning Area</a> is a new effort to teach basic web skills. Over the last 10 years, MDN added a lot of advanced material, serving experts with valuable information. This project is focused on materials for beginners, and tries to fill in a lot of knowledge gaps.</p>

<h3 id="The_future_of_MDN_What_will_be_different_when_we_celebrate_20_years_of_MDN">The future of MDN<br>
 <small>What will be different when we celebrate 20 years of MDN?</small></h3>

<p><em>1:02:46 - 1:11:39</em></p>
...
<p>These are the people who are sharing their memories and thoughts, in the order they appear:</p>

<h3 id="Justin_Crawford_Product_Manager_MDN">Justin Crawford<br>
 <small>Product Manager, MDN</small></h3>

<p><img alt="Justin Crawford" src="hoosteeno.jpg"></p>
...
<h3 id="Eric_Sheppy_Shepherd_Technical_Writer_MDN">Eric "Sheppy" Shepherd<br>
 <small>Technical Writer, MDN</small></h3>

<p><img alt="Eric Shepherd" src="a2sheppy.png"></p>
...
<h3 id="Jérémie_Patonnier_Technical_Writer_MDN">Jérémie Patonnier<br>
 <small>Technical Writer, MDN</small></h3>

<p><img alt="Jérémie Patonnier" src="jeremiepat.jpg"></p>
...
<h3 id="Janet_Swisher_Community_Manager_MDN">Janet Swisher<br>
 <small>Community Manager, MDN</small></h3>

<p><img alt="Janet Swisher" src="jmswisher.jpg"></p>
...
<h3 id="Stormy_Peters">Stormy Peters</h3>

<p><img alt="Stormy Peters" src="yaacgvya.jpg"></p>

<p>Stormy is <a href="https://twitter.com/storming">@storming</a> on Twitter.</p>

<h3 id="Ali_Spivak_Herder_of_awesome_MDN_cats">Ali Spivak<br>
 <small>Herder of awesome MDN cats</small></h3>

<p><img alt="Ali Spivak" src="iyqi3qpv.jpg"></p>
...
<h3 id="Jean-Yves_Perrier_Technical_Writer_MDN">Jean-Yves Perrier<br>
 <small>Technical Writer, MDN</small></h3>

<p><img alt="Jean-Yves Perrier" src="teoli2003.png"></p>
...
<h3 id="Florian_Scholz_Technical_Writer_MDN">Florian Scholz<br>
 <small>Technical Writer, MDN</small></h3>

<p><img alt="Florian Scholz" src="elchi3.jpg"></p>
...
<h3 id="David_Walsh_Web_developer_MDN">David Walsh<br>
 <small>Web developer, MDN</small></h3>

<p><img alt="David Walsh" src="darkwing.png"></p>
...
<h3 id="Luke_Crouch_Web_developer_MDN">Luke Crouch<br>
 <small>Web developer, MDN</small></h3>

<p><img alt="Luke Crouch" src="groovecoder.png"></p>
...
<h3 id="Julien_a.k.a._Sphinx_French_localization_MDN">Julien (a.k.a. Sphinx)<br>
 <small>French localization, MDN</small></h3>

<p><img alt="Julien" src="ensemble.png"></p>
...
<h3 id="Biraj_Karmakar_Mozilla_Reps_Mentor">Biraj Karmakar<br>
 <small>Mozilla Reps Mentor</small></h3>

<p><img alt="Biraj Karmakar" src="birajkarmakar.png"></p>

<p>Biraj is an Open Source Contributor, interested in the FOSS movement and Localizations.</p>

<h2 id="Our_awesome_contributors">Our awesome contributors</h2>

<p>Many more people have done amazing work on MDN:</p>
