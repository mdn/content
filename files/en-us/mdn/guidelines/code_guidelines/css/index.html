...
<p>The following guidelines cover how to write CSS for MDN code examples.</p>

<h2 id="In_this_article">In this article</h2>

<ul>
 <li><a href="/en-US/docs/MDN/Guidelines/Code_guidelines/CSS#high-level_guidelines">High-level guidelines</a>

  <ul>
   <li><a href="/en-US/docs/MDN/Guidelines/Code_guidelines/CSS#dont_use_preprocessors">Don't use preprocessors</a></li>
   <li><a href="/en-US/docs/MDN/Guidelines/Code_guidelines/CSS#dont_use_specific_css_methodologies">Don't use specific CSS methodologies</a></li>
   <li><a href="/en-US/docs/MDN/Guidelines/Code_guidelines/CSS#use_flexiblerelative_units">Use flexible/relative units</a></li>
   <li><a href="/en-US/docs/MDN/Guidelines/Code_guidelines/CSS#dont_use_resets">Don't use resets</a></li>
   <li><a href="/en-US/docs/MDN/Guidelines/Code_guidelines/CSS#plan_your_css_%e2%80%94_avoid_overriding">Plan your CSS — avoid overriding</a></li>
  </ul>
 </li>
 <li><a href="/en-US/docs/MDN/Guidelines/Code_guidelines/CSS#general_css_coding_style">General CSS coding style</a>
  <ul>
   <li><a href="/en-US/docs/MDN/Guidelines/Code_guidelines/CSS#use_expanded_syntax">Use expanded syntax</a></li>
   <li><a href="/en-US/docs/MDN/Guidelines/Code_guidelines/CSS#favor_longhand_rules_over_terse_shorthand">Favor longhand rules over terse shorthand</a></li>
   <li><a href="/en-US/docs/MDN/Guidelines/Code_guidelines/CSS#use_double_quotes_around_values">Use double quotes around values</a></li>
   <li><a href="/en-US/docs/MDN/Guidelines/Code_guidelines/CSS#spacing_around_function_parameters">Spacing around function parameters</a></li>
   <li><a href="/en-US/docs/MDN/Guidelines/Code_guidelines/CSS#css_comments">CSS comments</a></li>
   <li><a href="/en-US/docs/MDN/Guidelines/Code_guidelines/CSS#dont_use_!important">Don't use !important</a></li>
  </ul>
 </li>
 <li><a href="/en-US/docs/MDN/Guidelines/Code_guidelines/CSS#specific_css_syntax_points">Specific CSS syntax points</a>
  <ul>
   <li><a href="/en-US/docs/MDN/Guidelines/Code_guidelines/CSS#turning_off_borders_and_other_properties">Turning off borders and other properties</a></li>
   <li><a href="/en-US/docs/MDN/Guidelines/Code_guidelines/CSS#use_mobile_first_media_queries">Use "mobile first" media queries</a></li>
  </ul>
 </li>
 <li><a href="/en-US/docs/MDN/Guidelines/Code_guidelines/CSS#selectors">Selectors</a>
  <ul>
   <li><a href="/en-US/docs/MDN/Guidelines/Code_guidelines/CSS#dont_use_id_selectors">Don't use ID selectors</a></li>
   <li><a href="/en-US/docs/MDN/Guidelines/Code_guidelines/CSS#put_multiple_selectors_on_separate_lines">Put multiple selectors on separate lines</a></li>
  </ul>
 </li>
</ul>
...
<p>Don't use preprocessor syntax, e.g. <a href="https://sass-lang.com/">Sass</a>, <a href="https://lesscss.org/">Less</a>, or <a href="https://stylus-lang.com/">Stylus,</a> in your MDN example code. MDN documents the vanilla CSS language, and using preprocessors only serves to raise the bar to understanding the examples, potentially confusing readers.</p>
...
<ul>
 ...
 <li>{{cssxref("column-gap")}}: <code>0</code></li>
 <li>{{cssxref("row-gap")}}: <code>0</code></li>
...
<p>As an example, the first value that can be parsed as a <a href="/en-US/docs/Web/CSS/time" title="The &lt;time&gt; CSS data type represents a time value expressed in seconds or milliseconds. It is used in animation, transition, and related properties."><code>&lt;time&gt;</code></a> is assigned to the <a href="/en-US/docs/Web/CSS/animation-duration" title="The animation-duration CSS property sets the length of time that an animation takes to complete one cycle."><code>animation-duration</code></a>, and the second one is assigned to <a href="/en-US/docs/Web/CSS/animation-delay" title="The animation-delay CSS property sets when an animation starts. The animation can start later, immediately from its beginning, or immediately and partway through the animation."><code>animation-delay</code></a>. For more details, read the full <a href="/en-US/docs/Web/CSS/animation#syntax">animation syntax</a> details.</p>
...
<pre class="brush: css example-good">/* This is a CSS-style comment */</pre>
...
<p><code>!important</code> is a last resort generally only used when you need to override something and there is no other way. It is a bad practice and you should avoid it wherever possible.</p>
...
<pre class="brush: css example-good">/*Default CSS layout for narrow screens*/
...
<p>This has many advantages, outlined in our <a href="/en-US/docs/Web/Progressive_web_apps/Responsive/Mobile_first">Mobile First</a> article.</p>
