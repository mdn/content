...
<p>MDN Web Docs is not a very video-heavy site, but there are certain places where video content makes sense to use as part of an article. This article discusses when including videos in MDN articles is appropriate, and provides tips on how to create simple but effective videos on a budget.</p>

<h2 id="When_to_use_video_on_MDN">When to use video on MDN</h2>

<p>There are several arguments against using video content for technical documentation, particularly reference material and advanced level guides:</p>

<ul>
 <li>
  <p>Video is linear. People don’t tend to read online documentation in a linear fashion, starting at the start and reading through to the end. <a href="https://www.sensible.com/chapter.html">They scan</a>. Video is really hard to scan — it forces the user to consume the content start-to-finish.</p>
 </li>
 <li>
...
<p>There are many popular video sites that provide a lot of video tutorials. MDN isn't a video-driven site, but video does have a place on MDN in certain contexts.</p>
