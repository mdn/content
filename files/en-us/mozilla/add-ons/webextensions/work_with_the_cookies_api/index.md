...
<div class="note">
<p><strong>Note:</strong> The behavior of cookies can be controlled using the {{WebExtAPIRef("privacy.websites")}} <code>cookieConfig</code> property. This property controls whether and how cookies are accepted or whether all cookies are treated as session cookies.</p>
</div>

<h2 id="Permissions">Permissions</h2>

<p>To use the Cookies API you need to request both the <code>"cookies"</code> permission and <a href="/en-US/docs/Mozilla/Add-ons/WebExtensions/manifest.json/permissions#host_permissions">host permissions</a> for the protocols, domains, or websites you want to access or use <code>"&lt;all_urls&gt;"</code> to access any protocol and domain. The way in which you define your host permission string affects your extension’s ability to read, write, and delete cookies.</p>
