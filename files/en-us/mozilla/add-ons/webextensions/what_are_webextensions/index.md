...
![A new tab styled by the Tabliss extension shows a woodland picture with the time and a greeting message.](tabliss_new_tab.png)
...
![uBlock origin pop-up shows blocked tracker statistics.](ublock_origin_add_on.png)
