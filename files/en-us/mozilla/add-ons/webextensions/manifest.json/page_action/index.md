...
- `show_matches` {{optional_inline}}
  - : `Array` of [match patterns](/en-US/docs/Mozilla/Add-ons/WebExtensions/Match_patterns). Show the page action by default for pages whose URLs match any of the given match patterns. See also `hide_matches`.
