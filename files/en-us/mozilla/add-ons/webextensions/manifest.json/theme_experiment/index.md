...
<p><strong>Note:</strong> This key is only available for use in Firefox Developer Edition and Firefox Nightly channels and requires the <code>extensions.experiments.enabled</code> preference to be enabled. In Firefox 73 and earlier, the <code>extensions.legacy.enabled</code> had to be used instead.</p>
</div>
...
<img alt="Outcome of a theme experiment, showing the reload button colored orange." src="theme_experiment.png">
