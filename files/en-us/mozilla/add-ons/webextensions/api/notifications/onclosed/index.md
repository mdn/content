...
<p>Fired when a notification is closed, either by the system or by the user.</p>
...
<dl>
 ...
 <dl>
  ...
  <dd><code>boolean</code>. <code>true</code> if the notification was closed by the user, or <code>false</code> if it was closed by the system. This argument is not supported in Firefox.</dd>
 </dl>
 </dd>
</dl>
...
<p>In this simple example we add a listener to the {{WebExtAPIRef("notifications.onClosed")}} event to listen for system notifications being closed. When this occurs, we log an appropriate message to the console.</p>
