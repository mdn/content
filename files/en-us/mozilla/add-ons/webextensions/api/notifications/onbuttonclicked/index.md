...
<p>Fired when the user clicks one of the notification's buttons.</p>
...
<dl>
 ...
 <dl>
  ...
  <dd><code>integer</code>. The <a href="https://en.wikipedia.org/wiki/Zero-based_numbering">zero-based</a> index of the button that was clicked.</dd>
 </dl>
 </dd>
</dl>
