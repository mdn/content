...
<p>Fired when the user clicks a notification, but not on any of the notification's buttons (for that, see {{WebExtAPIRef("notifications.onButtonClicked")}}).</p>

<h2 id="Syntax">Syntax</h2>

<pre class="brush:js">browser.notifications.onClicked.addListener(callback)
...
<p>In this simple example we add a listener to the {{WebExtAPIRef("notifications.onClicked")}} event to listen for system notifications being clicked. When this occurs, we log an appropriate message to the console.</p>
