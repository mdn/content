...
- `excludeMatches` {{optional_inline}}
  - : `array` of [match patterns](/en-US/docs/Mozilla/Add-ons/WebExtensions/Match_patterns). Array of pages that this content script is excluded from but would otherwise be injected into.
- `id`
...
- `matches` {{optional_inline}}
  - : `array` of [match patterns](/en-US/docs/Mozilla/Add-ons/WebExtensions/Match_patterns). Array of the pages this content script is injected into. Must be specified for {{WebExtAPIRef("scripting.registerContentScripts()")}}.
