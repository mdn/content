...
<p>Creates a new contextual identity. Once created, the user will be able to create new tabs belonging to this contextual identity, just as they can with the built-in identities.</p>
...
<dl>
 ...
 <dl>
  ...
  <dd>
  <p><code>string</code>. The color associated with the new identity. This will be used to highlight tabs belonging to this identity. You can supply any of the following values here:</p>
  ...
  <dd>
  <p><code>string</code>. The name of an icon to display in the URL bar for tabs belonging to this identity. You can supply any of the following values here:</p>
...
<p>This example creates a new contextual identity and logs its cookie store ID:</p>
