...
Schedule code to run at a specific time in the future. This is like {{domxref("Window.setTimeout()")}}, {{domxref("Window.setInterval()")}}, except that those functions don't work with background pages that are loaded on demand.
