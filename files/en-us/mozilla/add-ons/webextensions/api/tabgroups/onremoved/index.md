...
> [!NOTE] In Firefox, this event does not fire when a window is closed ([bug 1965007](https://bugzilla.mozilla.org/show_bug.cgi?id=1965007)). As an alternative, use {{WebExtAPIRef("windows.onRemoved")}} to detect closed windows, and retrieve the remaining set of groups with {{WebExtAPIRef("tabGroups.query()")}}.
## Syntax
