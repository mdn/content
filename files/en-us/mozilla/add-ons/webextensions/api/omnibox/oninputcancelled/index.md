...
<p>Fired when the user has cancelled their interaction with your extension (for example, by clicking outside the address bar).</p>
...
<p>The listener function is passed no parameters.</p>
