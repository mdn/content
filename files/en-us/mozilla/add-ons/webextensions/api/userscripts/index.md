...
- {{WebExtAPIRef("userScripts.ExecutionWorld")}}
  - : The execution environment for a script injected with {{WebExtAPIRef("userScripts.execute()")}}, {{WebExtAPIRef("userScripts.register()")}}, or {{WebExtAPIRef("userScripts.update()")}}.
