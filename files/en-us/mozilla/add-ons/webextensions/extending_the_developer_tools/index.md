...
The devtools page doesn't have any visible DOM, but can include JavaScript sources using [`<script>`](/en-US/docs/Web/HTML/Reference/Element/script) tags. The sources must be bundled with the extension itself. The sources get access to:
