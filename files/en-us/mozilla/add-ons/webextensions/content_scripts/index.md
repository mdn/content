...
The same applies to [`setTimeout()`](/en-US/docs/Web/API/Window/setTimeout), [`setInterval()`](/en-US/docs/Web/API/setInterval), and [`Function()`](/en-US/docs/Web/JavaScript/Reference/Global_Objects/Function).
