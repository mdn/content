...
<table class="fullwidth-table standard-table">
  ...
  <tbody>
    <tr>
      <td>
        <code
          ><a href="/en-US/docs/Web/HTML/Reference/Element/button">&#x3C;button></a></code
        >
      </td>
      <td>
...
&#x3C;button class="browser-style">Click me&#x3C;/button></pre
    ...
    <tr>
      <td>
        <p>
          <code
            ><a href="/en-US/docs/Web/HTML/Reference/Element/select"
              >&#x3C;select></a
            ></code
          >
        </p>
...
&#x3C;/select></pre
    ...
    <tr>
      <td>
        <code
          ><a href="/en-US/docs/Web/HTML/Reference/Element/textarea"
            >&#x3C;textarea></a
          ></code
        >
      </td>
...
&#x3C;textarea class="browser-style">Write here&#x3C;/textarea></pre
    ...
    <tr>
      <td>
        Parent of an
        <code
          ><a href="/en-US/docs/Web/HTML/Reference/Element/input">&#x3C;input></a></code
        >
      </td>
      <td>
        <pre class="brush: html">
