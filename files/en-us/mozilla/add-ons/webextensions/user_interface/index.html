...
<div class="note">
<p><strong>Note:</strong> For advice on using these UI components to create a great user experience in your extension, please see the <a href="https://extensionworkshop.com/documentation/develop/user-experience-best-practices/">User experience best practices</a> article.</p>
</div>
...
<table class="standard-table">
 ...
 <tbody>
  <tr>
   <td><a href="/en-US/docs/Mozilla/Add-ons/WebExtensions/user_interface/Browser_action">Toolbar button</a> (browser action)</td>
   ...
   <td><img alt="Example showing a toolbar button (browser action)." src="browser-action.png"></td>
  </tr>
  <tr>
   <td>Toolbar button with a <a href="/en-US/docs/Mozilla/Add-ons/WebExtensions/user_interface/Popups">popup</a></td>
   ...
   <td><img alt="Example of the pop-up on a toolbar button" src="popup-shadow.png"></td>
  </tr>
  <tr>
   <td><a href="/en-US/docs/Mozilla/Add-ons/WebExtensions/user_interface/Page_actions">Address bar button</a> (page action)</td>
  ...
  <tr>
   <td>Address bar button with a <a href="/en-US/docs/Mozilla/Add-ons/WebExtensions/user_interface/Popups">popup</a></td>
  ...
  <tr>
   <td><a href="/en-US/docs/Mozilla/Add-ons/WebExtensions/user_interface/Context_menu_items">Context menu item</a></td>
   ...
   <td><img alt="Example of content menu items added by a WebExtension, from the context-menu-demo example" src="context_menu_example.png"></td>
  </tr>
  <tr>
   <td><a href="/en-US/docs/Mozilla/Add-ons/WebExtensions/user_interface/Sidebars">Sidebar</a></td>
   <td>
    <p>An HTML document displayed next to a web page, with the option for unique content per page. The sidebar is opened when the extension is installed, then obeys the user's sidebar visibility selection. User interaction within the sidebar is handled by its HTML document.</p>
   </td>
   <td><img alt="Example of a sidebar" src="bookmarks-sidebar.png"></td>
  </tr>
  <tr>
   <td><a href="/en-US/docs/Mozilla/Add-ons/WebExtensions/user_interface/Options_pages">Options page</a></td>
  ...
  <tr>
   <td><a href="/en-US/docs/Mozilla/Add-ons/WebExtensions/user_interface/Extension_pages">Extension page</a></td>
  ...
  <tr>
   <td><a href="/en-US/docs/Mozilla/Add-ons/WebExtensions/user_interface/Notifications">Notification</a></td>
   ...
   <td><img alt="Example of an extension triggered system notification" src="notify-shadowed.png"></td>
  </tr>
  <tr>
  ...
  <tr>
   <td><a href="/en-US/docs/Mozilla/Add-ons/WebExtensions/user_interface/devtools_panels">Developer tools panel</a></td>
   <td>A tab with an associated HTML document that displays in the browser's developer tools.</td>
   <td><img alt="Example showing the result of the firefox_code_search WebExtension's customization of the address bar suggestions." src="developer_panel_tab.png"></td>
  </tr>
 </tbody>
</table>
