...
- Make cross-domain XHR requests (with appropriate [CORS configuration](/en-US/docs/Web/Security/Practical_implementation_guides/CORS) in place or using background scripts).
