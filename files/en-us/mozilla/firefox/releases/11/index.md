...
- SVG-as-an-image can now be drawn into a canvas without [tainting the canvas](/en-US/docs/Web/HTML/Guides/CORS_enabled_image#what_is_a_.22tainted.22_canvas.3f).
