...
- [CSS3](/en-US/docs/Web/CSS) [Conditional Rules](/en-US/docs/Web/CSS/CSS_syntax/At-rule#block_at-rules) are now better supported: nested statements can now be added to [@media](/en-US/docs/Web/CSS/Reference/At-rules/@media), [@-moz-document](/en-US/docs/Web/CSS/Reference/At-rules/@document). (See [CSS Syntax](/en-US/docs/Web/CSS/CSS_syntax/Syntax) and [CSS at-rules](/en-US/docs/Web/CSS/CSS_syntax/At-rule)).
