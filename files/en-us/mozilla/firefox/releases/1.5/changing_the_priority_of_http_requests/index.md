...
>
> The best way to request resources over HTTP is to use [`fetch()`](/en-US/docs/Web/API/Window/fetch), which allows you to specify the [`priority`](/en-US/docs/Web/API/RequestInit#priority).
