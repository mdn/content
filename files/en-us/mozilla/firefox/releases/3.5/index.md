...
- [HTML video and audio](/en-US/docs/Learn_web_development/Core/Structuring_content/HTML_video_and_audio)
  - : Firefox 3.5 adds support for the HTML 5 [`audio`](/en-US/docs/Web/HTML/Reference/Element/audio) and [`video`](/en-US/docs/Web/HTML/Reference/Element/video) elements.
...
- `moz-opaque` attribute
  - : Added the [`moz-opaque`](/en-US/docs/Web/HTML/Reference/Element/canvas#moz-opaque) attribute, which lets the canvas know whether or not translucency will be a factor. If the canvas knows there's no translucency, painting performance can be optimized. See also {{domxref("HTMLCanvasElement.mozOpaque")}}.
...
- The `defer` attribute is now supported on [`script`](/en-US/docs/Web/HTML/Reference/Element/script) elements
...
- The `GetSVGDocument()` method has been added to [`object`](/en-US/docs/Web/HTML/Reference/Element/object) and [`iframe`](/en-US/docs/Web/HTML/Reference/Element/iframe) elements for compatibility.
