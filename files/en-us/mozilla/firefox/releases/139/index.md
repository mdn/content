...
- The {{WebExtAPIRef("tabGroups")}} API is now available. This API enables extensions to modify and rearrange tab groups. The [tab groups](https://support.mozilla.org/en-US/kb/tab-groups) feature was made available to users in Firefox 137. For more information, see [WebExtensions Support for Tab Groups](https://blog.mozilla.org/addons/2025/04/30/webextensions-support-for-tab-groups/). ([Firefox bug 1940631](https://bugzil.la/1940631))
