...
- With the introduction of the [extensions button](https://support.mozilla.org/kb/unified-extensions), the default value for `browser_action.default_area` has changed from `"navbar"` to `"menupanel" ({{bug(1799947)}}).
