...
- Implemented various commands to intercept requests:
  ...
  - [network.continueWithAuth](https://w3c.github.io/webdriver-bidi/#command-network-continueWithAuth) allows you to resume requests intercepted in the `AuthRequired` phase. Using the "action" argument, clients can either "cancel", "provideCredentials" with username and password, or fallback to "default" to let the browser display the authentication prompt.([Firefox bug 1826196](https://bugzil.la/1826196))
