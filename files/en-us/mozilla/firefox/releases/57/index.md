...
- The `Object.prototype.watch()` and `Object.prototype.unwatch()` methods are deprecated, will now throw a warning when used, and will be removed soon ([Firefox bug 934669](https://bugzil.la/934669)).
- The non-standard {{JSxRef("Iterator")}} and `StopIteration` objects as well as the legacy iteration protocol have been removed ([Firefox bug 1098412](https://bugzil.la/1098412)).
