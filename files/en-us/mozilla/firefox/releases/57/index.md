...
- The [date](/en-US/docs/Web/HTML/Reference/Element/input/date) and [time](/en-US/docs/Web/HTML/Reference/Element/input/time) {{htmlelement("input")}} types are now enabled in all builds ([Firefox bug 1399036](https://bugzil.la/1399036)).
