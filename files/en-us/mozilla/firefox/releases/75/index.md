...
The new roles and objects related to [ARIA annotations](/en-US/docs/Web/Accessibility/ARIA) are now exposed in Firefox, on Windows and Linux (bear in mind that these still won't be usable until screen readers start to support them):
