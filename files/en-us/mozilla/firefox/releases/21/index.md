...
- The `scoped` attribute has been added to the {{HTMLElement("style")}} element. It allows you to include styles that are isolated from the rest of the document. Such styles can be selected using the {{cssxref(":scope")}} CSS pseudo-class introduced in Firefox 20. ([Firefox bug 508725](https://bugzil.la/508725)).
