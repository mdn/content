...
- The JSON parser has been re-written for improved speed and compliance. This includes a fix for [Firefox bug 572279](https://bugzilla.mozilla.org/show_bug.cgi?id=572279).
...
- `nsICiter` (see [Firefox bug 633066](https://bugzilla.mozilla.org/show_bug.cgi?id=633066))
- `nsIDOM3Document` (see [Firefox bug 639849](https://bugzilla.mozilla.org/show_bug.cgi?id=639849))
- `nsIFIXptrEvaluator`
- `nsISelectElement` (see [Firefox bug 619996](https://bugzilla.mozilla.org/show_bug.cgi?id=619996))
