...
- The {{DOMxRef("URL.createObjectURL_static")}} and {{DOMxRef("URL.revokeObjectURL_static")}} methods are no longer available on {{DOMxRef("ServiceWorker")}} instances due to the potential they introduced for memory leaks to occur ([Firefox bug 1264182](https://bugzil.la/1264182)).
