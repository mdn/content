...
- The Fonts tab in the [Page Inspector](https://firefox-source-docs.mozilla.org/devtools-user/page_inspector/index.html) now includes an editor that makes it easy to view and edit the settings of the fonts on your page. See [Edit fonts](/en-US/docs/Tools/Page_Inspector/How_to/Edit_fonts) for details.
...
- When you hover over an object in the [Accessibility Inspector](https://firefox-source-docs.mozilla.org/devtools-user/accessibility_inspector/index.html), [the item is highlighted](/en-US/docs/Tools/Accessibility_inspector#highlighting_of_ui_items) and its role and name will be shown in an information bar on the page ({{bug(1473030)}}).
...
- A new icon has been added to the content in the [Network Monitor](https://firefox-source-docs.mozilla.org/devtools-user/network_monitor/index.html) to indicate when a URL belongs to a known tracker — see {{SectionOnPage("/en-US/docs/Tools/Network_Monitor/request_list", "Security icons")}} ({{bug(1333994)}}).
