...
<p>Firefox 16 shipped on October 9, 2012. This article lists key changes that are useful for not only Web developers to know about, but also Firefox and Gecko developers as well as add-on developers.</p>
...
<ul>
 <li>Support for the standard, unprefixed version of <a href="/en-US/docs/Web/CSS/CSS_Animations/Using_CSS_animations">CSS Animations</a> has been landed (<a href="https://bugzilla.mozilla.org/show_bug.cgi?id=762302">bug 762302</a>).</li>
 ...
 <li>Support for the standard, unprefixed version of <a href="/en-US/docs/Web/CSS/CSS_Transforms/Using_CSS_transforms">CSS Transforms</a> has been landed (<a href="https://bugzilla.mozilla.org/show_bug.cgi?id=745523">bug 745523</a>). {{cssxref("&lt;length&gt;")}} cannot be used for translation values in <code>matrix()</code> and <code>matrix3d()</code> anymore ({{bug(719054)}}).</li>
 <li>Support for the standard, unprefixed version of <a href="/en-US/docs/Web/CSS/CSS_Images/Using_CSS_gradients">CSS Gradients</a> has been landed. Note that the syntax has changed significantly since the prefixed version, so you should read up on this (<a href="https://bugzilla.mozilla.org/show_bug.cgi?id=752187">bug 752187</a>).</li>
 ...
 <li>On screen, for <a href="/en-US/docs/Web/CSS/Media_Queries/Using_media_queries">media queries</a>, <code>dppx</code>, <code>dpi</code>, and <code>dpcm</code> are now representing values based on CSS pixels and no more with the physical units (<a href="https://bugzilla.mozilla.org/show_bug.cgi?id=771390">bug 771390</a>).</li>
 ...
 <li>The {{cssxref("appearance")}} property gains two new values: <code>meterbar</code> and <code>meterchunk</code>. They represent components inside the {{HTMLElement("meter")}} element (<a href="https://bugzilla.mozilla.org/show_bug.cgi?id=659999">bug 659999</a>).</li>
...
<ul>
 <li>Two new properties <code>width</code> and <code>height</code> have been added to the {{domxref("HTMLInputElement")}} interface (<a href="https://bugzilla.mozilla.org/show_bug.cgi?id=683855">bug 683855</a>).</li>
 <li>IndexedDB properties and methods have been unprefixed. (<a href="https://bugzilla.mozilla.org/show_bug.cgi?id=726378">bug 726378</a>)</li>
 <li>The <a href="/en-US/docs/Web/API/Navigator/battery">Battery API</a> is now unprefixed.</li>
...
<ul>
 ...
 <li>The Harmony <a href="http://wiki.ecmascript.org/doku.php?id=harmony:spread">spread operator</a> is now supported in <a href="/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array"><code>Array</code></a> initializers (<a href="https://bugzilla.mozilla.org/show_bug.cgi?id=574130">bug 574130</a>). Note it is not yet supported in calls (<a href="https://bugzilla.mozilla.org/show_bug.cgi?id=762363">bug 762363</a>).</li>
...
<ul>
 <li>Initial <a href="/en-US/docs/Web/Apps/Getting_Started">Open Web App support</a> has been implemented in the desktop versions of Firefox (that is, on Windows, Mac OS X, and Linux).</li>
</ul>
