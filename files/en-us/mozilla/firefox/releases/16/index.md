...
- Support for the standard, unprefixed version of [CSS Gradients](/en-US/docs/Web/CSS/Guides/Images/Using_CSS_gradients) has been landed. Note that the syntax has changed significantly since the prefixed version, so you should read up on this ([bug 752187](https://bugzil.la/752187)).
