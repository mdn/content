...
- The {{ domxref("console") }} object has two new methods, {{domxref("console/time()") }} and {{ domxref("console.timeEnd_static", "console.time()") }} and {{ domxref("console.timeEnd()") }}, which can be used to set timers on a page.
