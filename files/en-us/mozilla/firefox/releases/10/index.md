...
- The new `:-moz-full-screen-ancestor` property has been added. This lets you match against elements that are ancestors of an element in fullscreen mode.
...
- The CSS {{ cssxref("gradient/linear-gradient") }} and {{ cssxref("gradient/repeating-linear-gradient") }} properties have been updated to support the new `to` syntax and the _magic corner_ algorithm. This allows you to give a precise color on the corner of a gradient-filled box.
