...
- The {{ domxref("console") }} object has two new methods, {{ domxref("console.time_static") }} and {{ domxref("console.timeend_static") }}, which can be used to set timers on a page.
