...
- Multiple CSS [math functions](/en-US/docs/Web/CSS/CSS_values_and_units/CSS_value_functions#math_functions) are now supported: [`abs()`](/en-US/docs/Web/CSS/Reference/Values/abs), [`sign()`](/en-US/docs/Web/CSS/Reference/Values/sign), [`round()`](/en-US/docs/Web/CSS/Reference/Values/round), [`mod()`](/en-US/docs/Web/CSS/Reference/Values/mod), [`rem()`](/en-US/docs/Web/CSS/Reference/Values/rem), [`pow()`](/en-US/docs/Web/CSS/Reference/Values/pow), [`sqrt()`](/en-US/docs/Web/CSS/Reference/Values/sqrt), [`hypot()`](/en-US/docs/Web/CSS/Reference/Values/hypot), [`log()`](/en-US/docs/Web/CSS/Reference/Values/log), and [`exp()`](/en-US/docs/Web/CSS/Reference/Values/exp) (Firefox bug [1814589](https://bugzil.la/1814589)).
