...
- Support for the [`sandbox`](/en-US/docs/Web/HTML/Reference/Element/iframe#sandbox) attribute on the {{HTMLElement("iframe")}} element has been added. ([Firefox bug 341604](https://bugzil.la/341604))
