...
[Webkit bug 658949](https://bugzilla.mozilla.org/show_bug.cgi?id=658949) changed how the hash (#) symbol is treated in data Ls which may break CSS stylesheets which contain such symbol if it is not escaped.
