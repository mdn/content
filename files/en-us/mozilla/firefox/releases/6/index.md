...
- [Webkit bug 658949](https://bugzilla.mozilla.org/show_bug.cgi?id=658949) changed how the hash (#) symbol is treated in data URLs which may break CSS stylesheets which contain such a symbol if it is not escaped.
...
- The {{ domxref("document.height") }} and {{ domxref("document.width") }} have been removed. [Webkit bug 585877](https://bugzilla.mozilla.org/show_bug.cgi?id=585877)
...
- The {{ domxref("CustomEvent") }} interface has been implemented. (see [Firefox bug 427537](https://bugzilla.mozilla.org/show_bug.cgi?id=427537))
...
- `nsITelemetry`
  - : Implements telemetry support to allow recording of telemetry data to be used to present histograms for performance tracking purposes. See [Firefox bug 649502](https://bugzilla.mozilla.org/show_bug.cgi?id=649502) and [Firefox bug 585196](https://bugzilla.mozilla.org/show_bug.cgi?id=585196).
- `nsITimedChannel`
  - : See [Firefox bug 576006](https://bugzilla.mozilla.org/show_bug.cgi?id=576006).
- `nsIWebSocketListener`
  - : See [Firefox bug 640003](https://bugzilla.mozilla.org/show_bug.cgi?id=640003).
...
- `nsIDOMDocumentEvent` (see [Firefox bug 655517](https://bugzilla.mozilla.org/show_bug.cgi?id=655517))
- `nsIDOMDocumentTraversal` (see [Firefox bug 655514](https://bugzilla.mozilla.org/show_bug.cgi?id=655514))
- `nsIDOMDocumentRange` (see [Firefox bug 655513](https://bugzilla.mozilla.org/show_bug.cgi?id=655513))
- `IWeaveCrypto` (see [Firefox bug 651596](https://bugzilla.mozilla.org/show_bug.cgi?id=651596))
- `nsIDOM3DocumentEvent` (see [Firefox bug 481863](https://bugzilla.mozilla.org/show_bug.cgi?id=481863))
- `nsIDOMAbstractView`
- `nsILiveTitleNotificationSubject`
- `nsIPlugin` (see [Firefox bug 637253](https://bugzilla.mozilla.org/show_bug.cgi?id=637253))
- `nsIPluginInstance` (see [Firefox bug 637253](https://bugzilla.mozilla.org/show_bug.cgi?id=637253))
- `nsIHTMLEditRules` (see [Firefox bug 633750](https://bugzilla.mozilla.org/show_bug.cgi?id=633750))
- `nsIXSLTProcessorObsolete` (see [Firefox bug 649534](https://bugzilla.mozilla.org/show_bug.cgi?id=649534))
