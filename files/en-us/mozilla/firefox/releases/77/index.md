...
- Certain commands could have caused a hang of Marionette when the currently selected top-level browsing context gets removed, like closing the window by a click ({{bug(1619481)}}).
