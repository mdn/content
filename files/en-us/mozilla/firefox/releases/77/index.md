...
- Firefox now displays the [label value](/en-US/docs/Web/HTML/Reference/Element/option#browser_compatibility) on an {{HTMLElement("option")}} element when the element's content is empty. ([Firefox bug 40545](https://bugzil.la/40545))
