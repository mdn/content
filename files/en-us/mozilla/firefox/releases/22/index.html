...
<ul>
 ...
 <li>ES2015 <a href="/en-US/docs/Web/JavaScript/Reference/Functions/Arrow_functions">Arrow Function</a> syntax has been implemented ({{bug(846406)}}).</li>
 ...
 <li>The ES2015 Proxy {{jsxref("Global_Objects/Proxy/Proxy/preventExtensions", "preventExtensions")}} trap have been implemented ({{bug(789897)}}).</li>
</ul>

<h3 id="DOM">DOM</h3>

<ul>
 <li>Support for the <code>multipart</code> property on <code>XMLHttpRequest</code> and <code>multipart/x-mixed-replace</code> responses in <code>XMLHttpRequest</code> has been removed. This was a Gecko-only feature that was never standardized. <a href="/en-US/docs/Web/API/Server-sent_events">Server-Sent Events</a>, <a href="/en-US/docs/Web/API/WebSockets_API">Web Sockets</a> or inspecting <code>responseText</code> from progress events can be used instead.</li>
 <li>Support for <a href="/en-US/docs/Web/API/Notifications_API/Using_the_Notifications_API">Web Notifications</a> has been landed ({{bug(782211)}}).</li>
 ...
 <li><code>Node.setUserData</code> and <code>Node.getUserData</code> has been removed for web content and are deprecated for chrome content ({{bug(842372)}}).</li>
 <li>The {{domxref("Element.attributes")}} property has been moved there from {{domxref("Node")}} as required by the spec ({{bug("844134")}}).</li>
 <li>The Mac OS X backend for <strong>Ambient Light Events</strong> has been implemented.</li>
...
<ul>
 <li>Support for <a href="/en-US/docs/Web/CSS/CSS_Flexible_Box_Layout/Basic_Concepts_of_Flexbox">CSS Flexbox layout</a> has been enabled by default ({{bug("841876")}}).</li>
...
<ul>
 ...
 <li>The {{ifmethod('inIDOMUtils', 'getCSSPropertyNames')}} method has been implemented and will return all supported <a href="/en-US/docs/Web/CSS/Reference">CSS property</a> names.</li>
