...
- {{domxref("SharedWorkerGlobalScope.connect_event")}}'s event object is a {{domxref("MessageEvent")}} instance — its `data` property is now an empty string value rather than `null` ({{bug(1508824)}}).
