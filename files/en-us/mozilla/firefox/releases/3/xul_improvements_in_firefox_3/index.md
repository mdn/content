...
- [Numeric controls](/en-US/docs/XUL_Tutorial/Numeric_Controls):
  ...
  - A [`<spinbuttons>`](/en-US/docs/XUL/spinbuttons) element is added which can be used when creating widgets using XBL bindings. ([Firefox bug 155053](https://bugzil.la/155053))
...
- A guide has been created for [menus and popups](/en-US/docs/XUL/PopupGuide) describing new features available:
  ...
  - A [`<dropmarker>`](/en-US/docs/XUL/dropmarker) element is added which is useful when creating menu-like widgets using XBL bindings. ([Firefox bug 348614](https://bugzil.la/348614))
