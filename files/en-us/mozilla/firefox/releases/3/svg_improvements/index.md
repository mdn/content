...
- [`pattern`](/en-US/docs/Web/SVG/Reference/Element/pattern) element support
- [`mask`](/en-US/docs/Web/SVG/Reference/Element/mask) element support
- Support for all SVG 1.1 [filters](/en-US/docs/Web/SVG/Tutorials/SVG_from_scratch/Filter_effects):
...
- the [`xml:space`](/en-US/docs/Web/SVG/Reference/Attribute/xml:space) attribute support
