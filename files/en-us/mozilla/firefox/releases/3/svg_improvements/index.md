...
- The `foreignObject` element is now supported ([Webkit bug 326966](https://bugzilla.mozilla.org/show_bug.cgi?id=326966)). See the [specification](https://www.w3.org/TR/SVG11/extend.html#ForeignObjectElement) or [this article](https://robert.ocallahan.org/2006/06/future-is-now_20.html) for details.
...
- `<a>` element handling in SVG has had several bugs fixed; see [Webkit bug 267664](https://bugzilla.mozilla.org/show_bug.cgi?id=267664), [Webkit bug 268135](https://bugzilla.mozilla.org/show_bug.cgi?id=268135), [Webkit bug 316248](https://bugzilla.mozilla.org/show_bug.cgi?id=316248), [Webkit bug 317270](https://bugzilla.mozilla.org/show_bug.cgi?id=317270) and [Webkit bug 320724](https://bugzilla.mozilla.org/show_bug.cgi?id=320724).
...
- `em` and `ex` units are now supported for indicating lengths ([Webkit bug 305859](https://bugzilla.mozilla.org/show_bug.cgi?id=305859)).
