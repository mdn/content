...
<h2 id="New_developer_features_in_Firefox_3">New developer features in Firefox 3</h2>

<h3 id="For_web_site_and_application_developers">For web site and application developers</h3>

<dl>
 <dt><a href="/en-US/docs/Mozilla/Firefox/Releases/3/Updating_web_applications">Updating web applications for Firefox 3</a></dt>
...
<dl>
 <dt><a href="/en-US/docs/Web/API/Navigator/registerProtocolHandler/Web-based_protocol_handlers">Web-based protocol handlers</a></dt>
...
<dl>
 <dt><a href="/en-US/docs/Web/API/Canvas_API/Tutorial/Drawing_text">Drawing text using a canvas</a></dt>
 <dd>You can now draw text in a canvas using a non-standardized API supported by Firefox 3.</dd>
</dl>

<dl>
 <dt><a href="/en-US/docs/Canvas_tutorial/Transformations#Transforms">Transform support for canvas</a></dt>
 <dd>Firefox now supports the <code>transform()</code> and <code>setTransform()</code> methods on canvases.</dd>
</dl>

<dl>
 <dt><a href="/en-US/docs/Using_microformats">Using microformats</a></dt>
 <dd>Firefox now has APIs for working with microformats.</dd>
</dl>

<dl>
 <dt><a href="/en-US/docs/Drag_and_drop_events">Drag and drop events</a></dt>
...
<dl>
 <dt><a href="/en-US/docs/Web/HTML/Using_the_application_cache">Offline resources in Firefox</a></dt>
...
<dl>
 <dt><a href="/en-US/docs/CSS_improvements_in_Firefox_3">CSS improvements in Firefox 3</a></dt>
 <dd>Firefox 3 features a number of improvements in its CSS support.</dd>
</dl>

<dl>
 <dt><a href="/en-US/docs/Mozilla/Firefox/Releases/3/DOM_improvements">DOM improvements in Firefox 3</a></dt>
...
<dl>
 <dt><a href="/en-US/docs/New_in_JavaScript_1.8">JavaScript 1.8 support</a></dt>
 <dd>Firefox 3 offers JavaScript 1.8.</dd>
</dl>

<dl>
 <dt><a href="/en-US/docs/Web/EXSLT">EXSLT support</a></dt>
 <dd>Firefox 3 provides support for a substantial subset of the <a href="/en-US/docs/Web/EXSLT">EXSLT</a> extensions to <a href="/en-US/docs/Web/XSLT">XSLT</a>.</dd>
</dl>

<dl>
 <dt><a href="/en-US/docs/Mozilla/Firefox/Releases/3/SVG_improvements">SVG improvements in Firefox 3</a></dt>
...
<dl>
 <dt><a href="/en-US/docs/Animated_PNG_graphics">Animated PNG graphics</a></dt>
...
<dl>
 <dt><a href="/en-US/docs/Mozilla/Firefox/Releases/3/Updating_extensions">Updating extensions for Firefox 3</a></dt>
 <dd>Provides a guide to the things you'll need to do to update your extension to work with Firefox 3.</dd>
</dl>

<dl>
 <dt><a href="/en-US/docs/XUL_improvements_in_Firefox_3">XUL improvements in Firefox 3</a></dt>
...
<dl>
 <dt><a href="/en-US/docs/Templates_in_Firefox_3">Templates in Firefox 3</a></dt>
...
<dl>
 <dt><a href="/en-US/docs/Extension_Versioning,_Update_and_Compatibility#Securing_Updates">Securing updates</a></dt>
 <dd>In order to provide a more secure add-on upgrade path for users, add-ons are now required to provide a secure method for obtaining updates before they can be installed. Add-ons hosted at <a href="https://addons.mozilla.org">AMO</a> automatically provide this. Any add-ons installed that do not provide a secure update method when the user upgrades to Firefox 3 will be automatically disabled. Firefox will however continue to check for updates to the extension over the insecure path and attempt to install any update offered (installation will fail if the update also fails to provide a secure update method).</dd>
</dl>

<dl>
 <dt><a href="/en-US/docs/Places_Developer_Guide">Places migration guide</a></dt>
 <dd>An article about how to update an existing extension to use the Places API.</dd>
</dl>

<dl>
 <dt><a href="/en-US/docs/Download_Manager_improvements_in_Firefox_3">Download Manager improvements in Firefox 3</a></dt>
 <dd>The Firefox 3 Download Manager features new and improved APIs, including support for multiple progress listeners.</dd>
</dl>

<dl>
 <dt><a href="/en-US/docs/XPCOM_Interface_Reference/Using_nsILoginManager">Using nsILoginManager</a></dt>
 <dd>The Password Manager has been replaced by the new Login Manager.</dd>
</dl>

<dl>
 <dt><a href="/en-US/docs/XBL/XBL_1.0_Reference/Elements#binding">Embedding XBL bindings</a></dt>
...
<dl>
 <dt><a href="/en-US/docs/Localization_and_Plurals">Localization and Plurals</a></dt>
...
<dl>
 <dt><a href="/en-US/docs/Theme_changes_in_Firefox_3">Theme changes in Firefox 3</a></dt>
...
<dl>
 <dt><a href="/en-US/docs/Toolkit_API/FUEL">FUEL Library</a></dt>
...
<dl>
 <dt><a href="/en-US/docs/Places">Places</a></dt>
 <dd>The history and bookmarks APIs have been completely replaced by the new <a href="/en-US/docs/Places">Places</a> API.</dd>
</dl>

<dl>
 <dt><a href="/en-US/docs/nsIIdleService">Idle service</a></dt>
...
<dl>
 <dt><a href="/en-US/docs/nsIZipWriter">ZIP writer</a></dt>
 <dd>The new {{Interface("nsIZipWriter")}} interface lets extensions create ZIP archives.</dd>
</dl>

<dl>
 <dt><a href="/en-US/docs/Mozilla/Firefox/Releases/3/Full_page_zoom">Full page zoom</a></dt>
 <dd>Firefox 3 improves the user experience by offering full page zoom in addition to text-only zoom.</dd>
</dl>

<dl>
 <dt><a href="/en-US/docs/Interfacing_with_the_XPCOM_cycle_collector">Interfacing with the XPCOM cycle collector</a></dt>
...
<dl>
 <dt><a href="/en-US/docs/The_Thread_Manager">The Thread Manager</a></dt>
...
<dl>
 <dt><a href="/en-US/docs/JavaScript_code_modules">JavaScript modules</a></dt>
...
<dl>
 <dt><a href="/en-US/docs/nsIJSON">The <code>nsIJSON</code> interface</a></dt>
 <dd>Firefox 3 offers the new {{Interface("nsIJSON")}} interface, which offers high-performance encoding and decoding of <a href="/en-US/docs/Glossary/JSON">JSON</a> strings.</dd>
</dl>

<dl>
 <dt><a href="/en-US/docs/XPCOM_Interface_Reference/nsIParentalControlsService">The nsIParentalControlsService interface</a></dt>
 <dd>Firefox 3 now supports the Microsoft Windows Vista parental controls feature, and allows code to interact with it.</dd>
</dl>

<dl>
 <dt><a href="/en-US/docs/Using_content_preferences">Using content preferences</a></dt>
...
<dl>
 <dt><a href="/en-US/docs/Monitoring_plugins">Plug-in Monitoring</a></dt>
...
<h4 id="Fixed_bugs">Fixed bugs</h4>

<dl>
 <dt><a href="/en-US/docs/Mozilla/Firefox/Releases/3/Notable_bugs_fixed">Notable bugs fixed in Firefox 3</a></dt>
...
<ul>
 ...
 <li><strong>Integration with Mac OS X.</strong> Firefox now supports <a href="http://growl.info/">Growl</a> for notifications of completed downloads and available updates.</li>
...
<ul>
 ...
 <li><strong>Malware protection.</strong> Firefox 3 warns you if you arrive at a web site that is known to install viruses, spyware, trojans, or other dangerous software (known as malware). You can see what the warning looks like by <a href="https://www.mozilla.com/firefox/its-an-attack.html">clicking here</a>.</li>
 <li><strong>Web forgery protection enhanced.</strong> Now when you visit a page that's suspected of being a forgery, you're shown a special page instead of the contents of the page with a warning. <a href="https://www.mozilla.com/firefox/its-a-trap.html">Click here</a> to see what it looks like.</li>
