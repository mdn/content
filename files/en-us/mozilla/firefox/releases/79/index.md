...
- The [`<iframe>`](/en-US/docs/Web/HTML/Reference/Element/iframe) element's `sandbox` attribute now supports the `allow-top-navigation-by-user-activation` token ([Firefox bug 1359867](https://bugzil.la/1359867)).
- Setting `target="_blank"` on [`<a>`](/en-US/docs/Web/HTML/Reference/Element/a) and [`<area>`](/en-US/docs/Web/HTML/Reference/Element/area) elements implicitly provides the same behavior as also setting `rel="noopener"` ([Firefox bug 1522083](https://bugzil.la/1522083)).
