...
- [`<link rel="prefetch">`](/en-US/docs/Glossary/Prefetch) now obeys the [`crossorigin`](/en-US/docs/Web/HTML/Reference/Element/link#crossorigin) attribute ([Firefox bug 1214819](https://bugzil.la/1214819)).
