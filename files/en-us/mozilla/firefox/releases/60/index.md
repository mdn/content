...
- Also in the CSS Pane rules view, [CSS variable names](/en-US/docs/Web/CSS/Guides/Cascading_variables/Using_custom_properties) will now auto-complete ([Firefox bug 1422635](https://bugzil.la/1422635)). If you enter `var(` into a property value and then type a dash (`-`), any variables you have declared in your CSS will then appear in an autocomplete list.
