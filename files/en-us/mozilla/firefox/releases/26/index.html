...
<ul>
 ...
 <li>The non-standard {{cssxref("-moz-text-blink")}} property has been removed ({{bug("812995")}}).</li>
 ...
 <li>The {{cssxref("text-align")}} property now applies to the <code>::-moz-placeholder</code> pseudo-element ({{bug(915551)}}).</li>
</ul>
...
<p><a href="/en-US/docs/Web/JavaScript/ECMAScript_6_support_in_Mozilla">EcmaScript 2015</a> implementation continues!</p>

<ul>
 <li>The ECMAScript 2015 compliant syntax for <a href="http://wiki.ecmascript.org/doku.php?id=harmony:generators">Generators (yield)</a> has been implemented ({{bug("666399")}}).</li>
 <li>Generator/Iterator results are now boxed like <code>{ value: foo, done: bool }</code> ({{bug(907744)}}).</li>
 <li>New mathematical methods have been implemented on <a href="/en-US/docs/Web/JavaScript/Reference/Global_Objects/Math"><code>Math</code></a>: <a href="/en-US/docs/Web/JavaScript/Reference/Global_Objects/Math/fround"><code>Math.fround()</code></a> ({{bug("900125")}}).</li>
 <li>The <a href="/en-US/docs/Web/JavaScript/Reference/Lexical_grammar#keywords">reserved words</a> cannot be used for function names:such a usage now throws a <a href="/en-US/docs/Web/JavaScript/Reference/Global_Objects/SyntaxError"><code>SyntaxError</code></a> ({{bug("907958")}}).</li>
 <li>The <a href="/en-US/docs/Web/JavaScript/Reference/Functions/Default_parameters">default parameter</a> syntax has been updated to allow parameters without defaults after default parameters, such as <code>function f(x=1, y)</code>. See {{bug(777060)}}.</li>
...
<ul>
 ...
 <li>The {{domxref("URL.URL", "URL()")}} constructor has been implemented on the {{domxref("URL")}} interface ({{bug("887364")}}).</li>
 <li>The properties {{domxref("HTMLAnchorElement/origin", "URLUtils.origin")}}, {{domxref("HTMLAnchorElement/password", "URLUtils.password")}}, and {{domxref("HTMLAnchorElement/username", "URLUtils.username")}} are now available to all interfaces implementing {{domxref("HTMLHyperlinkElementUtils", "URLUtils")}}: {{domxref("URL")}}, {{domxref("Location")}}, {{domxref("HTMLAnchorElement")}}, and {{domxref("HTMLAreaElement")}} ({{bug("887364")}}).</li>
 ...
 <li>The <a href="/en-US/docs/Web/API/Web_Audio_API">Web Audio API</a> has been made available by default ({{bug("885505")}}).</li>
</ul>
...
<ul>
 ...
 <li>The <code>SVGElement.ownerSVGElement()</code> method doesn't throw anymore ({{bug("835048")}}).</li>
</ul>
