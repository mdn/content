...
- Changing the speed of a media element ([<video>](/en-US/docs/Web/HTML/Element/video) or [<audio>](/en-US/docs/Web/HTML/Element/audio)) using the [`playbackRate` attribute](/en-US/docs/Web/API/HTMLMediaElement/playbackRate) now works when the media element is captured to a [`MediaStream`](/en-US/docs/Web/API/MediaStream) or via [`AudioContext.createMediaElementSource`](/en-US/docs/Web/API/AudioContext/createMediaElementSource)
