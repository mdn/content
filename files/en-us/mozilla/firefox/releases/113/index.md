...
- Features part of [CSS Color 4](https://www.w3.org/TR/css-color-4/) are now enabled by default.
  This allows the use of `color()`, `lab()`, `lch()`, `oklab()`, and `oklch()` functional notation described in the [CSS color value](/en-US/docs/Web/CSS/color_value) documentation.
  Additionally, the [`forced-color-adjust`](/en-US/docs/Web/CSS/forced-color-adjust) property and [`color-mix()`](/en-US/docs/Web/CSS/color_value/color-mix) functional notation are enabled by default.
