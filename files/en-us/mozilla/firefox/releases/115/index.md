...
- The [`modulepreload`](/en-US/docs/Web/HTML/Reference/Attributes/rel/modulepreload) keyword for the [`rel`](/en-US/docs/Web/HTML/Reference/Element/link#rel) attribute of the {{HTMLElement("link")}} element is now supported.
