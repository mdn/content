...
- {{domxref("PushMessageData.bytes()")}} is now supported for returning the data from a push message as an {{domxref("Uint8Array")}} object. ([Firefox bug 1897871](https://bugzil.la/1897871)).
