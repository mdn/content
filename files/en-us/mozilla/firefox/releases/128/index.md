...
- {{domxref('RTCRtpTransceiver.setCodecPreferences()')}} is now supported for setting the allowed codecs in preferred order. Web applications can use this to cause the remote peer to choose a preferred codec, and to disable the negotiation of specific codecs — including those used for retransmission, redundancy, and forward error correction. ([Firefox bug 1396922](https://bugzil.la/1396922)).
