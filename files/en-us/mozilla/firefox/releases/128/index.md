...
- Context menus created with {{WebExtAPIRef("menus.create")}} now persist across extension restart in Manifest V3 extensions with a non-persistent background context ([Firefox bug 1771328](https://bugzil.la/1771328)).
