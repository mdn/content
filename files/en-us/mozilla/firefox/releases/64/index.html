...
<p>This article provides information about the changes in Firefox 64 that will affect developers. Firefox 64 was released on December 11, 2018.</p>
...
<ul>
 <li>The non-standard <a href="/en-US/docs/Mozilla/Gecko/Chrome/CSS/display-xul"><code>-moz-box</code> and <code>-moz-inline-box</code></a> {{CSSxRef("display")}} values have been hidden from web content ({{bug(1496961)}}).</li>
 <li>The non-standard {{CSSxRef("::-moz-tree")}} <a href="/en-US/docs/Web/CSS/Pseudo-elements">pseudo-elements</a> have been hidden from web content ({{bug(1496961)}}).</li>
