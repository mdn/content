...
- The [`meta`](/en-US/docs/Web/HTML/Element/referrer#meta) attributes now also supports the `no-referrer-when-downgrade` and `origin-when-cross-origin` values ([Firefox bug 1178337](https://bugzil.la/1178337)).
