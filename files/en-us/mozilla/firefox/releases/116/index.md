...
- Added "container" badges in markup view on element with a `container-type` property of `size` or `inline-size` value ([Firefox bug 1789193](https://bugzil.la/1789193)).
