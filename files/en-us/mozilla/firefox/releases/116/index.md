...
- The [`dirname`](/en-US/docs/Web/HTML/Reference/Element/input#dirname) attribute is now supported on [`input`](/en-US/docs/Web/HTML/Reference/Element/input#dirname) and [`textarea`](/en-US/docs/Web/HTML/Reference/Element/textarea#dirname) elements.
