...
<p><a href="https://www.mozilla.org/firefox/developer/">To test the latest developer features of Firefox, install Firefox Developer Edition</a>Firefox 46 was released on April 26, 2016. This article lists key changes that are useful not only for web developers, but also Firefox and Gecko developers as well as add-on developers.</p>
...
<ul>
 ...
 <li>The properties {{cssxref("text-emphasis")}}, {{cssxref("text-emphasis-style")}}, {{cssxref("text-emphasis-color")}} and {{cssxref("text-emphasis-position")}} are now enabled by default ({{bug(1231485)}}).</li>
 ...
 <li>Added <code>-webkit-filter</code> for web compatibility, behind the preference <code>layout.css.prefixes.webkit</code>, defaulting to <code>false</code> ({{bug(1236506)}}).</li>
...
<ul>
 <li>The ES2015 {{jsxref("RegExp.prototype.unicode", "RegExp unicode (u) flag", "", 1)}} has been implemented ({{bug(1135377)}}).</li>
 <li>The ES2015 block-level functions have been implemented ({{bug(1071646)}}).</li>
 <li>The ES2015 {{jsxref("TypedArray.prototype.sort()")}} method has been implemented ({{bug(1121937)}}).</li>
 <li>The ES2015 {{jsxref("Functions/arguments/@@iterator", "arguments[@@iterator]")}} has been implemented ({{bug(1067049)}}).</li>
...
<ul>
 <li>The {{domxref("WEBGL_compressed_texture_etc")}} extension has been implemented, allowing the use of <a href="https://en.wikipedia.org/wiki/Ericsson_Texture_Compression">ETC2 compressed texture formats </a>({{bug(917505)}}). To use this extension, set the preference <code>webgl.enable-draft-extensions</code> to <code>true</code> in about:config.</li>
</ul>
...
<ul>
 <li>The {{domxref("RTCPeerConnection.createOffer()")}} method now supports the VP9 video codec, although this is disabled by default. To enable it, set the preference <code>media.peerconnection.video.vp9_enabled</code> to <code>true</code> in <code>about:config</code>. When enabled, VP9 is the preferred codec; previously VP8 was preferred ({{bug(1242324)}}).</li>
 <li>The method {{domxref("RTCRtpSender.setParameters()")}} has been added to allow changing the values of parameters after the {{domxref("RTCRtpSender")}} was initially created.</li>
</ul>

<h4 id="New_APIs">New APIs</h4>

<ul>
 <li>In SVG, the {{domxref("SVGStyleElement")}} interface now implements the <code>LinkStyle</code> mixin ){{bug(1239128)}}.</li>
</ul>
...
<ul>
 ...
 <li>Our experimental implementation of <a href="/en-US/docs/Web/API/Web_Animations_API">Web Animations API</a> has been updated:
  <ul>
   <li>{{domxref("AnimationEffectTimingReadOnly")}} and {{domxref("AnimationEffect/getTiming", "AnimationEffectReadOnly.timing")}} have been implemented ({{bug(1214536)}}).</li>
  </ul>
 </li>
