...
- The {{cssxref(":has", ":has()")}} selector, commonly referred to as the _parent selector_, is now supported. It allows developers to match elements that have, or "anchor", at least one element matching its relative selector.
