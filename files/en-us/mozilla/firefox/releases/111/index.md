...
- The `context-stroke` and `context-fill` properties are now supported inside `marker` elements.
  For more information, see the [marker](/en-US/docs/Web/SVG/Element/marker) reference page ({{bug(752638)}}).
