...
#### WebDriver BiDi
- Changed the behaviours for handling stale elements checks based on recently updated WebDriver classic specification ([Firefox bug 1808894](https://bugzil.la/1808894)).
