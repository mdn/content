...
- {{domxref("WorkerNavigator.language", "navigator.language")}} and  {{domxref("WorkerNavigator.language", "WorkerNavigator.languages")}} are now available to workers on {{domxref("WorkerNavigator")}} ({{bug(925849)}}).
