...
- The new exception reference with the value of `exnref` can now be used to help with [Exception Handling](/en-US/docs/WebAssembly/JavaScript_interface/Exception), either from WASM to JavaScript or JavaScript to WASM. ([Firefox bug 1908375](https://bugzil.la/1908375)).
