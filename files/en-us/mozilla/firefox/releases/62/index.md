...
- Added the {{domxref("console.timelog_static")}} method to display the current value of a console timer while continuing to track the time ([Firefox bug 1458466](https://bugzil.la/1458466)).
- Added {{domxref("console.countreset_static")}} to reset a console counter value ([Firefox bug 1459279](https://bugzil.la/1459279)).
