...
<p>This article provides information about the changes in Firefox 67 that will affect developers. Firefox 67 was released on May 21, 2019.</p>
...
<ul>
 <li>Debugger updates:
  <ul>
   <li><a href="/en-US/docs/Tools/Debugger/How_to/Set_a_breakpoint">Column breakpoints</a> allow you to select the specific point (or column) in a line of code where you want the debugger to break ({{bug(1528417)}}).</li>
   <li><a href="/en-US/docs/Tools/Debugger/Set_a_logpoint">Log points</a> allow you to log specific information to the console during code execution without pausing execution and without the need to change the code.</li>
   ...
   <li>You can <a href="/en-US/docs/Web/API/Web_Workers_API/Using_web_workers#debugging_worker_threads">debug worker</a> threads directly in the debugger.</li>
  </ul>
 </li>
 ...
 <li><a href="/en-US/docs/Tools/Network_Monitor">Network Monitor</a> enhancements:
  <ul>
   ...
   <li>You can change the <a href="/en-US/docs/Tools/Network_Monitor/request_list#network_request_columns">width of the columns</a> in the Network Monitor to suit your workflow ({{bug(1358414)}}).</li>
  </ul>
 </li>
</ul>
...
<ul>
 <li>The <a href="/en-US/docs/Web/Media/Formats/Video_codecs#av1">AV1 video codec</a> is now supported on Linux.</li>
 ...
 <li><a href="/en-US/docs/Web/API/WebVTT_API">WebVTT</a> has been revised to correctly use <code>auto</code> as the default for the {{domxref("VTTCue")}} object's {{domxref("VTTCue.positionAlign", "positionAlign")}} property, instead of <code>center</code>. This causes the cue box's alignment to correspond to the alignment of the text within it ({{bug(1528420)}}).</li>
</ul>
...
<ul>
 <li>Hacks release post: <a href="https://hacks.mozilla.org/2019/05/firefox-67-dark-mode-css-webrender/">Firefox 67: Dark Mode CSS, WebRender, and more</a></li>
</ul>
