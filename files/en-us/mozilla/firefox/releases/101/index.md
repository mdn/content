...
- Addition of `"matches"` and `"resources"` to the [`"web_accessible_resources"`)](https://developer.mozilla.org/docs/Mozilla/Add-ons/WebExtensions/manifest.json/web_accessible_resources) in Manifest V3 extensions.
