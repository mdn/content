...
<ul>
 ...
 <li>The default modifier keys for the <code><a href="/en-US/docs/Web/HTML/Global_attributes">accesskey</a></code> of HTML contents on Mac are changed to Control+Option. This is the same as WebKit-based browsers on Mac.</li>
</ul>

<h3 id="DOM">DOM</h3>

<ul>
 <li><a href="/en-US/docs/Web/API/HTMLElement/input_event">input</a> events are fired also on editing host element of <a href="/en-US/docs/Web/API/HTMLElement/contentEditable">contenteditable</a> editor and root element of <a href="/en-US/docs/Web/API/Document/designMode">designMode</a> editor.</li>
 ...
 <li>Support for the <a href="/en-US/docs/Web/API/MutationObserver">Mutation Observers</a> has been landed. It is designed as a replacement for the Mutation Events in DOM3, which has a number of issues regarding performance.</li>
 ...
 <li>The <code>GeoPositionAddress</code> interface, an obsolete part of the <a href="/en-US/docs/Web/API/Geolocation_API">Geolocation</a> API, has been removed.</li>
 <li>{{domxref("Storage", "localStorage/sessionStorage")}} now correctly return <code>undefined</code> instead of <code>null</code> for undeclared keys through property access.ff</li>
...
<ul>
 <li>The {{cssxref("text-transform")}} and {{cssxref("font-variant")}} CSS properties have been fixed to correctly handle the <code>i</code> → <code>İ</code> and <code>ı</code> → <code>I</code> <a href="https://en.wikipedia.org/wiki/Turkic_languages">Turkic</a>-specific case pairs.</li>
...
<ul>
 <li>Gecko now supports the new <a href="/en-US/docs/Web/HTTP">HTTP</a> <a href="/en-US/docs/Web/HTTP/Status#308"><code>308 Permanent Redirect</code></a> status code. As Gecko doesn't make a distinction between permanent and temporary redirects, it behaves like the <a href="/en-US/docs/Web/HTTP/Status#307"><code>307 Temporary Redirect</code></a> status code, as it forbids the user agent from changing the HTTP method used between the two requests (<code>POST</code> will stay <code>POST</code>, <code>GET</code> will stay <code>GET</code>).</li>
</ul>
...
<ul>
 ...
 <li>Added the new <a href="/en-US/docs/JavaScript_code_modules/source-editor.jsm#getLineStart%28%29"><code>getLineStart()</code></a> and <a href="/en-US/docs/JavaScript_code_modules/source-editor.jsm#getLineEnd%28%29"><code>getLineEnd()</code></a> methods.</li>
</ul>
...
<ul>
 <li>The {{interface("nsILocalFile")}} interface has been merged into {{interface("nsIFile")}} (<a href="https://bugzilla.mozilla.org/show_bug.cgi?id=682360">bug 682360</a>).</li>
 <li>The methods in {{interface("nsIPlacesImportExportService")}} for importing bookmarks have all been removed in favor of the <code><a href="/en-US/docs/JavaScript_code_modules/BookmarkHTMLUtils.jsm">BookmarkHTMLUtils.jsm</a></code> JavaScript code module.</li>
 <li>The {{interface("nsIDOMGeoPositionAddress")}} interface has been removed.</li>
 <li>The <code>getItemGUID</code>, <code>setItemGUID</code> and <code>getItemIdForGUID</code> methods have been removed from {{interface("nsINavBookmarksService")}} ({{bug("715355")}}).</li>
</ul>

<h3 id="Spellchecking">Spellchecking</h3>

<ul>
 <li>Dictionary names are now parsed as full <a href="https://datatracker.ietf.org/doc/html/bcp47">BCP 47</a> language tags (<a href="https://bugzilla.mozilla.org/show_bug.cgi?id=730209">bug 730209</a>, <a href="https://bugzilla.mozilla.org/show_bug.cgi?id=741842">bug 741842</a>). Developers are encouraged to not hard-code the name of their language in their dictionary names.</li>
</ul>
