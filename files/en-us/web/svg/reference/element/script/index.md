...
> [!NOTE]
> While SVG's `script` element is equivalent to the HTML {{HTMLElement('script')}} element, it has some discrepancies, like it uses the {{SVGAttr('href')}} attribute instead of [`src`](/en-US/docs/Web/HTML/Reference/Element/script#src) and it doesn't support ECMAScript modules so far (See browser compatibility below for details)
...
- [`crossorigin`](/en-US/docs/Web/HTML/Reference/Element/script#crossorigin)
...
- [`script` element in HTML](/en-US/docs/Web/HTML/Reference/Element/script)
