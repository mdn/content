...
</p><p>Extending the 'class' attribute to apply to all SVG elements will allow SVG authors to use the <a href="https://www.w3.org/TR/selectors-api/">Selectors API</a> to select <i>any</i> SVG element based on class. This seems like a good thing. Requiring SVG authors to know which elements can and cannot take a 'class' attribute would just put an extra burden on them.
