...
<p>The <strong><code>min</code></strong> attribute specifies the minimum value of the active animation duration.</p>
...
<dl>
 ...
 <dd>
 <p>Specifies the length of the minimum value of the active duration, measured in local time. The value must be greater than 0.</p>
 </dd>
</dl>
...
<table class="no-markdown">
 ...
 <tbody>
  <tr>
   <td>{{SpecName("SVG Animations 2", "#MinAttribute", "min")}}</td>
   <td>{{Spec2("SVG Animations 2")}}</td>
   <td>No change</td>
  </tr>
  <tr>
   <td>{{SpecName("SVG1.1", "animate.html#MinAttribute", "min")}}</td>
   <td>{{Spec2("SVG1.1")}}</td>
