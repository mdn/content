...
<p>The <strong><code>limitingConeAngle</code></strong> attribute represents the angle in degrees between the spot light axis (i.e. the axis between the light source and the point to which it is pointing at) and the spot light cone. So it defines a limiting cone which restricts the region where the light is projected. No light is projected outside the cone.</p>
...
<table class="no-markdown">
 ...
 <tbody>
  <tr>
   <td>{{SpecName("Filters 1.0", "#element-attrdef-fespotlight-limitingconeangle", "limitingConeAngle")}}</td>
   <td>{{Spec2("Filters 1.0")}}</td>
   <td>No change</td>
  </tr>
  <tr>
   <td>{{SpecName("SVG1.1", "filters.html#feSpotLightLimitingConeAngleAttribute", "limitingConeAngle")}}</td>
   <td>{{Spec2("SVG1.1")}}</td>
