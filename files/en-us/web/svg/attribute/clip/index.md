...
<p>The <strong><code>clip</code></strong> attribute is a presentation attribute defining the visible region of an element.</p>

<p>This attribute has the same parameter values as defined for the {{ cssxref("clip","CSS clip property") }}. Unitless values, which indicate current user coordinates, are permitted on the coordinate values on the <code>rect()</code>. The value of <code>auto</code> defines a clipping path along the bounds of the viewport created by the given element.</p>
...
<div class="warning"><p><strong>Warning:</strong> This property is deprecated. Use {{cssxref("clip-path")}} instead.</p></div>
