...
<p>The <strong><code>vector-effect</code></strong> property specifies the vector effect to use when drawing an object. Vector effects are applied before any of the other compositing operations, i.e. filters, masks and clips.</p>

<div class="note"><p><strong>Note:</strong> As a presentation attribute, <code>vector-effect</code> can be used as a CSS property.</p></div>
