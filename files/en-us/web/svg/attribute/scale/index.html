...
<p>The <strong><code>scale</code></strong> attribute defines the displacement scale factor to be used on a {{SVGElement("feDisplacementMap")}} filter primitive. The amount is expressed in the coordinate system established by the {{SVGAttr("primitiveUnits")}} attribute on the {{SVGElement("filter")}} element.</p>
...
<dl>
 ...
 <dd>
 <p>This value defines the scale factor for the displacement.</p>

 <p>When the value of this attribute is <code><span class="attr-value">0</span></code>, this operation has no effect on the source image.</p>
 </dd>
</dl>
