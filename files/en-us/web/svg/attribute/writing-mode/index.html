...
<dl>
 ...
 <dd>This value defines a top-to-bottom block flow direction. Both the writing mode and the typographic mode are horizontal.</dd>
 <dt><code>vertical-rl</code></dt>
 <dd>This value defines a right-to-left block flow direction. Both the writing mode and the typographic mode are vertical.</dd>
 <dt><code>vertical-lr</code></dt>
 <dd>This value defines a left-to-right block flow direction. Both the writing mode and the typographic mode are vertical.</dd>
</dl>
...
<table class="no-markdown">
 ...
 <tbody>
  ...
  <tr>
   ...
   <td>{{Spec2("SVG2")}}</td>
   <td>Mainly refers to the definition in CSS Writing Modes 3 and defines a mapping between the deprecated SVG 1.1 values and the new values.</td>
  </tr>
  <tr>
