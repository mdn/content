...
<table class="no-markdown">
  ...
  <tbody>
    <tr>
      <td>
        {{SpecName("SVG2", "pservers.html#RadialGradientElementSpreadMethodAttribute", "spreadMethod for &lt;radialGradient&gt;")}}
      </td>
      <td>{{Spec2("SVG2")}}</td>
      <td>No change</td>
    </tr>
    <tr>
      <td>
        {{SpecName("SVG2", "pservers.html#LinearGradientElementSpreadMethodAttribute", "spreadMethod for &lt;linearGradient&gt;")}}
      </td>
      <td>{{Spec2("SVG2")}}</td>
      <td>No change</td>
    </tr>
    <tr>
      <td>
        {{SpecName("SVG1.1", "pservers.html#RadialGradientElementSpreadMethodAttribute", "spreadMethod for &lt;radialGradient&gt;")}}
      </td>
      <td>{{Spec2("SVG1.1")}}</td>
    ...
    <tr>
      <td>
        {{SpecName("SVG1.1", "pservers.html#LinearGradientElementSpreadMethodAttribute", "spreadMethod for &lt;linearGradient&gt;")}}
      </td>
      <td>{{Spec2("SVG1.1")}}</td>
