...
<p>The <strong><code>stroke-dashoffset</code></strong> attribute is a presentation attribute defining an offset on the rendering of the associated dash array.</p>

<div class="note"><p><strong>Note:</strong> As a presentation attribute <code>stroke-dashoffset</code> can be used as a CSS property.</p></div>
...
<table class="properties">
 <tbody>
  <tr>
   ...
   <td><strong><a href="/en-US/docs/Web/SVG/Content_type#percentage">&lt;percentage&gt;</a></strong> | <strong><a href="/en-US/docs/Web/SVG/Content_type#length">&lt;length&gt;</a></strong></td>
  </tr>
  <tr>
...
<p>The offset is usually expressed in user units resolved against the {{SVGAttr('pathLength')}} but if a <a href="/en-US/docs/Web/SVG/Content_type#percentage">&lt;percentage&gt;</a> is used, the value is resolved as a percentage of the current viewport.</p>
