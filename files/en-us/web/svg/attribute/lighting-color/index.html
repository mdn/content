...
<p>The <strong><code>lighting-color</code></strong> attribute defines the color of the light source for lighting filter primitives.</p>
...
<table class="no-markdown">
 ...
 <tbody>
  <tr>
   <td>{{SpecName("Filters 1.0", "#LightingColorProperty", "lighting-color")}}</td>
   <td>{{Spec2("Filters 1.0")}}</td>
   <td>Removed the <code>&lt;icccolor&gt;</code> value.</td>
  </tr>
  <tr>
   <td>{{SpecName("SVG1.1", "filters.html#LightingColorProperty", "lighting-color")}}</td>
   <td>{{Spec2("SVG1.1")}}</td>
