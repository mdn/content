...
<p>The <strong><code>cx</code></strong> attribute define the x-axis coordinate of a center point.</p>
...
<p>For {{SVGElement('circle')}}, <code>cx</code> defines the x-axis coordinate of the center of the shape.</p>
...
<div class="note"><p><strong>Note:</strong> Starting with SVG2 <code>cx</code>, is a <em>Geometry Property</em>, meaning this attribute can also be used as CSS property for circles.</p></div>

<h2 id="ellipse">ellipse</h2>

<p>For {{SVGElement('ellipse')}}, <code>cx</code> defines the x-axis coordinate of the center of the shape.</p>
...
<div class="note"><p><strong>Note:</strong> Starting with SVG2 <code>cx</code>, is a <em>Geometry Property</em>, meaning this attribute can also be used as CSS property for ellipses.</p></div>

<h2 id="radialGradient">radialGradient</h2>

<p>For {{SVGElement('radialGradient')}}, <code>cx</code> defines the x-axis coordinate of the end circle for the radial gradient.</p>
...
<ul>
 ...
 <li><a href="/en-US/docs/Web/SVG/Attribute/r">r</a></li>
</ul>
