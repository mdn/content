...
<p>The <strong><code>divisor</code></strong> attribute specifies the value by which the resulting number of applying the {{SVGAttr("kernelMatrix")}} of a {{SVGElement("feConvolveMatrix")}} element to the input image color value is divided to yield the destination color value.</p>

<p>A divisor that is the sum of all the matrix values tends to have an evening effect on the overall color intensity of the result.</p>
...
<table class="properties">
 <tbody>
  ...
  <tr>
   ...
   <td>Sum of all values in {{SVGAttr("kernelMatrix")}} or <code>1</code> if sum is 0</td>
  </tr>
  <tr>
...
<dl>
 ...
 <dd>This value defines the divisor. If the specified divisor is <code><span class="css">0</span></code> then the default value will be used instead.</dd>
</dl>
