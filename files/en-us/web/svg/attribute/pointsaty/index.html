...
<p>The <strong><code>pointsAtY</code></strong> attribute represents the y location in the coordinate system established by attribute {{SVGAttr("primitiveUnits")}} on the {{SVGElement("filter")}} element of the point at which the light source is pointing.</p>
...
<table class="no-markdown">
 ...
 <tbody>
  <tr>
   <td>{{SpecName("Filters 1.0", "#element-attrdef-fespotlight-pointsaty", "pointsAtY")}}</td>
   <td>{{Spec2("Filters 1.0")}}</td>
   <td>No change</td>
  </tr>
  <tr>
   <td>{{SpecName("SVG1.1", "filters.html#feSpotLightPointsAtYAttribute", "pointsAtY")}}</td>
   <td>{{Spec2("SVG1.1")}}</td>
