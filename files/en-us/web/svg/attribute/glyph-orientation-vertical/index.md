...
> [!NOTE]
> As a presentation attribute, `glyph-orientation-vertical` also has a CSS property counterpart: {{cssxref("glyph-orientation-vertical")}}. When both are specified, the CSS property takes priority.
