...
<p>The <strong><code>r</code></strong> attribute defines the radius of a circle.</p>
...
<div class="note"><p><strong>Note:</strong> Starting with SVG2, <code>r</code> is a <em>Geometry Property</em> meaning this attribute can also be used as a CSS property for circles.</p></div>

<h2 id="radialGradient">radialGradient</h2>

<p>For {{ SVGElement("radialGradient") }}, <code>r</code> defines the radius of the end circle for the radial gradient.</p>
