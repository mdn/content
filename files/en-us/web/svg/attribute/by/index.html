...
<p>The <code><strong>by</strong></code> attribute specifies a relative offset value for an attribute that will be modified during an animation.</p>

<p>The starting value for the attribute is either indicated by specifying it as value for the attribute given in the {{SVGAttr("attributeName")}} or the {{SVGAttr("from")}} attribute.</p>
...
<p>When a list of values is defined via the {{SVGAttr("values")}} attribute, the <code>by</code> attribute is ignored.</p>
