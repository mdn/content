...
<p>The <strong><code>fy</code></strong> attribute defines the y-axis coordinate of the focal point for a radial gradient.</p>
...
<table class="properties">
 <tbody>
  ...
  <tr>
   ...
   <td>Coincides with the presentational value of {{SVGAttr("cy")}} for the element whether the value for <code>cy</code> was inherited or not.</td>
  </tr>
  <tr>
