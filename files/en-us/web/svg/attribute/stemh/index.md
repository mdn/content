...
<dl>
 ...
 <dd>This value indicates the horizontal stem width of the font.</dd>
</dl>
...
<table class="no-markdown">
 ...
 <tbody>
  <tr>
   <td>{{SpecName("SVG1.1", "fonts.html#FontFaceElementStemhAttribute", "stemh")}}</td>
   <td>{{Spec2("SVG1.1")}}</td>
