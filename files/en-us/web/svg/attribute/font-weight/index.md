...
<p>The <strong><code>font-weight</code></strong> attribute refers to the boldness or lightness of the glyphs used to render the text, relative to other fonts in the same font family.</p>

<div class="note"><p><strong>Note:</strong> As a presentation attribute, <code>font-weight</code> can be used as a CSS property. See the {{cssxref("font-weight", "CSS font-weight")}} property for more information.</p></div>
...
<table class="properties">
 <tbody>
  <tr>
   ...
   <td><code>normal</code> | <code>bold</code> | <code>bolder</code> | <code>lighter</code> | {{cssxref("number")}}</td>
  </tr>
  <tr>
...
<p>For a description of the values, please refer to the <a href="/en-US/docs/Web/CSS/font-weight#Values">CSS <code>font-weight</code></a> property.</p>
