...
<p>The <strong><code>fill</code></strong> attribute has two different meanings. For shapes and text it's a presentation attribute that defines the color (<em>or any SVG paint servers like gradients or patterns</em>) used to paint the element; for animation it defines the final state of the animation.</p>
...
<div class="note"><p><strong>Note:</strong> As a presentation attribute <code>fill</code> can be used as a CSS property.</p></div>
...
<div class="warning"><p><strong>Warning:</strong> As of SVG Animation 2 {{SVGElement('animateColor')}} is deprecated and shouldn't be used. Use {{SVGElement('animate')}} instead.</p></div>
 ...
 <tbody>
  ...
  <tr>
   ...
   <td>Definition for shapes and texts.<br>
    Adds <code>context-fill</code> and <code>context-stroke</code>.</td>
  </tr>
  <tr>
...
<div class="note"><p><strong>Note:</strong> For information on using the <code>context-fill</code> (and <code>context-stroke</code>) values from HTML documents, see the documentation for the non-standard {{cssxref("-moz-context-properties")}} property.</p></div>
