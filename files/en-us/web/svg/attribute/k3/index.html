...
<p>The <strong><code>k3</code></strong> attribute defines one of the values to be used within the <code>arithmetic</code> operation of the {{SVGElement("feComposite")}} filter primitive.</p>
...
<table class="no-markdown">
 ...
 <tbody>
  <tr>
   <td>{{SpecName("Filters 1.0", "#element-attrdef-fecomposite-k3", "k3")}}</td>
   <td>{{Spec2("Filters 1.0")}}</td>
   <td>No change</td>
  </tr>
  <tr>
   <td>{{SpecName("SVG1.1", "filters.html#feCompositeK3Attribute", "k3")}}</td>
   <td>{{Spec2("SVG1.1")}}</td>
