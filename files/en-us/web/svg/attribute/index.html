...
<p>SVG elements can be modified using attributes that specify details about exactly how the element should be handled or rendered.</p>

<p>Below is a list of all of the attributes available in SVG along with links to reference documentation to help you learn which elements support them and how they work.</p>
...
<ul>
  ...
  <li>{{SVGAttr("transform-origin")}}</li>
  <li>{{SVGAttr("type")}}</li>
</ul>
...
<h3 id="Generic_attributes">Generic attributes</h3>
  <dl>

    <dt>Core attributes</dt>
    <dd>
      <p><a href="/en-US/docs/Web/SVG/Attribute/Core">Core attributes</a></p>

      <p>{{SVGAttr("id")}}, {{SVGAttr("lang")}}, {{SVGAttr("tabindex")}}, {{SVGAttr("xml:base")}}, {{SVGAttr("xml:lang")}}, {{SVGAttr("xml:space")}}</p>
    </dd>

    <dt>Style attributes</dt>
    <dd>
      <p><a href="/en-US/docs/Web/SVG/Attribute/Styling">Style attributes</a></p>

      <p>{{SVGAttr("class")}}, {{SVGAttr("style")}}</p>
    </dd>

    <dt>Conditional processing attributes</dt>
    <dd>
...
<div class="note"><p><strong>Note:</strong> All <a href="/en-US/docs/Web/SVG/Attribute/Presentation">SVG presentation attributes</a> can be used as CSS properties.</p></div>
...
<h3 id="Filters_attributes">Filters attributes</h3>
  <dl>
    <dt>Filter primitive attributes</dt>
    <dd>
      <p>{{SVGAttr("height")}}, {{SVGAttr("result")}}, {{SVGAttr("width")}}, {{SVGAttr("x")}}, {{SVGAttr("y")}}</p>
    </dd>

    <dt>Transfer function attributes</dt>
    <dd>
...
<h3 id="Animation_attributes">Animation attributes</h3>
  <dl>
    <dt>Animation target element attributes</dt>
    <dd>
      <p>{{SVGAttr("href")}}</p>
    </dd>

    <dt>Animation attribute target attributes</dt>
    <dd>
      <p>{{SVGAttr("attributeType")}}, {{SVGAttr("attributeName")}}</p>
    </dd>

    <dt>Animation timing attributes</dt>
    <dd>
    ...
    <dt>Animation value attributes</dt>
    <dd>
    ...
    <dt>Animation addition attributes</dt>
    <dd>
      <p>{{SVGAttr("additive")}}, {{SVGAttr("accumulate")}}</p>
    </dd>
  </dl>

<h3 id="Event_attributes">Event attributes</h3>
  <dl>
    <dt>Animation event attributes</dt>
    <dd>
      <p><a href="/en-US/docs/Web/SVG/Attribute/Events#animation_event_attributes">Animation event attributes</a></p>

      <p><strong><code>onbegin</code></strong>, <strong><code>onend</code></strong>, <strong><code>onrepeat</code></strong></p>
    </dd>

    <dt>Document event attributes</dt>
    <dd>
      <p><a href="/en-US/docs/Web/SVG/Attribute/Events#document_event_attributes">Document event attributes</a></p>
    ...
    <dt>Global event attributes</dt>
    <dd>
      <p><a href="/en-US/docs/Web/SVG/Attribute/Events#global_event_attributes">Global event attributes</a></p>
    ...
    <dt>Graphical event attributes</dt>
    <dd>
      <p><a href="/en-US/docs/Web/SVG/Attribute/Events#graphical_event_attributes">Graphical event attributes</a></p>
