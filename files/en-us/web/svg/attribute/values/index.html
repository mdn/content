...
<p>The <code>values</code> attribute has different meanings, depending upon the context where it's used, either it defines a sequence of values used over the course of an animation, or it's a list of numbers for a color matrix, which is interpreted differently depending on the type of color change to be performed.</p>
...
<p>For {{SVGElement("animate")}}, {{SVGElement("animateColor")}}, {{SVGElement("animateMotion")}}, and {{SVGElement("animateTransform")}}, <code>values</code> is a list of values defining the sequence of values over the course of the animation. If this attribute is specified, any {{SVGAttr("from")}}, {{SVGAttr("to")}}, and {{SVGAttr("by")}} attribute values set on the element are ignored.</p>
...
<dl>
 ...
 <dd>The value holds a semicolon-separated list of one or more values. The type of the values is defined by the {{SVGAttr("href")}} and {{SVGAttr("attributeName")}} attributes.</dd>
</dl>

<h2 id="feColorMatrix">feColorMatrix</h2>

<p>For the {{SVGElement("feColorMatrix")}} element, <code>values</code> is a list of numbers interpreted differently depending on the value of the {{SVGAttr("type")}} attribute.</p>
...
<dl>
 ...
 <dd>
 <p>The value is a list of numbers, which is interpreted differently depending on the value of the <code>type</code> attribute:</p>
