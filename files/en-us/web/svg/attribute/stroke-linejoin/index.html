...
<p>The <strong><code>stroke-linejoin</code></strong> attribute is a presentation attribute defining the shape to be used at the corners of paths when they are stroked.</p>

<div class="notecard note"><p><strong>Note:</strong> As a presentation attribute <code>stroke-linejoin</code> can be used as a CSS property.</p></div>
...
<div class="notecard note"><p><strong>Note:</strong> The <code>arcs</code> value as been introduced in SVG2 and it isn't widely supported yet, see <a href="#browser_compatibility">Browser compatibility</a> below for details.</p></div>
...
<div class="notecard note"><p><strong>Note:</strong> the <code>miter-clip</code> value as been introduced in SVG2 and it isn't widely supported yet, see <a href="#browser_compatibility">Browser compatibility</a> below for details.</p></div>
