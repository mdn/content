...
<p>The <strong><code>k1</code></strong> attribute defines one of the values to be used within the <code>arithmetic</code> operation of the {{SVGElement("feComposite")}} filter primitive.</p>

<p>The pixel composition is computed using the following formula:</p>

<pre class="brush: js">result = k1*i1*i2 + k2*i1 + k3*i2 + k4</pre>
...
<table class="no-markdown">
 ...
 <tbody>
  <tr>
   <td>{{SpecName("Filters 1.0", "#element-attrdef-fecomposite-k1", "k1")}}</td>
   <td>{{Spec2("Filters 1.0")}}</td>
   <td>No change</td>
  </tr>
  <tr>
   <td>{{SpecName("SVG1.1", "filters.html#feCompositeK1Attribute", "k1")}}</td>
   <td>{{Spec2("SVG1.1")}}</td>
