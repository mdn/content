...
<p>The <strong><code>end</code></strong> attribute defines an end value for the animation that can constrain the active duration.</p>
...
<p>The <code>&lt;end-value-list&gt;</code> is a semicolon-separated list of values. Each value can be one of the following:</p>

<dl>
 <dt><code>&lt;offset-value&gt;</code></dt>
 <dd>This value defines a <a href="/en-US/docs/Web/SVG/Content_type#Clock-value">clock-value</a> that represents a point in time relative to the beginning of the SVG document (usually the {{domxref("SVGElement/load_event", "load")}} or {{domxref("Document/DOMContentLoaded_event", "DOMContentLoaded")}} event). Negative values are valid.</dd>
 <dt><code>&lt;syncbase-value&gt;</code></dt>
 <dd>
   <p>This value defines a <em>syncbase</em> and an optional offset from that <em>syncbase</em>. The element's animation end time is defined relative to the begin or active end of another animation.</p>
 ...
 <dd>
   <p>This value defines an access key that should trigger the end of the animation. The element animation will end when the user presses the specified key.</p>
 ...
 <dd>
   <p>This value defines the animation end time as a real-world clock time.</p>
 ...
 <dd>The end of the animation will be determined by an {{domxref("SVGAnimationElement.endElement()")}} method call.</dd>
</dl>
