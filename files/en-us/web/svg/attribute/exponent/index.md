...
<p>The <code><strong>exponent</strong></code> attribute defines the exponent of the gamma function.</p>
...
<dl>
 ...
 <dd>If the {{SVGAttr("type")}} attribute of the component element is set to <code>gamma</code>, this value specifies the exponent of the gamma function</dd>
</dl>
...
<table class="no-markdown">
 ...
 <tbody>
  <tr>
   <td>{{SpecName("Filters 1.0", "#element-attrdef-fecomponenttransfer-exponent", "exponent")}}</td>
   <td>{{Spec2("Filters 1.0")}}</td>
   <td>No change</td>
  </tr>
  <tr>
   <td>{{SpecName("SVG1.1", "filters.html#feComponentTransferExponentAttribute", "exponent")}}</td>
   <td>{{Spec2("SVG1.1")}}</td>
