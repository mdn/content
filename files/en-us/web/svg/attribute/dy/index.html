...
<p>The <strong><code>dy</code></strong> attribute indicates a shift along the y-axis on the position of an element or its content.</p>
...
<p>For {{SVGElement('altGlyph')}}, if it contains a single value, <code>dy</code> defines a shift along the y-axis for all alternate glyph.</p>
...
<p>For {{SVGElement('text')}}, if it contains a single value, <code>dy</code> defines a shift along the y-axis for all glyphs.</p>
...
<p>For {{SVGElement('tref')}}, if it contains a single value, <code>dy</code> defines a shift along the y-axis for all glyphs.</p>
...
<p>For {{SVGElement('tspan')}}, if it contains a single value, <code>dy</code> defines a shift along the y-axis for all alternate glyph.</p>
