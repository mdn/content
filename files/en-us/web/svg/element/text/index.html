...
<p>The SVG <strong><code>&lt;text&gt;</code></strong> element draws a graphics element consisting of text. It's possible to apply a gradient, pattern, clipping path, mask, or filter to <code>&lt;text&gt;</code>, like any other SVG graphics element.</p>
...
<dl>
 ...
 <dd><small>{{SVGAttr('class')}}, {{SVGAttr('style')}}, </small>{{SVGAttr('font-family')}}, {{SVGAttr('font-size')}}, {{SVGAttr('font-size-adjust')}}, {{SVGAttr('font-stretch')}}, {{SVGAttr('font-style')}}, {{SVGAttr('font-variant')}}, {{SVGAttr('font-weight')}}</dd>
