...
<p>The <strong><code>&lt;feFuncA&gt;</code></strong> <a href="/en-US/docs/Web/SVG">SVG</a> filter primitive defines the transfer function for the alpha component of the input graphic of its parent {{SVGElement("feComponentTransfer")}} element.</p>
...
<p>This element implements the {{domxref("SVGFEFuncAElement")}} interface.</p>
