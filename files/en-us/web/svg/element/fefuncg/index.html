...
<p>The <strong><code>&lt;feFuncG&gt;</code></strong> <a href="/en-US/docs/Web/SVG">SVG</a> filter primitive defines the transfer function for the green component of the input graphic of its parent {{SVGElement("feComponentTransfer")}} element.</p>
...
<p>This element implements the {{domxref("SVGFEFuncGElement")}} interface.</p>
