...
<p>The <strong><code>&lt;rect&gt;</code></strong> element is a <a href="/en-US/docs/Web/SVG/Tutorial/Basic_Shapes">basic SVG shape</a> that draws rectangles, defined by their position, width, and height. The rectangles may have their corners rounded.</p>
...
<dl>
 ...
 <small><em>Value type</em>: <code>auto</code>|<a href="/en-US/docs/Web/SVG/Content_type#length"><strong>&lt;length&gt;</strong></a>|<a href="/en-US/docs/Web/SVG/Content_type#percentage"><strong>&lt;percentage&gt;</strong></a> ; <em>Default value</em>: <code>auto</code>; <em>Animatable</em>: <strong>yes</strong></small></dd>
...
<div class="note">
<p><strong>Note:</strong> Starting with SVG2, <code>x</code>, <code>y</code>, <code>width</code>, <code>height</code>, <code>rx</code> and <code>ry</code> are <em>Geometry Properties</em>, meaning those attributes can also be used as CSS properties for that element.</p>
</div>
