...
<p>The <strong><code>&lt;radialGradient&gt;</code></strong> element lets authors define radial gradients that can be applied to fill or stroke of graphical elements.</p>

<div class="notecard note">
<p><strong>Note:</strong> Don't be confused with CSS {{cssxref('radial-gradient()')}} as CSS gradients can only apply to HTML elements where SVG gradient can only apply to SVG elements.</p>
</div>
...
<dl>
 <dt>{{SVGAttr("cx")}}</dt>
 <dd>This attribute defines the x coordinate of the end circle of the radial gradient.<br>
 <small><em>Value type</em>: <a href="/en-US/docs/Web/SVG/Content_type#length"><strong>&lt;length&gt;</strong></a> ; <em>Default value</em>: <code>50%</code>; <em>Animatable</em>: <strong>yes</strong></small></dd>
 <dt>{{SVGAttr("cy")}}</dt>
 <dd>This attribute defines the y coordinate of the end circle of the radial gradient.<br>
 <small><em>Value type</em>: <a href="/en-US/docs/Web/SVG/Content_type#length"><strong>&lt;length&gt;</strong></a> ; <em>Default value</em>: <code>50%</code>; <em>Animatable</em>: <strong>yes</strong></small></dd>
 <dt>{{SVGAttr("fr")}}</dt>
 <dd>This attribute defines the radius of the start circle of the radial gradient. The gradient will be drawn such that the 0% {{SVGElement('stop','gradient stop')}} is mapped to the perimeter of the start circle.<br>
 ...
 <dt>{{SVGAttr("fx")}}</dt>
 <dd>This attribute defines the x coordinate of the start circle of the radial gradient.<br>
 <small><em>Value type</em>: <a href="/en-US/docs/Web/SVG/Content_type#length"><strong>&lt;length&gt;</strong></a> ; <em>Default value</em>: Same as <code>cx</code>; <em>Animatable</em>: <strong>yes</strong></small></dd>
 <dt>{{SVGAttr("fy")}}</dt>
 <dd>This attribute defines the y coordinate of the start circle of the radial gradient.<br>
 <small><em>Value type</em>: <a href="/en-US/docs/Web/SVG/Content_type#length"><strong>&lt;length&gt;</strong></a> ; <em>Default value</em>: Same as <code>cy</code>; <em>Animatable</em>: <strong>yes</strong></small></dd>
