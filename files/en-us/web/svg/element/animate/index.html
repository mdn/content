...
<p>The SVG <strong><code>&lt;animate&gt;</code></strong> element provides a way to animate an attribute of an element over time.</p>

<h2>Example</h2>

<pre class="brush: css hidden">html,body,svg { height:100%; margin:0; padding:0; }</pre>
