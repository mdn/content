...
<p>The <strong><code>&lt;circle&gt;</code></strong> <a href="/en-US/docs/Web/SVG">SVG</a> element is an <a href="/en-US/docs/Web/SVG/Tutorial/Basic_Shapes">SVG basic shape</a>, used to draw circles based on a center point and a radius.</p>
...
<dl>
 ...
 <dd>The total length for the circle's circumference, in user units.<br>
...
<div class="note">
<p><strong>Note:</strong> Starting with SVG2, <code>cx</code>, <code>cy</code>, and <code>r</code> are <em>Geometry Properties</em>, meaning those attributes can also be used as CSS properties for that element.</p>
</div>
...
<ul>
 <li>Other SVG basic shapes: <strong>{{ SVGElement('ellipse') }}</strong>, {{ SVGElement('line') }}, {{ SVGElement('polygon') }}, {{ SVGElement('polyline') }}, {{ SVGElement('rect') }}</li>
</ul>
