...
<p>The <strong><code>&lt;metadata&gt;</code></strong> <a href="/en-US/docs/Web/SVG">SVG</a> element adds metadata to SVG content. Metadata is structured information about data. The contents of <code>&lt;metadata&gt;</code> should be elements from other {{Glossary("XML")}} {{Glossary("namespace", "namespaces")}} such as {{Glossary("RDF")}}, <a href="https://en.wikipedia.org/wiki/FOAF_(ontology)">FOAF</a>, etc.</p>
...
<ul>
 ...
 <li><a href="/en-US/docs/Web/HTML/Global_attributes">Global event attributes</a></li>
</ul>
...
<p>This element implements the {{domxref("SVGMetadataElement")}} interface.</p>

<h2 id="Example">Example</h2>

<pre class="brush: html">&lt;svg width="400" viewBox="0 0 400 300"
