...
<p>The SVG <strong><code>&lt;stop&gt;</code></strong> element defines a color and its position to use on a gradient. This element is always a child of a {{SVGElement("linearGradient")}} or {{SVGElement("radialGradient")}} element.</p>

<h2>Example</h2>

<pre class="brush: css hidden">html,body,svg { height:100% }</pre>

<pre class="brush: html; highlight[5,6]">&lt;svg viewBox="0 0 10 10" xmlns="http://www.w3.org/2000/svg"
...
<dl>
 ...
 <dd><small>Most notably: {{SVGAttr('color')}}, {{SVGAttr('display')}}, {{SVGAttr('stop-color')}}, {{SVGAttr('stop-opacity')}}, {{SVGAttr('visibility')}}</small></dd>
</dl>
