...
<p><a href="/en-US/docs/Web/SVG">SVG</a> is an <a href="/en-US/docs/Web/XML">XML</a> language, similar to <a href="/en-US/docs/Glossary/XHTML">XHTML</a>, which can be used to draw vector graphics, such as the ones shown to the right. It can be used to create an image either by specifying all the lines and shapes necessary, by modifying already existing raster images, or by a combination of both. The image and its components can also be transformed, composited together, or filtered to change their appearance completely.</p>

<p>SVG came about in 1999 after several competing formats had been submitted to the <a href="https://www.w3.org">W3C</a> and failed to be fully ratified. SVG is supported by all major <a href="https://caniuse.com/#search=svg">browsers</a>. A downside is loading SVG can be slow. SVG does offer benefits, some of which include having a <a href="/en-US/docs/Web/API">DOM interface</a> available for it, and not requiring third-party extensions. Whether or not to use it often depends on your specific use case.</p>
...
<p>SVG is a huge specification. This tutorial attempts to cover the basics. Once you are familiar you should be able to use the <a href="/en-US/docs/Web/SVG/Element">Element Reference</a> and the <a href="/en-US/docs/Web/API/Document_Object_Model#svg_interfaces">Interface Reference</a> to find out anything else you need to know.</p>

<h3 id="Flavors_of_SVG">Flavors of SVG</h3>

<p>Since becoming a recommendation in 2003, the most recent "full" SVG version is 1.1. It builds on top of SVG 1.0, but adds more modularization to ease implementation. <a href="https://www.w3.org/TR/SVG/">The second edition of SVG 1.1</a> became a Recommendation in 2011. "Full" SVG 1.2 was meant to be the next major release of SVG. It was dropped for the upcoming <a href="https://www.w3.org/TR/SVG2/">SVG 2.0</a>, which is under heavy development right now and follows a similar approach to CSS 3 in that it splits components into several loosely coupled specifications.</p>
