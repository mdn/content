...
> **Note:** If the value is omitted or set to `auto`, the browser will use the [Unicode bidirectional algorithm](/en-US/docs/Web/Guide/Unicode_Bidirectional_Text_Algorithm) to make a best guess about the text's direction.
