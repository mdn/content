...
This problem can be solved by lazy loading the images. Lazy loading is a techinque to load images only when they appear in the viewport. We explained two ways to lazy load images below.
