...
This is a more stringent requirement than [secure context](/en-US/docs/Web/Progressive_web_apps), which considers resources loaded from `file://` URLs to be secure.
