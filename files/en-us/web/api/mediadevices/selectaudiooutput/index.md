...
The prompt will not be displayed if the [`speaker-selection`](/en-US/docs/Web/HTTP/Headers/Permissions-Policy/speaker-selection) permission has not been granted.
