...
<dl>
  ...
  <dd>One or more of the requested source devices cannot be used at this time. This will
    ...
    <div class="note"><p><strong>Note:</strong> Older versions of the specification used <code>SecurityError</code>
      for this instead; <code>SecurityError</code> has taken on a new meaning.</p></div>
  </dd>
  ...
  <dd>The specified constraints resulted in no candidate devices which met the criteria
    ...
    <div class="note"><p><strong>Note:</strong> Because this error can occur even when the user has not yet granted
      permission to use the underlying device, it can potentially be used as a
      fingerprinting surface.</p></div>
  </dd>
