...
<p>The <strong><code>loadeddata</code></strong> event is fired when the frame at the current playback position of the media has finished loading; often the first frame. </p>
...
<div class="note">
<p><strong>Note:</strong> This event will not fire in mobile/tablet devices if data-saver is on in browser settings.</p>
</div>

<h2 id="Examples">Examples</h2>

<p>These examples add an event listener for the HTMLMediaElement's <code>loadeddata</code> event, then post a message when that event handler has reacted to the event firing.</p>
...
<p>Using the <code>onloadeddata</code> event handler property:</p>
