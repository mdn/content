...
existing ones removed. See [Event
  handlers](/en-US/docs/Web/API/VideoTrackList#event
__handlers) to learn more about watching for changes to a media element's track list.
