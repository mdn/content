...
<p>The <code>suspend</code> event is fired when media data loading has been suspended.</p>
...
<p>These examples add an event listener for the HTMLMediaElement's <code>suspend</code> event, then post a message when that event handler has reacted to the event firing.</p>
...
<p>Using the <code>onsuspend</code> event handler property:</p>
