...
<p>These examples add an event listener for the HTMLMediaElement's <code>durationchange</code> event, then post a message when that event handler has reacted to the event firing.</p>
...
<p>Using the <code>ondurationchange</code> event handler property:</p>
