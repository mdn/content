...
<p>The <code>waiting</code> event is fired when playback has stopped because of a temporary lack of data.</p>
...
<p>These examples add an event listener for the HTMLMediaElement's <code>waiting</code> event, then post a message when that event handler has reacted to the event firing.</p>
...
<p>Using the <code>onwaiting</code> event handler property:</p>
