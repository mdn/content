...
[`<audio>`](/en-US/docs/Web/HTML/Reference/Element/audio) or
...
We start with a
[`<video>`](/en-US/docs/Web/HTML/Reference/Element/video) that has
several [`<track>`](/en-US/docs/Web/HTML/Reference/Element/track)
children
