...
The {{domxref("HTMLMediaElement")}} method **`canPlayType()`** reports how likely it is that the current browser will be able to play media of a given [MIME type](/en-US/docs/Web/HTTP/Basics_of_HTTP/MIME_types).
...
- `type`
  - : A string specifying the [MIME type](/en-US/docs/Web/HTTP/Basics_of_HTTP/MIME_types) of the media and (optionally) a [`codecs` parameter](/en-US/docs/Web/Media/Formats/codecs_parameter) containing a comma-separated list of the supported codecs.
