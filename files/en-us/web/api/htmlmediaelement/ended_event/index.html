...
<p>The <code>ended</code> event is fired when playback or streaming has stopped because the end of the media was reached or because no further data is available. </p>

<p>This event occurs based upon {{domxref("HTMLMediaElement")}} ({{HTMLElement("audio")}} and {{HTMLElement("video")}}) fire <code>ended</code> when playback of the media reaches the end of the media.</p>
...
<div class="note">
<p><strong>Note:</strong> This event is also defined in <a href="/en-US/docs/Web/API/Media_Streams_API">Media Capture and Streams</a> and <a href="/en-US/docs/Web/API/Web_Audio_API">Web Audio API</a></p>
</div>

<h2 id="Examples">Examples</h2>

<p>These examples add an event listener for the HTMLMediaElement's <code>ended</code> event, then post a message when that event handler has reacted to the event firing.</p>
...
<p>Using the <code>onended</code> event handler property:</p>
...
<ul>
 ...
 <li><a href="/en-US/docs/Web/API/Media_Streams_API">Media Capture and Streams</a>
  <ul>
   <li><a href="/en-US/docs/Web/API/Media_Streams_API">Media Capture and Streams: ended event</a><a href="/en-US/docs/Web/API/MediaStreamTrack/ended_event">: ended event</a></li>
  </ul>
 </li>
 <li><a href="/en-US/docs/Web/API/Web_Audio_API">Web Audio API</a>
  <ul>
   <li><a href="/en-US/docs/Web/API/AudioScheduledSourceNode/ended_event">Web audio API: ended event</a></li>
  </ul>
 </li>
</ul>
