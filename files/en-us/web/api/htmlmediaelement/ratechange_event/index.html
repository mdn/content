...
<p>These examples add an event listener for the HTMLMediaElement's <code>ratechange</code> event, then post a message when that event handler has reacted to the event firing.</p>
...
<p>Using the <code>onratechange</code> event handler property:</p>
