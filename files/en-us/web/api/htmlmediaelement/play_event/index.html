...
<p>The <code>play</code> event is fired when the <code>paused</code> property is changed from <code>true</code> to <code>false</code>, as a result of the <code>play</code> method, or the <code>autoplay</code> attribute.</p>
...
<p>These examples add an event listener for the HTMLMediaElement's <code>play</code> event, then post a message when that event handler has reacted to the event firing.</p>
