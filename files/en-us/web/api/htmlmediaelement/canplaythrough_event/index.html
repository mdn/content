...
<table class="properties">
 <tbody>
  ...
  <tr>
   ...
   <td>{{domxref("GlobalEventHandlers.oncanplaythrough")}}</td>
  </tr>
  <tr>
...
<p>These examples add an event listener for the HTMLMediaElement's <code>canplaythrough</code> event, then post a message when that event handler has reacted to the event firing.</p>
...
<p>Using the <code>oncanplaythrough</code> event handler property:</p>
