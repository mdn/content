...
<p>The <strong><code>SVGHKernElement</code></strong> interface corresponds to the {{SVGElement("hkern")}} elements.</p>

<p>Object-oriented access to the attributes of the {{SVGElement("hkern")}} element via the SVG DOM is not possible.</p>
