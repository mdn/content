...
[`referrerpolicy`](/en-US/docs/Web/HTML/Reference/Element/script#referrerpolicy) of the {{HTMLElement("script")}} element, which defines how the referrer is set when fetching the script and any scripts it imports.
