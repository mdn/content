...
<div class="notecard warning">
  <p><strong>Warning:</strong> This interface is deprecated in the <a href="https://w3c.github.io/navigation-timing/#obsolete">Navigation Timing Level 2 specification</a>. Please use the {{domxref("PerformanceNavigationTiming")}} interface instead.</p>
</div>
...
<p>Each time is provided as a {{interwiki("wikipedia", "Unix_time", "Unix time")}} (<code>unsigned long long</code>) representing the moment, in milliseconds since the UNIX epoch.</p>
