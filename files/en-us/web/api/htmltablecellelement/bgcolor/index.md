...
Use CSS `background-color` instead. An example of using [`background-color` with HTML table elements](/en-US/docs/Web/CSS/Reference/Properties/background-color#basic_example) is available on the {{cssxref("background-color")}} page.
