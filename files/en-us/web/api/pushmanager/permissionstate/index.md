...
{{domxref("DOMString")}} indicating the permission state of the push manager. Possible
...
- `options {{optional_inline}}`
  ...
  - : An object containing optional configuration parameters. It can have the following
    ...
    - `userVisibleOnly`: A boolean indicating that the returned push
      ...
      user.
    - `applicationServerKey`: A public key your push server will use to
...
A {{jsxref("Promise")}} that resolves to a {{domxref("DOMString")}} with a value of
