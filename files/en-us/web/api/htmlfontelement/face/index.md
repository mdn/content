...
property is a string that reflects the [`face`](/en-US/docs/Web/HTML/Reference/Element/font#face) HTML attribute, containing a comma-separated list of one or more font
names.
