...
property is a string that reflects the [`color`](/en-US/docs/Web/HTML/Reference/Element/font#color) HTML attribute, containing either a named color or a color specified in the
