...
<p>The <strong>{{domxref("TextTrackList")}}</strong> method
    <strong><code>getTrackById()</code></strong> returns the first
    {{domxref("TextTrack")}} object from the track list whose
    <code><a href="/en-US/docs/Web/HTML/Global_attributes/id">id</a></code> matches the
...
<pre
  class="brush: js">var <em>theTrack</em> = <em>TextTrackList</em>.getTrackById(<em>id</em>);</pre>
...
<p>A {{domxref("TextTrack")}} object indicating the first track found within the
  <code>TextTrackList</code> whose <code>id</code> matches the specified string. If no
