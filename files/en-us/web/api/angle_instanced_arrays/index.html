...
<p>The <code><strong>ANGLE_instanced_arrays</strong></code> extension is part of the <a href="/en-US/docs/Web/API/WebGL_API">WebGL API</a> and allows to draw the same object, or groups of similar objects multiple times, if they share the same vertex data, primitive count and type.</p>
...
<dl>
 ...
 <dd>Returns a {{domxref("WebGL_API/Types", "GLint")}} describing the frequency divisor used for instanced rendering when used in the {{domxref("WebGLRenderingContext.getVertexAttrib()", "gl.getVertexAttrib()")}} as the <code>pname</code> parameter.</dd>
</dl>
