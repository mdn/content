...
<p>The <strong><code>firCount</code></strong> property of the
    ...
    <strong>Full Intra Request</strong> (<strong>FIR</strong>) packets have been sent by
    the receiver to the sender.</p>

<p>The receiver sends a FIR packet when the stream
  falls behind and needs to skip frames in order to catch up.</p>

<h2 id="Syntax">Syntax</h2>

<pre
  class="brush: js">var <em>firCount</em> = <em>rtcInboundRtpStreamStats</em>.firCount;</pre>
