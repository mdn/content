...
<p>The <strong><code>error</code></strong> read-only property of the
  {{domxref("SpeechRecognitionError")}} interface returns the type of error raised.</p>

<div class="notecard note">
  <p><strong>Note:</strong> This <code>SpeechRecognitionError</code> interface was renamed to
    {{domxref("SpeechRecognitionErrorEvent")}} in the Web Speech API specification.</p>
</div>
