...
| Range                       | Code                                                          |
| --------------------------- | ------------------------------------------------------------- |
| All keys ≥ **x**            | {{domxref("IDBKeyRange.lowerBound_static")}} `(x)`            |
| All keys > **x**            | {{domxref("IDBKeyRange.lowerBound_static")}} `(x, true)`      |
| All keys ≤ **y**            | {{domxref("IDBKeyRange.upperBound_static")}} `(y)`            |
| All keys < **y**            | {{domxref("IDBKeyRange.upperBound_static")}} `(y, true)`      |
| All keys ≥ **x** && ≤ **y** | {{domxref("IDBKeyRange.bound_static")}} `(x, y)`              |
| All keys > **x** &&< **y**  | {{domxref("IDBKeyRange.bound_static")}} `(x, y, true, true)`  |
| All keys > **x** && ≤ **y** | {{domxref("IDBKeyRange.bound_static")}} `(x, y, true, false)` |
| All keys ≥ **x** &&< **y**  | {{domxref("IDBKeyRange.bound_static")}} `(x, y, false, true)` |
| The key = **z**             | {{domxref("IDBKeyRange.only_static")}} `(z)`                  |
...
- {{domxref("IDBKeyRange.bound_static")}}
  - : Creates a new key range with upper and lower bounds.
- {{domxref("IDBKeyRange.only_static")}}
  - : Creates a new key range containing a single value.
- {{domxref("IDBKeyRange.lowerBound_static")}}
  - : Creates a new key range with only a lower bound.
- {{domxref("IDBKeyRange.upperBound_static")}}
