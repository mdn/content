...
<p>The <strong><code>RTCIceCandidate</code></strong> interface—part of the <a href="/en-US/docs/Web/API/WebRTC_API">WebRTC API</a>—represents a candidate Internet Connectivity Establishment ({{Glossary("ICE")}}) configuration which may be used to establish an {{domxref("RTCPeerConnection")}}.</p>
