...
It should be used when the data to be santitized is already available as DOM nodes.
...
This configuration may be customised using {{domxref("Sanitizer.Sanitizer","Sanitizer()")}} constructor options.
