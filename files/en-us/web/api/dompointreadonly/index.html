...
<dl>
 ...
 <dd>Creates a new <code>DOMPointReadOnly</code> object given the values of its coordinates and perspective. To create a point using a<code>DOMPointInit</code> object, you can instead use {{domxref("DOMPointReadOnly.fromPoint()")}}.</dd>
</dl>
...
<dl>
 ...
 <dd>A static method that creates a new <code>DOMPointReadOnly</code> object given the coordinates provided in the specified {{domxref("DOMPointInit")}} object.</dd>
</dl>
...
<dl>
 ...
 <dd>Applies a matrix transform specified as a {{domxref("DOMMatrixInit")}} object to the <code>DOMPointReadOnly</code> object.</dd>
