...
<table class="no-markdown">
  ...
  <tbody>
    ...
    <tr>
      <td>Run</td>
      <td>A generic way to process some shared storage data. Used, for example, by the <a href="https://developers.google.com/privacy-sandbox/relevance/private-aggregation">Private Aggregation API</a> to process shared storage data and generate aggregated reports. </td>
