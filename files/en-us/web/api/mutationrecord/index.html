...
<table class="standard-table">
 ...
 <tbody>
  ...
  <tr>
   ...
   <td>{{domxref("Node")}}</td>
   <td>Returns the node the mutation affected, depending on the {{domxref("MutationRecord.type")}}.<br>
    ...
    For <code>childList</code>, it is the node whose children changed.</td>
  </tr>
  <tr>
  ...
  <tr>
   ...
   <td><code>String</code></td>
   <td>
    <p>The return value depends on the {{domxref("MutationRecord.type")}}.<br>
     ...
     For <code>childList</code>, it is <code>null</code>.</p>

    <div class="note">
    <p><strong>Note:</strong> For this to work as expected, <code>attributeOldValue</code> or <code>characterDataOldValue</code> must be set to <code>true</code> in the corresponding <a href="/en-US/docs/Web/API/MutationObserverInit">MutationObserverInit</a> parameter of the <code>MutationObserver</code> <a href="/en-US/docs/Web/API/MutationObserver/observe">observe</a> method</p>
    </div>
   </td>
  </tr>
 </tbody>
