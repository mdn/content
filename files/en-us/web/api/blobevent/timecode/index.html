...
<p>The <strong><code>timecode</code></strong> readonlyinline
    ...
    produced by this recorder.</p>

<p>Note that the timecode in the first produced
  BlobEvent does not need to be zero.</p>

<h2 id="Syntax">Syntax</h2>

<pre class="brush: js">var timecode = blobEvent.timecode</pre>
