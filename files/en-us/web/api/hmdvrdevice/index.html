...
<p><em>This interface doesn't define any properties of its own, but it does inherit the properties of its parent interface, {{domxref("VRDevice")}}.</em></p>

<dl>
 <dt>{{domxref("VRDevice.hardwareUnitId")}} {{readonlyInline}}</dt>
 ...
 <dt>{{domxref("VRDevice.deviceId")}} {{readonlyInline}}</dt>
 ...
 <dt>{{domxref("VRDevice.deviceName")}} {{readonlyInline}}</dt>
