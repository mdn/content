...
<p>The <strong><code>PayerErrors</code></strong> dictionary is used by the <a href="/en-US/docs/Web/API/Payment_Request_API">Payment Request API</a> to indicate the presence of—and to explain how to correct—validation errors in the payer details.</p>

<p>For each field in the payment information that fails validation, the <code>PayerErrors</code> object contains a string explaining the error.</p>

<p>The payer details include the payer's name, phone number, and email address.</p>
