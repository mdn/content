...
<h2 id="SVG_animated_transform_list_interface">SVG animated transform list interface</h2>
...
<table class="standard-table">
 <tbody>
  ...
  <tr>
   ...
   <td>
    <ul>
     <li>readonly {{ domxref("SVGTransformList") }} <code>baseVal</code></li>
...
<p>The <code>SVGAnimatedTransformList</code> interface doesn't provide any specific methods.</p>
