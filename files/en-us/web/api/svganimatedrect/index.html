...
<p>The <code>SVGAnimatedRect</code> interface is used for attributes of basic {{ domxref("SVGRect") }} which can be animated.</p>
...
<table class="no-markdown">
 <tbody>
  ...
  <tr>
   ...
   <td>
    <ul>
     <li>readonly {{ domxref("SVGRect") }} <code>baseVal</code></li>
     <li>readonly {{ domxref("SVGRect") }} <code>animVal</code></li>
    </ul>
   </td>
  </tr>
  <tr>
...
<p><em>The <code>SVGAnimatedRect</code> interface do not provide any specific methods.</em></p>
