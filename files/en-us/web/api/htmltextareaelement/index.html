...
<table class="standard-table">
 <tbody>
  ...
  <tr>
   ...
   <td><code><em>object</em>:</code> Returns a reference to the parent form element. If this element is not contained in a form element, it can be the {{htmlattrxref("id", "form")}} attribute of any {{HTMLElement("form")}} element in the same document or the value <code>null</code>.</td>
  </tr>
  <tr>
  ...
  <tr>
   ...
   <td><code><em>long</em>:</code> Returns the codepoint length of the control's <code>value</code>. Same as reading <code>value.length</code></td>
  </tr>
  <tr>
  ...
  <tr>
   ...
   <td>{{domxref("NodeList")}}: Returns a list of label elements associated with this element.</td>
  </tr>
 </tbody>
</table>
...
<p>Insert some HTML tags or <em>smiles</em> or any custom text in a textarea.</p>
