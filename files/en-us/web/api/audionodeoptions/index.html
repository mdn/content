...
<p><code>AudioNodeOptions</code> is inherited from by the option objects of the different
  ...
  {{domxref("AnalyserNode.AnalyserNode")}} or {{domxref("GainNode.GainNode")}}.</p>
...
<dl>
  <dt><code>channelCount</code> {{optional_inline}}</dt>
  ...
  <dt><code>channelCountMode</code> {{optional_inline}}</dt>
  ...
  <dt><code>channelInterpretation</code> {{optional_inline}}</dt>
  <dd>Represents an enumerated value describing the meaning of the channels. This
