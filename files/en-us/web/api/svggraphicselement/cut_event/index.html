...
<p>The <strong><code>cut</code></strong> event is fired on an {{domxref("SVGGraphicsElement")}} when the user has initiated a "cut" action through the browser's user interface.</p>
...
<p>A handler for this event can <em>modify</em> the clipboard contents by calling <a href="/en-US/docs/Web/API/DataTransfer/setData" title="The DataTransfer.setData() method sets the drag operation's drag data to the specified data and type. If data for the given type does not exist, it is added at the end of the drag data store, such that the last item in the types list will be the new type. If data for the given type already exists, the existing data is replaced in the same position. That is, the order of the types list is not changed when replacing data of the same type."><code>setData(format, data)</code></a> on the event's  <a href="/en-US/docs/Web/API/ClipboardEvent/clipboardData" title="The ClipboardEvent.clipboardData property holds a DataTransfer object, which can be used:"><code>ClipboardEvent.clipboardData</code></a> property, and cancelling the default action using <code><a href="/en-US/docs/Web/API/Event/preventDefault">event.preventDefault()</a></code>.</p>
...
<ul>
 <li>Related events: <code><a href="/en-US/docs/Web/API/SVGGraphicsElement/copy_event">copy</a></code>, <code><a href="/en-US/docs/Web/API/SVGGraphicsElement/paste_event">paste</a></code></li>
 <li>This event on HTML {{domxref("Element")}} targets: <code><a href="/en-US/docs/Web/API/Element/cut_event">cut</a></code></li>
 <li>This event on {{domxref("Document")}} targets: <code><a href="Web/API/Document/cut_event">cut</a></code></li>
 <li>This event on {{domxref("Window")}} targets: <code><a href="Web/API/Window/cut_event">cut</a></code></li>
</ul>
