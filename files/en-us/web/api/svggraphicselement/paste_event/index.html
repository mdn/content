...
<table class="properties">
 <tbody>
  ...
  <tr>
   ...
   <td>{{domxref("SVGGraphicsElement/onpaste", "onpaste")}}</td>
  </tr>
 </tbody>
</table>
...
<pre class="brush: js">document.getElementById("element-to-paste-text").addEventListener("paste", evt =&gt; {
...
<ul>
 <li>Related events: <code><a href="/en-US/docs/Web/API/SVGGraphicsElement/cut_event">cut</a></code>, <code><a href="/en-US/docs/Web/API/SVGGraphicsElement/copy_event">copy</a></code></li>
 <li>This event on HTML {{domxref("Element")}} targets: <code><a href="/en-US/docs/Web/API/Element/paste_event">paste</a></code></li>
 <li>This event on {{domxref("Document")}} targets: <code><a href="Web/API/Document/paste_event">paste</a></code></li>
 <li>This event on {{domxref("Window")}} targets: <code><a href="Web/API/Window/paste_event">paste</a></code></li>
</ul>
