...
- `NotAllowedError` {{domxref("DOMException")}}
  - : Possible causes include:
    ...
    - The function is called cross-origin but the iframe's [`allow`](/en-US/docs/Web/HTML/Reference/Element/iframe#allow) attribute does not set an appropriate {{HTTPHeader("Permissions-Policy/publickey-credentials-create","publickey-credentials-create")}} policy.
