...
<p>The <strong><code>url</code></strong> read-only property of the {{domxref("Response")}}
  interface contains the URL of the response. The value of the <code>url</code> property
  will be the final URL obtained after any redirects. </p>

<h2 id="Syntax">Syntax</h2>

<pre
  class="brush: js">var <var>myURL</var> = <var>response</var>.url;</pre>
...
<p>Note that at the top of the <code>fetch()</code> block we log the response
  <code>URL</code> to the console.</p>
