...
We create an element with a [`width`](/en-US/docs/Web/CSS/Reference/Properties/width) determined using a [`calc()`](/en-US/docs/Web/CSS/calc) function, then {{domxref("console/log_static", "console.log()")}} the `operator`.
