...
We create an element with a {{cssxref("width")}} determined using a [`calc()`](/en-US/docs/Web/CSS/Reference/Values/calc) function, then {{domxref("console/log_static", "console.log()")}} the `operator`.
