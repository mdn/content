...
<dl>
 <dt>{{domxref("HTMLObjectElement.align")}} {{deprecated_inline}}</dt>
 ...
 <dt>{{domxref("HTMLObjectElement.archive")}} {{deprecated_inline}}</dt>
 ...
 <dt>{{domxref("HTMLObjectElement.border")}} {{deprecated_inline}}</dt>
 ...
 <dt>{{domxref("HTMLObjectElement.code")}} {{deprecated_inline}}</dt>
 ...
 <dt>{{domxref("HTMLObjectElement.codeBase")}} {{deprecated_inline}}</dt>
 ...
 <dt>{{domxref("HTMLObjectElement.codeType")}} {{deprecated_inline}}</dt>
 ...
 <dt>{{domxref("HTMLObjectElement.declare")}} {{deprecated_inline}}</dt>
 <dd>Is a boolean value that reflects the {{htmlattrxref("declare", "object")}} HTML attribute, indicating that this is a declaration, not an instantiation, of the object.</dd>
 <dt>{{domxref("HTMLObjectElement.form")}} {{readonlyInline}}</dt>
 <dd>Returns a {{domxref("HTMLFormElement")}} representing the object element's form owner, or null if there isn't one.</dd>
 ...
 <dt>{{domxref("HTMLObjectElement.hspace")}} {{deprecated_inline}}</dt>
 ...
 <dt>{{domxref("HTMLObjectElement.standby")}} {{deprecated_inline}}</dt>
 ...
 <dt>{{domxref("HTMLObjectElement.vspace")}} {{deprecated_inline}}</dt>
 <dd>Is a <code>long</code> representing the horizontal space in pixels around the control.</dd>
 ...
 <dd>Returns a boolean value that indicates whether the element is a candidate for constraint validation. Always <code>false</code> for <code>HTMLObjectElement</code> objects.</dd>
</dl>
...
<dl>
 ...
 <dd>Returns a boolean value that always is <code>true</code>, because <code>object</code> objects are never candidates for constraint validation.</dd>
