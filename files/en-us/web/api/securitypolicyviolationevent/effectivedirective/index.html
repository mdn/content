...
<p>The <code><strong>effectiveDirective</strong></code> read-only property of the
...
<pre
  class="brush: js">let <var>effDir</var> = <var>violationEventInstance</var>.effectiveDirective;</pre>
