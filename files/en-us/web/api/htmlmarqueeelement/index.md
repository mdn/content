...
<p>The <strong><code>HTMLMarqueeElement</code></strong> interface provides methods to manipulate {{HTMLElement("marquee")}} elements.</p>

<p>It inherits properties and methods from the {{DOMxRef("HTMLElement")}} interface.</p>
