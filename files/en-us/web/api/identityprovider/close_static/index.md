...
`close()` needs to be called from the same origin the IdP sign-in dialog is situated on, as defined in the [IdP config](/en-US/docs/Web/API/FedCM_API/IDP_integration#provide_a_config_file_and_endpoints).
