...
<p>The <strong><code>qpSum</code></strong> property of the
    ...
    <code>RTCOutboundRtpStreamStats</code> object.</p>

<p>In general, the higher this
  number is, the more heavily compressed the video data is.</p>

<h2 id="Syntax">Syntax</h2>

<pre
  class="brush: js">var qpSum = <em>RTCOutboundRtpStreamStats</em>.qpSum;</pre>
...
<p>It's important to keep in mind that the value of QP can change periodically—even every
  ...
  quantization")}} below for a function that does this.</p>
