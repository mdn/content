...
been encoded so far, and compute an average from there. See [Calculating average
  quantization](#calculating_average___quantization) below for a function that does this.
