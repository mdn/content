...
- {{DOMxRef("SharedWorker")}}
  - : Represents a specific kind of worker that can be _accessed_ from several {{glossary("browsing context", "browsing contexts")}}, be in several windows, iframes or even workers.
