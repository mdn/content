...
[`srcset`](/en-US/docs/Web/HTML/Reference/Element/img#srcset) attribute. One is 200px wide and the other is 400px
wide. Further, the [`sizes`](/en-US/docs/Web/HTML/Reference/Element/img#sizes) attribute is provided to specify the
