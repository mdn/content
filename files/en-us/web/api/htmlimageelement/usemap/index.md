...
{{Glossary("HTML")}} [`usemap`](/en-US/docs/Web/HTML/Reference/Element/img#usemap) attribute, which is a string
...
appropriate `<map>`'s [`name`](/en-US/docs/Web/HTML/Reference/Element/map#name) attribute with a
