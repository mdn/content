...
**`src`**, which reflects the HTML [`src`](/en-US/docs/Web/HTML/Reference/Element/img#src) attribute, specifies the image to display in the {{HTMLElement("img")}}
element.
...
[`src`](/en-US/docs/Web/HTML/Reference/Element/img#src) content attribute, or programmatically by setting the
element's `src` property.

If you use the [`srcset`](/en-US/docs/Web/HTML/Reference/Element/img#srcset) content attribute to provide multiple
...
corresponding [`sizes`](/en-US/docs/Web/HTML/Reference/Element/img#sizes) content attribute) _and_
