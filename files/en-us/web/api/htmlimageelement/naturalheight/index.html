...
<p>The {{domxref("HTMLImageElement")}} interface's
    <code><strong>naturalHeight</strong></code> property is a read-only value which
    returns the intrinsic (natural), density-corrected height of the image in
    {{Glossary("CSS pixel", "CSS pixels")}}.</p>

<p>This is the height the image is if
  ...
  <div class="notecard note"><p><strong>Note:</strong> Most of the time the natural height is the actual height of the image sent by the server.
    ...
    by such browser interventions as the natural height, and returns this value.</p>
  </div>

<h2 id="Syntax">Syntax</h2>

<pre
  class="brush: js">let <em>naturalHeight</em> = <em>htmlImageElement</em>.naturalHeight;</pre>

<h3 id="Value">Value</h3>

<p>An integer value indicating the intrinsic height, in CSS pixels, of the image. This is
...
<p>If the intrinsic height is not available—either because the image does not specify an
  intrinsic height or because the image data is not available in order to obtain this
  information, <code>naturalHeight</code> returns 0.</p>

<h2 id="Example">Example</h2>

<p>This example displays both the natural, density-adjusted size of an image as well as
  its rendered size as altered by the page's CSS and other factors.</p>
...
<p>The HTML features a 400x398 pixel image which is placed inside a
  {{HTMLElement("div")}}.</p>
...
<p>The main thing of note in the CSS above is that the style used for the container the
  image will be drawn in is 200px wide, and the image will be drawn to fill its width
  (100%).</p>

<h3 id="JavaScript">JavaScript</h3>

<pre class="brush: js">let output = document.querySelector(".output");
...
<p>The JavaScript code dumps the natural and as-displayed sizes into the
  {{HTMLElement("div")}} with the class <code>output</code>. This is done in response to
