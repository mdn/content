...
To prevent this reflow from occurring, you should explicitly specify the size of the image's presentation using the image element's [`width`](/en-US/docs/Web/HTML/Reference/Element/img#width) and
[`height`](/en-US/docs/Web/HTML/Reference/Element/img#height) attributes.
