...
[image](/en-US/docs/Web/HTML/Reference/Element/img) for each of a list of media conditions. This provides the ability to
...
evaluates to `true`. For more information about the syntax of the `sizes` attribute, see [`<img>`](/en-US/docs/Web/HTML/Reference/Element/img#sizes).
