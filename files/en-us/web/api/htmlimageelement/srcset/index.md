...
> [!NOTE]
> If the [`srcset`](/en-US/docs/Web/HTML/Reference/Element/img#srcset) attribute uses width descriptors, the `sizes` attribute must also be present, or the `srcset` itself will be ignored.
