...
- `width` {{optional_inline}}
  - : The width of the image (i.e., the value for the [`width`](/en-US/docs/Web/HTML/Reference/Element/img#width)
    attribute).
- `height` {{optional_inline}}
  - : The height of the image (i.e., the value for the [`height`](/en-US/docs/Web/HTML/Reference/Element/img#height)
    attribute).
