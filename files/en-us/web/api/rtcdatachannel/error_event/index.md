...
Error information is output to the console using {{domxref("console.error_static")}}. The `message` string is always output, as is information about the source file's name, line number, and column number at which the error occurred.
