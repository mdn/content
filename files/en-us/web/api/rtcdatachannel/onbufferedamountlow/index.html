...
<p>The <strong><code>RTCDataChannel.onbufferedamountlow</code></strong> property is an
  ...
  "bufferedAmountLowThreshold")}}.</p>

<p>See {{SectionOnPage("/en-US/docs/Web/API/WebRTC_API/Using_data_channels",
  "Buffering")}} to learn more about how to work with the data channel buffer.</p>

<h2 id="Syntax">Syntax</h2>

<pre
  class="brush: js"><em>RTCDataChannel</em>.onbufferedamountlow = <em>function</em>;</pre>
