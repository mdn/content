...
<p>The <strong><code>HTMLElement</code></strong> interface represents any <a href="/en-US/docs/Web/HTML">HTML</a> element. Some elements directly implement this interface, while others implement it via an interface that inherits it.</p>

<p>{{InheritanceDiagram}}</p>

<h2 id="Properties">Properties</h2>

<p><em>Inherits properties from its parent, {{DOMxRef("Element")}}, and implements those from {{DOMxRef("DocumentAndElementEventHandlers")}}, {{DOMxRef("GlobalEventHandlers")}}, and {{DOMxRef("TouchEventHandlers")}}.</em></p>
...
<dl>
 ...
 <dd>Is a {{DOMxRef("StylePropertyMap")}} representing the declarations of the element's {{htmlattrxref("style")}} attribute.</dd>
 ...
 <dd>Returns a {{DOMxRef("DOMStringMap")}} with which script can read and write the element's <a href="/en-US/docs/Learn/HTML/Howto/Use_data_attributes">custom data attributes</a> (<code>data-*</code>) .</dd>
 ...
 <dd>Is a {{DOMxRef("DOMString")}} defining what action label (or icon) to present for the enter key on virtual keyboards.</dd>
 ...
 <dd>Is a {{JSxRef("Boolean")}} indicating whether an import script can be executed in user agents that support module scripts.</dd>
 ...
 <dd>Is a {{JSxRef("Boolean")}} that controls <a href="/en-US/docs/Web/HTML/Global_attributes/spellcheck">spell-checking</a>. It is present on all HTML elements, though it doesn't have an effect on all of them.</dd>
 <dt>{{DOMxRef("HTMLElement.style")}}</dt>
 <dd>Is a {{DOMxRef("CSSStyleDeclaration")}} representing the declarations of the element's {{htmlattrxref("style")}} attribute.</dd>
...
<p>Most event handler properties, of the form <code>onXYZ</code>, are defined on the {{DOMxRef("DocumentAndElementEventHandlers")}}, {{DOMxRef("GlobalEventHandlers")}} or {{DOMxRef("TouchEventHandlers")}} interfaces and implemented by <code>HTMLElement</code>. In addition, the following handlers are specific to <code>HTMLElement</code>.</p>
...
<dl>
 ...
 <dd>Returns the event handling code for the {{domxref("Element/touchstart_event", "touchstart")}} event.</dd>
 <dt>{{DOMxRef("TouchEventHandlers.ontouchend")}} {{Non-standard_Inline}}</dt>
 <dd>Returns the event handling code for the {{domxref("Element/touchend_event", "touchend")}} event.</dd>
 <dt>{{DOMxRef("TouchEventHandlers.ontouchmove")}} {{Non-standard_Inline}}</dt>
 <dd>Returns the event handling code for the {{domxref("Element/touchmove_event", "touchmove")}} event.</dd>
 ...
 <dd>Returns the event handling code for the {{domxref("Element/touchcancel_event", "touchcancel")}} event.</dd>
</dl>

<h2 id="Methods">Methods</h2>

<p><em>Inherits methods from its parent, {{DOMxRef("Element")}}, and implements those from {{DOMxRef("DocumentAndElementEventHandlers")}}, {{DOMxRef("GlobalEventHandlers")}}, and {{DOMxRef("TouchEventHandlers")}}.</em></p>
...
<dl>
 <dt>{{domxref("HTMLInputElement/invalid_event", "invalid")}}</dt>
 <dd>Fired when an element does not satisfy its constraints during constraint validation.<br>
 Also available via the {{domxref("GlobalEventHandlers/oninvalid", "oninvalid")}} property.</dd>
</dl>
...
<dl>
 ...
 Also available via the {{domxref("GlobalEventHandlers/oninput", "oninput")}} property.</dd>
 <dt>{{domxref("HTMLElement/change_event", "change")}}</dt>
 <dd>Fired when the <code>value</code> of an {{HTMLElement("input")}}, {{HTMLElement("select")}}, or {{HTMLElement("textarea")}} element has been changed and committed by the user. Unlike the {{domxref("HTMLElement/input_event", "input")}} event, the <code>change</code> event is not necessarily fired for each alteration to an element's <code>value</code>.</dd>
</dl>
...
<dl>
 ...
 <dd>Fired when an element captures a pointer using {{domxref("Element/setPointerCapture", "setPointerCapture()")}}.<br>
...
<dl>
 ...
 <dd>Fired when a <a href="/en-US/docs/Web/CSS/CSS_Transitions/Using_CSS_transitions">CSS transition</a> is canceled.<br>
 ...
 <dd>Fired when a <a href="/en-US/docs/Web/CSS/CSS_Transitions/Using_CSS_transitions">CSS transition</a> has completed.<br>
 ...
 <dd>Fired when a <a href="/en-US/docs/Web/CSS/CSS_Transitions/Using_CSS_transitions">CSS transition</a> is first created.<br>
 ...
 <dd>Fired when a <a href="/en-US/docs/Web/CSS/CSS_Transitions/Using_CSS_transitions">CSS transition</a> has actually started.<br>
