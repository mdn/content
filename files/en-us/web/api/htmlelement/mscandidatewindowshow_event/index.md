...
The **`mscandidatewindowshow`** event is thrown immediately after the {{glossary("IME")}} (Input Method Editor) candidate window is set to appear, but before it renders.
