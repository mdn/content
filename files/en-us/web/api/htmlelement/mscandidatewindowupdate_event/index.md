...
The **`mscandidatewindowupdate`** event is thrown after the {{glossary("IME")}} (Input Method Editor) candidate window has been identified as needing to change size, but before any visual updates have rendered.
