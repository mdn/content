...
<dl>
  ...
  <dd>A {{domxref("DOMString","string")}} representing the name of the event. One of:
    <ul>
      <li><code>onbackgroundfetchsuccess</code></li>
      <li><code>onbackgroundfetchfail</code></li>
    </ul>
  </dd>
  <dt><code>BackgroundFetchEventInit</code></dt>
  <dd>An object including the following:
    <dl>
      <dt>A {{domxref("BackgroundFetchRegistration")}}.</dt>
      <dd>The background fetch registration instance.</dd>
