...
<p>The <code><strong>Touch.pageY</strong></code> read-only property returns the Y
  coordinate of the touch point relative to the viewport, including any scroll offset.</p>

<h2 id="Syntax">Syntax</h2>

<pre class="brush: js"><em>touchItem</em>.pageY;</pre>

<h3 id="Return_Value">Return value</h3>

<p>A <code>long</code> value that representes the Y coordinate of the touch point relative
  to the viewport, including any scroll offset.</p>
