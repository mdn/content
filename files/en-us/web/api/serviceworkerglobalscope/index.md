...
- {{domxref("ServiceWorkerGlobalScope/messageerror_event", "messageerror")}}
  - : Occurs when incoming messages can't be deserialized. Controlled pages can use the {{domxref("MessagePort.postMessage()")}} method to send messages to service workers.
