...
<p>The <code><strong>results</strong></code> read-only property of the
  {{domxref("SpeechRecognitionEvent")}} interface returns a
  {{domxref("SpeechRecognitionResultList")}} object representing all the speech
  recognition results for the current session.</p>

<p>Specifically this object will contain all final results that have been returned,
  ...
  will not be overwritten or removed.</p>

<h2 id="Syntax">Syntax</h2>

<pre class="brush: js">var myResults = event.results;
</pre>

<h3 id="Value">Value</h3>

<p>A {{domxref("SpeechRecognitionResultList")}} object.</p>
