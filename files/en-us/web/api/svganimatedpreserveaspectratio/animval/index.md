...
This property reflects the animated state of the {{SVGAttr("preserveAspectRatio")}} attribute during an animation. If the attribute is not currently being animated, `animVal` will be the same as `baseVal`.
