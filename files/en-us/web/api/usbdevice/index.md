...
- {{domxref("USBDevice.configuration")}} {{ReadOnlyInline}} {{Experimental_Inline}} {{SecureContext_Inline}}
  - : A {{domxref("USBConfiguration")}} object for the currently selected interface for a paired USB device.
- {{domxref("USBDevice.configurations")}} {{ReadOnlyInline}} {{Experimental_Inline}} {{SecureContext_Inline}}
  - : An {{jsxref("array")}} of device-specific interfaces for controlling a paired USB device.
- {{domxref("USBDevice.deviceClass")}} {{ReadOnlyInline}} {{Experimental_Inline}} {{SecureContext_Inline}}
...
- {{domxref("USBDevice.deviceProtocol")}} {{ReadOnlyInline}} {{Experimental_Inline}} {{SecureContext_Inline}}
...
- {{domxref("USBDevice.deviceSubclass")}} {{ReadOnlyInline}} {{Experimental_Inline}} {{SecureContext_Inline}}
...
- {{domxref("USBDevice.deviceVersionMajor")}} {{ReadOnlyInline}} {{Experimental_Inline}} {{SecureContext_Inline}}
  - : The major version number of the device in a semantic versioning scheme.
- {{domxref("USBDevice.deviceVersionMinor")}} {{ReadOnlyInline}} {{Experimental_Inline}} {{SecureContext_Inline}}
  - : The minor version number of the device in a semantic versioning scheme.
- {{domxref("USBDevice.deviceVersionSubminor")}} {{ReadOnlyInline}} {{Experimental_Inline}} {{SecureContext_Inline}}
  - : The patch version number of the device in a semantic versioning scheme.
- {{domxref("USBDevice.manufacturerName")}} {{ReadOnlyInline}} {{Experimental_Inline}} {{SecureContext_Inline}}
  - : The name of the organization that manufactured the USB device.
- {{domxref("USBDevice.opened")}} {{ReadOnlyInline}} {{Experimental_Inline}} {{SecureContext_Inline}}
  - : Indicates whether a session has been started with a paired USB device.
- {{domxref("USBDevice.productId")}} {{ReadOnlyInline}} {{Experimental_Inline}} {{SecureContext_Inline}}
  - : The manufacturer-defined code that identifies a USB device.
- {{domxref("USBDevice.productName")}} {{ReadOnlyInline}} {{Experimental_Inline}} {{SecureContext_Inline}}
  - : The manufacturer-defined name that identifies a USB device.
- {{domxref("USBDevice.serialNumber")}} {{ReadOnlyInline}} {{Experimental_Inline}} {{SecureContext_Inline}}
  - : The manufacturer-defined serial number for the specific USB device.
- {{domxref("USBDevice.usbVersionMajor")}} {{ReadOnlyInline}} {{Experimental_Inline}} {{SecureContext_Inline}}
...
- {{domxref("USBDevice.usbVersionMinor")}} {{ReadOnlyInline}} {{Experimental_Inline}} {{SecureContext_Inline}}
...
- {{domxref("USBDevice.usbVersionSubminor")}} {{ReadOnlyInline}} {{Experimental_Inline}} {{SecureContext_Inline}}
...
- {{domxref("USBDevice.vendorId")}} {{ReadOnlyInline}} {{Experimental_Inline}} {{SecureContext_Inline}}
  - : The official usb.org-assigned vendor ID.

## Instance methods

- {{domxref("USBDevice.claimInterface()")}} {{Experimental_Inline}} {{SecureContext_Inline}}
  - : Returns a {{jsxref("Promise")}} that resolves when the requested interface is claimed for exclusive access.
- {{domxref("USBDevice.clearHalt()")}} {{Experimental_Inline}} {{SecureContext_Inline}}
  - : Returns a {{jsxref("Promise")}} that resolves when a halt condition is cleared.
- {{domxref("USBDevice.controlTransferIn()")}} {{Experimental_Inline}} {{SecureContext_Inline}}
...
- {{domxref("USBDevice.controlTransferOut()")}} {{Experimental_Inline}} {{SecureContext_Inline}}
...
- {{domxref("USBDevice.close()")}} {{Experimental_Inline}} {{SecureContext_Inline}}
  - : Returns a {{jsxref("Promise")}} that resolves when all open interfaces are released and the device session has ended.
- {{domxref("USBDevice.forget()")}} {{Experimental_Inline}} {{SecureContext_Inline}}
...
- {{domxref("USBDevice.isochronousTransferIn()")}} {{Experimental_Inline}} {{SecureContext_Inline}}
...
- {{domxref("USBDevice.isochronousTransferOut()")}} {{Experimental_Inline}} {{SecureContext_Inline}}
...
- {{domxref("USBDevice.open()")}} {{Experimental_Inline}} {{SecureContext_Inline}}
  - : Returns a {{jsxref("Promise")}} that resolves when a device session has started.
- {{domxref("USBDevice.releaseInterface()")}} {{Experimental_Inline}} {{SecureContext_Inline}}
  - : Returns a {{jsxref("Promise")}} that resolves when a claimed interface is released from exclusive access.
- {{domxref("USBDevice.reset()")}} {{Experimental_Inline}} {{SecureContext_Inline}}
...
- {{domxref("USBDevice.selectAlternateInterface()")}} {{Experimental_Inline}} {{SecureContext_Inline}}
  - : Returns a {{jsxref("Promise")}} that resolves when the specified alternative endpoint is selected.
- {{domxref("USBDevice.selectConfiguration()")}} {{Experimental_Inline}} {{SecureContext_Inline}}
  - : Returns a {{jsxref("Promise")}} that resolves when the specified configuration is selected.
- {{domxref("USBDevice.transferIn()")}} {{Experimental_Inline}} {{SecureContext_Inline}}
...
- {{domxref("USBDevice.transferOut()")}} {{Experimental_Inline}} {{SecureContext_Inline}}
