...
If a Permissions Policy blocks use of a feature it is because your code is inconsistent with the policies set on your server. This is not something that would ever be shown to a user. Our [Permissions_Policy](/en-US/docs/Web/HTTP/Permissions_Policy) article contains implementation instructions.
