---
title: "IntegrityViolationReportBody: blockedURL property"
short-title: blockedURL
slug: Web/API/IntegrityViolationReportBody/blockedURL
page-type: web-api-instance-property
browser-compat: api.IntegrityViolationReportBody.blockedURL
---

{{APIRef("Reporting API")}}

The **`blockedURL`** read-only property of the {{domxref("IntegrityViolationReportBody")}} interface is a string value that represents the resource that was blocked because it violates a [Content Security Policy (CSP)](/en-US/docs/Web/HTTP/Guides/CSP).
