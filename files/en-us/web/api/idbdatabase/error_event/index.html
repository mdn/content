...
<p>The <code>error</code> event is fired on <code>IDBDatabase</code> when a request returns an error and the event bubbles up to the connection object.</p>
...
<table class="properties">
 <tbody>
  ...
  <tr>
   ...
   <td><code><a href="/en-US/docs/Web/API/IDBDatabase/onerror">onerror</a></code></td>
  </tr>
 </tbody>
</table>
...
<ul>
 ...
 <li><code><a href="/en-US/docs/Web/API/IDBDatabase/onerror">onerror</a></code> event handler property</li>
</ul>
