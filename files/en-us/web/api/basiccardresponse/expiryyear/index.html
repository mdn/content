...
<pre class="brush: js"><em>"expiryYear"</em> : "number"</pre>

<h3 id="Value">Value</h3>

<p>A {{domxref("DOMString")}} representing the card expiry year as a four-digit number in
  the range 0000 to 9999.</p>
