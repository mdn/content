...
<p>The <strong><code>domainLookupStart</code></strong> read-only property returns the
  {{domxref("DOMHighResTimeStamp","timestamp")}} immediately before the browser starts the
  domain name lookup for the resource.</p>

<p>{{AvailableInWorkers}}</p>

<h2 id="Syntax">Syntax</h2>

<pre class="brush: js"><em>resource</em>.domainLookupStart;
</pre>

<h3 id="Return_Value">Return value</h3>

<p>A {{domxref("DOMHighResTimeStamp")}} immediately before the browser starts the domain
  name lookup for the resource.</p>
