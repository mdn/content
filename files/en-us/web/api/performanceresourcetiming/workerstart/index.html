...
<p>The <strong><code>workerStart</code></strong> read-only property of the
  ...
  is not intercepted by a Service Worker the property will always return 0.</p>

<p>{{AvailableInWorkers}}</p>

<h2 id="Syntax">Syntax</h2>

<pre class="brush: js"><em>resource</em>.workerStart;
</pre>
