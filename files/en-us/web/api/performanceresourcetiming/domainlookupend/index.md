...
<p>The <strong><code>domainLookupEnd</code></strong> read-only property returns the
...
<p>If the user agent has the domain information in cache,
  ...
  times when the user agent starts and ends the domain data retrieval from the cache.</p>

<p>{{AvailableInWorkers}}</p>

<h2 id="Syntax">Syntax</h2>

<pre class="brush: js"><em>resource</em>.domainLookupEnd;
</pre>

<h3 id="Return_Value">Return value</h3>

<p>A {{domxref("DOMHighResTimeStamp")}} representing the time immediately after the
  browser finishes the domain name lookup for the resource.</p>
