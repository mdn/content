...
<p>The <strong><code>secureConnectionStart</code></strong> read-only property returns a
  ...
  the property returns zero.</p>

<p>{{AvailableInWorkers}}</p>

<h2 id="Syntax">Syntax</h2>

<pre class="brush: js"><em>resource</em>.secureConnectionStart;
</pre>

<h3 id="Return_Value">Return value</h3>

<p>If the resource is fetched over a secure connection, a
