...
All supported `entryTypes` are available using the static property {{domxref("PerformanceObserver.supportedEntryTypes_static")}}.
...
- {{domxref("PerformanceObserver.supportedEntryTypes_static")}}
