...
<p>The <strong><code>linearAcceleration</code></strong> read-only property of the {{domxref("GamepadPose")}} interface returns an array representing the linear acceleration vector of the {{domxref("Gamepad")}}, in meters per second per second.</p>

<p>In other words, the current acceleration of the sensor, along the <code>x</code>, <code>y</code>, and <code>z</code> axes.</p>

<h2 id="Syntax">Syntax</h2>

<pre class="brush: js">var myGamepadLinAcc = gamepadPoseInstance.linearAcceleration;</pre>
