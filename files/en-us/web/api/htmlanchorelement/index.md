...
- {{domxref("HTMLAnchorElement.interestForElement")}} {{experimental_inline}} {{ReadOnlyInline}}
  - : Returns a reference to the interest invoker target element, in cases where the associated {{htmlelement("a")}} element has been specified as an [interest invoker](/en-US/docs/Web/API/Popover_API/Interest_invokers#creating_an_interest_invoker).
