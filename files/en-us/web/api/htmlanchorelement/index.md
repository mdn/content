...
The `blur()` and `focus()` methods are inherited from {{domxref("HTMLElement")}}. They were originally defined on`HTMLAnchorElement` in DOM Level 2 HTML and earlier specifications.
