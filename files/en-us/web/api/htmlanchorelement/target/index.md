...
It reflects the [`target`](/en-US/docs/Web/HTML/Reference/Element/a#target) attribute of the {{HTMLElement("a")}} element.
...
- One of the [keyword with specific values](/en-US/docs/Web/HTML/Reference/Element/a#target): `_blank`, `_self`, `_parent`, or `_top`.
