...
The `window.ondragdrop` property and the `ondragdrop` attribute are not implemented in Firefox ([Webkit bug 112288](https://bugzilla.mozilla.org/show_bug.cgi?id=112288)), you have to use `addEventListener`. See [addEventListener](/en-US/docs/Web/API/EventTarget/addEventListener) for details.
