...
<table class="properties">
 <tbody>
  ...
  <tr>
   ...
   <td><code><a href="/en-US/docs/Web/API/Window/onvrdisplaypointerunrestricted">onvrdisplaypointerunrestricted</a></code></td>
  </tr>
 </tbody>
</table>
...
<p>You can use the <code>vrdisplaypointerunrestricted</code> event in an <code><a href="/en-US/docs/Web/API/EventTarget/addEventListener">addEventListener</a></code> method:</p>

<pre class="brush: js">window.addEventListener('vrdisplaypointerunrestricted', function() {
  // Run code to handle freeing app from pointer lock
});</pre>

<p>Or use the <code><a href="/en-US/docs/Web/API/Window/onvrdisplaypointerunrestricted">onvrdisplaypointerunrestricted</a></code> event handler property:</p>

<pre class="brush: js">window.onvrdisplaypointerunrestricted = function() {
  // Run code to handle freeing app from pointer lock
};</pre>
