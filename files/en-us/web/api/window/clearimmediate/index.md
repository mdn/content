...
> by Node.js 0.10+. It meets resistance both from [Gecko](https://bugzil.la/686201) (Firefox) and [Chromium/WebKit](https://bugs.chromium.org/p/chromium/issues/detail?id=146172) (Chrome/Safari).
