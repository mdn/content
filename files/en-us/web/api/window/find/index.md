...
> versions of Gecko. See [Webkit bug 672395](https://bugzilla.mozilla.org/show_bug.cgi?id=672395).
...
- `aWholeWord` {{Unimplemented_Inline}}
  - : A boolean value. If `true`, specifies a whole word search. This is not implemented; see [Firefox bug 481513](https://bugzilla.mozilla.org/show_bug.cgi?id=481513).
- `aSearchInFrames`
