...
> **Note:** On devices with multiple displays, browsers will report the value of `screenLeft` relative to the [multi-screen origin](/en-US/docs/Web/API/Window_Management_API#multi-screen_origin).
