...
For most properties, in particular those that do not depend on layout such as `display`, `font-size`, or `line-height`, the resolved value is the computed value.
