...
<p>You can use the <code>vrdisplayfocus</code> event in an <code><a href="/en-US/docs/Web/API/EventTarget/addEventListener">addEventListener</a></code> method:</p>

<pre class="brush: js">window.addEventListener('vrdisplayfocus', function() {
  info.textContent = 'Display focused.';
  reportDisplays();
});</pre>

<p>Or use the <code><a href="/en-US/docs/Web/API/Window/onvrdisplayfocus">onvrdisplayfocus</a></code> event handler property:</p>
