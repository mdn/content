...
<p>The <strong><code>Window</code></strong> interface represents a window containing a {{glossary("DOM")}} document; the <code>document</code> property points to the <a href="/en-US/docs/Web/API/Document">DOM document</a> loaded in that window.</p>

<p>A window for a given document can be obtained using the {{domxref("document.defaultView")}} property.</p>
...
<p>See also the <a href="/en-US/docs/Web/API/Document_Object_Model">DOM Interfaces</a>.</p>

<dl>
 <dt>{{domxref("DOMParser")}}</dt>
 <dd><code>DOMParser</code> can parse XML or HTML source stored in a string into a DOM <a href="/en-US/docs/Web/API/Document">Document</a>. <code>DOMParser</code> is specified in <a href="https://w3c.github.io/DOM-Parsing/">DOM Parsing and Serialization</a>.</dd>
 ...
 <dd>Used for creating a <a href="/en-US/docs/Web/API/Web_Workers_API/Using_web_workers">Web worker.</a></dd>
...
<dl>
 ...
 <dt>{{domxref("isSecureContext")}} {{experimental_inline}} {{readOnlyInline}}</dt>
 ...
 <dt>{{domxref("Window.messageManager")}} {{non-standard_inline}}</dt>
...
<dl>
 ...
 <dt>{{domxref("Window.showOpenFilePicker()")}}</dt>
 <dd>Shows a file picker that allows a user to select a file or multiple files.</dd>
 <dt>{{domxref("Window.showSaveFilePicker()")}}</dt>
 <dd>Shows a file picker that allows a user to save a file.</dd>
 <dt>{{domxref("Window.showDirectoryPicker()")}}</dt>
 <dd>Displays a directory picker which allows the user to select a directory.</dd>
...
<dl>
 ...
 <dd>Accepts a variety of different image sources, and returns a {{jsxref("Promise")}} which resolves to an {{domxref("ImageBitmap")}}. Optionally the source is cropped to the rectangle of pixels originating at <em>(sx, sy)</em> with width sw, and height sh.</dd>
 <dt>{{domxref("fetch()")}}</dt>
...
<dl>
 ...
 <dt><code>Window.ondeviceproximity</code> {{deprecated_inline}}</dt>
 <dd>An event handler property for device proximity event (see {{domxref("DeviceProximityEvent")}})</dd>
...
<dl>
 ...
 <dt>{{domxref("Window/resize_event", "resize")}}</dt>
 ...
 <dt>{{domxref("Window/storage_event", "storage")}}</dt>
...
<p>See <a href="/en-US/docs/Web/API/Document_Object_Model">DOM Reference</a>.</p>
