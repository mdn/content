...
<p>The <code><strong>moveBy()</strong></code> method of the {{domxref("Window")}}
...
<pre class="brush: js">window.moveBy(<em>deltaX</em>, <em>deltaY</em>)
</pre>

<h3 id="Parameters">Parameters</h3>

<ul>
  <li><code>deltaX</code> is the amount of pixels to move the window horizontally.
    Positive values are to the right, while negative values are to the left.</li>
  <li><code>deltaY</code> is the amount of pixels to move the window vertically. Positive
    values are down, while negative values are up.</li>
</ul>

<h2 id="Example">Example</h2>

<p>This example moves the window 10 pixels to the right and 10 pixels up.</p>
