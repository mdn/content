...
<pre class="brush: js"><em>window</em>.onvrdisplaypresentchange = <em>functionRef</em>;
</pre>

<h2 id="Examples">Examples</h2>

<p>The presenting state of a {{domxref("VRDisplay")}} can be checked using the
  {{domxref("VRDisplay.isPresenting")}} property.</p>
