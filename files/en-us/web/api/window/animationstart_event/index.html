...
tags:
  ...
  - Web
  - Window
browser-compat: api.Window.animationstart_event
---
<div>{{APIRef}}</div>
...
<p><a href="/en-US/docs/Web/API/HTMLElement/animationstart_event#live_example">See a live example of this event.</a></p>
...
<ul>
 ...
 <li>Related events: {{domxref("Window/animationend_event", "animationend")}}, {{domxref("Window/animationiteration_event", "animationiteration")}}, {{domxref("Window/animationcancel_event", "animationcancel")}}</li>
 <li>This event on {{domxref("Document")}} targets: {{domxref("Document/animationstart_event", "animationstart")}}</li>
 <li>This event on {{domxref("HTMLElement")}} targets: {{domxref("HTMLElement/animationstart_event", "animationstart")}}</li>
</ul>
