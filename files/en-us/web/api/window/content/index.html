...
<p>In unprivileged content (webpages), <code>content</code> is normally equivalent to <a href="/en-US/docs/Web/API/Window/top">top</a> (except in the case of a webpage loaded in a sidebar, <code>content</code> still refers to the <code>Window</code> of the currently selected tab).</p>
...
<ul>
 ...
 <li>When accessing content documents from privileged code, be aware of <a href="/en-US/XPCNativeWrapper">XPCNativeWrappers</a>.</li>
</ul>
