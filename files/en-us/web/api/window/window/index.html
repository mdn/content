...
<p>The <strong><code>window</code></strong> property of a {{domxref("Window")}} object points to the window object itself.</p>

<p>Thus, the following expressions all return the same window object:</p>

<pre class="brush: js">window.window
