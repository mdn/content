...
2. you can access built-in properties of the window object without having to type `window.` prefix:
    ...
    ```js
    setTimeout("alert('Hi!')", 50); // equivalent to using setTimeout.
