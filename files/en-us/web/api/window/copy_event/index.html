...
<ul>
 <li>Related events: {{domxref("Window/cut_event", "cut")}}, {{domxref("Window/paste_event", "paste")}}</li>
 <li>This event on {{domxref("Element")}} targets: {{domxref("Element/copy_event", "copy")}}</li>
 <li>This event on {{domxref("Document")}} targets: {{domxref("Document/copy_event", "copy")}}</li>
</ul>
