...
![DOM object tree](sample1-tabledom.jpg)
...
2. Then we get the second paragraph element from the list of `p` elements:
   ...
   ![text Node object](sample2a2.jpg)
...
![appending a new node element to the text node object](sample2c.jpg)
...
![object tree node text structure](sample2d.jpg)
...
![HTML table object tree structure](sample1-tabledom.jpg)
