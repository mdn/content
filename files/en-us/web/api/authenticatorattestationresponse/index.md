...
- {{domxref("AuthenticatorAttestationResponse.attestationObject")}} {{securecontext_inline}} {{ReadOnlyInline}}
  ...
  - : An {{jsxref("ArrayBuffer")}} containing authenticator data and an attestation statement for a newly-created key pair, generated by the authenticator.

- {{domxref("AuthenticatorResponse.clientDataJSON", "AuthenticatorAttestationResponse.clientDataJSON")}} {{securecontext_inline}} {{ReadOnlyInline}}
