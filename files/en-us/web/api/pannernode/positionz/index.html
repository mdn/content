...
<div>
  <p>The <strong><code>positionZ</code></strong> property of the {{ domxref("PannerNode")
...
<pre class="brush: js">var <em>positionZ</em> = <em>PannerNode</em>.positionZ;
...
<p>An {{domxref("AudioParam")}} whose <code>value</code> is the Z coordinate of the audio
  source's position, in 3D Cartesian coordinates.</p>

<h2 id="Example">Example</h2>

<p>The following example starts an oscillator and moves it in front of the listener after
