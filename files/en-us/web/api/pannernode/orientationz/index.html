...
<pre class="brush: js">var <em>orientationZ</em> = <em>PannerNode</em>.orientationZ;

<em>PannerNode</em>.orientationZ.value = <em>newOrientationZ</em>;
</pre>

<h3 id="Value">Value</h3>

<p>An {{domxref("AudioParam")}} whose <code>value</code> is the Z component of the
