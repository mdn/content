...
- {{domxref("TextTrack.inBandMetadataTrackDispatchType")}}{{readonlyInline}}
  - : Returns a {{domxref("DOMString")}} which indicates the track's in-band metadata track dispatch type.
- {{domxref("TextTrack.kind")}}{{readonlyInline}}
  - : Returns a {{domxref("DOMString")}} indicating what kind of text track the `TextTrack` describes. It must be one of the permitted values.
