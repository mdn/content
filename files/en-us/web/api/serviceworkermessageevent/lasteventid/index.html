...
<p>The <strong><code>lastEventID</code></strong> read-only property of the
  {{domxref("ServiceWorkerMessageEvent")}} interface represents, in <a
    href="/en-US/docs/Web/API/en-US/docs/Server-sent_events/Using_server-sent_events">server-sent
    events</a>, the last event ID of the event source.</p>

<h2 id="Syntax">Syntax</h2>

<pre
  class="brush: js">var myLastEventId = ServiceWorkerMessageEventInstance.lastEventId;</pre>
