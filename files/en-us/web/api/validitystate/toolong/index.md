...
The following example checks the validity of a [textarea element](/en-US/docs/Web/HTML/Reference/Element/textarea).
A constraint has been added using the [`maxlength` attribute](/en-US/docs/Web/HTML/Reference/Element/input/text#maxlength) so the textarea expects a maximum of 10 characters.
