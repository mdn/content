...
The following example checks the validity of a [text input element](/en-US/docs/Web/HTML/Reference/Element/input/text).
A constraint has been added using the [`minlength` attribute](/en-US/docs/Web/HTML/Reference/Element/input/text#minlength) so the input expects a string with a minimum of 4 characters.
