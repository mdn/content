...
The `typeMismatch` occurs when there is a disconnect between the [`value`](/en-US/docs/Web/HTML/Reference/Element/input#value) expected via the [`type`](/en-US/docs/Web/HTML/Reference/Element/input#input_types) attribute and the data that is actually present.
