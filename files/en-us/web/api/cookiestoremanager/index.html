...
<p>To get a <code>CookieStoreManager</code>, call {{domxref("ServiceWorkerRegistration.cookies")}}.</p>

<h2 id="Methods">Methods</h2>

<dl>
  <dt>{{domxref("CookieStoreManager.getSubscriptions()")}}</dt>
  <dd>Returns a {{jsxref("promise")}} which resolves to a list of the cookie change subscriptions for this service worker registration.</dd>
  <dt>{{domxref("CookieStoreManager.subscribe()")}}</dt>
  <dd>Subscribes to changes to cookies. It returns a {{jsxref("promise")}} which resolves when the subscription is successful.</dd>
  <dt>{{domxref("CookieStoreManager.unsubscribe()")}}</dt>
  <dd>Unsubscribes the registered service worker from changes to cookies. It returns a {{jsxref("promise")}} which resolves when the operation is successful.</dd>
</dl>
...
<p>If the {{domxref("ServiceWorkerRegistration")}} has subscribed to any cookies then {{domxref("CookieStoreManager.getSubscriptions()","getSubscriptions()")}} will return a list of cookies represented by objects in the same format as used for the original subscription.</p>
