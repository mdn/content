...
These can accessed using methods inherited from the {{DOMxRef("CSSStyleDeclaration")}} base class, such as {{DOMxRef("CSSStyleDeclaration/getPropertyValue", "getPropertyValue()")}} and {{DOMxRef("CSSStyleDeclaration/setProperty", "setProperty()")}}.
