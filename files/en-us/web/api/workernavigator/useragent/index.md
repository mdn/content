...
<p>The <code><strong>WorkerNavigator.userAgent</strong></code> read-only property returns the
...
<p>A {{domxref("DOMString")}} specifying the complete user agent string the browser
  ...
  methods on the {{domxref("WorkerNavigator")}} object.</p>
...
<pre class="brush:js">alert(navigator.userAgent)
