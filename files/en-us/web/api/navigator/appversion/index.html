...
<h3 id="Returned_value">Value</h3>

<p>Either "<code>4.0</code>" or a string representing version information about the
  browser.</p>
...
<p>The <code>window.navigator.userAgent</code> property may also contain the version
  number (for example
  "<code>Mozilla/5.0 (Windows; U; Win98; en-US; rv:0.9.2) Gecko/20010725 Netscape 6/6.1</code>"),
  ...
  themselves are with these properties.</p>

<p>The <code>window.navigator.appVersion</code>, <code>window.navigator.appName</code> and
  <code>window.navigator.userAgent</code> properties have been used in "browser sniffing"
  ...
  values from these properties in order not to be locked out of some websites.</p>
