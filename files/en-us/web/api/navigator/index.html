...
<p><em>Doesn't inherit any properties.</em></p>
...
<dl>
 ...
 <dd>Returns an {{domxref("HID")}} object providing methods
  for connecting to HID devices, listing attached HID devices, and event
  handlers for connected HID devices.</dd>
...
<dl>
 ...
 <dd>Returns a {{domxref('ContactsManager')}} interface which allows users to select entries from their contact list and share limited details of the selected entries with a website or application.</dd>
...
<dl>
 ...
 <dt>{{domxref("Navigator.mimeTypes")}} {{readonlyInline}}{{deprecated_inline}}</dt>
...
<dl>
 ...
 <dd>Sets a badge on the icon associated with this app and returns a {{jsxref("Promise")}} that resolves with {{jsxref("undefined")}}.</dd>
