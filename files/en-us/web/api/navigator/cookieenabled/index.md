...
The **`navigator.cookieEnabled`** read-only property of the {{domxref("Navigator")}} interface indicates whether cookies are enabled or not.
...
A boolean.
`true` if the browser can set cookies; otherwise `false`.
