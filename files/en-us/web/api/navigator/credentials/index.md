...
The **`credentials`** read-only property of the {{domxref("Navigator")}}
interface returns the {{domxref("CredentialsContainer")}} object for the current document, which exposes
