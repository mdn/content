...
<pre class="brush: js">navigator.mozIsLocallyAvailable(<em>uri</em>, <em>ifOffline</em>);
</pre>
...
<dl>
  <dt><code>uri</code></dt>
  <dd>The URI of the resource whose availability is to be checked, as a string.</dd>
  <dt><code>ifOffline</code></dt>
  <dd>
    <p>Allows you to specify whether or not the offline resources cache should be checked;
      specify <code>true</code> to consider the offline resources cache.</p>
  </dd>
</dl>
