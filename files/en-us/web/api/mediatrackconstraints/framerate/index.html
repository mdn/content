...
<p>The {{domxref("MediaTrackConstraints")}} dictionary's
  <code><strong>frameRate</strong></code> property is a <a href="/en-US/docs/Web/API/MediaTrackConstraints#ConstrainDouble"><code>ConstrainDouble</code></a>
  describing the requested or mandatory constraints placed upon the value of the
  {{domxref("MediaTrackSettings.frameRate", "frameRate")}} constrainable property.</p>
...
<pre class="brush: js">var <em>constraintsObject</em> = { frameRate: <em>constraint</em> };

<em>constraintsObject</em>.frameRate = <em>constraint</em>;
</pre>

<h3 id="Value">Value</h3>

<p>A <a href="/en-US/docs/Web/API/MediaTrackConstraints#ConstrainDouble"><code>ConstrainDouble</code></a> describing the acceptable or required value(s) for a
  video track's frame rate, in frames per second.</p>

<p>If this value is a number, the user agent will attempt to obtain media whose frame rate
  is as close as possible to this number given the capabilities of the hardware and the
  other constraints specified. Otherwise, the value of this <a href="/en-US/docs/Web/API/MediaTrackConstraints#ConstrainDouble"><code>ConstrainDouble</code></a>
  will guide the user agent in its efforts to provide an exact match to the required frame
  rate (if <code>exact</code> is specified or both <code>min</code> and <code>max</code>
  are provided and have the same value) or to a best-possible value.</p>
