...
<p>The {{domxref("MediaTrackConstraints")}} dictionary's
  <code><strong>height</strong></code> property is a <a href="/en-US/docs/Web/API/MediaTrackConstraints#ConstrainULong"><code>ConstrainULong</code></a>
...
<pre class="brush: js">var <em>constraintsObject</em> = { height: <em>constraint</em> };

<em>constraintsObject</em>.height = <em>constraint</em>;
</pre>
