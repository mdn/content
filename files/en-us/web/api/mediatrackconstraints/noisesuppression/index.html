...
<p>The {{domxref("MediaTrackConstraints")}} dictionary's
  <code><strong>noiseSuppression</strong></code> property is a
  ...
  "noiseSuppression")}} constrainable property.</p>
...
<p>Noise suppression is typically provided by microphones, although it can be provided by
  other input sources as well.</p>

<h2 id="Syntax">Syntax</h2>

<pre class="brush: js">var <em>constraintsObject</em> = { noiseSuppression: <em>constraint</em> };

<em>constraintsObject</em>.noiseSuppression = <em>constraint</em>;
</pre>
