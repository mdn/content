...
<p>The {{domxref("MediaTrackConstraints")}} dictionary's
  <code><strong>sampleRate</strong></code> property is a <a href="/en-US/docs/Web/API/MediaTrackConstraints#ConstrainULong"><code>ConstrainULong</code></a>
...
<pre class="brush: js">var <em>constraintsObject</em> = { sampleRate: <em>constraint</em> };

<em>constraintsObject</em>.sampleRate = <em>constraint</em>;
</pre>
...
<p>If this value is a number, the user agent will attempt to obtain media whose sample
  ...
  <a href="/en-US/docs/Web/API/MediaTrackConstraints#ConstrainULong"><code>ConstrainULong</code></a> will guide the user agent in its efforts to provide an
