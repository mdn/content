...
The property value is set using the `delegatesFocus` property of the object passed to {{domxref("Element.attachShadow()")}}, or declaratively using the [`shadowrootdelegatesfocus`](/en-US/docs/Web/HTML/Element/template#shadowrootclonable) attribute of the [`<template>`](/en-US/docs/Web/HTML/Element/template) element.
