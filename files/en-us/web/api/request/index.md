...
> **Note:** The body type can only be a {{domxref("Blob")}}, {{domxref("BufferSource")}}, {{domxref("FormData")}}, {{domxref("URLSearchParams")}}, string, or {{domxref("ReadableStream")}} type, so for adding a JSON object to the payload you need to stringify that object.
