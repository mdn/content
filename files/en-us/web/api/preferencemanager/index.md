...
The **`PreferenceManager`** interface of the [User Peferences API](/en-US/docs/Web/API/User_Preferences_API) provides access to the various {{domxref("PreferenceObject")}} objects.
