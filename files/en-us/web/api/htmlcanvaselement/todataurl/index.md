...
The **`HTMLCanvasElement.toDataURL()`** method returns a [data URL](/en-US/docs/Web/URL/Data_URLs) containing a representation of the image in the format specified by the `type` parameter.
...
A string containing the requested [data URL](/en-US/docs/Web/URL/Data_URLs).
...
- [Data URLs](/en-US/docs/Web/URL/Data_URLs) in the [HTTP](/en-US/docs/Web/HTTP) reference.
