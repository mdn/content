...
If the height or width of the canvas is `0` or larger than the [maximum canvas size](/en-US/docs/Web/HTML/Reference/Element/canvas#maximum_canvas_size), the string `"data:,"` is returned.
