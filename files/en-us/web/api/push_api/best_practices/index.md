...
In the case of Firefox, see [Firefox bug 1524619](https://bugzilla.mozilla.org/show_bug.cgi?id=1524619), in which we find that Firefox 68 implements this, disabled by default, behind the preference `dom.webnotifications.requireuserinteraction`.
