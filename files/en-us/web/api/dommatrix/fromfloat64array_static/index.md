...
The **`fromFloat64Array()`** static method of the {{domxref("DOMMatrix")}} interface creates a new mutable `DOMMatrix` object given an array of double-precision (64-bit) floating-point values.
