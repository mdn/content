...
The **`HIDConnectionEvent`** interface of the {{domxref('WebHID API')}} represents HID connection events, and is the event type passed to {{domxref("HID.connect_event")}} and {{domxref("HID.disconnect_event")}} when an input report is received.
