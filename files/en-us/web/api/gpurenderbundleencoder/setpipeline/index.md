...
{{domxref("GPURenderBundleEncoder")}} interface sets the {{domxref("GPURenderPipeline")}} to use for this render bundle.
...
- `pipeline`
  - : The {{domxref("GPURenderPipeline")}} to use for this render bundle.
