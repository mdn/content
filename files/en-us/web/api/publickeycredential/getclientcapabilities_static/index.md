...
- `"conditionalCreate"`
  - : The client is capable of creating [discoverable credentials](/en-US/docs/Web/API/Web_Authentication_API/Passkey_authentication).
- `"conditionalGet"`
  - : The client is capable of authenticating using [discoverable credentials](/en-US/docs/Web/API/Web_Authentication_API/Passkey_authentication).
