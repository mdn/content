...
<p>The {{domxref("MediaTrackSupportedConstraints")}} dictionary's
  ...
  {{Glossary("user agent")}} supports the <code>deviceId</code> constraint. If the
...
<pre
  class="brush: js"><em>deviceIdConstraintSupported</em> = <em>supportedConstraintsDictionary</em>.deviceId;</pre>

<h3 id="Value">Value</h3>

<p>This property is present in the dictionary (and its value is always <code>true</code>)
  if the user agent supports the <code>deviceId</code> constraint. If the property isn't
