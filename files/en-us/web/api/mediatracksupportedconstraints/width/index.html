...
<p>The {{domxref("MediaTrackSupportedConstraints")}} dictionary's
  <code><strong>width</strong></code> property is a read-only Boolean value which is
  ...
  {{Glossary("user agent")}} supports the <code>width</code> constraint. If the constraint
...
<pre
  class="brush: js"><em>widthConstraintSupported</em> = <em>supportedConstraintsDictionary</em>.width;</pre>

<h3 id="Value">Value</h3>

<p>This property is present in the dictionary (and its value is always <code>true</code>)
  if the user agent supports the <code>width</code> constraint. If the property isn't
