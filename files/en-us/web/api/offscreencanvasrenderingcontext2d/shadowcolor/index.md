...
{{domxref("OffscreenCanvasRenderingContext2D.fillStyle", "fillStyle")}} color when filling, and
of the {{domxref("OffscreenCanvasRenderingContext2D.strokeStyle", "strokeStyle")}} color when
stroking.
