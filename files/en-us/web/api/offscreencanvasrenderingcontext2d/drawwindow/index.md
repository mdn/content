---
title: OffscreenCanvasRenderingContext2D.drawWindow()
slug: Web/API/OffscreenCanvasRenderingContext2D/drawWindow
...
tags:
  ...
  - Reference
  - Deprecated
browser-compat: api.OffscreenCanvasRenderingContext2D.drawWindow
---

{{APIRef}} {{deprecated_header}}{{Non-standard_header}}

The deprecated, non-standard and internal only
**`OffscreenCanvasRenderingContext2D.drawWindow()`**
...
{{domxref("OffscreenCanvasRenderingContext2D.drawImage")}}. If you're writing chrome code,
