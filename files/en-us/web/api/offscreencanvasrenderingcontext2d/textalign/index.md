---
title: OffscreenCanvasRenderingContext2D.textAlign
slug: Web/API/OffscreenCanvasRenderingContext2D/textAlign
...
tags:
  ...
  - Property
  - Reference
browser-compat: api.OffscreenCanvasRenderingContext2D.textAlign
---
...
{{domxref("OffscreenCanvasRenderingContext2D.fillText", "fillText()")}} method. For example, if
...
the {{domxref("OffscreenCanvasRenderingContext2D.direction", "direction")}} property is manually
