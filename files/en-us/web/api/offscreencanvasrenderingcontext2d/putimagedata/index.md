...
The **`OffscreenCanvasRenderingContext2D.putImageData()`**
...
> {{domxref("OffscreenCanvasRenderingContext2D.getImageData()", "getImageData()")}} method.
...
of {{domxref("OffscreenCanvasRenderingContext2D.fillRect()")}}.
