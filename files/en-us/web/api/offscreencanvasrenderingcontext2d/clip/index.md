...
> canvas, such as {{domxref("OffscreenCanvasRenderingContext2D.fillRect()","fillRect()")}}.
> Instead, you'd have to use {{domxref("OffscreenCanvasRenderingContext2D.rect()","rect()")}} to
