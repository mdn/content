---
title: OffscreenCanvasRenderingContext2D.arc()
slug: Web/API/OffscreenCanvasRenderingContext2D/arc
...
tags:
  ...
  - Method
  - Reference
browser-compat: api.OffscreenCanvasRenderingContext2D.arc
---
...
method of the [Canvas 2D API](/en-US/docs/Web/API/OffscreenCanvasRenderingContext2D) adds a circular arc to the current sub-path.
...
- Use {{domxref("OffscreenCanvasRenderingContext2D.ellipse()")}} to draw an elliptical arc.
