---
title: OffscreenCanvasRenderingContext2D.font
slug: Web/API/OffscreenCanvasRenderingContext2D/font
...
tags:
  ...
  - Property
  - Reference
browser-compat: api.OffscreenCanvasRenderingContext2D.font
---
...
- In Gecko, when setting a system font as the value of a canvas 2D context's
  {{domxref("OffscreenCanvasRenderingContext2D.font", "font")}} (e.g., `menu`),
