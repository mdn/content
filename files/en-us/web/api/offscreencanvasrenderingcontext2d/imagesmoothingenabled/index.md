...
{{domxref("OffscreenCanvasRenderingContext2D")}} interface, part of the [Canvas API](/en-US/docs/Web/API/Canvas_API), determines whether scaled images
...
> {{domxref("OffscreenCanvasRenderingContext2D.imageSmoothingQuality", "imageSmoothingQuality")}}
> property.
