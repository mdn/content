---
title: OffscreenCanvasRenderingContext2D.createConicGradient()
slug: Web/API/OffscreenCanvasRenderingContext2D/createConicGradient
...
tags:
  ...
  - Method
  - Reference
browser-compat: api.OffscreenCanvasRenderingContext2D.createConicGradient
---

{{APIRef}}

The **`OffscreenCanvasRenderingContext2D.createConicGradient()`** method of the Canvas 2D API creates a gradient around a point with given coordinates.

This method returns a conic {{domxref("CanvasGradient")}}. To be applied to a shape, the gradient must first be assigned to the {{domxref("OffscreenCanvasRenderingContext2D.fillStyle", "fillStyle")}} or {{domxref("OffscreenCanvasRenderingContext2D.strokeStyle", "strokeStyle")}} properties.
