---
title: OffscreenCanvasRenderingContext2D.getContextAttributes()
slug: Web/API/OffscreenCanvasRenderingContext2D/getContextAttributes
...
browser-compat: api.OffscreenCanvasRenderingContext2D.getContextAttributes
---

{{APIRef("WebGL")}}

The **`OffscreenCanvasRenderingContext2D.getContextAttributes()`**
method
...
A `OffscreenCanvasRenderingContext2DSettings` object that contains the actual context
parameters.
