---
title: OffscreenCanvasRenderingContext2D.closePath()
slug: Web/API/OffscreenCanvasRenderingContext2D/closePath
...
tags:
  ...
  - Method
  - Reference
browser-compat: api.OffscreenCanvasRenderingContext2D.closePath
---
...
the {{domxref("OffscreenCanvasRenderingContext2D.stroke()", "stroke()")}} or
{{domxref("OffscreenCanvasRenderingContext2D.fill()", "fill()")}} methods.
