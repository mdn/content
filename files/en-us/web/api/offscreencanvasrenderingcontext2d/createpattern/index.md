...
be assigned to the {{domxref("OffscreenCanvasRenderingContext2D.fillStyle")}} or
{{domxref("OffscreenCanvasRenderingContext2D.strokeStyle")}} properties, after which it is
