...
gradient must first be assigned to the {{domxref("OffscreenCanvasRenderingContext2D.fillStyle",
  "fillStyle")}} or {{domxref("OffscreenCanvasRenderingContext2D.strokeStyle", "strokeStyle")}}
properties.
