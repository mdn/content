...
The {{domxref("OffscreenCanvasRenderingContext2D.rotate()", "rotate()")}} method rotates the
transformation matrix by 45°. The {{domxref("OffscreenCanvasRenderingContext2D.fillRect()",
...
You can also use the {{domxref("OffscreenCanvasRenderingContext2D.setTransform()",
