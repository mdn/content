...
- [View Transitions match-element demo](/en-US/docs/Web/CSS/view-transition-name#using_the_match-element_value): An SPA featuring animated list items, which demonstrates usage of the `view-transition-name` property's `match-element` value.
