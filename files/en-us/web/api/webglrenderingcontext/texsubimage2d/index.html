...
<p>The <strong><code>WebGLRenderingContext.texSubImage2D()</code></strong> method of the
...
<pre class="brush: js">gl.texSubImage2D(gl.TEXTURE_2D, 0, 0, 0, gl.RGBA, gl.UNSIGNED_BYTE, image);
</pre>
