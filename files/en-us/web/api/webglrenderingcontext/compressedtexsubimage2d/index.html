...
<p>The <strong><code>WebGLRenderingContext.compressedTexSubImage2D()</code></strong>
...
<p>Compressed image formats must be enabled by <a
  ...
  using this method or a {{domxref("WebGL2RenderingContext")}} must be used.</p>

<h2 id="Syntax">Syntax</h2>

<pre class="brush: js">// WebGL 1:
void <var>gl</var>.compressedTexSubImage2D(<var>target</var>, <var>level</var>, <var>xoffset</var>, <var>yoffset</var>, <var>width</var>, <var>height</var>, <var>format</var>, ArrayBufferView? <var>pixels</var>);
