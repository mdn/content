...
<p>The <strong>WebGLRenderingContext.compileShader()</strong> method of the <a
    href="/en-US/docs/Web/API/WebGL_API">WebGL API</a> compiles a GLSL shader into binary
  data so that it can be used by a {{domxref("WebGLProgram")}}.</p>

<h2 id="Syntax">Syntax</h2>

<pre class="brush: js">void <var><em>gl</em>.compileShader</var><var>(shader);</var>
</pre>
