...
<p>The <strong><code>WebGLRenderingContext.getRenderbufferParameter()</code></strong>
  method of the <a href="/en-US/docs/Web/API/WebGL_API">WebGL API</a> returns information
  about the renderbuffer.</p>

<h2 id="Syntax">Syntax</h2>

<pre class="brush: js">any <var>gl</var>.getRenderbufferParameter(<var>target</var>, <var>pname</var>);
</pre>
  ...
  <dd>A {{domxref("WebGL_API/Types", "GLenum")}} specifying the information to query. Possible values:
    <ul>
      ...
      <li><code>gl.RENDERBUFFER_INTERNAL_FORMAT</code>: Returns a {{domxref("WebGL_API/Types", "GLenum")}}
        ...
        <ul>
          <li><code>gl.RGBA4</code>: 4 red bits, 4 green bits, 4 blue bits 4 alpha bits.
          </li>
...
<pre class="brush: js">gl.getRenderbufferParameter(gl.RENDERBUFFER, gl.RENDERBUFFER_WIDTH);
</pre>
