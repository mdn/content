...
<p>The <code><strong>WEBGL_multi_draw.multiDrawArraysInstancedWEBGL()</strong></code>
   method of the
   <a href="/en-US/docs/Web/API/WebGL_API">WebGL API</a> renders multiple primitives from
   array data. It is
   identical to multiple calls to the
   <a
      href="/en-US/docs/Web/API/WebGL2RenderingContext/drawArraysInstanced"><code>gl.drawArraysInstanced()</code></a>
   method.
</p>
...
<ul>
   ...
   <li>If <code>drawCount</code> or items in <code>firstsList</code>,
      <code>countsList</code>, or <code>instanceCountsList</code> are negative,
