...
<p>The <strong>Touch<code>Event()</code></strong> constructor creates a new {{domxref("TouchEvent")}}.</p>

<h2 id="Syntax">Syntax</h2>

<pre class= "brush: js">const event = new TouchEvent(typeArg, touchEventInit);</pre>
...
<dl>
	...
	<dt><em>touchEventInit</em> {{optional_inline}}</dt>
