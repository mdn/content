...
> will always fire the first render cycle after `observe()` is called, even if the
...
> with [`intersecting`](/en-US/docs/Web/API/IntersectionObserverEntry/isIntersecting)
> set to `false`.
