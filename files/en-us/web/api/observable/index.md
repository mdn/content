...
- {{domxref("Observable.switchMap", "switchMap()")}} {{Experimental_Inline}}
  - : Executes an action represented by an inner observable whenever a source emits and, if the previous inner subscription has not completed, unsubscribes from it.
