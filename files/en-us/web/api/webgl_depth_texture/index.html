...
<ul>
 <li>The <code>attachment</code> parameter now accepts <code>gl.DEPTH_STENCIL_ATTACHMENT</code>.</li>
</ul>

<div class="note">
<p><strong>Note:</strong> Incorrectly stated as the <code>target</code> parameter in the specification, see <a href="https://www.khronos.org/bugzilla/show_bug.cgi?id=674">https://www.khronos.org/bugzilla/show_bug.cgi?id=674</a>.</p>
</div>


<h2 id="Examples">Examples</h2>

<pre class="brush:js">var ext = gl.getExtension('WEBGL_depth_texture');
