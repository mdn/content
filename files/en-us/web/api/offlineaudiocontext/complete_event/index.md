...
When processing is complete, you might want to use the `complete` event handler the prompt the user that the audio can now be played, and enable the play button:
