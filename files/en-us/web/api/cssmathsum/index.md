...
We create an element with a [`width`](/en-US/docs/Web/CSS/width) determined using a [`calc()`](/en-US/docs/Web/CSS/calc) function, then {{domxref("console.log_static")}} the `operator` and `values`, and dig into the values a bit.
