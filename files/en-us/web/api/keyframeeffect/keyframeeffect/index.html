...
<p>The <strong><code>KeyframeEffect()</code></strong> constructor of the <a href="/en-US/docs/Web/API/Web_Animations_API">Web Animations API</a> returns a new <code>{{domxref("KeyframeEffect")}}</code> object instance, and also allows you to clone an existing keyframe effect object instance.</p>
...
<dl>
 ...
 <dd>A {{domxref("KeyframeEffect")}} object that you want to clone.</dd>
</dl>
