...
A string containing the container's `name` HTML content attribute (e.g., [`<iframe name="myIframe">`](/en-US/docs/Web/HTML/Reference/Element/iframe#name) or [`<object name="myObject">`](/en-US/docs/Web/HTML/Reference/Element/object#name)).
