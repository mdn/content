...
myVRLayerInit.rightBounds = [0.5, 0.0, 0.5, 1.0];</pre>
...
<p>If <code>leftBounds</code> is not specified in the dictionary, the default value used is <code>[0.5, 0.0, 0.5, 1.0]</code>.</p>
