...
<p>Linear filtering on floating-point textures is not allowed with this extension. If you set the magnification or minification filter in the {{domxref("WebGLRenderingContext.texParameter()")}} method to one of <code>gl.LINEAR</code>, <code>gl.LINEAR_MIPMAP_NEAREST</code>, <code>gl.NEAREST_MIPMAP_LINEAR</code>, or <code>gl.LINEAR_MIPMAP_LINEAR</code>, and use floating-point textures, the texture will be marked as incomplete.</p>

<p>To use linear filtering on floating-point textures, enable the {{domxref("OES_texture_float_linear")}} extension in addition to this extension.</p>

<h2 id="Floating-point_color_buffers">Floating-point color buffers</h2>

<p>This extension implicitly enables the {{domxref("WEBGL_color_buffer_float")}} extension (if supported), which allows rendering to 32-bit floating-point color buffers.</p>

<h2 id="Examples">Examples</h2>

<pre class="brush:js">var ext = gl.getExtension('OES_texture_float');
