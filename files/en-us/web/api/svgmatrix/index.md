...
**`SVGMatrix`** does not have a public constructor. You can create a **`SVGMatrix`** through `createSVGMatrix` method on [`SVGSVGElement`](/en-US/docs/Web/API/SVGSVGElement#methods).
