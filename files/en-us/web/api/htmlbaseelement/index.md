...
- {{domxref("HTMLBaseElement.href")}}
  - : Is a string that reflects the {{htmlattrxref("href", "base")}} HTML attribute, containing a base URL for relative URLs in the document.
- {{domxref("HTMLBaseElement.target")}}
  - : Is a string that reflects the {{htmlattrxref("target", "base")}} HTML attribute, containing a default target browsing context or frame for elements that do not have a target reference specified.
