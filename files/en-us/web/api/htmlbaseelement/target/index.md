...
It reflects the [`target`](/en-US/docs/Web/HTML/Reference/Element/base#target) attribute of the {{HTMLElement("base")}} element.
...
- One of the [keyword with specific values](/en-US/docs/Web/HTML/Reference/Element/base#target): `_blank`, `_self`, `_parent`, or `_top`.
