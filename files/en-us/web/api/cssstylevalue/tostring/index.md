...
The **`toString()`** method of the {{domxref("CSSStyleValue")}} interface is a {{Glossary("stringifier")}} that returns a serialization of the value as a string of CSS text.
...
const length1 = CSSNumericValue.parse("42.0px");
