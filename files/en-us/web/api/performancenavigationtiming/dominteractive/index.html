...
<p>The <strong><code>domInteractive</code></strong> read-only property returns a
  ...
  current document to <a
    href="https://html.spec.whatwg.org/multipage/syntax.html#the-end">interactive</a>.</p>

<h2 id="Syntax">Syntax</h2>

<pre class="brush: js"><em>perfEntry</em>.domInteractive;
</pre>
