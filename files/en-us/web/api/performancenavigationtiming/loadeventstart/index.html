...
<p>The <strong><code>loadEventStart</code></strong> read-only property returns a
  {{domxref("DOMHighResTimeStamp","timestamp")}} representing the time value equal to the
  time immediately before the load event of the current document is fired.</p>

<h2 id="Syntax">Syntax</h2>

<pre class="brush: js"><em>perfEntry</em>.loadEventStart;
</pre>
