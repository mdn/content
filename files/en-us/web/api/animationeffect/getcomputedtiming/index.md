...
- the following additional properties:
  ...
  - `progress`
    - : `null` or a `number`.
      ...
      The value is typically between `0` and `1`, but may fall outside this range depending on the effect's {{cssxref("easing-function")}}'s output. For example, an easing function of `cubic-bezier(0.3, 2, 0.6, 2)` would transform the time progress of `0.75` to approximately `1.22`.
