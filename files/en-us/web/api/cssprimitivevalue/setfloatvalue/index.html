...
<pre
  class="brush: js"><var>cssPrimitiveValue</var>.setFloatValue(<var>unitType</var>, <var>floatValue</var>);</pre>
...
<dl>
  ...
  <dt>floatValue</dt>
  <dd>A <code>float</code> representing the new float value.</dd>
</dl>
  ...
  <tbody>
    <tr>
      ...
      <td>An <code>INVALID_ACCESS_ERR</code> is raised if the CSS value doesn't contain a
        float value or if the string value can't be converted into the specified unit.<br>
