...
<dl>
  ...
  <dd>The x-axis coordinate of the top left corner of the sub-rectangle of the source
    <code>image</code> to draw into the destination context. Note that this argument is
    not included in the 3- or 5-argument syntax.</dd>
  ...
  <dd>The width of the sub-rectangle of the source <code>image</code> to draw into the
    ...
    image is used. Note that this argument is not included in the 3- or 5-argument syntax.
  </dd>
  <dt><code>sHeight</code> {{optional_inline}}</dt>
  <dd>The height of the sub-rectangle of the source <code>image</code> to draw into the
    destination context. Note that this argument is not included in the 3- or 5-argument
    syntax.</dd>
  <dt><code>dx</code></dt>
