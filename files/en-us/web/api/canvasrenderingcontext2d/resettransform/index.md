...
transformation matrix by 45°. The {{domxref("CanvasRenderingContext2D.fillRect()", "fillRect()")}}
...
You can also use the {{domxref("CanvasRenderingContext2D.setTransform()", "setTransform()")}}
