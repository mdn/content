...
- An early Canvas specification draft specified the value `"darker"`.
  ...
  ([Firefox bug 571532](https://bugzilla.mozilla.org/show_bug.cgi?id=571532)). See also [this blog post](https://dropshado.ws/post/77229081704/firefox-doesnt-support-canvas-composite-darker) that suggests using `"difference"` as a way to achieve a
