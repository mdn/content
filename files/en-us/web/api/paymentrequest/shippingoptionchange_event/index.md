...
You can also create an event handler for `shippingoptionchange` using its corresponding event handler property, {{domxref("PaymentRequest.shippingoptionchange_event", "onshippingoptionchange")}}:
