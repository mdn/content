...
In this snippet, the page's {{htmlelement("body")}} element is an {{domxref("EventTarget")}}. We obtain a stream of [`mousedown`](/en-US/docs/Web/API/Element/mousedown_event) events fired on it using the `when()` method.
