...
<pre class="syntaxbox notranslate">var <var>promise</var> = SerialPort.getSignals();</pre>
...
<p>Returns a {{jsxref("Promise")}} that resolves with an object containing the following members:</p>
