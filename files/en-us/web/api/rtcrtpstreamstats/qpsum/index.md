...
<p>The <strong><code>qpSum</code></strong> property of the
    ...
    <code>RTCRtpStreamStats</code> object.</p>

<p>In general, the higher this number is,
  the more heavily compressed the video data is.</p>

<h2 id="Syntax">Syntax</h2>

<pre
  class="brush: js">var qpSum = <em>RTCRtpStreamStats</em>.qpSum;</pre>
...
<p>An unsigned 64-bit integer value which indicates the sum of the quantization parameter
  ...
  the stream generally has been.</p>
