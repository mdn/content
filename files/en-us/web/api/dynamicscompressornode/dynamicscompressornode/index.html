...
<p>The <strong><code>DynamicsCompressorNode()</code></strong>
  ...
  multiple sounds are played and multiplexed together at once.</p>

<h2 id="Syntax">Syntax</h2>

<pre
  class="brush: js">var dynamicsCompressorNode = new DynamicsCompressorNode(context, options)</pre>
