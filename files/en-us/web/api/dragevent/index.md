...
- {{domxref("HTMLElement/dragover_event", "dragover")}}
  - : This event is fired while an element or text selection is being dragged and the mouse pointer is over a valid drop target. It can fire repeatedly while the drag continues, but browsers may dispatch it at different intervals depending on whether the pointer is moving. This firing pattern is different than {{domxref("Element/mouseover_event", "mouseover")}}.
