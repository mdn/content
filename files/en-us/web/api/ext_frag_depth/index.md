...
The **`EXT_frag_depth`** extension is part of the [WebGL API](/en-US/docs/Web/API/WebGL_API) and enables you to set a depth value of a fragment from within the fragment shader.
