...
<h2 id="SVG_animated_length_list_interface">SVG animated length list interface</h2>

<p>The <code>SVGAnimatedLengthList</code> interface is used for attributes of type {{ domxref("SVGLengthList") }} which can be animated.</p>
...
<table class="standard-table">
 <tbody>
  ...
  <tr>
   ...
   <td>
    <ul>
     <li>readonly {{ domxref("SVGLengthList") }} <code>baseVal</code></li>
...
<p>The <code>SVGAnimatedLengthList</code> interface do not provide any specific methods.</p>
