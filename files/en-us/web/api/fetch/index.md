  ...
  - : An object containing any custom settings that you want to apply to the request. The
    ...
    - `method`
      - : The request method, e.g., `GET`, `POST`. Note that the
        ...
        As specified in [whatwg specification](https://fetch.spec.whatwg.org/#methods), any method that match [RFC 9110](https://www.rfc-editor.org/rfc/rfc9110#name-overview ) will be uppercased automatically. If you want to use a custom method (like `PATCH`), you should uppercase it yourself.
    - `headers`
