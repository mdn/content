...
Check whether prioritized task scheduling is supported by testing for the `scheduler` property in the global "`this`" (such as {{domxref("Window.scheduler")}} or {{domxref("WorkerGlobalScope.scheduler")}}).
