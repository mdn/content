...
<p>The <strong><code>grammars</code></strong> property of the
  ...
  by the current <code>SpeechRecognition</code>.</p>

<h2 id="Syntax">Syntax</h2>

<pre class="brush: js">var myGrammars = mySpeechRecognition.grammars;
mySpeechRecognition.grammars = mySpeechGrammarList;
</pre>

<h3 id="Value">Value</h3>

<p>A {{domxref("SpeechGrammarList")}} containing the {{domxref("SpeechGrammar")}} objects
  that represent your grammar for your app.</p>
