...
<p>The <code><strong>start()</strong></code> method of the <a
    href="/en-US/docs/Web/API/Web_Speech_API">Web Speech API</a> starts the speech
  recognition service listening to incoming audio with intent to recognize grammars
  associated with the current {{domxref("SpeechRecognition")}}.</p>

<h2 id="Syntax">Syntax</h2>

<pre class="brush: js">mySpeechRecognition.start();</pre>
