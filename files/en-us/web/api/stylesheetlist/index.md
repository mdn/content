...
> **Note:** Typically list interfaces like StyleSheetList wrap around {{jsxref("Array")}} types, so you can use Array methods on them. This is not the case here due to [historical reasons](https://stackoverflow.com/questions/74630989/why-use-domstringlist-rather-than-an-array/74641156#74641156). However, you can convert StyleSheetList to an array, see the example below.
