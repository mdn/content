...
<p>The <code><strong>DOMPointInit</strong></code> dictionary is used to provide the values of the coordinates and perspective when creating and JSONifying a {{domxref("DOMPoint")}} or {{domxref("DOMPointReadOnly")}} object.</p>

<p>It's used as an input parameter to the <code>DOMPoint</code>/<code>DOMPointReadOnly</code> method {{domxref("DOMPointReadOnly.fromPoint", "fromPoint()")}}. It's used as the return value when calling {{domxref("DOMPointReadOnly.toJSON", "toJSON()")}}.</p>

<h2 id="Properties">Properties</h2>

<dl>
	<dt>{{domxref("DOMPointInit.x")}}</dt>
...
<p>This example creates a new <code>DOMPoint</code> representing the top-left corner of the current window, with a <code>z</code> component added to move the point closer to the user. This same code will work to create a <code>DOMPointReadOnly</code> object; just change the interface name in the code.</p>

<pre class="brush: js">const pointDesc = {
  x: window.screenX,
  y: window.screenY,
  z: 5.0
};

const windTopLeft = DOMPoint.fromPoint(pointDesc)</pre>
