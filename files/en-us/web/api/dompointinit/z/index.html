...
<p>The <strong>{{domxref("DOMPointInit")}}</strong> dictionary's
    <code><strong>z</strong></code> property is used to specify the <em>z</em>-coordinate
...
<p>Typically, a <code>z</code> value of 0 represents the plane of the screen. As the value
  ...
  screen, receding into the distance.</p>

<p>Of course, if <a href="/en-US/docs/Web/CSS/CSS_Transforms">transforms</a> have been
  applied, the axes may have changed orientation.</p>
...
<em>DOMPointInit</em>.z = <em>zPos</em>;

var <em>zPos</em> = <em>DOMPointInit</em>.z;</pre>

<h3 id="Value">Value</h3>

<p>A double-precision floating-point value indicating the point's <em>z</em>-coordinate.
