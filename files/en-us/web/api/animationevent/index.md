...
- {{domxref("AnimationEvent.animationName")}} {{readonlyInline}}
  - : Is a string containing the value of the {{cssxref("animation-name")}} that generated the animation.
...
- {{domxref("AnimationEvent.pseudoElement")}} {{readonlyInline}}
  - : Is a string, starting with `'::'`, containing the name of the [pseudo-element](/en-US/docs/Web/CSS/Pseudo-elements) the animation runs on. If the animation doesn't run on a pseudo-element but on the element, an empty string: `''`.
