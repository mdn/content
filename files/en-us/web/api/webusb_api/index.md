...
- {{domxref("USBConnectionEvent")}}
  - : The event type passed to {{domxref("USB.connect_event")}} or {{domxref("USB.disconnect_event")}} when the user agent detects a new USB device has been connected to, or disconnected from the host.
- {{domxref("USBDevice")}}
