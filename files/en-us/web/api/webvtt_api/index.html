...
<p>A WebVTT file (<code>.vtt</code>) contains cues, which can be either a single line or multiple lines, as shown below:</p>
...
<p>The structure of a WebVTT consists of the following components, some of them optional, in this order:</p>
...
<h5 id="Example_2_-_Very_simple_WebVTT_file_with_a_text_header">Example 2 - Very simple WebVTT file with a text header</h5>

<pre class="brush: plain">WEBVTT - This file has no cues.
</pre>

<h5 id="Example_3_-_Common_WebVTT_example_with_a_header_and_cues">Example 3 - Common WebVTT example with a header and cues</h5>

<pre class="brush: plain">WEBVTT - This file has cues.
...
<h3 id="Inner_structure_of_a_WebVTT_file">Inner structure of a WebVTT file</h3>

<p>Let's re-examine one of our previous examples, and look at the cue structure in a bit more detail.</p>
...
<ul>
 <li>The first line is started with a time, which is the starting time for showing the text that appears underneath.</li>
 <li>On the same line, we then have a string of "<code>--&gt;</code>".</li>
 <li>We finish the first line with a second time, which is the ending time for showing the associated text.</li>
 <li>We can then have one or more lines that start with a hyphen (-), each containing part of the text track to be shown.</li>
</ul>

<p>We can also place comments in our <code>.vtt</code> file, to help us remember important information about the parts of our file. These should be on separate lines, starting with the string <code>NOTE</code>. You'll find more about these in the below section.</p>

<p>It is important to not use "extra" blank lines within a cue, for example between the timings line and the cue payload. WebVTT is line based; a blank line will close the cue.</p>

<h2 id="WebVTT_comments">WebVTT comments</h2>
...
<pre class="brush: plain">NOTE This is a comment
</pre>

<h5 id="Example_5_-_Multi-line_comment">Example 5 - Multi-line comment</h5>

<pre class="brush: plain">NOTE
...
<pre class="brush: plain">WEBVTT - Translation of that film I like
