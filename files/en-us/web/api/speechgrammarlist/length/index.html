...
<pre
  class="brush: js">var myListLength = speechGrammarListInstance.length;</pre>

<h3 id="Value">Value</h3>

<p>A number indicating the number of {{domxref("SpeechGrammar")}} objects contained in the
  {{domxref("SpeechGrammarList")}}.</p>
