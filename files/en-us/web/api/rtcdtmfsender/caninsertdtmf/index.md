...
The {{domxref("RTCDTMFSender")}} interface's `canInsertDTMF` property is a read-only boolean value which indicates whether the `RTCDTMFSender` is capable of sending DTMF tones over the {{domxref("RTCPeerConnection")}}.
