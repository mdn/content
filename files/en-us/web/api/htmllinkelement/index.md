...
The **`HTMLLinkElement`** interface represents reference information for external resources and the relationship of those resources to a document and vice versa (corresponds to [`<link>`](/en-US/docs/Web/HTML/Reference/Element/link) element; not to be confused with [`<a>`](/en-US/docs/Web/HTML/Reference/Element/a), which is represented by [`HTMLAnchorElement`](/en-US/docs/Web/API/HTMLAnchorElement)). This object inherits all of the properties and methods of the {{domxref("HTMLElement")}} interface.
...
- {{domxref("HTMLLinkElement.referrerPolicy")}}
  - : A string that reflects the [`referrerpolicy`](/en-US/docs/Web/HTML/Reference/Element/link#referrerpolicy) HTML attribute indicating which referrer to use.
...
- {{domxref("HTMLLinkElement.relList")}} {{ReadOnlyInline}}
  - : A {{domxref("DOMTokenList")}} that reflects the [`rel`](/en-US/docs/Web/HTML/Reference/Element/link#rel) HTML attribute, as a list of tokens.
- {{domxref("HTMLLinkElement.sizes")}} {{ReadOnlyInline}}
  - : A {{domxref("DOMTokenList")}} that reflects the [`sizes`](/en-US/docs/Web/HTML/Reference/Element/link#sizes) HTML attribute, as a list of tokens.
