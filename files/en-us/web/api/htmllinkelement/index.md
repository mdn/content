...
- {{domxref("HTMLLinkElement.integrity")}}
  - : A string that reflects the inline metadata that user agent can use to verify that a fetched resource has been delivered free of unexpected manipulation. It reflects the `integrity` attribute of the {{HTMLElement("link")}} element.
