...
<div>
  <p>The <strong><code>count()</code></strong> method of the {{domxref("IDBIndex")}}
    interface returns an {{domxref("IDBRequest")}} object, and in a separate thread,
    returns the number of records within a key range.</p>
...
<pre class="brush: js">var <em>request</em> = <em>myIndex</em>.count();
var <em>request</em> = <em>myIndex</em>.count(<em>key</em>);</pre>

<h3 id="Parameters">Parameters</h3>

<dl>
  <dt>key {{optional_inline}}</dt>
  <dd>The key or key range that identifies the record to be counted.</dd>
</dl>

<h3 id="Return_value">Return value</h3>

<p>A {{domxref("IDBRequest")}} object on which subsequent events related to this operation
  are fired.</p>
...
<p><code>myIndex.count()</code> is then used to count the number of records in the index,
