...
<div>
  <p>The <strong><code>unique</code></strong> read-only property returns a boolean that
    states whether the index allows duplicate keys.</p>
  ...
  <p>This is decided when the index is created, using the
    ...
    parameter, <code>unique</code>, which if set to <code>true</code> means that the index
    will not be able to accept duplicate entries.</p>
...
<pre
  class="brush: js">var <em>isUnique</em> = <em>IDBIndex</em>.unique; </pre>
...
<table class="standard-table">
  ...
  <tbody>
    <tr>
      ...
      <td>The current index does not allow duplicate values for a key.</td>
    </tr>
    <tr>
      <td><code>false</code></td>
      <td>The current index allows duplicate key values.</td>
    </tr>
  </tbody>
</table>
...
<p>The unique status of the index is logged to the console: it should be returned
