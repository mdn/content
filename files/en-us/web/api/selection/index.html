...
<dl>
 ...
 <div class="note"><p><strong>Note:</strong> This is not the same as the focused <em>element</em> of the document, as returned by {{DOMxRef("document.activeElement")}}.</p></div>
 </dd>
 <dt>range</dt>
