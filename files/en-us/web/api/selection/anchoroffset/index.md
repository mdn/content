...
In the case of {{domxref("Selection.anchorNode")}} being another type of node, **`Selection.anchorOffset`** returns the number of {{domxref("Node.childNodes")}} the offset of the selection's end is within the {{domxref("Selection.anchorNode")}}.
