...
- {{DOMxRef("Selection.direction")}} {{ReadOnlyInline}}
  - : Returns a string describing the direction of the current selection.
...
- {{DOMxRef("Selection.getComposedRanges()")}}
  - : XxxxReturns a {{DOMxRef("Range")}} object representing one of the ranges currently selected.
