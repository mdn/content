...
<dl>
  ...
  <dd>Returns a boolean value indicating whether or not the element has any child
    nodes.</dd>
  ...
  <dd>Accepts a namespace URI as an argument and returns a boolean value with a
