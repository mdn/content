...
- `referenceNode`
  - : The node before which `newNode` is inserted. If this is
    ...
    > Failing to provide it or passing invalid values may [behave](https://bugs.chromium.org/p/chromium/issues/detail?id=419780) [differently](https://bugzil.la/119489) in different browser versions.
