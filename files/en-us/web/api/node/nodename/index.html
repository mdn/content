...
<p>The <code><strong>nodeName</strong></code> read-only property returns the name of the
  current {{domxref("Node")}} as a string.</p>

<h2 id="Syntax">Syntax</h2>

<pre class="brush: js">var <em>str</em> = <em>node</em>.nodeName;
</pre>

<h3 id="Value">Value</h3>

<p>A {{domxref("DOMString")}}. Values for the different types of nodes are:</p>

<table class="standard-table">
  <tbody>
    <tr>
      <th>Interface</th>
      <th>nodeName value</th>
    </tr>
    <tr>
      <td>{{domxref("Attr")}}</td>
...
<p>In XHTML (or any other XML format), <code>text_field</code>'s value would read
...
<p>Note that the {{domxref("Element.tagName")}} property could have been used instead,
  since <code>nodeName</code> has the same value as <code>tagName</code> for an element.
  Bear in mind, however, that <code>nodeName</code> will return <code>"#text"</code> for
  text nodes while <code>tagName</code> will return <code>undefined</code>.</p>
