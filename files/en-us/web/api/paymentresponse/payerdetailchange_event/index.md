...
In the example below, `onpayerdetailchange` is used to set up a listener for the {{domxref("PaymentRequest.payerdetailchange_event", "payerdetailchange")}} event in order to validate the information entered by the user, requesting that any mistakes be corrected
