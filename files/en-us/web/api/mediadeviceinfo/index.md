...
- {{domxref("MediaDeviceInfo.deviceId")}} {{ReadOnlyInline}} {{SecureContext_Inline}}
...
- {{domxref("MediaDeviceInfo.groupId")}} {{ReadOnlyInline}} {{SecureContext_Inline}}
...
- {{domxref("MediaDeviceInfo.kind")}} {{ReadOnlyInline}} {{SecureContext_Inline}}
  - : Returns an enumerated value that is either `"videoinput"`, `"audioinput"` or `"audiooutput"`.
- {{domxref("MediaDeviceInfo.label")}} {{ReadOnlyInline}} {{SecureContext_Inline}}
...
- {{domxref("MediaDeviceInfo.toJSON()")}} {{SecureContext_Inline}}
