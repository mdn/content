...
<p>Several more specific events are based on <code>MouseEvent</code>, including {{domxref("WheelEvent")}} and {{domxref("DragEvent")}}.</p>
...
<dl>
 ...
 <dd>Returns the current state of the specified modifier key. See {{domxref("KeyboardEvent.getModifierState", "KeyboardEvent.getModifierState()")}} for details.</dd>
...
<p>This example demonstrates simulating a click (programmatically generating a click event) on a checkbox using DOM methods. Event state (canceled or not) is then determined with the return value of method {{domxref("EventTarget.dispatchEvent", "EventTarget.dispatchEvent()")}}.</p>
