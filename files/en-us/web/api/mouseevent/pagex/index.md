...
Originally, this property was defined as a `long` integer. The [CSSOM View Module](/en-US/docs/Web/API/CSSOM_view) redefined it as a
`double` float. See the [Browser compatibility](#browser_compatibility) section for
details.

See [Coordinate systems](/en-US/docs/Web/API/CSSOM_view/Coordinate_systems#page) for additional information about coordinates specified in this fashion.
...
You can also see an example that demonstrates [how to access the mouse position](/en-US/docs/Web/API/CSSOM_view/Coordinate_systems#example) information in every available coordinate system.
