...
This property can be set to change both the hostname and the port of the URL. If the URL's scheme is not [hierarchical](https://www.rfc-editor.org/info/rfc3986/#section-1.2.3) (which the URL standard calls "[special schemes](https://url.spec.whatwg.org/#special-scheme)"), then it has no concept of a host and setting this property has no effect.
