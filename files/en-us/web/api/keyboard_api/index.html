...
<h2 id="Keyboard_API_concepts_and_usage">Keyboard API concepts and usage</h2>

<h3 id="Keyboard_mapping">Keyboard mapping</h3>
...
<h3 id="Keyboard_locking">Keyboard locking</h3>
...
<h3 id="Writing_system_keys">Writing system keys</h3>
...
<dl>
 <dt>{{domxref('Keyboard')}} {{experimental_inline}}</dt>
 <dd>Provides functions that retrieve keyboard layout maps and toggle capturing of key presses from the physical keyboard.</dd>
 <dt>{{domxref('KeyboardLayoutMap')}} {{experimental_inline}}</dt>
 <dd>A map-like object with functions for retrieving the string associated with specific physical keys.</dd>
...
<h3 id="Keyboard_API">Keyboard API</h3>

<p>{{Compat("api.Keyboard")}}</p>

<h3 id="Keyboard_lock_API">Keyboard lock API</h3>
