...
- {{domxref("HTMLVideoElement.height")}}
  - : A string that reflects the [`height`](/en-US/docs/Web/HTML/Reference/Element/video#height) HTML attribute, which specifies the height of the display area, in CSS pixels.
- {{domxref("HTMLVideoElement.poster")}}
  - : A string that reflects the [`poster`](/en-US/docs/Web/HTML/Reference/Element/video#poster) HTML attribute, which specifies an image to show while no video data is available.
...
- {{domxref("HTMLVideoElement.width")}}
  - : A string that reflects the [`width`](/en-US/docs/Web/HTML/Reference/Element/video#width) HTML attribute, which specifies the width of the display area, in CSS pixels.
