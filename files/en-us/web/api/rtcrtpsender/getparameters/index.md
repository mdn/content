...
The **`getParameters()`** method of the {{domxref("RTCRtpSender")}} interface returns an {{domxref("RTCRtpSendParameters")}} object describing the current configuration for the encoding and transmission of media on the sender's {{domxref("RTCRtpSender.track", "track")}}.
...
An {{domxref("RTCRtpSendParameters")}} object indicating the current configuration of the sender.
