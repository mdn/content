...
<h2 id="SVG_string_list_interface">SVG string list interface</h2>

<p>The <code>SVGStringList</code> defines a list of {{domxref("DOMString")}} objects.</p>
...
<table class="standard-table">
 <tbody>
  ...
  <tr>
   ...
   <td><a href="https://www.w3.org/TR/SVG11/types.html#InterfaceSVGStringList">SVG 1.1 (2nd Edition)</a></td>
  </tr>
 </tbody>
</table>
...
<table class="standard-table">
 ...
 <tbody>
  ...
  <tr>
   ...
   <td><code>unsigned long</code></td>
   <td>A mirror of the value in <code>numberOfItems</code>, for consistency with other interfaces. {{non-standard_inline}}</td>
  </tr>
 </tbody>
</table>
