...
- {{domxref("HTMLIFrameElement.browsingTopics")}} {{Experimental_Inline}}
  - : A boolean property that specifies whether observed topics should be sent in a {{httpheader("Sec-Browsing-Topics")}} header with the request for the associated {{htmlelement("iframe")}}'s source. This reflects the `browsingtopics` content attribute value.
