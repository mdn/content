...
After calling `restartIce()`, the next offer created using
...
[Lifetime of a WebRTC session, ICE restart](/en-US/docs/Web/API/WebRTC_API/Session_lifetime#ice_restart) and
