...
By the time this event is delivered, the new track has been fully added to the peer connection. See [WebRTC API, Track event types](/en-US/docs/Web/API/RTCTrackEvent#track_event_types) for details.
