...
<p>The <strong><code>FileReader</code></strong> object lets web applications asynchronously read the contents of files (or raw data buffers) stored on the user's computer, using {{domxref("File")}} or {{domxref("Blob")}} objects to specify the file or data to read.</p>
...
<p>See <a href="/en-US/docs/Web/API/File/Using_files_from_web_applications">Using files from web applications</a> for details and examples.</p>
...
<div class="note">
<p><strong>Note:</strong> As <code>FileReader</code> inherits from {{domxref("EventTarget")}}, all those events can also be listened for by using the {{domxref("EventTarget.addEventListener()","addEventListener")}} method.</p>
</div>
...
<dl>
 ...
 <dd>Starts reading the contents of the specified {{domxref("Blob")}}, once finished, the <code>result</code> attribute contains an {{jsxref("ArrayBuffer")}} representing the file's data.</dd>
 ...
 <dd>Starts reading the contents of the specified {{domxref("Blob")}}, once finished, the <code>result</code> attribute contains the contents of the file as a text string. An optional encoding name can be specified.</dd>
</dl>
...
<dl>
 ...
 <dd>Fired when a read has been aborted, for example because the program called {{domxref("FileReader.abort()")}}.<br>
 Also available via the {{domxref("FileReader/onabort", "onabort")}} property.</dd>
 <dt>{{domxref("FileReader/error_event", "error")}}</dt>
 <dd>Fired when the read failed due to an error.<br>
 Also available via the {{domxref("FileReader/onerror", "onerror")}} property.</dd>
 <dt>{{domxref("FileReader/load_event", "load")}}</dt>
 <dd>Fired when a read has completed successfully.<br>
 Also available via the {{domxref("FileReader/onload", "onload")}} property.</dd>
 <dt>{{domxref("FileReader/loadend_event", "loadend")}}</dt>
 <dd>Fired when a read has completed, successfully or not.<br>
 Also available via the {{domxref("FileReader/onloadend", "onloadend")}} property.</dd>
 <dt>{{domxref("FileReader/loadstart_event", "loadstart")}}</dt>
 <dd>Fired when a read has started.<br>
 Also available via the {{domxref("FileReader/onloadstart", "onloadstart")}} property.</dd>
 <dt>{{domxref("FileReader/progress_event", "progress")}}</dt>
 <dd>Fired periodically as data is read.<br>
 Also available via the {{domxref("FileReader/onprogress", "onprogress")}} property.</dd>
</dl>
