...
<dl>
 ...
 <dl>
  ...
  <div class="note"><p><strong>Note:</strong> Not all browsers support prerendering.</p></div>
  </dd>
  <dt><code>unloaded</code></dt>
  <dd>The page is in the process of being unloaded from memory.
  <div class="note"><p><strong>Note:</strong> Not all browsers support the <code>unloaded</code> value.</p></div>
  </dd>
 </dl>
 </dd>
