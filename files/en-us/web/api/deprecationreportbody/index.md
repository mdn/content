...
- {{domxref("DeprecationReportBody.id")}} {{deprecated_inline}}
...
- {{domxref("DeprecationReportBody.anticipatedRemoval")}} {{deprecated_inline}}
...
- {{domxref("DeprecationReportBody.message")}} {{deprecated_inline}}
...
- {{domxref("DeprecationReportBody.toJSON()")}} {{deprecated_inline}}
