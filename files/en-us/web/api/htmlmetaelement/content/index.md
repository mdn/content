...
For more information, see the [content](/en-US/docs/Web/HTML/Reference/Element/meta#content) attribute.
...
The `content` value is logged to the console to display the [keywords](/en-US/docs/Web/HTML/Reference/Element/meta/name#standard_metadata_names_defined_in_the_html_specification) of the document:
