...
For more details on the possible values, see the [http-equiv](/en-US/docs/Web/HTML/Reference/Element/meta#http-equiv) attribute.
...
The `http-equiv` attribute is logged to the console showing a `refresh` [pragma directive](/en-US/docs/Web/HTML/Reference/Element/meta#http-equiv) that instructs the browser to refresh the page after a number of seconds defined by the `content` attribute:
