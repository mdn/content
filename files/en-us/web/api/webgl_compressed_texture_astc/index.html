...
<p>The <code><strong>WEBGL_compressed_texture_astc</strong></code> extension is part of the <a href="/en-US/docs/Web/API/WebGL_API">WebGL API</a> and exposes <a href="https://en.wikipedia.org/wiki/Adaptive_Scalable_Texture_Compression">Adaptive Scalable Texture Compression</a> (ASTC) compressed texture formats to WebGL.</p>

<p>For more information, see the article <a href="https://developer.nvidia.com/astc-texture-compression-for-game-assets">Using ASTC Texture Compression for Game Assets</a> by nvidia.</p>
...
<p>This extension exposes one new methods.</p>

<dl>
 <dt>{{domxref("WEBGL_compressed_texture_astc.getSupportedProfiles", "ext.getSupportedProfiles()")}}</dt>
 <dd>
 <p>Returns an array of strings containing the names of the ASTC profiles supported by the implementation.</p>
 </dd>
</dl>
