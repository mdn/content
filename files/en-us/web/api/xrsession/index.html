...
<dl>
 <dt>{{DOMxRef("XRSession.depthDataFormat", "depthDataFormat")}} {{Experimental_Inline}} {{ReadOnlyInline}}</dt>
 <dd>Returns the depth-sensing data format with which the session was configured.</dd>
 <dt>{{DOMxRef("XRSession.depthUsage", "depthUsage")}} {{Experimental_Inline}} {{ReadOnlyInline}}</dt>
 <dd>Returns the depth-sensing usage with which the session was configured.</dd>
 <dt>{{DOMxRef("XRSession.domOverlayState", "domOverlayState")}} {{Experimental_Inline}} {{ReadOnlyInline}}</dt>
 <dd>Provides information about the DOM overlay, if the feature is enabled.</dd>
