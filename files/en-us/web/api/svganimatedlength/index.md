...
<p>The <code>SVGAnimatedLength</code> interface is used for attributes of basic type <a href="/en-US/docs/SVG/Content_type#Length">&lt;length&gt;</a> which can be animated.</p>
