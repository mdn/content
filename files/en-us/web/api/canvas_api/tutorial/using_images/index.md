...
Another possible way to include images is via the [data: URL](/en-US/docs/Web/URL/Data_URLs). Data URLs allow you to completely define an image as a Base64 encoded string of characters directly in your code.
