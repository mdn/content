...
> See [Security and tainted canvases](/en-US/docs/Web/HTML/Guides/CORS_enabled_image#security_and_tainted_canvases).
...
Once you have generated a data URL from your canvas, you are able to use it as the source of any {{HTMLElement("img")}} or put it into a hyperlink with a [download attribute](/en-US/docs/Web/HTML/Reference/Element/a#download) to save it to disc, for example.
