...
![A canvas grid with center at top left corner. The canvas and it's origin are moved on the grid by 'x' units horizontally and 'y' units vertically.](canvas_grid_translate.png)
...
![Canvas grid with center at top left corner: The grid is rotated around the origin in clock-wise direction by alpha radians.](canvas_grid_rotate.png)
