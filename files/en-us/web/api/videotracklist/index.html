...
<p>The <strong><code>VideoTrackList</code></strong> interface is used to represent a list of the video tracks contained within a {{HTMLElement("video")}} element, with each track represented by a separate {{domxref("VideoTrack")}} object in the list.</p>
...
<dl>
 ...
 Also available via the {{domxref("VideoTrackList.onaddtrack", "onaddtrack")}} property.</dd>
 <dt>{{domxref("VideoTrackList.change_event", "change")}}</dt>
 <dd>Fired when a video track has been made active or inactive.<br>
 Also available via the {{domxref("VideoTrackList.onchange", "onchange")}} property.</dd>
 ...
 Also available via the {{domxref("VideoTrackList.onremovetrack", "onremovetrack")}} property.</dd>
</dl>
...
<h3 id="Getting_a_media_elements_video_track_list">Getting a media element's video track list</h3>
