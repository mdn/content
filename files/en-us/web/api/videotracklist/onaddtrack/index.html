...
<pre
  class="brush: js"><em>VideoTrackList</em>.onaddtrack = <em>eventHandler</em>;</pre>
...
<p>The {{event("addtrack")}} event is called whenever a new track is added to the media
  element whose video tracks are represented by the <code>VideoTrackList</code> object.
