...
when invoked, increments the [`value`](/en-US/docs/Web/HTML/Reference/Element/input#value) by
([`step`](/en-US/docs/Web/HTML/Reference/Element/input#step) \* n), where `n` defaults to
