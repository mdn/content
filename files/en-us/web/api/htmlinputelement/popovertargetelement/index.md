...
In this case we don't set the [`popovertargetaction`](/en-US/docs/Web/HTML/Reference/Element/button#popovertargetaction) HTML attribute on the `<input>` or the [`popover`](/en-US/docs/Web/HTML/Global_attributes/popover) attribute on the `<div>`, as we will be doing so programmatically.
