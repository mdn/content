...
[`value`](/en-US/docs/Web/HTML/Reference/Element/input#value) by ([`step`](/en-US/docs/Web/HTML/Reference/Element/input#step) \* n), where n
...
- `InvalidStateError` {{domxref("DOMException")}}
  - : Thrown in one of the following cases:
    - if the method is not applicable to for the current
      [`type`](/en-US/docs/Web/HTML/Reference/Element/input#type) value,
    - if the element has no [`step`](/en-US/docs/Web/HTML/Reference/Element/input#step) value,
    - if the [`value`](/en-US/docs/Web/HTML/Reference/Element/input#value) cannot be converted to a number,
    - if the resulting value is above the [`max`](/en-US/docs/Web/HTML/Reference/Element/input#max) or below the
      [`min`](/en-US/docs/Web/HTML/Reference/Element/input#min).
