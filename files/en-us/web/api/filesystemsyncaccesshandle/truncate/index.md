...
- `QuotaExceededError` {{domxref("DOMException")}}
  - : Thrown if the `newSize` is larger than the original size of the file, and exceeds the browser's [storage quota](/en-US/docs/learn/javascript/client-side_web_APIs/browser_storage_limits_and_eviction_criteria).
