...
<p>The <strong><code>WebGL2RenderingContext.getSyncParameter()</code></strong> method of
  the <a href="/en-US/docs/Web/API/WebGL_API">WebGL 2 API</a> returns parameter
  information of a {{domxref("WebGLSync")}} object.</p>

<h2 id="Syntax">Syntax</h2>

<pre class="brush: js">any <var>gl</var>.getSyncParameter(<var>sync</var>, <var>pname</var>);
</pre>
