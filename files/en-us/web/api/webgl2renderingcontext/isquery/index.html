...
<p>The <strong><code>WebGL2RenderingContext.isQuery()</code></strong> method of the <a
    href="/en-US/docs/Web/API/WebGL_API">WebGL 2 API</a> returns <code>true</code> if the
  passed object is a valid {{domxref("WebGLQuery")}} object.</p>

<h2 id="Syntax">Syntax</h2>

<pre class="brush: js">GLBoolean <var>gl</var>.isQuery(<var>query</var>);
</pre>
