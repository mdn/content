...
<p>The <strong><code>WebGLRenderingContext.texImage3D()</code></strong> method of the <a
    href="/en-US/docs/Web/API/WebGL_API">WebGL API </a>specifies a three-dimensional
  texture image.</p>

<h2 id="Syntax">Syntax</h2>

<pre class="brush: js">void <var>gl</var>.texImage3D(target, level, internalformat, width, height, depth, border, format, type, GLintptr offset);
