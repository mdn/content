...
The read-only **`DataTransferItem.kind`** property returns the kind of the {{domxref("DataTransferItem")}} object representing the _drag data item_: a plain Unicode string or file.
