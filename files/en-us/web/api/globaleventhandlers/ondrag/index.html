...
<p>A {{domxref("GlobalEventHandlers","global event handler")}} for the {{event("drag")}}
  event.</p>

<h2 id="Syntax">Syntax</h2>

<pre class="brush: js">var <var>dragHandler</var> = <var>targetElement</var>.ondrag;
</pre>
...
<p>This example includes the use of the <em>ondrag</em> attribute handler to set an
  element's <em>drag</em> event handler.</p>
