...
- {{domxref("HTMLFieldSetElement.disabled")}}
  - : A boolean value reflecting the [`disabled`](/en-US/docs/Web/HTML/Reference/Element/fieldset#disabled) HTML attribute, indicating whether the user can interact with the control.
...
- {{domxref("HTMLFieldSetElement.name")}}
  - : A string reflecting the [`name`](/en-US/docs/Web/HTML/Reference/Element/fieldset#name) HTML attribute, containing the name of the field set. This can be used when accessing the field set in JavaScript. It is _not_ part of the data which is sent to the server.
