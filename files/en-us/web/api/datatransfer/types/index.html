...
<p>The <strong><code>DataTransfer.types</code></strong> read-only property returns an
  ...
  included in the drag operation.</p>

<p>The formats are Unicode strings giving the type or format of the data, generally given
  by a MIME type. Some values that are not MIME types are special-cased for legacy reasons
  (for example "<code>text</code>"). </p>

<h2 id="Syntax">Syntax</h2>

<pre class="brush: js"><var>dataTransfer</var>.types;
</pre>

<h3 id="Return_value">Return value</h3>

<p>An array of the data formats used in the drag operation. Each format is
  ...
  will be the string <code>Files</code>. </p>

<h2 id="Example">Example</h2>

<p>This example shows the use of the <code>types</code> and
  {{domxref("DataTransfer.items","items")}} properties.</p>
