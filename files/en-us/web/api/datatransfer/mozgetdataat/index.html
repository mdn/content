...
<p>The <strong><code>DataTransfer.mozGetDataAt()</code></strong> method is used to
  retrieve an item in the drag event's {{domxref("DataTransfer","data transfer")}} object,
  based on a given <code>format</code> and <code>index</code>. This method returns
  <code>null</code> if the specified item does not exist or if the index is not in the
  range from zero to the number of items minus one.</p>

<div class="note"><p><strong>Note:</strong> This method is Gecko-specific.</p></div>

<h2 id="Syntax">Syntax</h2>

<pre class="brush: js">nsIVariant <em>dataTransfer</em>.mozGetDataAt([type], index);
</pre>
...
<dl>
  <dt><em>type</em></dt>
  <dd>A {{domxref("DOMString","string")}} representing the type of the drag data to
    retrieve from the {{domxref("DataTransfer","drag data object")}}.</dd>
  <dt><em>index</em></dt>
  <dd>A <code>unsigned long</code> representing the index of the data to retrieve.</dd>
</dl>
...
<dl>
  ...
  <dd>The data item requested. If the specified item does not exist, <code>null</code> is
    returned.</dd>
</dl>

<h2 id="Example">Example</h2>

<p>This example shows the use of the <code>mozGetDataAt()</code> method in a
