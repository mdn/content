  ...
  - : An object that specifies characteristics about the event listener. The available
    ...
    - `passive` {{optional_inline}}
      - : A boolean value that, if `true`, indicates that the function specified by `listener` will never call {{domxref("Event.preventDefault", "preventDefault()")}}. If a passive listener calls `preventDefault()`, nothing will happen and a console warning may be generated.
        ...
        If this option is not specified, it defaults to `false` — except that it defaults to `true` for {{domxref("Element/wheel_event", "wheel")}}, {{domxref("Element/mousewheel_event", "mousewheel")}}, {{domxref("Element/touchstart_event", "touchstart")}}, and {{domxref("Element/touchmove_event", "touchmove")}} events on {{domxref("Window")}}, {{domxref("Document")}}, {{domxref("Document.documentElement")}}, and {{domxref("Document.body")}}. See [Using passive listeners](#using_passive_listeners) to learn more.
...
To realize the scroll performance benefits of passive listeners in legacy code, the specification for `addEventListener()` defines the default value of the `passive` option as `true` for the {{domxref("Element/wheel_event", "wheel")}}, {{domxref("Element/mousewheel_event", "mousewheel")}}, {{domxref("Element/touchstart_event", "touchstart")}}, and {{domxref("Element/touchmove_event", "touchmove")}} events on {{domxref("Window")}}, {{domxref("Document")}}, {{domxref("Document.documentElement")}}, and {{domxref("Document.body")}}. For other events and targets, the default is `false`. A passive listener cannot [cancel the event](/en-US/docs/Web/API/Event/preventDefault), so the browser does not need to wait for it to finish before scrolling.
