...
Unlike browser-generated ("native") events [event loop](/en-US/docs/Web/JavaScript/Reference/Execution_model), `dispatchEvent()` invokes event handlers _synchronously_, meaning all applicable event handlers complete
execution before `dispatchEvent()` returns.
