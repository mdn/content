...
<div class="note">
<p><strong>Note:</strong> Starting in {{Gecko("5.0") }},the <code>SVGLengthList</code> DOM interface is now indexable and can be accessed like arrays</p>
</div>
	...
	<tbody>
		...
		<tr>
			...
			<ul>
				...
				<li>{{ domxref("SVGLength") }} <code>initialize(in {{ domxref("SVGLength") }} <em>newItem</em>)</code></li>
				<li>{{ domxref("SVGLength") }} <code>getItem(in unsigned long <em>index</em>)</code></li>
				<li>{{ domxref("SVGLength") }} <code>insertItemBefore(in {{ domxref("SVGLength") }} <em>newItem</em>, in unsigned long <em>index</em>)</code></li>
				<li>{{ domxref("SVGLength") }} <code>replaceItem(</code><code>in {{ domxref("SVGLength") }} <em>newItem</em>, in unsigned long <em>index</em></code><code>)</code></li>
				<li>{{ domxref("SVGLength") }} <code>removeItem(in unsigned long <em>index</em>)</code></li>
				<li>{{ domxref("SVGLength") }} <code>appendItem(in {{ domxref("SVGLength") }} <em>newItem</em>)</code></li>
			</ul>
			</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td><a href="https://www.w3.org/TR/SVG11/types.html#InterfaceSVGLengthList">SVG 1.1 (2nd Edition)</a></td>
		</tr>
	</tbody>
</table>
...
<table class="standard-table">
	...
	<tbody>
		...
		<tr>
			<td><code><strong>initialize</strong>(</code><code>in {{ domxref("SVGLength") }} <em>newItem</em></code><code>)</code></td>
		...
		<tr>
			<td><code><strong>insertItemBefore</strong>(in {{ domxref("SVGLength") }} <em>newItem</em>, in unsigned long <em>index</em>)</code></td>
			<td>{{ domxref("SVGLength") }}</td>
			<td>
		...
		<tr>
			<td><code><strong>replaceItem</strong>(</code><code>in {{ domxref("SVGLength") }} <em>newItem</em>, in unsigned long <em>index</em></code><code>)</code></td>
			<td>{{ domxref("SVGLength") }}</td>
			<td>
		...
		<tr>
			<td><code><strong>appendItem</strong>(in {{ domxref("SVGLength") }} <em>newItem</em>)</code></td>
			<td>{{ domxref("SVGLength") }}</td>
			<td>
