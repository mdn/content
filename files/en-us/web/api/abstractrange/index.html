...
<pre class="brush: js">let startElem = document.querySelector("p");
...
<p><a href="simpledom.svg"><img alt="Diagram of the DOM for a simple web page" src="simpledom.svg"></a></p>
...
<pre class="brush: js">let pRange = document.createRange();
...
<pre class="brush: html">let r = document.createRange();
...
<p><img alt="A DocumentFragment representing the cloned content" src="dom-fragment.svg"></p>
