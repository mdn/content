...
```js
// Let's say an <a id="myAnchor" href="/en-US/docs/Web/API/Location/pathname"> element is in the document
const anchor = document.getElementById("myAnchor");
const result = anchor.pathname; // Returns:'/en-US/docs/Web/API/Location/pathname'
```
