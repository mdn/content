...
<p>{{domxref("VRStageParameters")}} object containing the <code>VRDisplay</code>'s room-scale parameters, or <code>null</code> if the <code>VRDisplay</code> is not capable of supporting room-scale experiences.</p>
