...
<p>As with the {{domxref("Element/fullscreenchange_event", "fullscreenchange")}} event, two <code>fullscreenerror</code> events are fired; the first is sent to the {{domxref("Element")}} which failed to change modes, and the second is sent to the {{domxref("Document")}} which contains that element.</p>
...
<ul>
 <li><a href="/en-US/docs/Web/API/Element/fullscreenchange_event"><code>fullscreenchange</code></a></li>
