...
<p><strong><code>Element</code></strong> is the most general base class from which all element objects (i.e. objects that represent elements) in a {{DOMxRef("Document")}} inherit. It only has methods and properties common to all kinds of elements. More specific classes inherit from <code>Element</code>.</p>

<p>For example, the {{DOMxRef("HTMLElement")}} interface is the base interface for HTML elements, while the {{DOMxRef("SVGElement")}} interface is the basis for all SVG elements. Most functionality is specified further down the class hierarchy.</p>
...
<dl>
 ...
 <dd>Returns the first child element of this element.</dd>
...
<dl>
  ...
  <dd>Is a {{domxref("DOMString")}} reflecting the <code>aria-description</code> attribute, which defines a string value that describes or annotates the current element.</dd>
  ...
  <dd>Is a {{domxref("DOMString")}} reflecting the <code>aria-haspopup</code> attribute, which indicates the availability and type of interactive popup element, such as menu or dialog, that can be triggered by an element.</dd>
  ...
  <dd>Is a {{domxref("DOMString")}} reflecting the <code>aria-keyshortcuts</code> attribute, which indicates keyboard shortcuts that an author has implemented to activate or give focus to an element.</dd>
  <dt>{{domxref("Element.ariaLabel")}}</dt>
  <dd>Is a {{domxref("DOMString")}} reflecting the <code>aria-label</code> attribute, which defines a string value that labels the current element.</dd>
...
<dl>
 ...
 <dd>An event handler for the {{event("fullscreenchange")}} event, which is sent when the element enters or exits full-screen mode. This can be used to watch both for successful expected transitions, but also to watch for unexpected changes, such as when your app is running in the background.</dd>
...
<dl>
 ...
 <dd>Inserts a set of {{domxref("Node")}} objects or {{domxref("DOMString")}} objects after the last child of the element.</dd>
 <dt>{{DOMxRef("Element.before()")}}</dt>
 <dd>Inserts a set of {{domxref("Node")}} or {{domxref("DOMString")}} objects in the children list of the <code>Element</code>'s parent, just before the <code>Element</code>.</dd>
 ...
 <dd>Dispatches an event to this node in the DOM and returns a boolean value that indicates whether no handler canceled the event.</dd>
 ...
 <dd>Returns a boolean value indicating if the element has the specified attribute or not.</dd>
 <dt>{{DOMxRef("Element.hasAttributeNS()")}}</dt>
 <dd>Returns a boolean value indicating if the element has the specified attribute, in the specified namespace, or not.</dd>
 <dt>{{DOMxRef("Element.hasAttributes()")}}</dt>
 <dd>Returns a boolean value indicating if the element has one or more HTML attributes present.</dd>
 ...
 <dd>Returns a boolean value indicating whether or not the element would be selected by the specified selector string.</dd>
 <dt>{{DOMxRef("Element.prepend()")}}</dt>
 <dd>Inserts a set of {{domxref("Node")}} objects or {{domxref("DOMString")}} objects before the first child of the element.</dd>
...
<dl>
 ...
 <dd>Fired when a {{domxref("Element/contextmenu_event", "contextmenu")}} event was fired on/bubbled to an element that has a <code><a href="/en-US/docs/Web/HTML/Global_attributes/contextmenu">contextmenu</a></code> attribute. {{deprecated_inline}}<br>
