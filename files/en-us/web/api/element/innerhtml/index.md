...
So for example [`<template>`](/en-US/docs/Web/HTML/Reference/Element/template) is parsed into as {{domxref("HTMLTemplateElement")}}, whether or not the [`shadowrootmode`](/en-US/docs/Web/HTML/Reference/Element/template#shadowrootmode) attribute is specified
