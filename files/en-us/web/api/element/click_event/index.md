...
> [!NOTE]
> In practice, browsers don't fire the `click` event for custom controls such as a `<div>` with `tabindex="0"`. To check the reason behind this behavior, see this <a href="https://issues.chromium.org/issues/40776466">Chromium issue</a>.
