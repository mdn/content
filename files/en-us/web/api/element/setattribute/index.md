...
- The first call to `setAttribute()` above shows changing the `name` attribute's value to "helloButton".
  ...
  [Firefox](https://firefox-source-docs.mozilla.org/devtools-user/page_inspector/index.html), [Safari](https://support.apple.com/en-in/guide/safari-developer/welcome/mac)).
