...
<table class="properties">
	<tbody>
		...
		<tr>
			...
			<td>{{domxref("MouseWheelEvent")}} {{deprecated_inline}}</td>
		</tr>
		<tr>
			<th scope="row">Event handler property</th>
			<td>{{domxref("GlobalEventHandlers.onmousewheel", "onmousewheel")}}</td>
		</tr>
	</tbody>
</table>

<h2 id="The_detail_property">The detail property</h2>
