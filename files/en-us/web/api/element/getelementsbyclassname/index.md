...
We can also use {{jsxref("Array")}} methods on any {{domxref("HTMLCollection")}} by transforming the {{domxref("HTMLCollection")}} to an array. Here we'll find all {{HTMLElement("div")}} elements that have a class of `test`:
