...
<p><em>This interface inherits properties from the {{domxref("EventTarget")}} interface and <code>WindowOrWorkerGlobalScope</code> and {{domxref("WindowEventHandlers")}} mixins.</em></p>
...
<dl>
 ...
 <dd>Fired when an error occurred.<br>
 ...
 <dd>An event handler for unhandled <a href="/en-US/docs/Web/JavaScript/Reference/Global_Objects/Promise" title="The Promise object is used for deferred and asynchronous computations. A Promise represents an operation that hasn't completed yet, but is expected in the future."><code>Promise</code></a> rejection events.<br>
 Also available via the {{domxref("WorkerGlobalScope.onunhandledrejection")}} property.</dd>
</dl>

<h2 id="Methods">Methods</h2>

<p><em>This interface inherits methods from the {{domxref("EventTarget")}} interface and <code>WindowOrWorkerGlobalScope</code> and {{domxref("WindowEventHandlers")}} mixins.</em></p>
