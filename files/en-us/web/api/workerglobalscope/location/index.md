...
> **Note:** Firefox has a bug with using `console.log` inside shared/service workers (see [Webkit bug 1058644](https://bugzilla.mozilla.org/show_bug.cgi?id=1058644)), which may return strange results, but this should be fixed soon.
