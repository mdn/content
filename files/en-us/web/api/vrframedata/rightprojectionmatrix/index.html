...
<div class="warning">
<p><strong>Warning:</strong> It is highly recommended that applications use this matrix without modification. Failure to use this projection matrix when rendering may cause the presented frame to be distorted or badly aligned, resulting in varying degrees of user discomfort.</p>
</div>

<h2 id="Syntax">Syntax</h2>

<pre class="brush: js">var myRPM = vrFrameDataInstance.rightProjectionMatrix;</pre>
