...
Before starting a project that will require sharing of audio, be sure to check the [MediaDevices.getDisplayMedia(), Browser compatibility](/en-US/docs/Web/API/MediaDevices/getDisplayMedia#browser_compatibility) to see if the browsers you wish compatibility with have support for audio in captured screen streams.
