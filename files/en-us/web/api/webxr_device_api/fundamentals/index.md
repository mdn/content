...
Generally, applications only define and manage the horizontal FOV. For more details, see [WebXR Device API, The optics of 3D](/en-US/docs/Web/API/WebXR_Device_API/Rendering#the_optics_of_3d).
