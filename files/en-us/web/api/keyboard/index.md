...
The following example captures the <kbd>W</kbd>, <kbd>A</kbd>, <kbd>S</kbd>, and <kbd>D</kbd> keys by calling `lock()` with a list that contains the key code attribute value for each of these keys:
