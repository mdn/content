...
<pre class="brush: js">let ariaRowCount = ElementInternals.ariaRowCount;
ElementInternals.ariaRowCount = ariaRowCount;</pre>
...
<p>In this example the value of <code>ariaRowCount</code> is set to "100".</p>

<pre class="brush: js">this.internals_.ariaRowCount = "100";</pre>
