...
<pre class="brush: js">let ariaColIndexText = ElementInternals.ariaColIndexText;
ElementInternals.ariaColIndexText = ariaColIndexText;</pre>
...
<p>In this example the value of <code>ariaColIndexText</code> is set to "Column name".</p>

<pre class="brush: js">this.internals_.ariaColIndexText = "Column name";</pre>
