...
<pre class="brush: js">ElementInternals.setFormValue(value);
ElementInternals.setFormValue(value, state);</pre>

<h3 id="Parameters">Parameters</h3>

<dl>
  <dt><code>value</code></dt>
  <dd>A {{domxref("File")}}, or a {{domxref("USVString","string")}}, or {{domxref("FormData")}} as the value to be submitted to the server.</dd>
  <dt><code>state</code>{{Optional_Inline}}</dt>
  <dd>A {{domxref("File")}}, or a {{domxref("USVString","string")}}, or {{domxref("FormData")}} representing the input made by the user. This allows the application to re-display the information that the user submitted, in the form that they submitted it, if required.</dd>
</dl>
...
<p>In the following example, a checkbox custom element sets <code>on</code> as the value to send to the server, and <code>checked</code> as the state.</p>

<pre class="brush: js">this.internals_.setFormValue("on","checked");</pre>
