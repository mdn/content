...
<pre class="brush: js">let ariaMultiline = ElementInternals.ariaMultiline;
ElementInternals.ariaMultiline = ariaMultiline;</pre>
...
<p>In this example the value of <code>ariaMultiline</code> is set to "true".</p>

<pre class="brush: js">this.internals_.ariaMultiline = "true";</pre>
