...
<pre class="brush: js">let ariaValueMin = ElementInternals.ariaValueMin;
ElementInternals.ariaValueMin = ariaValueMin;</pre>
...
<p>In this example the value of <code>ariaValueMin</code> is set to "10".</p>

<pre class="brush: js">this.internals_.ariaValueMin = "10";</pre>
