...
<pre class="brush: js">let ariaSetSize = ElementInternals.ariaSetSize;
ElementInternals.ariaSetSize = ariaSetSize;</pre>
...
<p>In this example the value of <code>ariaSetSize</code> is set to "4".</p>

<pre class="brush: js">this.internals_.ariaSetSize = "4";</pre>
