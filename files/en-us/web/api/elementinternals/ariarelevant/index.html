...
<pre class="brush: js">let ariaRelevant = ElementInternals.ariaRelevant;
ElementInternals.ariaRelevant = ariaRelevant;</pre>
...
<p>In this example the value of <code>ariaRelevant</code> is set to "all".</p>

<pre class="brush: js">this.internals_.ariaRelevant = "all";</pre>
