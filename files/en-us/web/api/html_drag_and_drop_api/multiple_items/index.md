...
<p><strong>Warning:</strong> All of the methods and properties with a <strong>moz</strong> prefix (such as <strong>mozSetDataAt()</strong> are Gecko specific interfaces. These interfaces will <strong>only</strong> work with Gecko based browsers.</p>
</div>
