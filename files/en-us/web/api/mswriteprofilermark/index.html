...
<p>Type: <strong>HRESULT</strong>. If this method succeeds, it returns <strong><em>S_OK</em></strong>. Otherwise, it returns an <em><strong>HRESULT </strong></em>error code.</p>
