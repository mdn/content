...
The `valueAsString` property of the {{domxref("SVGLength")}} interface represents the [\<length>](/en-US/docs/Web/SVG/Content_type#length)'s value as a **string**, in the units expressed by {{domxref("SVGLength.unitType", "unitType")}}.
