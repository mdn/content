...
<h2 id="SVG_length_interface">SVG length interface</h2>

<p>The <code>SVGLength</code> interface correspond to the <a href="/en-US/docs/SVG/Content_type#Length">&lt;length&gt;</a> basic data type.</p>
...
<table class="standard-table">
 <tbody>
  ...
  <tr>
   ...
   <td>
    <ul>
     <li><code>void <strong>newValueSpecifiedUnits</strong>(in unsigned short <var>unitType</var>, in float <var>valueInSpecifiedUnits</var>)</code></li>
     <li><code>void <strong>convertToSpecifiedUnits</strong>(in unsigned short <var>unitType</var>)</code></li>
    </ul>
   </td>
  </tr>
  <tr>
   ...
   <td>
    <ul>
     ...
     <li>{{ domxref("DOMString") }} <code>valueAsString</code></li>
    </ul>
   </td>
  </tr>
  <tr>
  ...
  <tr>
   ...
   <td><a href="https://www.w3.org/TR/SVG11/types.html#InterfaceSVGLength">SVG 1.1 (2nd Edition)</a></td>
  </tr>
 </tbody>
</table>
...
<pre class="brush: xml">&lt;svg height="200" onload="start();" version="1.1" width="200" xmlns="http://www.w3.org/2000/svg"&gt;
...
<p>Results on a desktop monitor (pixel units will be dpi-dependent):</p>

<pre class="brush: plain">value: 37.7952766418457, valueInSpecifiedUnits: 6: 1, valueAsString: 1cm
...
<table class="standard-table">
 ...
 <tbody>
  ...
  <tr>
   ...
   <td><code>1</code></td>
   <td>No unit type was provided (i.e., a unitless value was specified), which indicates a value in user units.</td>
  </tr>
  <tr>
...
<table class="standard-table">
 ...
 <tbody>
  <tr>
   ...
   <td>The type of the value as specified by one of the <code>SVG_LENGTHTYPE_*</code> constants defined on this interface.</td>
  </tr>
  <tr>
  ...
  <tr>
   ...
   <td>
    ...
    <ul>
     <li>a {{ domxref("DOMException") }} with code <code>SYNTAX_ERR</code> is raised if the assigned string cannot be parsed as a valid <a href="/en-US/docs/SVG/Content_type#Length">&lt;length&gt;</a>.</li>
...
<table class="standard-table">
 ...
 <tbody>
  <tr>
   <td><code><strong>newValueSpecifiedUnits</strong>(in unsigned short <var>unitType</var>, in float <var>valueInSpecifiedUnits</var>)</code></td>
   <td><var>void</var></td>
   <td>
