...
<div class="warning">
<p><strong>Warning:</strong> This version of <code>timestamp</code> has been removed from the spec — instead, timestamps are returned when {{domxref("VRDisplay.getFrameData()")}} is called — see {{domxref("VRFrameData.timestamp")}}.</p>
</div>
