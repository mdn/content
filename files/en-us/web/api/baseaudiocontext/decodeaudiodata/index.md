...
> **Note:** You can [run the example live](https://mdn.github.io/webaudio-examples/decode-audio-data/) and acces the [source code](https://github.com/mdn/webaudio-examples/tree/master/decode-audio-data).
