...
<p>The <code>currentTime</code> read-only property of the {{ domxref("BaseAudioContext") }}
  interface returns a double representing an ever-increasing hardware timestamp in seconds that
  can be used for scheduling audio playback, visualizing timelines, etc. It starts at 0.</p>

<h2 id="Syntax">Syntax</h2>

<pre class="brush: js">var <em>curTime</em> = <em>baseAudioContext</em>.currentTime;
</pre>
...
<p>To offer protection against timing attacks and fingerprinting, the precision of
  <code>audioCtx.currentTime</code> might get rounded depending on browser settings.<br>
