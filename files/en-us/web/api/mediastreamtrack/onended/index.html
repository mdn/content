...
<pre class="brush: js"><em>MediaStreamTrack</em>.onended = <em>function</em>;
</pre>
...
<p>This example sets up an event handler for the <code>ended</code> event which changes an
  on-screen icon to indicate that the track is no longer active.</p>
...
<ul>
  <li>The
    <code><a href="/en-US/docs/Web/API/MediaStreamTrack/ended_event">ended</a></code>
