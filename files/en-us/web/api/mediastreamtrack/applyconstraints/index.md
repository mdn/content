...
can also specify ideal and/or acceptable sizes or ranges of sizes. See [Applying constraints](/en-US/docs/Web/API/Media_Streams_API/Constraints#applying_constraints) in [Capabilities, constraints,
and settings](/en-US/docs/Web/API/Media_Streams_API/Constraints) for more information on how to apply your preferred constraints.
