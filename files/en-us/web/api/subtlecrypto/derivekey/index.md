...
Press the Encrypt button to encrypt the text in the top `<input>` element, displaying the encrypted cipertext and decrypted ciphertext in the following two elements.
