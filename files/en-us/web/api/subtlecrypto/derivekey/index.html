...
<ul>
  ...
  <li>Raised when the master key is not a key for the requested derivation algorithm 
    or if the <em>keyUsages</em> value of that key doesn't contain <code>deriveKey</code>.</li>
