...
<p>The <strong><code>SVGFontFaceElement</code></strong> interface corresponds to the {{SVGElement("font-face")}} elements.</p>

<p>Object-oriented access to the attributes of the {{SVGElement("font-face")}} element via the SVG DOM is not possible.</p>
