...
<p>The {{domxref("XRPermissionDescriptor")}}
    ...
    operate without if permission isn't granted to use them.</p>
...
<em>xrPermissionDescriptor</em>.optionalFeatures = <em>optFeatureList</em>;
<em>optFeatureList</em> = <em>xrPermissionDescriptor</em>.optionalFeatures;</pre>

<h3 id="Value">Value</h3>

<p>An array of strings indicating set of features that your app would like to use, but can operate without if
...
<table>
  ...
  <tbody>
    ...
    <td>
      ...
      For devices with six degrees of freedom (6DoF) tracking, the <code>local</code> reference space tries to keep the origin stable relative to the environment.
    </td>
