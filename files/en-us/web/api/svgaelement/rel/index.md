...
The **`rel`** property of the {{domxref("SVGAElement")}} interface returns a string reflecting the value of the [`rel`](/en-US/docs/Web/HTML/Reference/Elements/a#rel) attribute of the SVG {{svgelement("a")}} element.
