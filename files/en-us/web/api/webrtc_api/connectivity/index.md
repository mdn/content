...
<p>This article describes how the various WebRTC-related protocols interact with one another in order to create a connection and transfer data and/or media among peers.</p>
...
<ol>
 ...
 <li>The caller creates <code>RTCPeerConnection</code> and calls {{domxref("RTCPeerConnection.addTrack()")}} (Since <code>addStream</code> is deprecating)</li>
