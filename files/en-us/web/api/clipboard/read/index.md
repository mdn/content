...
- This may not work on chromium browsers as the sample frame is not granted the [Permissions-Policy](/en-US/docs/Web/HTTP/Reference/Headers/Permissions-Policy) {{httpheader("Permissions-Policy/clipboard-read", "clipboard-read")}} and {{httpheader("Permissions-Policy/clipboard-write", "clipboard-write")}} permissions ([required by Chromium browsers](/en-US/docs/Web/API/Clipboard_API#security_considerations)).
