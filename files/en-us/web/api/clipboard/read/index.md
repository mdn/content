...
- This may not work on Chromium browsers because the sample frame is not granted the [Permissions-Policy](/en-US/docs/Web/HTTP/Reference/Headers/Permissions-Policy) {{httpheader("Permissions-Policy/clipboard-read", "clipboard-read")}} and {{httpheader("Permissions-Policy/clipboard-write", "clipboard-write")}} permissions. See [Clipboard API security considerations](/en-US/docs/Web/API/Clipboard_API#security_considerations).
