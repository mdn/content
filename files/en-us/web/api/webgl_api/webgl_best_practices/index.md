...
_(see also: <https://kdashg.github.io/misc/webgl/webgl-feature-levels.html>)_
...
Operations like `readPixels` and `getBufferSubData` are typically synchronous, but using the same APIs, non-blocking, asynchronous data readback can be achieved. The approach in WebGL 2 is analogous to the approach in OpenGL: <https://kdashg.github.io/misc/async-gpu-downloads.html>
...
Demo: <https://kdashg.github.io/misc/webgl/device-pixel-presnap.html>
