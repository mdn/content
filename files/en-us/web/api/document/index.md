...
- {{DOMxRef("Document.activeViewTransition")}} {{ReadOnlyInline}}
  - : Returns a {{DOMxRef('ViewTransition')}} instance representing the [view transition](/en-US/docs/Web/API/View_Transition_API) currently active on the page, or `null` if there is no active view transition.
