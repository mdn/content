...
A string containing the _document_'s title. If the title was overridden by setting `document.title`, it contains that value. Otherwise, it contains the title specified in the markup in the [`<title>`](/en-US/docs/Web/HTML/Element/title) element.
