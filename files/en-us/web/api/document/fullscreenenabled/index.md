...
which contain the document have their [`allowfullscreen`](/en-US/docs/Web/HTML/Reference/Element/iframe#allowfullscreen)
attribute set.
...
- The {{HTMLElement("iframe")}} [`allowfullscreen`](/en-US/docs/Web/HTML/Reference/Element/iframe#allowfullscreen)
  attribute
