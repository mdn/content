...
<p>To create an element without specifying a namespace URI, use the
  {{DOMxRef("Document.createElement()", "createElement()")}} method.</p>

<h2 id="Syntax">Syntax</h2>

<pre class="brush: js"><var>var element</var> = <var>document</var>.createElementNS(<var>namespaceURI</var>, <var>qualifiedName</var>[, <var>options</var>]);
</pre>
...
<dl>
  ...
  <dd>A string that specifies the <a class="external"
      href="https://www.w3.org/TR/2004/REC-DOM-Level-3-Core-20040407/glossary.html#dt-namespaceURI">namespace
      URI</a> to associate with the element. The {{DOMxRef("element.namespaceURI",
    "namespaceURI")}} property of the created element is initialized with the value of
    <var>namespaceURI</var>. See <a href="#important_namespace_uris">Valid Namespace
      URIs</a>.</dd>
  <dt><var>qualifiedName</var></dt>
  <dd>A string that specifies the type of element to be created. The
  ...
  <dd><p>An optional <code>ElementCreationOptions</code> object containing a single property
    ...
    previous versions of the <a class="external external-icon"
      href="https://www.w3.org/TR/custom-elements/">Custom Elements specification</a>,
...
<dl>
  ...
  <dt><a href="/en-US/docs/Mozilla/Tech/XUL">XUL</a> {{Non-standard_Inline}}</dt>
  <dd><code>http://www.mozilla.org/keymaster/gatekeeper/there.is.only.xul</code></dd>
  <dt><a
      href="/en-US/docs/Mozilla/Tech/XBL">XBL</a> {{Non-standard_Inline}} {{Deprecated_Inline}}
  </dt>
...
<p>This creates a new &lt;div&gt; element in the {{Glossary("XHTML")}} namespace and
  appends it to the vbox element. Although this is not an extremely useful <a
    href="/en-US/docs/Mozilla/Tech/XUL">XUL</a> document, it does demonstrate the use of
  elements from two different namespaces within a single document:</p>
...
<div class="notecard note">
  <p><strong>Note:</strong> The example given above uses inline script which is not recommended in XHTML
    documents. This particular example is actually an XUL document with embedded XHTML,
    however, the recommendation still applies.</p>
</div>
...
<ul>
  ...
  <li><a class="external"
      href="https://www.w3.org/TR/1999/REC-xml-names-19990114">Namespaces in XML</a></li>
</ul>
