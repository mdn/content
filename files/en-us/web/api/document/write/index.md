...
Using `document.write()` in [deferred](/en-US/docs/Web/HTML/Reference/Element/script#defer) or [asynchronous](/en-US/docs/Web/HTML/Reference/Element/script#async) scripts will be ignored and you'll get a message like "A call to `document.write()` from an asynchronously-loaded external script was ignored" in the error console.
