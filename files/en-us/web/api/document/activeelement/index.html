...
<p>The <strong><code>activeElement</code></strong> read-only property
of the {{domxref("Document")}} interface returns the {{domxref("Element")}} within the DOM that currently has focus.</p>
...
<p>Often <code>activeElement</code> will return a {{domxref("HTMLInputElement")}} or
  ...
  an {{HTMLElement("input")}} element, of <code>type</code> <code>"button"</code>,
  <code>"checkbox"</code>, or <code>"radio"</code>.</p>

<p>Typically a user can press the tab key to move the focus around the page among
  ...
  aren't text input elements are not typically focusable by default.</p>

<div class="note">
  <p><strong>Note:</strong> Focus (which element is receiving user input events) is not
    the same thing as selection (the currently highlighted part of the document). You can
    get the current selection using {{domxref("window.getSelection()")}}.</p>
</div>

<h2 id="Syntax">Syntax</h2>

<pre
  class="brush: js"><em>element</em> = <em>document</em>.activeElement</pre>

<h3 id="Value">Value</h3>

<p>The {{domxref('Element')}} which currently has focus, {{HTMLElement("body")}} or
  <code>null</code> if there is no focused element.</p>

<h2 id="Example">Example</h2>

<h3 id="HTML">HTML</h3>

<pre class="brush: html">&lt;p&gt;Select some text from one of the text areas below:&lt;/p&gt;
...
<pre class="brush: js">function onMouseUp(e) {
