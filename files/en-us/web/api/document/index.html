...
<p>The <strong><code>Document</code></strong> interface represents any web page loaded in the browser and serves as an entry point into the web page's content, which is the <a href="/en-US/docs/Web/API/Document_object_model/Using_the_W3C_DOM_Level_1_Core">DOM tree</a>.</p>

<p>The DOM tree includes elements such as {{HTMLElement("body")}} and {{HTMLElement("table")}}, among <a href="/en-US/docs/Web/HTML/Element">many others</a>. It provides functionality globally to the document, like how to obtain the page's URL and create new elements in the document.</p>

<p>{{InheritanceDiagram}}</p>

<p>The <code>Document</code> interface describes the common properties and methods for any kind of document. Depending on the document's type (e.g. <a href="/en-US/docs/Web/HTML">HTML</a>, <a href="/en-US/docs/Web/XML">XML</a>, SVG, …), a larger API is available: HTML documents, served with the <code>"text/html"</code> content type, also implement the {{DOMxRef("HTMLDocument")}} interface, whereas XML and SVG documents implement the {{DOMxRef("XMLDocument")}} interface.</p>
...
<dl>
 ...
 <dt>{{DOMxRef("Document.preferredStyleSheetSet")}} {{deprecated_inline}}{{ReadOnlyInline}}</dt>
 ...
 <dt>{{DOMxRef("Document.selectedStyleSheetSet")}} {{deprecated_inline}}</dt>
 <dd>Returns which style sheet set is currently in use.</dd>
 <dt>{{DOMxRef("Document.styleSheetSets")}} {{deprecated_inline}}{{ReadOnlyInline}}</dt>
...
<dl>
 ...
 <dt>{{DOMxRef("Document.enableStyleSheetsForSet()")}} {{deprecated_inline}}</dt>
 ...
 <dt>{{domxref("Document.getBoxQuads()")}} {{experimental_inline}}</dt>
 ...
 <dt>{{DOMxRef("Document.replaceChildren()")}}</dt>
 <dd>Replaces the existing children of a document with a specified new set of children.</dd>
...
<dl>
 ...
 <dd>Compiles an <code><a href="/en-US/docs/Web/API/XPathExpression">XPathExpression</a></code> which can then be used for (repeated) evaluations.</dd>
...
<dl>
 ...
 <dt>{{DOMxRef("Document.execCommand()")}} {{deprecated_inline}}</dt>
...
<dl>
 ...
 <dt><code><a href="/en-US/docs/Web/API/Document/fullscreenerror_event">fullscreenerror</a></code></dt>
...
<dl>
 ...
 <dd>Fired when an element captures a pointer using <code><a href="/en-US/docs/Web/API/Element/setPointerCapture">setPointerCapture()</a></code>.<br>
...
<h3 id="Firefox notes">Firefox notes</h3>

<p> Firefox defines some non-standard methods:</p>
...
<dl>
 ...
 <dt>{{DOMxRef("Document.loadOverlay()")}} {{deprecated_inline}}</dt>
...
<dl>
 ...
 <dd>Returns size in bytes of the document. Starting with Internet Explorer 11, that property is no longer supported. See <a href="https://msdn.microsoft.com/en-us/library/ms533752%28v=VS.85%29.aspx">MSDN</a>.</dd>
</dl>
