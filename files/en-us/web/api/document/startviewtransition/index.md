...
{{domxref("View Transitions API", "View Transitions API", "", "nocode")}} starts a new same-document (SPA) view transition and returns a {{domxref("ViewTransition")}} object to represent it.
