...
Long tasks that block the main thread for 50 ms or more cause, among other issues:
...
A long task is any uninterrupted period where the main UI thread is busy for 50 ms or longer. Common examples include:
