...
<p>You can collect statistics at various levels throughout the WebRTC hierarchy of objects. Most broadly, you can call {{domxref("RTCPeerConnection.getStats", "getStats()")}} on an {{domxref("RTCPeerConnection")}} to get statistics for the connection overall. In this example, a new {{domxref("RTCPeerConnection")}} is created, and then {{domxref( "setInterval()")}} is used to set the function <code>getConnectionStats()</code> to be called every second.</p>
...
<table class="standard-table">
 ...
 <tbody>
  ...
  <tr>
   ...
   <td>Statistics about a specific codec being used by streams being sent or received by this connection.</td>
   <td>{{domxref("RTCCodecStats")}}<br>
    {{domxref("RTCStats")}}</td>
  </tr>
  <tr>
  ...
  <tr>
   ...
   <td>
    ...
    {{domxref("RTCAudioSourceStats")}} <em>or</em> {{domxref("RTCVideoSourceStats")}}</td>
  </tr>
  <tr>
  ...
  <tr>
   ...
   <td>
    <p>Statistics related to a specific {{domxref("MediaStreamTrack")}}'s attachment to one of the connection's senders or receivers. The referenced object's type depends on the track type.</p>

    <div class="notecard note">
    <p><strong>Note:</strong> These statistics have all been moved to <code>media-source</code>, <code>sender</code>, <code>receiver</code>, <code>outbound-rtp</code>, and <code>inbound-rtp</code>, and this statistic category type is thus obsolete and shouldn't be used anymore.</p>
    </div>
   </td>
   <td>
    <ul>
