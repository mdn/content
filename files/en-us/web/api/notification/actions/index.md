...
> **Note:** Browsers typically limit the maximum number of actions they will display for a particular notification. Check the static {{DOMxRef("Notification.maxActions_static")}} property to determine the limit.
...
- {{DOMxRef("Notification.maxActions_static")}}
