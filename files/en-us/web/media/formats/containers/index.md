...
<table class="standard-table">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <p>Yes</p>
        <p>Firefox support for AV1 is disabled on Android ([Firefox bug 1672276](https://bugzilla.mozilla.org/show_bug.cgi?id=1672276)) and on Windows on ARM (enable by setting the preference <code>media.av1.enabled</code> to <code>true</code>).</p>
      </td>
      <td></td>
    </tr>
    <tr>
