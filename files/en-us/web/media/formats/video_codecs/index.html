 ...
 <tbody>
  <tr>
   <td>
    ...
    <p>A <a href="https://en.wikipedia.org/wiki/Moir%C3%A9_pattern"><strong>Moiré pattern</strong></a> is a large-scale spatial interference pattern produced when a pattern in the source image and the manner in which the encoder operates are slightly out of alignment spatially. The artifacts generated by the encoder then introduce strange, swirling effects in the source image's pattern upon decoding.</p>
   </td>
   <td><a href="moire-pattern.jpg"><img alt="" src="moire-pattern.jpg"></a></td>
  </tr>
  <tr>
   <td>
   ...
   <td><a href="staircase-effect.jpg"><img alt="" src="staircase-effect.jpg"></a></td>
  </tr>
  <tr>
   <td>
   ...
   <td><a href="stroboscopic-effect.gif"><img alt="" src="stroboscopic-effect.gif"></a></td>
  </tr>
 </tbody>
</table>
...
<p><a href="ringing-effects.png"><img alt="Example of the ringing effect" src="ringing-effects.png"></a></p>
...
<p><a href="posterize-effect.jpg"><img alt="" src="posterize-effect.jpg"></a></p>
...
<p><a href="contouring-effect.jpg"><img alt="Example of an image whose compression has introduced contouring" src="contouring-effect.jpg"></a></p>
...
<table class="standard-table">
 ...
 <tbody>
  <tr>
   ...
   <td><img alt="Differences between the frames after shifting two pixels right" src="motion-comp-compensated.jpg"></td>
  </tr>
  <tr>
...
<p>Aside from the lack of Safari support, VP9 is a good choice if you are able to use a WebM container and are able to provide a fallback video in a format such as AVC or HEVC for Safari users. This is especially true if you wish to use an open codec rather than a proprietary one. If you can't provide a fallback and are willing to sacrifice Safari compatibility, VP9 in WebM is a good option. Otherwise, you should probably consider a different codec.</p>
