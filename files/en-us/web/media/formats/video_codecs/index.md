  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        <p>Firefox only supports VP8 in MSE when no H.264 hardware decoder is available. Use {{domxref("MediaSource.isTypeSupported_static")}} to check for availability.</p>
      </td>
    </tr>
    <tr>
      <th scope="row">Container support</th>
    ...
    <tr>
      ...
      <td>
        ...
        <p>
          ...
          {{domxref("MediaSource.isTypeSupported_static")}} to check for availability.
        </p>
        <ul>
