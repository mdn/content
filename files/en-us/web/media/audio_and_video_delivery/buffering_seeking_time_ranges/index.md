...
![A simple audio player with play button, seek bar and volume control, with a bar below it. The bar has a green portion to show played video, and a dark gray bar to show how much has been buffered.](bufferedprogress.png)
