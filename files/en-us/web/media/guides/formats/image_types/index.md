    ...
    <tr>
      ...
      <td>
        <p>
          ...
          Note that when using AVIF, you should include fallbacks to formats with better browser support (i.e., using the <code><a href="/en-US/docs/Web/HTML/Reference/Element/picture">&#x3C;picture></a></code> element).<br />
          <strong>Support:</strong> Chrome, Edge, Firefox, Opera, Safari.
        </p>
      </td>
    </tr>
...
As support is not yet comprehensive (and has little historical depth) you should provide a fallback in [WebP](#webp_image), [JPEG](#jpeg_joint_photographic_experts_group_image) or [PNG](#png_portable_network_graphics) format using [the `<picture>` element](/en-US/docs/Web/HTML/Reference/Element/picture) (or some other approach).
...
> Additionally, their use for favicons has subsided in favor of using a PNG file and the {{HTMLElement("link")}} element, as described in [Providing icons for different usage contexts](/en-US/docs/Web/HTML/Reference/Element/link#providing_icons_for_different_usage_contexts).
...
Provide a fallback in either [JPEG](#jpeg_joint_photographic_experts_group_image) or [PNG](#png_portable_network_graphics) format, such as with [the `<picture>` element](/en-US/docs/Web/HTML/Reference/Element/picture).
