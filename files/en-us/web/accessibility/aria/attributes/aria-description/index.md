...
> **Note:** `aria-description` is still in W3C Editor's Draft for ARIA 1.3. For the time being, continue
> to use [`aria-describedby`](/en-US/docs/Web/Accessibility/ARIA/Attributes/aria-describedby), which has
> been supported since ARIA 1.1.
