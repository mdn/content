...
The `tabindex` attribute is required to enable focus. JavaScript is required to toggle the `aria-checked` state. And, if this checkbox is part of a submitable form, more JavaScript is required to set a name and a value.
