...
Instead of `aria-selected="true"`, include the [`checked`](/en-US/docs/Web/HTML/Reference/Element/input/checkbox#checked) attribute. The browser does the rest.
