...
The `aria-valuemin` attribute defines the minimum value allowed for range widgets. It is similar to the `min` attribute of {{HTMLElement('progress')}}, {{HTMLElement('meter')}}, and {{HTMLElement('input')}} of type [`range`](/en-US/docs/Web/HTML/Reference/Element/input/range), [`number`](/en-US/docs/Web/HTML/Reference/Element/input/number) and all the date-time types.
...
- [`<input type="range>` element `min` attribute](/en-US/docs/Web/HTML/Reference/Element/input/range#min)
