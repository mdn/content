...
It is preferable to use the HTML5 [`<nav>` element](/en-US/docs/Web/HTML/Reference/Element/nav) to define a navigation landmark. If the HTML5 nav element technique is not being used, use a `role="navigation"` attribute to define a navigation landmark.
