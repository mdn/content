...
- [HTML `<li>` element](/en-US/docs/Web/HTML/Reference/Element/li)
- [HTML `<ul>` element](/en-US/docs/Web/HTML/Reference/Element/ul)
- [HTML `<ol>` element](/en-US/docs/Web/HTML/Reference/Element/ol)
