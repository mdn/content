...
Most closely related to HTML's {{HTMLElement('fieldset')}} element, the `group` role is used to identify a set of user interface objects which, as compared to [`region`](/en-US/docs/Web/Accessibility/ARIA/Roles/region_role), is not intended to be included in the page's summary or table of contents. 
