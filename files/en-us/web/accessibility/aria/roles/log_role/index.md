...
- [`aria-label`](/en-US/docs/Web/Accessibility/ARIA/Attributes/aria-label) and `aria-labelledby`

  - : The `log` is required to have an accessible name.  Use [`aria-labelledby`](/en-US/docs/Web/Accessibility/ARIA/Attributes/aria-labelledby) if a visible label is present, otherwise use `aria-label`.
