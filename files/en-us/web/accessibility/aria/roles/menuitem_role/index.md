...
| -------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------ |
| {{SpecName("ARIA","#menuitem role","ARIA: menuitem role")}}                                             | {{Spec2('ARIA')}}                         |
| {{SpecName("ARIA Authoring Practices","#aria_lh_menuitem_role","menuitem role")}} | {{Spec2('ARIA Authoring Practices')}} |
