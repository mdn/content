...
<ul>
 <li><a href="/en-US/docs/Web/Accessibility/ARIA/forms/Basic_form_hints">Basic form hints</a>: Adding hints and descriptions for invalid or required fields</li>
 <li><a href="/en-US/docs/Web/Accessibility/ARIA/forms/alerts">Alerts</a>: Using alerts to provide client-side validation error messages</li>
