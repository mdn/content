...
> **Note:** To read the W3C definitions for Robust and its guidelines and success criteria, see <a href="https://www.w3.org/TR/WCAG21/#robust">Principle 4: Robust — Content must be robust enough that it can be interpreted reliably by a wide variety of user agents, including assistive technologies</a>.
...
> **Note:** Also see the WCAG description for <a href="https://www.w3.org/TR/WCAG21/#compatible">Guideline 4.1: Compatible: Maximize compatibility with current and future user agents, including assistive technologies</a>.
