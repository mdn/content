...
WCAG 2.2 is the most recent version of the guidelines and WCAG 3.0 is the working draft, but WCAG 2.1 and 2.0 is also widely used. WCAG is not meant to supersede previous versions, but WAI recommends using the most recent version of the guidelines to ensure the best possible accessibility for your website.
