  ...
  <tbody>
    <tr>
      ...
      <td>
        ...
        way to achieve this is to set the [`lang`](/en-US/docs/Web/HTML/Global_attributes#lang)
    ...
    <tr>
      ...
      <td>
        <p>
          ...
          [`lang`](/en-US/docs/Web/HTML/Global_attributes#lang) attribute on an element wrapped
    ...
    <tr>
      ...
      <td>
        ...
        <p>
          ...
          takes a [`title`](/en-US/docs/Web/HTML/Global_attributes#title) attribute that contains the
