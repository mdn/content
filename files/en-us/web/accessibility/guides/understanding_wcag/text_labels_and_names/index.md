...
See the [`<area>` element reference page](/en-US/docs/Web/HTML/Reference/Element/area) for a live interactive example.
...
You can see a live, interactive version of this example on the [`<fieldset>` reference page](/en-US/docs/Web/HTML/Reference/Element/fieldset).
...
Also, be sure you are using [heading elements](/en-US/docs/Web/HTML/Reference/Element/Heading_Elements) only for actual section headings, and not as a shortcut way to make text stand out. Screen reader users typically "skim" a page's headings, much like sighted users; non-heading text that is marked-up with heading elements can cause confusion.
