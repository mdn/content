...
Both the \<a> and \<img> are hyperlinks Also, both the \<div> and \<a> are hypertexts So the \<a> is both a hypertext and a hyperlink, because it contains text and is contained within text.
