...
Please read the [ARIA spec](https://www.w3.org/TR/wai-aria/#liveregions) or the [live region report](/en-US/docs/Web/Guide/AJAX/WAI_ARIA_Live_Regions_API_Support) to learn about ARIA live region markup.
