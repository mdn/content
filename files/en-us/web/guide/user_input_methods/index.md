...
In some cases, typically game development, you might need to access mouse events even when the cursor goes past the boundary of the browser or screen: the {{domxref("Pointer_Lock_API", "Pointer Lock API")}} gives you full control of the pointing device.
...
> **Note:** For a full tutorial and reference, read our {{domxref("Pointer_Lock_API", "Pointer Lock API")}} page.
...
- {{domxref("Pointer_Lock_API", "Pointer Lock API")}}
