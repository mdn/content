...
A 404 status code does not indicate whether the resource is temporarily or permanently missing. If a resource is permanently removed, use the {{HTTPStatus("410")}} (Gone) status instead of the 404 status.
...
You can display a custom 404 page to be more helpful to a user and provide guidance on what to do next. E.g., for the Apache server, you can specify a path to a custom 404 page in an `.htaccess` file: 
