...
The HTTP **`400 Bad Request`** status response code indicates that the server would not process the request due to something the server considered to be a client error.
