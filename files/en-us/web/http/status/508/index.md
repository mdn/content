...
This status was introduced as a fallback for cases where WebDAV clients do not support {{HTTPStatus(208)}} responses (when requests do not explicitly include a `DAV` header).
