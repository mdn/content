...
This can be sent by a server that is not configured to produce responses for the combination of [scheme](/en-US/docs/Web/URI#scheme) and [authority](/en-US/docs/Web/URI#authority) that are included in the request URI.
