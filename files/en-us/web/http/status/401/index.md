...
This error status is similar to the {{HTTPStatus("403 Forbidden")}} error status, except that in situations resulting in this error status, user authentication can allow access to the resource.
