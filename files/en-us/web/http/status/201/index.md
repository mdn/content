...
The HTTP **`201 Created`** status response code indicates that the HTTP request has led to the creation of a resource.
...
The newly-created items are returned in the body of the message, located at either the **URL of the request** or the URL in the value of the {{HTTPHeader("Location")}} header in the response.
