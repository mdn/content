...
In many cases, it is caused by a browser plugin (e.g., an ad blocker or privacy protector like [Facebook Container](https://addons.mozilla.org/en-US/firefox/addon/facebook-container/)) blocking the request.
