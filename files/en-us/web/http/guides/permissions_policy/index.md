...
- The {{htmlelement("iframe")}} [`allow`](/en-US/docs/Web/HTML/Reference/Element/iframe#attributes) attribute, to control feature usage only in specific {{htmlelement("iframe")}}s.
...
See [Permissions policies available to fenced frames](/en-US/docs/Web/HTML/Reference/Element/fencedframe#permissions_policies_available_to_fenced_frames) for more details.
