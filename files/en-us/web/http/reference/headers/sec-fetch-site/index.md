...
The HTTP **`Sec-Fetch-Site`** [fetch metadata request header](/en-US/docs/Web/HTTP/Guides/Fetch_metadata) indicates the relationship between a request initiator's origin and the origin of the requested resource.
