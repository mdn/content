...
individual documents, using the [`http-equiv`](/en-US/docs/Web/HTML/Reference/Element/meta#http-equiv) attribute on
...
that hostname by using the [`rel`](/en-US/docs/Web/HTML/Reference/Element/link#rel) attribute on the
