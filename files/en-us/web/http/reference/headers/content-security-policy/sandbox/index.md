...
resource similar to the {{HTMLElement("iframe")}} [`sandbox`](/en-US/docs/Web/HTML/Reference/Element/iframe#sandbox)
...
- [`sandbox`](/en-US/docs/Web/HTML/Reference/Element/iframe#sandbox) attribute on {{HTMLElement("iframe")}}
  elements
