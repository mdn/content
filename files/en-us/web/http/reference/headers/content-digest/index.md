...
The HTTP **`Content-Digest`** {{Glossary("request header", "request")}} and {{Glossary("response header")}} provides a {{Glossary("hash", "digest")}} calculated using a hashing algorithm applied to the message content.
