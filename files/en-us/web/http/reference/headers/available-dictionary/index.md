...
Clients can send an `Available-Dictionary` header when they support `dcb` or `dcz` encodings. The header is a colon-surrounded base-64 encoded SHA-256 {{glossary("Hash", "hash")}} of the dictionary contents.
...
- `<base64-hash>`
  - : A base-64 encoded SHA-256 {{glossary("Hash", "hash")}} of the dictionary contents.
