...
This is similar to the role played by `x` descriptors in the `<img>` [`srcset`](/en-US/docs/Web/HTML/Reference/Element/img#srcset) attribute to allow user agents to select a preferred image.
