...
The following example shows what a client may send when an [`<input type="file">`](/en-US/docs/Web/HTML/Reference/Element/input/file) element uses an image on form submission with `method="post"`:
