...
Here's an example of what an `Access-Control-Allow-Headers` header might look like.
...
Below, we see that `Access-Control-Allow-Headers` includes the headers that were requested.
