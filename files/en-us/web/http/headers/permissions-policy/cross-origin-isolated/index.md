...
The HTTP {{HTTPHeader("Permissions-Policy")}} header `cross-origin-isolated` directive controls whether the current document is treated as {{domxref("Window.crossOriginIsolated", "cross-origin isolated", "", 1)}}.
