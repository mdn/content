...
- {{httpheader('Permissions-Policy/layout-animations','layout-animations')}} {{Experimental_Inline}} {{Non-standard_Inline}}
  - : Controls whether the current document is allowed to show layout animations.
- {{httpheader('Permissions-Policy/legacy-image-formats','legacy-image-formats')}} {{Experimental_Inline}} {{Non-standard_Inline}}
...
- {{httpheader('Permissions-Policy/oversized-images','oversized-images')}} {{Experimental_Inline}} {{Non-standard_Inline}}
...
- {{httpheader('Permissions-Policy/sync-xhr', 'sync-xhr')}} {{Experimental_Inline}} {{Non-standard_Inline}}
...
SecureCorp Inc. wants to disable Microphone and Geolocation APIs in its application. It can do so by delivering the following HTTP response header to define a Permissions Policy:
