...
- \<range-start>
  - : An integer in the given unit indicating the start position (zero-indexed) of the request range.
- \<range-end>
  - : An integer in the given unit indicating the end position (zero-indexed) of the requested range.
- \<size>
