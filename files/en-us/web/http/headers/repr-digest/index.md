...
The **`Repr-Digest`** response or request header is the `Repr-` analogue to {{HTTPHeader("Content-Digest")}}.
...
A static file server may choose to compress an HTML page, resulting in differing {{HTTPHeader("Content-Digest")}} and **`Repr-Digest`**
```http
...
Repr-Digest: sha-256=:293wcr5IoFAsDCzdoDXR1Qppgf2yxOPO1bvQ3nZQtuI=:, unixsum=54809
Content-Digest: sha-256=:AEGPTgUMw5e96wxZuDtpfm23RBU3nFwtgY5fw4NYORo=:, sha-512=:U59TCCaZPA9Qio3CzHJVAgDnIAut53t5Sgkj2Gv4BvDd0b+OX9QpIdgWkzdXLmBsmvBrf3t5PBt+UrVK6k5dkw==:
...
