...
- {{HTTPHeader("Accept-Charset")}} {{deprecated_inline}}
  - : Advertised a client's supported {{glossary("character encoding", "character encodings")}}.
...
- {{HTTPHeader("DNT")}} {{deprecated_inline}}
...
- {{HTTPHeader("Observe-Browsing-Topics")}} {{experimental_inline}}
...
- {{HTTPHeader("Sec-Browsing-Topics")}} {{experimental_inline}}
