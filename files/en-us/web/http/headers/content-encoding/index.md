...
The **`Content-Encoding`** {{Glossary("representation header")}} lists any encodings that have been applied to the message {{glossary("HTTP content", "content")}}, and in what order.
