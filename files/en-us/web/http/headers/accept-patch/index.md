...
The HTTP **`Accept-Patch`** response header advertises which [media types](/en-US/docs/Web/HTTP/Basics_of_HTTP/MIME_types) the server is able to understand in a {{HTTPMethod("PATCH")}} request.
