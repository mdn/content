...
> [!NOTE]
> Only cooperative robots follow these rules, and a crawler still needs to access the resource to read them (see [Interaction with robots.txt](#interaction_with_robots.txt)).
