...
<div class="notecard note">
  <p>
    <strong>Note:</strong> Public Key Pinning mechanism was deprecated in favor of
    <a href="/en-US/docs/Web/Security/Certificate_Transparency">Certificate Transparency</a>
    and {{HTTPHeader("Expect-CT")}} header.
  </p>
</div>

<p>The HTTP <code><strong>Public-Key-Pins-Report-Only</strong></code> response header was
  used to send reports of pinning violation to the <code>report-uri</code> specified in
  ...
  modern browsers as support for HPKP has been removed. Use <a
    href="/en-US/docs/Web/Security/Certificate_Transparency">Certificate Transparency</a>
  and the {{HTTPHeader("Expect-CT")}} header instead.</p>

<p>For more information, see the {{HTTPHeader("Public-Key-Pins")}} header reference page
  and the <a href="/en-US/docs/Web/HTTP/Public_Key_Pinning">HTTP Public Key Pinning</a>
  article.</p>
...
<pre class="brush: html">Public-Key-Pins-Report-Only: pin-sha256="&lt;pin-value&gt;";
                             max-age=&lt;expire-time&gt;;
                             includeSubDomains;
                             report-uri="&lt;uri&gt;"</pre>
...
<dl>
  ...
  <dd>This directive is meaningless for the Public-Key-Pins-Report-Only header, it will be
    ignored by user agents and the header will not be cached.</dd>
  ...
  <dd>Pin validation failures are reported to the given URL. This directive should be used
    with this header, otherwise this header will be a no-op.</dd>
</dl>
