...
browser-compact: http. headers. Cross-Origin-Opener-Policy
---
...
- `same-origin-allow-popups`
  - : Retains references to newly opened windows or tabs that either don't set COOP or opt out of isolation by setting a COOP of `unsafe-none`.
- `same-origin`
