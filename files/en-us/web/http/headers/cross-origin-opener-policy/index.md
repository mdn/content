...
The HTTP **`Cross-Origin-Opener-Policy`** (COOP) response header allows you to ensure a top-level document does not share a {{glossary("Browsing context","browsing context group")}} with cross-origin documents.
