...
<p>The HTTP {{HTTPHeader("Feature-Policy")}} header <code>midi</code> directive controls whether the current document is allowed to use the <a href="/en-US/docs/Web/API/Web_MIDI_API">Web MIDI API</a>. When this policy is enabled, the {{jsxref("Promise")}} returned by {{domxref("Navigator.requestMIDIAccess()")}} will reject with a <code>DOMException</code>.</p>

<h2 id="Syntax">Syntax</h2>

<pre>Feature-Policy: midi &lt;allowlist&gt;;</pre>
