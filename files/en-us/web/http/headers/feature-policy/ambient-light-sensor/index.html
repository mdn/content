...
<p>The HTTP {{HTTPHeader('Feature-Policy')}} header <code>ambient-light-sensor</code> directive controls whether the current document is allowed to gather information about the amount of light in the environment around the device through the {{domxref('AmbientLightSensor')}} interface.</p>
