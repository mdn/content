...
> **Note:** As of [Firefox 41](/en-US/docs/Mozilla/Firefox/Releases/41), the `X-Content-Duration` header is no longer supported. See [Webkit bug 1160695](https://bugzilla.mozilla.org/show_bug.cgi?id=1160695) for more details.
