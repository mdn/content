...
In the example below a {{HTTPStatus("204")}} response code is used, because the response does not contain a body. A {{HTTPStatus("200")}} response that contains a body with information about the action could be used instead, for instance.
