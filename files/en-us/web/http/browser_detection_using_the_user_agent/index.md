...
| Presto-based (Opera 12-)                                          | `Opera Mobi/xyz` token [inside](https://blogs.opera.com/news/) the comment.                                                                                                                                                       | `Opera/9.80 (Android 2.3.3; Linux; Opera Mobi/ADR-1111101157; U; es-ES) Presto/2.9.201 Version/11.50`                                                            |
