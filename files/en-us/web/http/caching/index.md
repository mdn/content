...
For more information, see the documentation for your CDN, and consult the [service worker documentation here](https://developer.mozilla.org/en-US/docs/Web/API/Service_Worker_API).
