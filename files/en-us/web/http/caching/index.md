...
For more information, see the documentation for your CDN, and consult [service worker documentation](https://developer.mozilla.org/en-US/docs/Web/API/Service_Worker_API).
