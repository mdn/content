...
step-by-step: NOTE: Each step along the way is a valid "arrow function"
...
> **Note:** As shown above, the { brackets } and ( parentheses ) and "return"
...
to re-introduce brackets **PLUS the "return"** (arrow functions do not magically
...
Multiple params require parentheses. Multiline statements require body brackets
and return:
