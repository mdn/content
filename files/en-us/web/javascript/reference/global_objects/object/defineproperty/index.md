...
It is important to consider the way default values of attributes are applied. There is often a difference between using property accessors and using `Object.defineProperty()`, as shown in the example below.
