...
<dl>
 ...
 <dd>Creates a new <code>Uint16Array</code> object.</dd>
</dl>
...
<dl>
 ...
 <dd>Returns the string value of the constructor name. In the case of the <code>Uint16Array</code> type: "<code>Uint16Array</code>".</dd>
</dl>
...
<dl>
 ...
 <dd>Returns the number of elements held in the <code>Uint16Array</code>. Fixed at construction time and thus <strong>read only.</strong></dd>
</dl>
