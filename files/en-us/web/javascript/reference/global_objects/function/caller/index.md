...
A {{jsxref("Function")}} object's **`caller`** property returns the function that invoked the specified function. For {{jsxref("/en-US/docs/Web/JavaScript/Reference/Strict_mode", "strict")}}, async function and generator function callers, accessing the `caller` property throws an exception.
