...
The timestamp is always an integer number of milliseconds, so its resolution is limited to 1 ms in all contexts, which already satisfies certain basic security and privacy needs.
