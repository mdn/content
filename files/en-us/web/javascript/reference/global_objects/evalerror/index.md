...
The **`EvalError`** object indicates an error regarding the global {{jsxref("eval()")}} function. This exception is not thrown by JavaScript anymore, however the `EvalError` object remains for compatibility.
