...
This is _similar_ to the `r` prefix in Python, or the `@` prefix in C# for
string literals. (But it is not _identical_; see explanations in
...
[tag functions](/en-US/docs/Web/JavaScript/Reference/Template_literals#tagged_template_literals)).
