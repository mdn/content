...
> **Warning:** The `<font>` element itself has been removed in [HTML5](/en-US/docs/Glossary/HTML5) and shouldn't be used anymore. Instead web developers should use [CSS](/en-US/docs/Web/CSS) properties.
