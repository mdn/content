...
```js
const date1 = new Date(Date.UTC(2024, 0, 10, 10, 0, 0));
const date2 = new Date(Date.UTC(2024, 0, 10, 11, 0, 0));
const date3 = new Date(Date.UTC(2024, 0, 20, 10, 0, 0));
// > 'Wed, 10 Jan 2024 10:00:00 GMT'
// > 'Wed, 10 Jan 2024 11:00:00 GMT'
