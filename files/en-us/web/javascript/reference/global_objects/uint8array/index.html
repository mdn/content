...
<p>The <strong><code>Uint8Array</code></strong> typed array represents an array of 8-bit unsigned integers. The contents are initialized to <code>0</code>. Once established, you can reference elements in the array using the object's methods, or using standard array index syntax (that is, using bracket notation).</p>

<h2 id="Constructor">Constructor</h2>

<dl>
 <dt>{{jsxref("Global_Objects/Uint8Array/Uint8Array", "Uint8Array()")}}</dt>
 <dd>Creates a new <code>Uint8Array</code> object.</dd>
</dl>
...
<dl>
 ...
 <dd>Returns the string value of the constructor name. In the case of the <code>Uint8Array</code> type: "<code>Uint8Array</code>".</dd>
</dl>
...
<h3 id="Different_ways_to_create_a_Uint8Array">Different ways to create a Uint8Array</h3>
...
<ul>
 <li>A polyfill of <code>Uint8Array</code> is available in <a href="https://github.com/zloirock/core-js#ecmascript-typed-arrays"><code>core-js</code></a></li>
