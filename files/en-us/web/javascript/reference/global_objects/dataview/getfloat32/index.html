...
<p>The <strong><code>getFloat32()</code></strong> method gets a signed 32-bit float
  (float) at the specified byte offset from the start of the {{jsxref("DataView")}}.</p>
...
<dl>
  ...
  <dd>{{optional_inline}} Indicates whether the 32-bit float is stored in
...
<p>A signed 32-bit float number.</p>
...
<h3 id="Using_the_getFloat32_method">Using the getFloat32 method</h3>
