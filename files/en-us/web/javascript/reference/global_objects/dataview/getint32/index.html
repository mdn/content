...
<p>The <strong><code>getInt32()</code></strong> method gets a signed 32-bit integer (long)
  at the specified byte offset from the start of the {{jsxref("DataView")}}.</p>
...
<dl>
  ...
  <dd>The offset, in bytes, from the start of the view where to read the data.</dd>
...
<p>A signed 32-bit integer number.</p>
...
<h3 id="Using_the_getInt32_method">Using the getInt32 method</h3>
