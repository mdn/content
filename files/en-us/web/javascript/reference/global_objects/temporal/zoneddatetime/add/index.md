...
- Add/subtract the date portion of a duration using calendar arithmetic; in other words, add the same duration to its `PlainDateTime` using {{jsxref("Temporal/PlainDateTime/add", "Temporal.PlainDateTime.prototype.add()")}}, and take the date of the result. The result will automatically adjust for daylight saving time using the rules of this instance's `timeZone` field. For example, `2024-11-03T01:00:00-04:00[America/New_York]` plus one day is `2024-11-04T01:00:00-05:00[America/New_York]`, as if the day has 25 hours.
- Add/subtract the time portion of a duration using real-world time; in other words, add the same duration to its `Instant` using {{jsxref("Temporal/Instant/add", "Temporal.Instant.prototype.add()")}}, and take the time of the result in the same time zone. For example, `2024-11-03T01:00:00-04:00[America/New_York]` plus one hour is `2024-11-04T01:00:00-05:00[America/New_York]`.
- If a result is [ambiguous](/en-US/docs/Web/JavaScript/Reference/Global_Objects/Temporal/ZonedDateTime#ambiguity_and_gaps_from_local_time_to_utc_time) or invalid due to a time zone offset transition, the later of the two possible instants will be used for time-skipped transitions and the earlier of the two possible instants will be used for time-repeated transitions. This behavior corresponds to the default `disambiguation: "compatible"` option used in {{jsxref("Temporal/ZonedDateTime/from", "Temporal.ZonedDateTime.from()")}}. For example, `2024-03-09T02:05:00-05:00[America/New_York]` plus one day is supposedly `2024-03-10T02:05:00-05:00[America/New_York]`, but this time doesn't exist, so the wall-clock time one hour after, `2024-03-10T03:05:00-04:00[America/New_York]`, is returned.
