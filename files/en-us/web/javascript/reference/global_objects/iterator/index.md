...
- Iterator-Like objects such as [`NodeIterator`](/en-US/docs/Web/API/NodeIterator) can have similar behavior to built-in iterators but may not conform to the [iterator protocol](/en-US/docs/Web/JavaScript/Reference/Iteration_protocols#the_iterator_protocol) or even the [iterable protocol](/en-US/docs/Web/JavaScript/Reference/Iteration_protocols#the_iterable_protocol).
