...
See also [Block scoping rules with let, const, class, or function declaration in strict mode](/en-US/docs/Web/JavaScript/Reference/Statements/block) to get to know the details.
