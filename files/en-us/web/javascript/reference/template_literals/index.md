...
Template literals are sometimes informally called _template strings_, because one of their most common uses is to create strings by substituting placeholder variables and expressions and returning a string ([string interpolation](#string-interpolation)). 
