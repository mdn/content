...
`x` in the object you pass as the second argument, you won't get an error -- just unexpected results. It's also unclear what the actual intent of this code is.
