...
The **`import source`** declaration is similar to the regular [`import`](/en-US/docs/Web/JavaScript/Reference/Statements/import) declaration, except that it results in an object that represents the module's compiled source code. The module is [fetched](/en-US/docs/Web/JavaScript/Guide/Modules/Module_graph#loading_the_graph) and compiled, but its dependencies are not [loaded](/en-US/docs/Web/JavaScript/Guide/Modules/Module_graph#loading_the_graph) and it is not [linked](/en-US/docs/Web/JavaScript/Guide/Modules/Module_graph#linking_modules) or [evaluated](/en-US/docs/Web/JavaScript/Guide/Modules/Module_graph#evaluating_modules). It can be imperatively evaluated later, such as by using [dynamic import](/en-US/docs/Web/JavaScript/Reference/Operators/import) or [`WebAssembly.instantiate()`](/en-US/docs/WebAssembly/Reference/JavaScript_interface/instantiate_static).
