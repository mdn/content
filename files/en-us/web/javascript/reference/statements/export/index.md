...
`export from` supports all appendices that `import` supports — for example, [import assertions](/en-US/docs/Web/JavaScript/Reference/Statements/import/assertions):
