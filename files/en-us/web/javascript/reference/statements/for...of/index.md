...
You can use [destructuring](/en-US/docs/Web/JavaScript/Reference/Operators/Destructuring_assignment) to assign multiple local varibles, or use an object property like `for (x.y of iterable)` to have the iterated value assigned to an object property as well.
