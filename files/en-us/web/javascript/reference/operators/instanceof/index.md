...
For example, checking if a [`Node`](/en-US/docs/Web/API/Node) is a [`SVGElement`](/en-US/docs/Web/API/SVGElement) in a different context, you can use `myNode instanceof myNode.ownerDocument.defaultView.SVGElement`.
