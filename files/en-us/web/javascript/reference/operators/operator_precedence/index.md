...
matter. Observe how multiplication has higher precedence than addition and
...
`(a OP1 b) OP2 c`, while right-associativity (right-to-left) means it is
interpreted as `a OP1 (b OP2 c)`. Assignment operators are right-associative, so
you can write:
...
Looking at the code snippets above, `6 / 3 / 2` is the same as `(6 / 3) / 2`
