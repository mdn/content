...
You can pass a bare module name (also known as a bare module specifier) to `import.meta.resolve()`, as long as you have the corresponding [import map](/en-US/docs/Web/JavaScript/Guide/Modules#importing_modules_using_import_maps). For example, the following works in a browser:
...
The [`URL()`](/en-US/docs/Web/API/URL/URL) constructor accepts a second _base URL_ argument. When the first argument is a relative path and the base URL is [`import.meta.url`](/en-US/docs/Web/JavaScript/Reference/Operators/import.meta#value), the resulting URL is calculated similar to `import.meta.resolve()`:
...
- Deno implements [compatibility with browser behavior](https://deno.land/manual@v1.28.3/runtime/import_meta_api).
