...
> **Note:** Do not use >> 0 to truncate numbers to integers use [Math.trunc()](/en-US/docs/Web/JavaScript/Reference/Global_Objects/Math/trunc#using_bitwise_no-ops_to_truncate_numbers) instead.
