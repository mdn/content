...
- When importing statically significantly slows the loading of your code and increases your program's memory usage, and there is a low likelihood that you will need the code you are importing or that you will not need it until a later time.
