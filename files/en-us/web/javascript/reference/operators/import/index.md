...
- `options`
  - : An object containing import options, which correspond to the attributes at the end of the [`import`](/en-US/docs/Web/JavaScript/Reference/Statements/import) statement. The following key is recognized:
    - `assert`
