...
- If one side is a string, string-concatenation will performed. (The other size will [converted to a string](/en-US/docs/Web/JavaScript/Reference/Global_Objects/String#string_coercion).)
