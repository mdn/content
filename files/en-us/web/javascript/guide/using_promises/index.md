...
### Comparing task queues and microtasks
...
For more details, refer to differences between [tasks and microtasks](/en-US/docs/Web/API/HTML_DOM_API/Microtask_guide/In_depth#Comparing_task_queues_and_microtasks).
