...
JavaScript is a multi-paradigm, dynamic language with types and operators, standard built-in objects, and methods. Its syntax is based on the Java and C languages — many structures from those languages apply to JavaScript as well. JavaScript supports the object-oriented paradigm with [object prototypes](/en-US/docs/Web/JavaScript/Inheritance_and_the_prototype_chain) and classes. It also supports the functional paradigm since functions are [first-class](/en-US/docs/Glossary/First-class_Function), so they can be easily created via expressions and passed around like any other object.
