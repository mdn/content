...
When it is returned by the driver, either by [Get Timeouts](/en-US/docs/Web/WebDriver/Commands/GetTimeouts) or in the matched capabilities from [having created a session](/en-US/docs/Web/WebDriver/Commands/NewSession), all fields will be present.

## Examples

### Setting timeouts at session creation

You can override the default session timeouts by providing a [timeouts capabilities object](/en-US/docs/Web/WebDriver/Capabilities) when you start a new WebDriver session:
