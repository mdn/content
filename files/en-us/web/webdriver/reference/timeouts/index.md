...
You can override the default session timeouts by providing a [timeouts capabilities object](/en-US/docs/Web/WebDriver/Reference/Classic/Capabilities) when you start a new WebDriver session:
