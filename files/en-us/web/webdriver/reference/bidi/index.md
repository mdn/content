...
WebDriver BiDi is a bidirectional protocol for browser automation that provides event-driven communication between the local and remote ends.
...
This reference documents the commands, capabilities, modules, events, and errors available in WebDriver BiDi.

- [Commands](/en-US/docs/Web/WebDriver/Reference/BiDi/Commands)
...
- Events
  - : Notifications sent by the remote end signaling that something of interest has occurred.
- Errors
