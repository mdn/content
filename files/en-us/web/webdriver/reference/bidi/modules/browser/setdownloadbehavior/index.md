...
- `userContexts` {{optional_inline}}
  - : An array of strings where each string is the ID of a [user context](/en-US/docs/Web/WebDriver/Reference/BiDi/Modules/browser#user_contexts) in which to apply the download behavior.
