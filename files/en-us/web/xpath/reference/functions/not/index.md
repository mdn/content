...
- `expression`
  - : The expression is evaluated exactly as if it were passed as an argument to the [boolean()](/en-US/docs/Web/XPath/Reference/Functions/boolean) function.
...
- This function should behave similarly to the [boolean()](/en-US/docs/Web/XPath/Reference/Functions/boolean) function except that it returns the opposite value.
