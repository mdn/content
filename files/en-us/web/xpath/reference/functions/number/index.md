...
- A node-set is first converted to a string as if by a call to the [string()](/en-US/docs/Web/XPath/Reference/Functions/string) function and then converted in the same way as a string argument.
