...
- `node-set`
  - : The node-set to be evaluated. Each node in this node-set is evaluated as if it were passed to the [number()](/en-US/docs/Web/XPath/Reference/Functions/number) function, and a sum of the resulting numbers is returned.
