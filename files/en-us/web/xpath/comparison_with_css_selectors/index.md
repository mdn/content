...
| ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| [`ancestor`](/en-US/docs/Web/XPath/Axes#ancestor), [`parent`](/en-US/docs/Web/XPath/Axes#parent) or [`preceding-sibling`](/en-US/docs/Web/XPath/Axes#preceding-sibling) axis | {{CSSxRef(":has",":has()")}} selector                                                                                                                        |
...
| [`following-sibling`](/en-US/docs/Web/XPath/Axes#following-sibling) axis                                                                                                     | [Subsequent-sibling combinator](/en-US/docs/Web/CSS/Subsequent-sibling_combinator) or [Next-sibling combinator](/en-US/docs/Web/CSS/Next-sibling_combinator) |
