...
> **Note:** Support for XPath varies widely; it's supported reasonably well in Firefox (although there are no plans to improve support further), while other browsers implement it to a lesser extent, if at all. If you need a polyfill, you may consider [js-xpath](https://sourceforge.net/projects/js-xpath/files/js-xpath/1.0.0/xpath.js/download?use_mirror=versaweb&download=&failedmirror=nchc.dl.sourceforge.net) or [wicked-good-xpath](https://github.com/google/wicked-good-xpath).
