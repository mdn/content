...
- [`dir`](/en-US/docs/Web/MathML/Global_attributes/dir)
  ...
  - : An [[enumerated](/en-US/docs/Glossary/Enumerated)](/en-US/docs/Glossary/Enumerated) attribute indicating the directionality of the MathML element. It can have the following values:
