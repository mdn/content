...
2. Followed by an [`<unsigned-number>`](/en-US/docs/Web/MathML/Reference/Values#mathml-specific_types) (let's call it α below).
3. Optionally followed by a value (if absent, the specified value is interpreted as "100 times α percent").
   ...
   - A [namedspace constant](/en-US/docs/Web/MathML/Reference/Values#constants). The specified value is interpreted as α times the constant.
