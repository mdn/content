...
The **`<mfenced>`** [MathML](/en-US/docs/Web/MathML) element provides the possibility to add custom opening and closing brackets (such as parenthesis) and separators (such as commas or semicolons) to an expression.
