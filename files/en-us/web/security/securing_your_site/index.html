...
<dl>
 <dt><a href="/en/How_to_Turn_Off_Form_Autocompletion">How to turn off form autocompletion</a></dt>
 ...
 <dt><a href="/en-US/docs/CSS/Privacy_and_the_:visited_selector">Privacy and the :visited selector</a></dt>
...
<dl>
 <dt><a href="/en/Properly_Configuring_Server_MIME_Types">Properly configuring server MIME types</a></dt>
 ...
 <dt><a href="/en/Security/HTTP_Strict_Transport_Security">HTTP Strict Transport Security</a></dt>
 ...
 <dt>Access control by configuring a website</dt>
 <dd>It is the best way to secure your site. You can ignore specific IPs, restrict access to certain areas of website, protect different files, protect against image hotlinking, and a lot more. For example, .htaccess file is used for websites hosted on <a href="https://httpd.apache.org/">Apache HTTP Server</a>.</dd>
</dl>
