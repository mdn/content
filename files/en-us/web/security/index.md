...
- [HTTP X-Frame-Options](/en-US/docs/Web/HTTP/Reference/Headers/X-Frame-Options)
  - : The **`X-Frame-Options`** [HTTP](/en-US/docs/Web/HTTP) response header can be used to indicate whether a browser should be allowed to render a page in a [`<frame>`](/en-US/docs/Web/HTML/Reference/Element/frame), [`<iframe>`](/en-US/docs/Web/HTML/Reference/Element/iframe), [`<embed>`](/en-US/docs/Web/HTML/Reference/Element/embed) or [`<object>`](/en-US/docs/Web/HTML/Reference/Element/object). Sites can use this to avoid clickjacking attacks, by ensuring that their content is not embedded into other sites.
