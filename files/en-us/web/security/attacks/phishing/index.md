...
In particular, in the most common MFA implementations, the user has to enter their password and another code, called a [one-time password (OTP)](/en-US/docs/Web/Security/Authentication/OTP), which is unique to this login attempt. Two common variants are:
...
The strongest technical defense against phishing is to authenticate users using [passkeys](/en-US/docs/Web/Security/Authentication/Passkeys).
