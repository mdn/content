...
- [`<xsl:apply-templates>`](/en-US/docs/Web/XSLT/Reference/Element/apply-templates)
- [`<xsl:attribute>`](/en-US/docs/Web/XSLT/Reference/Element/attribute)
- [`<xsl:attribute-set>`](/en-US/docs/Web/XSLT/Reference/Element/attribute-set)
- [`<xsl:call-template>`](/en-US/docs/Web/XSLT/Reference/Element/call-template)
- [`<xsl:choose>`](/en-US/docs/Web/XSLT/Reference/Element/choose)
- [`<xsl:comment>`](/en-US/docs/Web/XSLT/Reference/Element/comment)
- [`<xsl:copy>`](/en-US/docs/Web/XSLT/Reference/Element/copy)
- [`<xsl:copy-of>`](/en-US/docs/Web/XSLT/Reference/Element/copy-of)
- [`<xsl:decimal-format>`](/en-US/docs/Web/XSLT/Reference/Element/decimal-format)
- [`<xsl:element>`](/en-US/docs/Web/XSLT/Reference/Element/element)
- [`<xsl:fallback>`](/en-US/docs/Web/XSLT/Reference/Element/fallback) _(not supported)_
- [`<xsl:for-each>`](/en-US/docs/Web/XSLT/Reference/Element/for-each)
- [`<xsl:if>`](/en-US/docs/Web/XSLT/Reference/Element/if)
- [`<xsl:import>`](/en-US/docs/Web/XSLT/Reference/Element/import) _(mostly supported)_
- [`<xsl:include>`](/en-US/docs/Web/XSLT/Reference/Element/include)
- [`<xsl:key>`](/en-US/docs/Web/XSLT/Reference/Element/key)
- [`<xsl:message>`](/en-US/docs/Web/XSLT/Reference/Element/message)
...
- [`<xsl:otherwise>`](/en-US/docs/Web/XSLT/Reference/Element/otherwise)
- [`<xsl:output>`](/en-US/docs/Web/XSLT/Reference/Element/output) _(partially supported)_
- [`<xsl:param>`](/en-US/docs/Web/XSLT/Reference/Element/param)
- [`<xsl:preserve-space>`](/en-US/docs/Web/XSLT/Reference/Element/preserve-space)
- [`<xsl:processing-instruction>`](/en-US/docs/Web/XSLT/Reference/Element/processing-instruction)
- [`<xsl:sort>`](/en-US/docs/Web/XSLT/Reference/Element/sort)
- [`<xsl:strip-space>`](/en-US/docs/Web/XSLT/Reference/Element/strip-space)
- [`<xsl:stylesheet>`](/en-US/docs/Web/XSLT/Reference/Element/stylesheet) _(partially supported)_
- [`<xsl:template>`](/en-US/docs/Web/XSLT/Reference/Element/template)
- [`<xsl:text>`](/en-US/docs/Web/XSLT/Reference/Element/text) _(partially supported)_
- [`<xsl:transform>`](/en-US/docs/Web/XSLT/Reference/Element/transform)
- [`<xsl:value-of>`](/en-US/docs/Web/XSLT/Reference/Element/value-of) _(partially supported)_
- [`<xsl:variable>`](/en-US/docs/Web/XSLT/Reference/Element/variable)
- [`<xsl:when>`](/en-US/docs/Web/XSLT/Reference/Element/when)
- [`<xsl:with-param>`](/en-US/docs/Web/XSLT/Reference/Element/with-param)
