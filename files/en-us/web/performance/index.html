...
<dl>
 ...
 <dd>The <a href="/en-US/docs/Web/API/Beacon_API">Beacon</a> interface schedules an asynchronous and non-blocking request to a web server.</dd>
...
<ul>
 ...
 <li><a href="/en-US/docs/Web/HTML/Link_types/preload">Preloading content with <code>rel="preload"</code></a> - <a href="https://w3c.github.io/preload/">(https://w3c.github.io/preload/ </a>)</li>
</ul>
...
<ul>
 ...
 <li><a href="/en-US/docs/Web/API/FetchEvent/preloadResponse">FetchEvent.preloadResponse</a></li>
