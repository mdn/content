...
1. In the URL bar, enter _about:config_; click the _I'll be careful, I promise!_ button to enter the config screen.
    ![Warning screen that changing setting can be risky, with button to accept risks. ](pic1.png)
...
3. Double-click the entry to set the value to `true`. Now you will be able to see three little purple boxes at the upper left corner of the Firefox window. The first box represents FPS.
    ![Entering the search term filters the options. Only the draw-fps is showing, set to true, which led to the numbers 001, 001, and 108, appearing in the upper left corner of the browser, above the chrome. ](pic2.png)
...
![Entering the search term filters the options. Only the async animations is showing, set to true. The 3 numbers in the upper left corner of the browser, above the chrome, have increased to 005, 003, and 108. ](pic3.png)
