...
For a text-heavy site such as a blog or a news site, the [First Contentful Paint](/en-US/docs/Glossary/First_contentful_paint) metric could reflect more closely the user behavior. (i.e., How fast can users start reading), which will inform file specific budgets (e.g., Font size), and their optimizations. (e.g., Using [font-display](/en-US/docs/Web/CSS/Reference/At-rules/@font-face/font-display) to improve [Perceived Performance](/en-US/docs/Learn_web_development/Extensions/Performance/Perceived_performance)).
