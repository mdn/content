...
See also: [Element Link](/en-US/docs/Web/HTML/Reference/Element/link).
...
The [`loading`](/en-US/docs/Web/HTML/Reference/Element/img#loading) attribute on an {{HTMLElement("img")}} element, or the [`loading`](/en-US/docs/Web/HTML/Reference/Element/iframe#loading) attribute on an {{HTMLElement("iframe")}}, can be used to instruct the browser to defer loading of images/iframes that are off-screen until the user scrolls near them.
