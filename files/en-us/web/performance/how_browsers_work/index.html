...
<p><img alt="Mobile requests go first to the cell tower, then to a central phone company computer before being sent to the internet" src="latency.jpg"></p>
...
<p><img alt="The DNS lookup, the TCP handshake, and 5 steps of the TLS handshake including clienthello, serverhello and certificate, clientkey and finished for both server and client." src="ssl.jpg"></p>
...
<p><img alt="TCP slow start" src="congestioncontrol.jpg"></p>
...
<p><img alt="The DOM tree for our sample code, showing all the nodes, including text nodes." src="dom.gif"></p>
...
<p><img alt="The main thread is occupied by the downloading, parsing and execution of a  javascript file - over a fast connection" src="visa_network.png"></p>
