...
- [Protected Audience API](/en-US/docs/Web/API/Protected_Audience_API): Use data from one app or site to help select an ad when the user is visiting another app or site.
- [Attribution Reporting API](/en-US/docs/Web/API/Attribution_Reporting_API): Enables measurement of ad impressions and conversions.
