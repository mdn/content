...
<p>To protect against redirect tracking Firefox periodically clears cookies and site data from trackers. We only clear this data from storage if the user is <a href="/en-US/docs/Web/Privacy/Storage_Access_Policy">blocking tracking cookies</a> (i.e., the <code>network.cookie.cookieBehavior</code> pref is set to <code>4</code>). Support for other cookie policies is tracked by <a href="https://bugzilla.mozilla.org/show_bug.cgi?id=1643045">Bug 1643045</a>.</p>
