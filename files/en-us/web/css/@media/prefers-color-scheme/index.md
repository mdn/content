...
To learn more about SVGs, see the [SVG documentation](/en-US/docs/Web/SVG) and for more information about iframes, see the [iframe documentation](/en-US/docs/Web/HTML/Reference/Element/iframe).
...
- [`<meta name="color-scheme">`](/en-US/docs/Web/HTML/Reference/Element/meta/name#color-scheme)
