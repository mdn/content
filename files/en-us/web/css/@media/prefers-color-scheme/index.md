...
SVGs must be used embedded (i.e., `<img src="circle.svg" alt="circle" />`) as opposed to [inlined in HTML](/en-US/docs/Web/SVG/Tutorials/SVG_from_scratch/SVG_In_HTML_Introduction#basic_example).
