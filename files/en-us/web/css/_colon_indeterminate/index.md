...
- [`<input type="checkbox">`](/en-US/docs/Web/HTML/Reference/Element/input/checkbox) elements whose [`indeterminate`](/en-US/docs/Web/API/HTMLInputElement/indeterminate) property is set to `true`
- [`<input type="radio">`](/en-US/docs/Web/HTML/Reference/Element/input/radio) elements, when all radio buttons with the same `name` value in the form are unchecked
...
- The [`<input type="checkbox">`](/en-US/docs/Web/HTML/Reference/Element/input/checkbox) element's [`indeterminate`](/en-US/docs/Web/API/HTMLInputElement/indeterminate) property
