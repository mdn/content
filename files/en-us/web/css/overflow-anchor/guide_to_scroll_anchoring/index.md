...
> **Note:** In [Firefox bug 1584285](https://bugzilla.mozilla.org/show_bug.cgi?id=1584285) the `layout.css.scroll-anchoring.suppressions.enabled` flag was added to Firefox Nightly in order to allow the disabling of these triggers.
