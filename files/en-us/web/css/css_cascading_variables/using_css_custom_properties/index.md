...
The selector given to the ruleset ([`<section>`](/en-US/docs/Web/HTML/Reference/Element/section) elements in the example above) defines the scope in which the custom property can be used.
