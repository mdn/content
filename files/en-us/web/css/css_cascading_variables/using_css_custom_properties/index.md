...
When the browser encounters an invalid `var()` substitution, then the [initial](/en-US/docs/Web/CSS/CSS_cascade/Value_processing#initial-value) or [inherited](/en-US/docs/Web/CSS/CSS_cascade/Inheritance) value of the property is used.
