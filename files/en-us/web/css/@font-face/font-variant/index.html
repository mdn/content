...
<p>The <strong><code>font-variant</code></strong> CSS <a href="/en-US/docs/Web/CSS/Shorthand_properties">shorthand property</a> allows you to set all the font variants for the fonts specified in the {{cssxref("@font-face")}} rule.</p>
...
<p>The following finds a local Open Sans font or imports it, and allows using the font for small-caps.</p>
...
<ul>
 ...
 <li>{{cssxref("@font-face/font-variant", "font-stretch")}}</li>
