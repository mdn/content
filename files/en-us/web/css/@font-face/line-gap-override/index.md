...
The **`line-gap-override`** [CSS](/zh-CN/docs/Web/CSS) descriptor for the {{cssxref("@font-face")}} at-rule defines the line-gap metric for the font. The line-gap metric is the font recommended line-gap or external leading.
