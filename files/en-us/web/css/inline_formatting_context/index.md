...
In the example below, inside the two ({{HTMLElement("div")}}) elements, each word participates in an inline formatting context. The boxes in the horizontal writing mode run horizontally, and the vertical writing mode boxes run vertically.
