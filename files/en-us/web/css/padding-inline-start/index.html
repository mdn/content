...
<p>The <strong><code>padding-inline-start</code></strong> <a href="/en-US/docs/Web/CSS">CSS</a> property defines the logical inline start padding of an element, which maps to a physical padding depending on the element's writing mode, directionality, and text orientation.</p>
...
<h3 id="Setting_inline_start_padding_for_vertical_text">Setting inline start padding for vertical text</h3>
