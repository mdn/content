...
> **Note:** The `border-spacing` property is equivalent to the deprecated `cellspacing`'s `<table>` attribute, except that it has an optional second value that can be used to set different horizontal and vertical spacing.
