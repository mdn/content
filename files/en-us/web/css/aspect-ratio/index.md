...
At least one of the box's sizes needs to be automatic in order for aspect ratio to have any effect. If neither width nor height is an automatic size, then the provided aspect ratio has no effect on the box's preferred sizes.
