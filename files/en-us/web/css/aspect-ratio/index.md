...
- `auto`
  ...
  - : [Replaced elements](/en-US/docs/Web/CSS/CSS_images/Replaced_element_properties) with an intrinsic aspect ratio use _that_ aspect ratio, otherwise the box has no preferred aspect ratio. Size calculations involving intrinsic aspect ratio always work with the content box dimensions.
