...
<p>The <strong><code>border-top-right-radius</code></strong> <a href="/en-US/docs/Web/CSS">CSS</a> property rounds the top-right corner of an element by specifying the radius (or the radius of the semi-major and semi-minor axes) of the ellipse defining the curvature of the corner.</p>
...
<ul>
	...
	<li>{{cssxref("border-bottom-right-radius")}}, {{cssxref("border-bottom-left-radius")}}, and {{cssxref("border-top-left-radius")}}</li>
</ul>
