...
- The [`dialog`](/en-US/docs/Web/HTML/Reference/Element/dialog) element opened with the `showModal()` API.
...
This example styles a modal dialog that opens when the "Update details" button is activated. This example has been built on top of the {{HTMLElement("dialog")}} element [example](/en-US/docs/Web/HTML/Reference/Element/dialog#handling_the_return_value_from_the_dialog).
...
- [`dialog`](/en-US/docs/Web/HTML/Reference/Element/dialog) element
