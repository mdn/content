...
The **`animation-timeline`** [CSS](/en-US/docs/Web/CSS) property specifies the timeline that is used to control the progress of a CSS animation. At the time of writing, three different types of timelines can be set via `animation-timeline`:
...
> **Note:** {{cssxref("animation-timeline")}} is included in the {{cssxref("animation")}} shorthand as a reset-only value. This means that including `animation` resets a previously-declared `animation-timeline` value to `auto`, but a specific value cannot be set via `animation`. When creating [CSS Scroll-driven Animations](/en-US/docs/Web/CSS/CSS_Scroll-driven_Animations), you need to declare `animation-timeline` after declaring any `animation` shorthand for it to take effect.
...
<div class="content">
  ...
  <p>Dolor sed viverra ipsum nunc aliquet. Sed sed risus pretium quam vulputate dignissim. Tortor aliquam nulla facilisi cras. A erat nam at lectus urna duis convallis convallis. Nibh ipsum consequat nisl vel pretium lectus. Sagittis aliquam malesuada bibendum arcu vitae elementum. Malesuada bibendum arcu vitae elementum curabitur vitae nunc sed velit.</p>
...
- Related named scroll progress timeline properties: {{cssxref("scroll-timeline-name")}}, {{cssxref("scroll-timeline-axis")}}, {{cssxref("scroll-timeline-attachment")}}, {{cssxref("scroll-timeline")}}
- Related named view progress timeline properties: {{cssxref("view-timeline-name")}}, {{cssxref("view-timeline-axis")}}, {{cssxref("view-timeline-attachment")}}, {{cssxref("view-timeline")}}, {{cssxref("view-timeline-inset")}}
