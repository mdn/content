...
The **computed value** of a [CSS](/en-US/docs/Web/CSS) property is the value that is transferred from parent to child during inheritance. It is calculated from the [specified value](/en-US/docs/Web/CSS/CSS_cascade/Value_processing#specified-value) by:
...
> [!NOTE]
> The {{domxref("Window.getComputedStyle", "getComputedStyle()")}} DOM API returns the [resolved value](/en-US/docs/Web/CSS/CSS_cascade/Value_processing#resolved-value), which may either be the computed value or the [used value](/en-US/docs/Web/CSS/CSS_cascade/Value_processing#used-value), depending on the property.
