...
The **used value** of a [CSS](/en-US/docs/Web/CSS) property is its value after all calculations have been performed on the [computed value](/en-US/docs/Web/CSS/CSS_cascade/Value_processing#computed-value).
...
> [!NOTE]
> The {{domxref("Window.getComputedStyle", "getComputedStyle()")}} DOM API returns the [resolved value](/en-US/docs/Web/CSS/CSS_cascade/Value_processing#resolved-value), which may either be the [computed value](/en-US/docs/Web/CSS/CSS_cascade/Value_processing#computed-value) or the used value, depending on the property.
