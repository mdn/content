...
<p>This property may be specified as:</p>

<ul>
 <li>either the keyword value <code>none</code></li>
 <li>or a <code>&lt;track-list&gt;</code> value</li>
 <li>or an <code>&lt;auto-track-list&gt;</code> value.</li>
</ul>
...
<dl>
 ...
 <dd>Is a keyword meaning that there is no explicit grid. Any rows will be implicitly generated and their size will be determined by the {{cssxref("grid-auto-rows")}} property.</dd>
 <dt><code>[linename]</code></dt>
 <dd>A <code><a href="/en-US/docs/">&lt;custom-ident&gt;</a></code> specifying a name for the line in that location. The ident may be any valid string other then the reserved words <code>span</code> and <code>auto</code>. Lines may have multiple names separated by a space inside the square brackets, for example <code>[line-name-a line-name-b]</code>.</dd>
 <dt>{{cssxref("&lt;length&gt;")}}</dt>
 <dd>Is a non-negative length.</dd>
 <dt>{{cssxref("&lt;percentage&gt;")}}</dt>
 <dd>Is a non-negative {{cssxref("percentage", "&lt;percentage&gt;")}} value, relative to the block size of the grid container. If the size of the grid container depends on the size of its tracks, then the percentage must be treated as <code>auto</code>.<br>
 ...
 <dd>Is a non-negative dimension with the unit <code>fr</code> specifying the track’s flex factor. Each <code>&lt;flex&gt;</code>-sized track takes a share of the remaining space in proportion to its flex factor. When appearing outside a <code>minmax()</code> notation, it implies an automatic minimum (i.e. <code>minmax(auto, &lt;flex&gt;)</code>).</dd>
...
<h3 id="Specifying_grid_row_sizes">Specifying grid row sizes</h3>
...
<p>{{EmbedLiveSample("Specifying_grid_row_sizes", "40px", "100px")}}</p>
