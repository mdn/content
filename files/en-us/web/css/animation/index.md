...
.sun {
  ...
  animation: 4s linear 0s infinite alternate rise, /* animation parameters are set independently */
...
.sun {
  ...
  */
  animation: 4s linear 0s infinite alternate rise, /* bounce 'overwrites' the transform set by rise */
