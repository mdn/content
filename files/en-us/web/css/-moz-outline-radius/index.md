...
- `dotted` or `dashed` radiused corners were rendered as solid until Firefox 50, [Firefox bug 382721](https://bugzilla.mozilla.org/show_bug.cgi?id=382721)
- Future versions of Gecko/Firefox may drop this property completely. See [Firefox bug 593717](https://bugzilla.mozilla.org/show_bug.cgi?id=593717).
