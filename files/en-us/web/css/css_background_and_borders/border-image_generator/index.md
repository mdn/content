...
tags:
  ...
  - Tools
---
This tool can be used to generate CSS3 {{cssxref("border-image")}} values.

<div id="Border_Image_Generator"><pre class="brush: html hidden">    &#x3C;div id="container">
...
&#x3C;/div>
    &#x3C;/div></pre><pre class="brush: css hidden">/\* GRID OF TWELVE
...
#remote-url:focus {
box-shadow: 0px 0px 3px -1px #379B4A; /_#68ACE8; _/
