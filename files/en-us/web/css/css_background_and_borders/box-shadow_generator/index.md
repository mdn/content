...
<div id="box-shadow_generator"><pre class="brush: html hidden">&#x3C;div id="container">
...
</pre><pre class="brush: css hidden">/*  GRID OF TWELVE
 * ========================================================================== */
...
/_ container with shadows stacks _/
#stack_container {
height: 400px;
overflow: hidden;
position: relative;
...
{{ EmbedLiveSample('box-shadow_generator', '100%', '1000px', '') }}
