...
<p>The <strong><code>scaleY()</code></strong> <a href="/en-US/docs/Web/CSS">CSS</a> <a
    href="/en-US/docs/Web/CSS/CSS_Functions">function</a> defines a transformation that resizes an element along the
  y-axis (vertically). Its result is a {{cssxref("&lt;transform-function&gt;")}} data type.</p>
...
<div class="note">
  <p><strong>Note:</strong> <code>scaleY(sy)</code> is equivalent to
    <code><a href="/en-US/docs/Web/CSS/transform-function/scale()">scale</a>(1, sy)</code> or
    <code><a href="/en-US/docs/Web/CSS/transform-function/scale3d()">scale3d</a>(1, sy, 1)</code>.
  </p>
...
<dl>
  <dt><code>s</code></dt>
  <dd>Is a {{cssxref("&lt;number&gt;")}} representing the scaling factor to apply on the ordinate of each point of the
    element.</dd>
</dl>
