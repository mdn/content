...
<p>The <strong><code>rotateX()</code></strong> <a href="/en-US/docs/Web/CSS">CSS</a> <a
...
<div class="note">
  <p><strong>Note:</strong> <code>rotateX(a)</code> is equivalent to
    <code><a href="/en-US/docs/Web/CSS/transform-function/rotate3d">rotate3d</a>(1, 0, 0, a)</code>.
  </p>
</div>
...
<p>The amount of rotation created by <code>rotateX()</code> is specified by an {{cssxref("&lt;angle&gt;")}}. If
  positive, the movement will be clockwise; if negative, it will be counter-clockwise.</p>

<pre class="brush: css">rotateX(<var>a</var>)
</pre>
