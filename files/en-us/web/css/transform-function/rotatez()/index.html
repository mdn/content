...
<p>The <strong><code>rotateZ()</code></strong> <a href="/en-US/docs/Web/CSS">CSS</a> <a
    href="/en-US/docs/Web/CSS/CSS_Functions">function</a> defines a transformation that rotates an element around the
  z-axis without deforming it. Its result is a {{cssxref("&lt;transform-function&gt;")}} data type.</p>

<div>{{EmbedInteractiveExample("pages/css/function-rotateZ.html")}}</div>

<p>The axis of rotation passes through an origin, defined by the {{ cssxref("transform-origin") }} CSS property.</p>

<div class="note">
  <p><strong>Note:</strong> <code>rotateZ(a)</code> is equivalent to
    <code><a href="/en-US/docs/Web/CSS/transform-function/rotate">rotate</a>(a)</code> or
    <code><a href="/en-US/docs/Web/CSS/transform-function/rotate3d">rotate3d</a>(0, 0, 1, a)</code>.
  </p>
</div>
...
<p>The amount of rotation created by <code>rotateZ()</code> is specified by an {{cssxref("&lt;angle&gt;")}}. If
  positive, the movement will be clockwise; if negative, it will be counter-clockwise.</p>

<pre class="brush: css">rotateZ(<var>a</var>)
</pre>
