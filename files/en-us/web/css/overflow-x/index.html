...
<p>The <strong><code>overflow-x</code></strong> <a href="/en-US/docs/Web/CSS">CSS</a> property sets what shows when content overflows a block-level element's left and right edges. This may be nothing, a scroll bar, or the overflow content.</p>
...
<p>The <code>overflow-x</code> property is specified as a single keyword chosen from the list of values below.</p>

<h3 id="Values">Values</h3>

<dl>
 <dt><code>visible</code></dt>
 <dd>Content is not clipped and may be rendered outside the padding box's left and right edges. If {{cssxref("overflow-y")}} is <code>hidden</code>, <code>scroll</code> or <code>auto</code> and this property is <code>visible</code>, it will implicitly compute to <code>auto</code>.</dd>
