...
<h3 id="Dashed_border_with_vertical_text">Dashed border with vertical text</h3>
...
<ul>
 <li>This property maps to one of the physical border properties: {{cssxref("border-top-style")}}, {{cssxref("border-right-style")}}, {{cssxref("border-bottom-style")}}, and {{cssxref("border-left-style")}}.</li>
