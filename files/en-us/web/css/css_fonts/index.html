...
<p><strong>CSS Fonts</strong> is a module of CSS that defines font-related properties and how font resources are loaded. It lets you define the style of a font, such as its family, size and weight, line height, and the glyph variants to use when multiple are available for a single character.</p>

<h2 id="Basic_example">Basic example</h2>

<p>The following example shows a simple use of basic font properties to style a paragraph of text.</p>
...
<h2 id="Variable_fonts_examples">Variable fonts examples</h2>

<p>You can find a number of variable fonts examples at <a href="https://v-fonts.com/">v-fonts.com</a> and <a href="https://www.axis-praxis.org/">axis-praxis.org</a>; see also our <a href="/en-US/docs/Web/CSS/CSS_Fonts/Variable_Fonts_Guide">Variable fonts guide</a> for more information and usage information.</p>
