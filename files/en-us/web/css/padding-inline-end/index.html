...
<p>The <strong><code>padding-inline-end</code></strong> <a href="/en-US/docs/Web/CSS">CSS</a> property defines the logical inline end padding of an element, which maps to a physical padding depending on the element's writing mode, directionality, and text orientation.</p>
...
<h3 id="Setting_inline_end_padding_for_vertical_text">Setting inline end padding for vertical text</h3>
...
<p>{{EmbedLiveSample("Setting_inline_end_padding_for_vertical_text", 140, 140)}}</p>
