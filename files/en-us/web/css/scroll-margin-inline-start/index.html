...
<dl>
 ...
 <dd>An outset from the inline start edge of the scroll container.</dd>
</dl>
...
<p>This means that when scrolling past the middle child elements, the scrolling will snap to <code>1rem</code> outside the inline start edge of the second <code>&lt;div&gt;</code>, and <code>2rems</code> outside the inline start edge of the third <code>&lt;div&gt;</code>.</p>
