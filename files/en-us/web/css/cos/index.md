...
- `A`
  - : The argument specified as a {{cssxref("&lt;number&gt;")}} or an {{cssxref("&lt;angle&gt;")}}. When specifiing unitless numbers they are interpreted as a number of radians, representing an {{cssxref("&lt;angle&gt;")}}. If `A` is `infinity`, `-infinity`, or `NaN`, the result is `NaN`.
