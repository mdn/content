...
<div class="notecard note">
  <p><strong>Note:</strong> This document is an explanation of an early stage specification that is attracting a lot of interest from web developers. The examples and syntax below should be seen as an explainer to an evolving specification, in order to encourage experimentation and feedback. Once the specification matures, this will be the location of the full MDN documentation for container queries.</p>
</div>
...
<ul>
  ...
  <li><a href="https://github.com/sturobson/Awesome-Container-Queries">Collection of Container Queries articles</a></li>
</ul>
