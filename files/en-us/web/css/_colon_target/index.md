...
For example, the following URL has a fragment identifier (denoted by the _#_ sign) that marks the element with [`id`](/en-US/docs/Web/HTML/Global_attributes/id) `setup` as the document's target element:
