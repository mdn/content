...
The mask image can be a [CSS gradient](/en-US/docs/Web/CSS/Guides/Images/Using_CSS_gradients), an [imported image](/en-US/docs/Web/CSS/CSS_masking/Masking#with_imported_images) (such as a PNG, SVG, etc.), or an SVG {{svgelement("mask")}} element.
