...
<p>You can try this out in the live example below. Change <code>writing-mode</code> from <code>vertical-rl</code> to <code>horizontal-tb</code> on <code>.grid</code> to see how the different properties change the layout.</p>
