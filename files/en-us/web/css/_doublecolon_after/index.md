...
> **Note:** The pseudo-elements generated by `::before` and `::after` are [contained by the element's formatting box](https://www.w3.org/TR/CSS2/generate.html#before-after-content), and thus don't apply to [replaced](/en-US/docs/Web/CSS/Replaced_element) and [empty](/en-US/docs/Glossary/Empty_element) elements such as {{HTMLElement("img")}}, or to {{HTMLElement("input")}} elements.
