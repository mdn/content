...
> [!NOTE]
> [Selectors Level 3](https://drafts.csswg.org/selectors-3/#first-line) introduced the double-colon notation (`::`) to distinguish [pseudo-elements](/en-US/docs/Web/CSS/Pseudo-elements) from the single-colon (`:`) [pseudo-classes](/en-US/docs/Web/CSS/Reference/Selectors/Pseudo-classes). Browsers accept both `::first-line` and `:first-line`, which was introduced in CSS2.
