...
The **`::-webkit-inner-spin-button`** [CSS](/zh-CN/docs/Web/CSS) pseudo-element is used to style the inner part of the spinner button of number picker input elements.
