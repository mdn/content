...
The **`symbols()`** [CSS](/zh-CN/docs/Web/CSS) function enables defining counter styles inline, directly as a value of properties such as {{cssxref("list-style")}}, providing a less powerful but simpler alternative to the {{cssxref("@counter-style")}} method of defining a counter style.
