...
<p>The <strong><code>hsl()</code></strong> functional notation expresses a given color according to its hue, saturation, and lightness components. An optional alpha component represents the color's transparency.</p>

<div class="notecard note">
  <p><strong>Note:</strong> CSS Colors Level 4 made some changes to <code>hsl()</code>. In browsers that support the standard {{cssxref("color_value/hsla()","hsla()")}} is an alias for <code>hsl()</code>, they accept the same parameters and behave the same way.</p>
...
<pre class="brush: css">hsl(100, 100%, 50%) /* #5f0 */
...
<p>{{Compat("css.types.color.hsl")}}</p>
...
<p>{{Compat("css.types.color.hsl_function_accepts_alpha")}}</p>
