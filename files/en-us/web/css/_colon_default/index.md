...
- Related HTML elements: {{htmlelement("button")}}, [`<input type="checkbox">`](/en-US/docs/Web/HTML/Reference/Element/input/checkbox), [`<input type="radio">`](/en-US/docs/Web/HTML/Reference/Element/input/radio), and {{htmlelement("option")}}
