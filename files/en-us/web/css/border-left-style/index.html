...
<p>The <strong><code>border-left-style</code></strong> <a href="/en-US/docs/Web/CSS">CSS</a> property sets the line style of an element's left {{cssxref("border")}}.</p>
...
<h3 id="Setting_border-left-style">Setting border-left-style</h3>
