...
<p>The <strong><code>minmax()</code></strong> <a href="/en-US/docs/Web/CSS/CSS_Functions">CSS function</a> defines a size range greater than or equal to <var>min</var> and less than or equal to <var>max</var>. It is used with <a href="/en-US/docs/Web/CSS/CSS_Grid_Layout">CSS Grids</a>.</p>
...
<pre class="brush: css">/* &lt;inflexible-breadth&gt;, &lt;track-breadth&gt; values */
minmax(200px, 1fr)
minmax(400px, 50%)
minmax(30%, 300px)
...
<ul>
 ...
 <li><a href="/en-US/docs/Web/CSS/CSS_Grid_Layout/CSS_Grid_Logical_Values_and_Writing_Modes">CSS grids, logical values and writing modes</a></li>
 <li>
  <p>Video tutorial: <em><a href="https://gridbyexample.com/video/series-minmax/">Introducing minmax()</a></em></p>
 </li>
</ul>
