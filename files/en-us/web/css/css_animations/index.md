...
i {
  ...
  background-image: linear-gradient(
      ...
      white 57%,
      transparent 57%
    ), linear-gradient(135deg, transparent 43%, white 43%, white 57%, transparent
        57%);
}
i:nth-of-type(4n) {
...
.cloud {
  ...
  box-shadow: 5px 15px 15px white, -5px 15px 15px white,
    0 20px 20px rgba(125 125 125 / 0.5);
  animation: clouds ease 5s alternate infinite 0.2s, wind ease-out 4s alternate
      infinite;
}
.ground {
  bottom: 0;
