...
- Whether the container is positioned via {{cssxref("position", "position: sticky", "#sticky")}} and stuck to a boundary of a {{glossary("scroll container", "scrolling container")}}.
