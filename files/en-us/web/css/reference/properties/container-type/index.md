...
[Container size queries](/en-US/docs/Web/CSS/Guides/Containment/Container_size_and_style_queries#container_size_queries) allow you to selectively apply CSS rules to a container's descendants based on a size condition such as a maximum or minimum dimension, aspect ratio, or orientation.
...
- Whether the container is positioned via [`position: sticky`](/en-US/docs/Web/CSS/Reference/Properties/display) and stuck to a boundary of a {{glossary("scroll container", "scrolling container")}}.
