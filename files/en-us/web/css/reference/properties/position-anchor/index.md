...
> [!NOTE]
> The anchor positioning CSS for this demo currently doesn't work in Firefox as the slider's thumb, targeted via the {{cssxref("::-moz-range-thumb")}} pseudo-element, is currently not anchorable (see [Firefox bug 1993699](https://bugzil.la/1993699)).
