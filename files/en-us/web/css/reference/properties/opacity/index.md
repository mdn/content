...
When [transitioning](/en-US/docs/Web/CSS/Guides/Transitions) the opacity of elements as you add them to the page when content was formerly hidden with {{cssxref("visibility", "visibility: hidden", "#hidden")}}, {{cssxref("display", "display: none", "#none")}}, or {{cssxref("content-visibility", "content-visibility: hidden", "#hidden")}}, you need to include both a [`@starting-style`](/en-US/docs/Web/CSS/Reference/At-rules/@starting-style) and {{cssxref("transition-behavior", "transition-behavior: allow-discrete", "#allow-discrete")}}:
