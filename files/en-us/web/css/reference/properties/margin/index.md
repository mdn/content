...
A more common method to center an element horizontally is by setting `display: flex;` and {{cssxref("justify-content", "justify-content: center;")}} on a container, which [centers its flex item](/en-US/docs/Web/CSS/Guides/Flexible_box_layout/Aligning_items) children.
