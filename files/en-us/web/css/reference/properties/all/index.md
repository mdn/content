...
- {{cssxref("initial")}}
  - : Specifies that all the element's properties should be changed to their [initial values](/en-US/docs/Web/CSS/Guides/Cascade/Value_processing#initial_value).
- {{cssxref("inherit")}}
