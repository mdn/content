...
The **`-webkit-text-stroke`** [CSS](/en-US/docs/Web/CSS) [shorthand](/en-US/docs/Web/CSS/Guides/Cascade/Shorthand_properties) property specifies the [width](/en-US/docs/Web/CSS/Reference/Values/length) and [color](/en-US/docs/Web/CSS/Reference/Values/color_value) of strokes for text characters.
