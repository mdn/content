...
Because {{cssxref(":where()")}} has zero [specificity](/en-US/docs/Web/CSS/Guides/Cascade/Specificity), bare selectors and `&` add zero weight. The specificity weight is determined by the rest of the selector.
