...
The **`inherits`** [CSS](/en-US/docs/Web/CSS) descriptor of the {{cssxref("@property")}} [at-rule](/en-US/docs/Web/CSS/Guides/Syntax/At-rules) controls whether or not the registered [CSS custom property](/en-US/docs/Web/CSS/Reference/Properties/--*) inherits by default.
