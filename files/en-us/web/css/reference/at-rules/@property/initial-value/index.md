...
The **`initial-value`** descriptor of the {{cssxref("@property")}} [at-rule](/en-US/docs/Web/CSS/CSS_syntax/At-rules) specifies the initial value for the registered [CSS custom property](/en-US/docs/Web/CSS/Reference/Properties/--*).
