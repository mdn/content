...
The **`-webkit-device-pixel-ratio`** is a non-standard Boolean [CSS](/en-US/docs/Web/CSS) [media feature](/en-US/docs/Web/CSS/Reference/At-rules/@media#media_features) which is an alternative to the standard [`resolution`](/en-US/docs/Web/CSS/Reference/At-rules/@media/resolution) media feature.

> [!NOTE]
> If possible, use the [`resolution`](/en-US/docs/Web/CSS/Reference/At-rules/@media/resolution) media feature query instead, which is a standard media feature. While this prefixed media feature is a WebKit feature, other browser engines may support it. See [browser compatibility](#browser_compatibility) below.
