...
The **`pointer`** [CSS](/en-US/docs/Web/CSS) [media feature](/en-US/docs/Web/CSS/Reference/At-rules/@media#media_features) tests whether the user has a pointing device (such as a mouse), and if so, how accurate the _primary_ pointing device is.

> [!NOTE]
> If you want to test the accuracy of _any_ pointing device, use [`any-pointer`](/en-US/docs/Web/CSS/Reference/At-rules/@media/any-pointer) instead.
...
- [The `any-pointer` media feature](/en-US/docs/Web/CSS/Reference/At-rules/@media/any-pointer)
