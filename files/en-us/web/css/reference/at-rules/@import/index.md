...
For example, the code below shows an `@import` that is conditional on both [child combinators](/en-US/docs/Web/CSS/Reference/Selectors/Child_combinator) (`selector()`) and the `font-tech()` function:
