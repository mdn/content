...
When a `<url>` references an external resource, the resource is subject to [Cross-origin restrictions](https://developer.mozilla.org/en-US/docs/Web/HTTP/Guides/CORS).
