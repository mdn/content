...
- The keyword [`round`](/en-US/docs/Web/CSS/Reference/Values/basic-shape/polygon#round_length) followed by a {{cssxref("length")}} value, separated by a space. This specifies that the polygon should have rounded corners, with the `<length>` specifying the corner radius.
