...
The **`inherit`** [CSS](/en-US/docs/Web/CSS) keyword causes the element to take the [computed value](/en-US/docs/Web/CSS/Guides/Cascade/Value_processing#computed_value) of the property from its parent element. It can be applied to any CSS property, including the CSS shorthand property {{cssxref("all")}}.
