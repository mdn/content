...
This can result in some complex expressions. For example, here we are calculating the first two channels of an {{cssxref("rgb()")}} color proportionate to the same width proportion as before:
