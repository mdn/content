...
The **`<calc-sum>`** [CSS](/en-US/docs/Web/CSS) [data type](/en-US/docs/Web/CSS/Reference/Values/Data_types) represents an expression which performs a calculation in any [CSS math function](/en-US/docs/Web/CSS/Reference/Values/Functions#math_functions). The expression executes a basic arithmetic operation of addition and subtraction between two values.
