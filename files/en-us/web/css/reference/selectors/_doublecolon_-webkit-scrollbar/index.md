...
> [!NOTE]
> If {{cssxref("scrollbar-color")}} and {{cssxref("scrollbar-width")}} are supported and their _computed_ value is anything other than `auto`, they will override `::-webkit-scrollbar-*` styling.
