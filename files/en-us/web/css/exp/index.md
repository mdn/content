...
```css
/* A <number> value */
width: calc(100px * exp(-1)); /*  36px */
width: calc(100px * exp(0));  /* 100px */
width: calc(100px * exp(1));  /* 217px */
```
...
The `exp()` function can be used to {{CSSxRef("transform-function/rotate", "rotate")}} elements as it return an {{CSSxRef("&lt;angle&gt;")}}.
...
div.box-1 {
  transform: rotate(1turn * exp(-1));    // 0.3678794411714423turn
}
div.box-2 {
  transform: rotate(1turn * exp(-0.75)); // 0.4723665527410147turn
}
div.box-3 {
  transform: rotate(1turn * exp(-0.5));  // 0.6065306597126334turn
}
div.box-4 {
  transform: rotate(1turn * exp(-0.25)); // 0.7788007830714049turn
}
div.box-5 {
  transform: rotate(1turn * exp(0));     // 1turn
}
```
