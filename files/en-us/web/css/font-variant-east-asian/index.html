...
<dl>
 ...
 <dd>This keyword forces the use of special glyphs for ruby characters. As these are usually smaller, font creators often designs specific forms, usually slightly bolder to improve the contrast. This keyword corresponds to the OpenType values <code>ruby</code>.</dd>
 <dt><code>&lt;east-asian-variant-values&gt;</code></dt>
 <dd>These values specify a set of logographic glyph variants which should be used for display. Possible values are:
 ...
 <dd>These values control the sizing of figures used for East Asian characters. Two values are possible:
 <ul>
  <li><code>proportional-width</code> activating the set of East Asian characters which vary in width. It corresponds to the OpenType values <code>pwid</code>.</li>
  <li><code>full-width</code> activating the set of East Asian characters which are all of the same, roughly square, width metric. It corresponds to the OpenType values <code>fwid</code>.</li>
 </ul>
 </dd>
</dl>
...
<h3 id="Setting_East_Asian_glyph_variants">Setting East Asian glyph variants</h3>

<p>This example require font "Yu Gothic" installed in your OS, other fonts may not support OpenType features.</p>
