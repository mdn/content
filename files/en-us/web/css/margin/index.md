...
The top and bottom margins have no effect on _non-[replaced](/en-US/docs/Web/CSS/CSS_images/Replaced_element_properties)_ inline elements, such as {{HTMLElement("span")}} or {{HTMLElement("code")}}.
