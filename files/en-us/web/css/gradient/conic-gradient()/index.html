...
<p><strong>Note:</strong> Why is it called a "conic" gradient? If the color stops are much lighter on one side than the other, it can look like a cone from above.</p>
</div>
