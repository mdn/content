...
<p>The <strong><code>calc()</code></strong> <a href="/en-US/docs/Web/CSS">CSS</a> <a href="/en-US/docs/Web/CSS/CSS_Functions">function</a> lets you perform calculations when specifying CSS property values. It can be used anywhere a {{cssxref("&lt;length&gt;")}}, {{cssxref("&lt;frequency&gt;")}}, {{cssxref("&lt;angle&gt;")}}, {{cssxref("&lt;time&gt;")}}, {{cssxref("&lt;percentage&gt;")}}, {{cssxref("&lt;number&gt;")}}, or {{cssxref("&lt;integer&gt;")}} is allowed.</p>
...
<dl>
 ...
 <dd>Subtraction.</dd>
 <dt><code>*</code></dt>
 <dd>Multiplication. At least one of the arguments must be a {{cssxref("&lt;number&gt;")}}.</dd>
 <dt><code>/</code></dt>
 <dd>Division. The right-hand side must be a {{cssxref("&lt;number&gt;")}}.</dd>
</dl>

<p>The operands in the expression may be any {{cssxref("&lt;length&gt;")}} syntax value. You can use different units for each value in your expression, if you wish. You may also use parentheses to establish computation order when needed.</p>
...
<ul>
 ...
 <li>The <code>*</code> and <code>/</code> operators do not require whitespace, but adding it for consistency is both allowed and recommended.</li>
 <li>Division by zero results in an error being generated by the HTML parser.</li>
...
<h3 id="Nested_calc_with_CSS_Variables">Nested <code>calc()</code> with CSS Variables</h3>
