...
- {{cssxref("&lt;percentage&gt;")}}
  - : The size of the margin as a percentage, relative to the [inline direction](/en-US/docs/Web/CSS/CSS_Flow_Layout/Block_and_Inline_Layout_in_Normal_Flow) (_width_ in a horizontal language) of the [containing block](/en-US/docs/Web/CSS/Containing_block).
- `auto`
