...
Including a ruleset inside a [`@scope`](/en-US/docs/Web/CSS/@scope) block does not directly affect the specificity of its selector, regardless of the selectors used inside the scope root and limit.
