...
The **`<position-area>`** [CSS](/en-US/docs/Web/CSS) [data type](/en-US/docs/Web/CSS/CSS_Types) defines the cell or spanned cells of an **position-area grid**, a 3x3 grid whose center cell is an anchor element.
