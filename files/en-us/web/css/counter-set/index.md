...
The **`counter-set`** [CSS](/en-US/docs/Web/CSS) property sets existing [CSS counters](/en-US/docs/Web/CSS/CSS_counter_styles/Using_CSS_counters) on the element to the given values.
