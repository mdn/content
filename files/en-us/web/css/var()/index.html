...
<p>The <strong><code>var()</code></strong> <a href="/en-US/docs/Web/CSS">CSS</a> <a href="/en-US/docs/Web/CSS/CSS_Functions">function</a> can be used to insert the value of a <a href="/en-US/docs/Web/CSS/--*">custom property</a> (sometimes called a "CSS variable") instead of any part of a value of another property.</p>
...
<div class="note">
<p><strong>Note:</strong> The syntax of the fallback, like that of custom properties, allows commas. For example, <code>var(--foo, red, blue)</code> defines a fallback of <code>red, blue</code>; that is, anything between the first comma and the end of the function is considered a fallback value.</p>
</div>
...
<dl>
 ...
 <dd>A custom property’s name represented by an identifier that starts with two dashes. Custom properties are solely for use by authors and users; CSS will never give them a meaning beyond what is presented here.</dd>
 <dt><code>&lt;declaration-value&gt;</code></dt>
 <dd>The custom property's fallback value, which is used in case the custom property is invalid in the used context. This value may contain any character except some characters with special meaning like newlines, unmatched closing brackets, i.e. <code>)</code>, <code>]</code>, or <code>}</code>, top-level semicolons, or exclamation marks.</dd>
</dl>
