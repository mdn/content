...
One basic example of using `::before` pseudo-elements is to provide quotation marks. Here we use both `::before` and {{Cssxref("::after")}} to insert quotation characters.
...
In this example we will create a short to-do list using pseudo-elements. This method can often be used to add small touches to the UI and improve user experience.
