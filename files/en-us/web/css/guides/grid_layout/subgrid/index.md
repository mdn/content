...
When you add {{cssxref("display", "display: grid")}} to a grid container, only the direct children become grid items, which can then be placed on the grid you created. The children of these items display in normal flow.
