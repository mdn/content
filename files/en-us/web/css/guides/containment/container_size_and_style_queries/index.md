...
This container style query matches any element that has `blue` as the [computed value](/en-US/docs/Web/CSS/Guides/Cascade/Value_processing#computed_value) of the `--accent-color` custom property.
