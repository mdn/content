...
When transitioning these properties {{cssxref("transition-behavior", "transition-behavior: allow-discrete", "#allow-discrete")}} needs to be set on the transitions. This effectively enables `display`/`content-visibility` transitions.
