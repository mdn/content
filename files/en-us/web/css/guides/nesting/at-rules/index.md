...
{{cssxref("@layer", "cascade layers")}} can be nested to [create child-layers](/en-US/docs/Web/CSS/Reference/At-rules/@layer#nesting_layers). These are joined with a `.` (dot).
