...
- Element that has had stacking context-creating properties (such as `opacity`) animated using {{cssxref("@keyframes")}}, with {{cssxref("animation-fill-mode")}} set to {{cssxref("animation-fill-mode", "forwards", "#forwards")}}.
