...
We can set the attachment range to the `contain` named timeline range to have the animation start when 20% of it is 20% of the way through the container and end when 60% of it is 60% of the way through.
