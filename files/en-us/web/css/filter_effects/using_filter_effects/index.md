...
| {{cssxref("filter-function/brightness", "brightness()")}}   | {{SVGElement("feComponentTransfer")}}                                                                                                                 | {{cssxref("&lt;number&gt;")}} or {{cssxref("&lt;percentage&gt;")}} | 1       | 0   |     |
| {{cssxref("filter-function/contrast", "contrast()")}}       | {{SVGElement("feComponentTransfer")}}                                                                                                                 | {{cssxref("&lt;length&gt;")}}                                      |         |     |     |
| {{cssxref("filter-function/drop-shadow", "drop-shadow()")}} | {{SVGElement("feGaussianBlur")}}, {{SVGElement("feOffset")}}, {{SVGElement("feFlood")}}, {{SVGElement("feComposite")}}, and {{SVGElement("feMerge")}} | {{cssxref("&lt;length&gt;")}}                                      |         |     |     |
...
| {{cssxref("filter-function/invert", "invert()")}}           | {{SVGElement("feComponentTransfer")}}                                                                                                                 | {{cssxref("&lt;length&gt;")}}                                      |         |     |     |
| {{cssxref("filter-function/opacity", "opacity()")}}         | {{SVGElement("feComponentTransfer")}}                                                                                                                 | {{cssxref("&lt;length&gt;")}}                                      |         |     |     |
