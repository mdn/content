...
<dl>
 ...
 <dd>
   ...
   <div class="notecard note">
     <p><strong>Note:</strong> <code>auto</code> track sizes (and only <code>auto</code> track sizes) can be stretched by the {{cssxref("align-content")}} and {{cssxref("justify-content")}} properties.</p>
   </div>
 </dd>
</dl>
...
<h3 id="Setting_grid_column_size">Setting grid column size</h3>
...
<p>{{EmbedLiveSample("Setting_grid_column_size", "410px", "100px")}}</p>
