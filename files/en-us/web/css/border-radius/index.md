...
<table>
  <tbody>
    <tr>
      <td><em>radius</em></td>
      <td><img alt="A light blue rectangle with a light gray border. All 4 corners have been traced with a thick black line." src="all-corner.png" /></td>
      <td>
    ...
    <tr>
      ...
      <td>
        <img alt="A light blue rectangle with a light gray border. The 2 corners on the top left and the bottom right have been traced with a thick black line." src="top-left-bottom-right.png" />
      </td>
      <td>
        Is a {{cssxref("&lt;length&gt;")}} or a
        {{cssxref("&lt;percentage&gt;")}} denoting a radius to use
    ...
    <tr>
      ...
      <td>
        <img alt="A light blue rectangle with a light gray border. The 2 corners on the top right and the bottom left have been traced with a thick black line." src="top-right-bottom-left.png" />
      </td>
      <td>
        Is a {{cssxref("&lt;length&gt;")}} or a
        {{cssxref("&lt;percentage&gt;")}} denoting a radius to use
    ...
    <tr>
      ...
      <td><img alt="A light blue rectangle with a light gray border. The corner on the top left has been traced with a thick black line." src="top-left.png" /></td>
      <td>
        Is a {{cssxref("&lt;length&gt;")}} or a
        {{cssxref("&lt;percentage&gt;")}} denoting a radius to use
    ...
    <tr>
      ...
      <td><img alt="A light blue rectangle with a light gray border. The corner on the top right has been traced with a thick black line." src="top-right.png" /></td>
      <td>
        Is a {{cssxref("&lt;length&gt;")}} or a
        {{cssxref("&lt;percentage&gt;")}} denoting a radius to use
    ...
    <tr>
      ...
      <td><img alt="A light blue rectangle with a light gray border. The corner on the bottom right has been traced with a thick black line." src="bottom-right.png" /></td>
      <td>
        Is a {{cssxref("&lt;length&gt;")}} or a
        {{cssxref("&lt;percentage&gt;")}} denoting a radius to use
    ...
    <tr>
      ...
      <td><img alt="A light blue rectangle with a light gray border. The corner on the bottom left has been traced with a thick black line." src="bottom-left.png" /></td>
      <td>
        Is a {{cssxref("&lt;length&gt;")}} or a
        {{cssxref("&lt;percentage&gt;")}} denoting a radius to use
