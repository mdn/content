...
<p>The <strong><code>::placeholder</code></strong> <a href="/en-US/docs/Web/CSS">CSS</a> <a href="/en-US/docs/Web/CSS/Pseudo-elements">pseudo-element</a> represents the <a href="/en-US/docs/Learn/Forms#the_placeholder_attribute">placeholder text</a> in an {{HTMLElement("input")}} or {{HTMLElement("textarea")}} element.</p>
...
<p>Placeholder text will appear with the same styling as user-entered text content when rendered in <a href="/en-US/docs/Web/CSS/@media/-ms-high-contrast">Windows High Contrast Mode</a>. This will make it difficult for some people to determine which content has been entered, and which content is placeholder text.</p>
...
<h3 id="Change_placeholder_appearance">Change placeholder appearance</h3>

<p>This example shows some of the adjustments that you can make to the styles of placeholder text.</p>
...
<p>{{EmbedLiveSample("Change_placeholder_appearance", 200, 60)}}</p>

<h3 id="Opaque_text">Opaque text</h3>

<p>Some browsers (such as Firefox) set the default {{cssxref("opacity")}} of placeholders to something less than 100%. If you want fully opaque placeholder text, set <code>opacity</code> to <code>1</code>.</p>
...
<p>{{EmbedLiveSample("Opaque_text", 200, 60)}}</p>
