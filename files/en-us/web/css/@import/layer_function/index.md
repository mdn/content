...
The **`layer()`** [CSS](/en-US/docs/Web/CSS) [function](/en-US/docs/Web/CSS/CSS_Functions) is used along with the [`@import`](/en-US/docs/Web/CSS/@import) at-rule to put the imported resource in a separate named [cascade layer](/en-US/docs/Web/CSS/@layer).
