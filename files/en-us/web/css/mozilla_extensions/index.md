...
- `-moz-use-text-color` {{deprecated_inline}} (removed in [Firefox bug 1306214](https://bugzilla.mozilla.org/show_bug.cgi?id=1306214)); use {{CSSxRef("color_value#currentcolor_keyword","currentcolor")}} instead.
...
- {{CSSxRef("-moz-alt-content")}} (see [Webkit bug 11011](https://bugzilla.mozilla.org/show_bug.cgi?id=11011))
