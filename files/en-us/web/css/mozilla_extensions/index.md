...
- {{CSSxRef("backface-visibility", "-moz-backface-visibility")}} {{Deprecated_Inline}} \[Superseded by the standard version {{CSSxRef("backface-visibility")}}]
...
- {{CSSxRef("perspective", "-moz-perspective")}} {{Deprecated_Inline}} \[Superseded by the standard version {{CSSxRef("perspective")}}]
- {{CSSxRef("perspective-origin", "-moz-perspective-origin")}} {{Deprecated_Inline}} \[Superseded by the standard version {{CSSxRef("perspective-origin")}}]
...
- {{CSSxRef("transform", "-moz-transform")}} {{Deprecated_Inline}} \[Superseded by the standard version {{CSSxRef("transform")}}]
- {{CSSxRef("transform-origin", "-moz-transform-origin")}} {{Deprecated_Inline}} \[Superseded by the standard version {{CSSxRef("transform-origin")}}]
- {{CSSxRef("transform-style", "-moz-transform-style")}} {{Deprecated_Inline}} \[Superseded by the standard version {{CSSxRef("transform-style")}}]
