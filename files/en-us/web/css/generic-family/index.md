...
The **`<generic-family>`** [CSS](/en-US/docs/Web/CSS) [data type](/en-US/docs/Web/CSS/CSS_Types) represents the keyword values for generic font family names used in the {{cssxref("font")}} shorthand and {{cssxref("font-family")}} longhand properties.
...
- `sans-serif`
  ...
  - : Glyphs have stroke endings that are plain. Example sans-serif fonts include Open Sans, Fira Sans, Lucida Sans, Lucida Sans Unicode, Trebuchet MS, Liberation Sans, and Nimbus Sans L.
