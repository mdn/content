...
A CSS property is _animatable_ if it's property values can be made to change gradually over a given amount of time. **Certain CSS properties can be animated** using [CSS Animations](/en-US/docs/Web/CSS/CSS_Animations) or [CSS Transitions](/en-US/docs/Web/CSS/CSS_Transitions). CSS properties that define animation parameters are not animatable because animating them would create complex recursive behavior.
