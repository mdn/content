...
- Matches HTML elements: [`<a>`](/en-US/docs/Web/HTML/Reference/Element/a) and [`<area>`](/en-US/docs/Web/HTML/Reference/Element/area) with an [`href`](/en-US/docs/Web/HTML/Reference/Element/a#href) attribute
