...
<p>The <strong><code>border-bottom-style</code></strong> <a href="/en-US/docs/Web/CSS">CSS</a> property sets the line style of an element's bottom {{cssxref("border")}}.</p>
...
<p>The <code>border-bottom-style</code> property is specified as a single keyword chosen from those available for the {{cssxref("border-style")}} property.</p>
...
<h3 id="Demonstrating_all_border_styles">Demonstrating all border styles</h3>
...
<p>{{ EmbedLiveSample('Demonstrating_all_border_styles', 300, 200) }}</p>
