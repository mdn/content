...
<p>This property affects the corner between the block-end and the inline-end sides of the element. For instance, in a <code>horizontal-tb</code> writing mode with <code>ltr</code> direction, it corresponds to the {{CSSxRef("border-bottom-right-radius")}} property.</p>
...
<ul>
 <li>The mapped physical property: {{CSSxRef("border-bottom-right-radius")}}</li>
