    ...
    <table class="standard-table">
      ...
      <tbody>
        ...
        <tr style="cursor: no-drop">
          ...
          <td>
            An item may not be dropped at the current location.<br />[Firefox bug 275173](https://bugzilla.mozilla.org/show_bug.cgi?id=275173):
        ...
        <tr style="cursor: all-scroll">
          ...
          <td>
            Something can be scrolled in any direction (panned).<br />[Firefox bug 275174](https://bugzilla.mozilla.org/show_bug.cgi?id=275174):
