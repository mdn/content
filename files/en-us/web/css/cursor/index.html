...
<p>The <strong><code>cursor</code></strong> <a href="/en-US/docs/Web/CSS">CSS</a> property sets the type of mouse cursor, if any, to show when the mouse pointer is over an element.</p>
 ...
 <table class="standard-table">
  ...
  <tbody>
   ...
   <tr style="cursor: all-scroll;">
    <th rowspan="15" scope="row" style="cursor: auto;">Resizing &amp; scrolling</th>
...
<p>Although the specification does not define any size limitations for <code>cursor</code>, individual {{Glossary("user agent", "user agents")}} may choose to do so. Cursor changes using images which are outside the size range supported by the browser will generally just be ignored.</p>

<p>Check the {{anch("Browser compatibility")}} table for any notes on cursor size limits.</p>
...
<h3 id="Setting_cursor_types">Setting cursor types</h3>
...
<ul>
 <li><a href="/en-US/docs/Web/CSS/CSS_Basic_User_Interface/Using_URL_values_for_the_cursor_property">Using URL values for the cursor property</a></li>
