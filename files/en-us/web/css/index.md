...
- [CSS values and units](/en-US/docs/Web/CSS/CSS_Values_and_Units) module, including [numeric data types](/en-US/docs/Web/CSS/CSS_Values_and_Units/Numeric_Data_Types), [textual data types](/en-US/docs/Web/CSS/CSS_Values_and_Units/Textual_Data_Types) and [functional notations](/en-US/docs/Web/CSS/CSS_Functions)
