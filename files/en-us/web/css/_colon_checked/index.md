...
- Related HTML elements: [`<input type="checkbox">`](/en-US/docs/Web/HTML/Reference/Element/input/checkbox), [`<input type="radio">`](/en-US/docs/Web/HTML/Reference/Element/input/radio), {{HTMLElement("select")}}, and {{HTMLElement("option")}}
