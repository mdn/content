...
- A fixed {{cssxref("aspect-ratio")}} of `3/4` has been set on them, to control their sizing as the list size changes, keeping their width constant as the height of the list stays constant.
