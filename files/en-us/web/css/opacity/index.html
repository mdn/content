...
<p>The <strong><code>opacity</code></strong> CSS property sets the opacity of an element. Opacity is the degree to which content behind an element is hidden, and is the opposite of transparency.</p>
...
<dl>
 ...
 <dd>A {{cssxref("number")}} in the range <code>0.0</code> to <code>1.0</code>, inclusive, or a {{cssxref("percentage")}} in the range <code>0%</code> to <code>100%</code>, inclusive, representing the opacity of the channel (that is, the value of its alpha channel). Any value outside the interval, though valid, is clamped to the nearest limit in the range.
 <table class="standard-table">
  <tbody>
   ...
   <tr>
    <td>Any {{cssxref("number")}} strictly between <code>0</code> and <code>1</code></td>
...
<p>Using <code>opacity</code> with a value other than <code>1</code> places the element in a new <a href="/en-US/docs/Web/CSS/CSS_Positioning/Understanding_z_index/The_stacking_context">stacking context</a>.</p>

<p>If you <a href="http://stackoverflow.com/questions/13508877/resetting-the-opacity-of-a-child-elements-maple-browser-samsung-tv-app">do not want to apply opacity to child elements</a>, use the {{cssxref("background")}} property instead. For example:</p>
...
<h3 id="Setting_background_opacity">Setting background opacity</h3>

<h4 id="HTML">HTML</h4>

<pre class="brush: html">&lt;div class="light"&gt;You can barely see this.&lt;/div&gt;
&lt;div class="medium"&gt;This is easier to see.&lt;/div&gt;
&lt;div class="heavy"&gt;This is very easy to see.&lt;/div&gt;</pre>
...
<pre class="brush: html">&lt;img src="<a href="/static/img/opengraph-logo.png">//developer.mozilla.org/static/img/opengraph-logo.png</a>"
...
<p>{{EmbedLiveSample('Setting_opacity_on_hover', '150', '175')}}</p>
...
<ul>
 <li><a href="https://msdn.microsoft.com/en-us/library/ms532910%28VS.85%29.aspx">Microsoft's filter:alpha(opacity=xx)</a></li>
</ul>
