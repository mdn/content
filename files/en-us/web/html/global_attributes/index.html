...
<dl>
 ...
 <dt><a href="/en-US/docs/Web/HTML/Global_attributes/autofocus">{{HTMLAttrDef("autofocus")}}</a></dt>
 <dd>Indicates that an element is to be focused on page load, or as soon as the {{HTMLElement("dialog")}} it is part of is displayed. This attribute is a boolean, initially false.</dd>
 ...
 <dt><a href="/en-US/docs/Web/HTML/Global_attributes/contextmenu">{{HTMLAttrDef("contextmenu")}}</a> {{deprecated_inline}}</dt>
 <dd>The <a href="#attr-id"><strong><code>id</code></strong></a> of a {{HTMLElement("menu")}} to use as the contextual menu for this element.</dd>
...
<div class="note">
<p><strong>Note:</strong> The <code>item*</code> attributes are part of the <a href="https://html.spec.whatwg.org/multipage/microdata.html#microdata">WHATWG HTML Microdata feature</a>.</p>
</div>
...
<dl>
 ...
 <dt><a href="/en-US/docs/Web/HTML/Global_attributes/translate">{{HTMLAttrDef("translate")}}</a></dt>
