...
- {{htmlelement("input")}} elements, except for [`password`](/en-US/docs/Web/HTML/Reference/Element/input/password), [`email`](/en-US/docs/Web/HTML/Reference/Element/input/email), and [`url`](/en-US/docs/Web/HTML/Reference/Element/input/url), which do not support autocorrection.
...
The {{htmlelement("input")}} element types that don't support auto-correction always have the `off` state: [`password`](/en-US/docs/Web/HTML/Reference/Element/input/password), [`email`](/en-US/docs/Web/HTML/Reference/Element/input/email) and [`url`](/en-US/docs/Web/HTML/Reference/Element/input/url).
...
The HTML markup defines a {{htmlelement("button")}}, a "name" {{htmlelement("input")}} element of [`type="text"`](/en-US/docs/Web/HTML/Reference/Element/input/text), a "bio" {{htmlelement("textarea")}} element, and two {{htmlelement("label")}} elements.
