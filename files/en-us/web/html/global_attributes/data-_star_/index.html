...
<p>The <strong><code>data-*</code></strong> <a href="/en-US/docs/Web/HTML/Global_attributes">global attributes</a> form a class of attributes called <strong>custom data attributes</strong>, that allow proprietary information to be exchanged between the <a href="/en-US/docs/Web/HTML">HTML</a> and its <a href="/en-US/docs/Web/API/Document_Object_Model">DOM</a> representation by scripts.</p>
...
<p>By adding <code>data-*</code> attributes, even ordinary HTML elements can become rather complex and powerful program-objects. For example, a space-ship "<a href="https://en.wikipedia.org/wiki/Sprite_(computer_graphics)">sprite</a><em>"</em> in a game could be a simple {{HTMLElement("img")}} element with a <a href="/en-US/docs/Web/HTML/Global_attributes/class"><code>class</code></a> attribute and several <code>data-*</code> attributes:</p>
...
<p>For a more in-depth tutorial about using HTML data attributes, see <a href="/en-US/docs/Learn/HTML/Howto/Use_data_attributes">Using data attributes</a>.</p>
