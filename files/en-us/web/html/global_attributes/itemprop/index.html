...
<ol>
 ...
 <li>If the item is not a typed item it must be:
  <ol>
   <li>A string that contains no "<code>.</code>" (U+002E FULL STOP) characters and no "<code>:</code>" characters (U+003A COLON) and is used as a proprietary item property name (again, one not defined in a public specification).</li>
  </ol>
 </li>
</ol>
...
<ul>
 <li>If the element has an <code>itemscope</code> attribute

  <ul>
   <li>The value is the <strong>item</strong> created by the element.</li>
  </ul>
 </li>
 <li>If the element is a <code>meta</code> element
  <ul>
   <li>The value is the value of the element's <code>content</code> attribute</li>
  </ul>
 </li>
 <li>If the element is an <code>audio</code>, <code>embed</code>, <code>iframe</code>, <code>img</code>, <code>source</code>, <code>track</code>, or <code>video</code> element
  <ul>
 ...
 <li>If the element is an <code>a</code>, <code>area</code>, or <code>link</code> element
  <ul>
 ...
 <li>If the element is an <code>object</code> element
  <ul>
 ...
 <li>If the element is a <code>data</code> element
  <ul>
   <li>The value is the value of the element's value attribute</li>
  </ul>
 </li>
 <li>If the element is a <code>meter</code> element
  <ul>
   <li>The value is the value of the element's <code>value</code> attribute</li>
  </ul>
 </li>
 <li>If the element is a <code>time</code> element
  <ul>
   <li>The value is the element's <code>datetime</code> value</li>
  </ul>
 </li>
</ul>
...
<ul>
 <li>The value is the element's <var>textContent</var>.</li>
</ul>

<p>If a property's value is a <code>URL</code>, the property must be specified using a URL property element. The URL property elements are the <code>a</code>, <code>area</code>, <code>audio</code>, <code>embed</code>, <code>iframe</code>, <code>img</code>, <code>link</code>, <code>object</code>, <code>source</code>, <code>track</code>, and <code>video</code> elements.</p>
...
<p>In the following example, the "a" property has the values "1" and "2", <em>in that order</em>, but whether the "a" property comes before the "b" property or not is not important</p>
