...
- The [event handler](/en-US/docs/Web/HTML/Reference/Attributes#event_handler_attributes) attributes: `onanimationcancel`, `onanimationend`, `onanimationiteration`, `onanimationstart`, `onauxclick`, `onbeforeinput`, `onbeforematch`, `onbeforetoggle`, `onbeforexrselect`, `onblur`, `onchange`, `onclick`, `oncommand`, `oncompositionend`, `oncompositionstart`, `oncompositionupdate`, `oncontentvisibilityautostatechange`, `oncontextmenu`, `oncopy`, `oncut`, `ondblclick`, `ondrag`, `ondragend`, `ondragenter`, `ondragleave`, `ondragover`, `ondragstart`, `ondrop`, `onerror`, `onfocus`, `onfocusin`, `onfocusout`, `onfullscreenchange`, `onfullscreenerror`, `ongesturechange`, `ongestureend`, `ongesturestart`, `ongotpointercapture`, `oninput`, `onkeydown`, `onkeyup`, `onload`, `onlostpointercapture`, `onmousedown`, `onmouseenter`, `onmouseleave`, `onmousemove`, `onmouseout`, `onmouseover`, `onmouseup`, `onpaste`, `onpointercancel`, `onpointerdown`, `onpointerenter`, `onpointerleave`, `onpointermove`, `onpointerout`, `onpointerover`, `onpointerrawupdate`, `onpointerup`, `onscroll`, `onscrollend`, `onscrollsnapchange`, `onscrollsnapchanging`, `onsecuritypolicyviolation`, `onselectstart`, `ontoggle`, `ontouchcancel`, `ontouchend`, `ontouchmove`, `ontouchstart`, `ontransitioncancel`, `ontransitionend`, `ontransitionrun`, `ontransitionstart`, `onwebkitmouseforcechanged`, `onwebkitmouseforcedown`, `onwebkitmouseforceup`, `onwebkitmouseforcewillbegin`, `onwheel`.
