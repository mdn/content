...
slug: Web/HTML/Reference/Element/audio
...
- [`crossorigin`](/en-US/docs/Web/HTML/Reference/Attributes/crossorigin)
  ...
  - : This [enumerated](/en-US/docs/Glossary/Enumerated) attribute indicates whether to use CORS to fetch the related audio file. [CORS-enabled resources](/en-US/docs/Web/HTML/Guides/CORS_enabled_image) can be reused in the {{HTMLElement("canvas")}} element without being _tainted_. The allowed values are:
