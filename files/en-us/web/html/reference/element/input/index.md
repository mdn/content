...
slug: Web/HTML/Reference/Element/input
...
- [`step`](/en-US/docs/Web/HTML/Reference/Attributes/step)
  ...
  - : Valid for `date`, `month`, `week`, `time`, `datetime-local`, `number`, and `range`, the [`step`](/en-US/docs/Web/HTML/Reference/Attributes/step) attribute is a number that specifies the granularity that the value must adhere to.
    ...
    - Each date/time input type has a default `step` value appropriate for the type; see the individual input pages: [`date`](/en-US/docs/Web/HTML/Reference/Element/input/date#step), [`datetime-local`](/en-US/docs/Web/HTML/Reference/Element/input/datetime-local#step), [`month`](/en-US/docs/Web/HTML/Reference/Element/input/month#step), [`time`](/en-US/docs/Web/HTML/Reference/Element/input/time#step), and [`week`](/en-US/docs/Web/HTML/Reference/Element/input/week#step).
...
<table class="no-markdown">
  ...
  <tbody>
    ...
    <tr>
      <td>{{Cssxref(":open")}}</td>
      <td>
        <code>&lt;input&gt;</code> elements that display a picker for the user to choose a value from (for example <a href="/en-US/docs/Web/HTML/Reference/Element/input/color"><code>&lt;input type="color"&gt;</code></a>) — but only when the element is in the open state, that is, when the picker is displayed.
      </td>
    </tr>
  </tbody>
</table>
...
This property is typically used to create form fields that shrinkwrap their content and grow as more text is entered. This works with input types that accept direct text input (for example, [`text`](/en-US/docs/Web/HTML/Reference/Element/input/text) and [`url`](/en-US/docs/Web/HTML/Reference/Element/input/url)), input type [`file`](/en-US/docs/Web/HTML/Reference/Element/input/file), and {{htmlelement("textarea")}} elements.
...
The semantic pairing of `<input>` and `<label>` elements is useful for assistive technologies such as screen readers. By pairing them using the `<label>`'s [`for`](/en-US/docs/Web/HTML/Reference/Element/label#for) attribute, you bond the label to the input in a way that lets screen readers describe inputs to users more precisely.
