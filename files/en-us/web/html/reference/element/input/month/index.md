...
slug: Web/HTML/Reference/Element/input/month
...
In browsers that don't support `month` inputs, the control degrades gracefully to [`<input type="text">`](/en-US/docs/Web/HTML/Reference/Element/input/text), although there may be automatic validation of the entered text to ensure it's formatted as expected.
...
You can set a default value for the input control by including a month and year inside the [`value`](/en-US/docs/Web/HTML/Reference/Element/input#value) attribute, like so:
...
Any values in the list that are not compatible with the [`type`](/en-US/docs/Web/HTML/Reference/Element/input#type) are not included in the suggested options.
...
If the [`value`](/en-US/docs/Web/HTML/Reference/Element/input#value) entered into the element exceeds this, the element fails [constraint validation](/en-US/docs/Web/HTML/Guides/Constraint_validation).
...
If the [`value`](/en-US/docs/Web/HTML/Reference/Element/input#value) of the element is less than this, the element fails [constraint validation](/en-US/docs/Web/HTML/Guides/Constraint_validation).
...
Only values which are equal to the basis for stepping ([`min`](#min) if specified, [`value`](/en-US/docs/Web/HTML/Reference/Element/input#value) otherwise, and an appropriate default value if neither of those is provided) are valid.
...
You can use the [`min`](/en-US/docs/Web/HTML/Reference/Element/input#min) and [`max`](/en-US/docs/Web/HTML/Reference/Element/input#max) attributes to restrict the range of dates that the user can choose.
...
`<input type="month">` doesn't support form sizing attributes such as [`size`](/en-US/docs/Web/HTML/Reference/Element/input#size).
...
To help avoid this, you can use [`min`](/en-US/docs/Web/HTML/Reference/Element/input#min) and [`max`](/en-US/docs/Web/HTML/Reference/Element/input#max) to restrict the available dates (see [Setting maximum and minimum dates](#setting_maximum_and_minimum_dates)), and in addition use the [`required`](/en-US/docs/Web/HTML/Reference/Element/input#required) attribute to make filling in the date mandatory.
...
One way around this is to put a [`pattern`](/en-US/docs/Web/HTML/Reference/Element/input#pattern) attribute on your `month` input.
...
- [`<input type="datetime-local">`](/en-US/docs/Web/HTML/Reference/Element/input/datetime-local), [`<input type="date">`](/en-US/docs/Web/HTML/Reference/Element/input/date), [`<input type="time">`](/en-US/docs/Web/HTML/Reference/Element/input/time), and [`<input type="week">`](/en-US/docs/Web/HTML/Reference/Element/input/week)
