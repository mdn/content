...
slug: Web/HTML/Reference/Element/input/file
...
- If it is, we:
  ...
  - Generate a thumbnail preview of the image by calling {{domxref("URL/createObjectURL_static", "URL.createObjectURL(file)")}}. Then, insert the image into the list item too by creating a new {{htmlelement("img")}} and setting its [`src`](/en-US/docs/Web/HTML/Reference/Element/img#src) to the thumbnail.
...
<table class="properties">
  <tbody>
    ...
    <tr>
      ...
      <td><a href="/en-US/docs/Web/HTML/Reference/Element/input#required"><code>required</code></a></td>
    </tr>
    <tr>
