...
slug: Web/HTML/Reference/Element/input/range
...
- If the [`value`](/en-US/docs/Web/HTML/Reference/Element/input#value) is set to something which can't be converted into a valid floating-point number, validation fails because the input is suffering from a bad input.
- The value won't be less than [`min`](/en-US/docs/Web/HTML/Reference/Element/input#min). The default is 0.
- The value won't be greater than [`max`](/en-US/docs/Web/HTML/Reference/Element/input#max). The default is 100.
- The value will be a multiple of [`step`](/en-US/docs/Web/HTML/Reference/Element/input#step). The default is 1.
...
The `step` attribute is a number that specifies the granularity that the value must adhere to. Only values that match the specified stepping interval ([`min`](#min) if specified, [`value`](/en-US/docs/Web/HTML/Reference/Element/input#value) otherwise, or an appropriate default value if neither of those is provided) are valid.
...
By default, the minimum is 0 and the maximum is 100. If that's not what you want, you can easily specify different bounds by changing the values of the [`min`](/en-US/docs/Web/HTML/Reference/Element/input#min) and/or [`max`](/en-US/docs/Web/HTML/Reference/Element/input#max) attributes. These can be any floating-point value.
...
By default, the granularity is 1, meaning the value is always an integer. To control the granularity, you can change the [`step`](/en-US/docs/Web/HTML/Reference/Element/input#step) attribute. For example, If you need a value to be halfway between 5 and 10, you should set the value of `step` to 0.5:
...
If you want to accept any value regardless of how many decimal places it extends to, you can specify a value of `any` for the [`step`](/en-US/docs/Web/HTML/Reference/Element/input#step) attribute:
...
To add tick marks to a range control, include the `list` attribute, giving it the `id` of a {{HTMLElement("datalist")}} element which defines a series of tick marks on the control. Each point is represented using an {{HTMLElement("option")}} element with its [`value`](/en-US/docs/Web/HTML/Reference/Element/option#value) set to the range's value at which a mark should be drawn.
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        <a href="/en-US/docs/Web/HTML/Reference/Element/input#max"><code>max</code></a>,
        <a href="/en-US/docs/Web/HTML/Reference/Element/input#min"><code>min</code></a>,
...
- [`<input type="number">`](/en-US/docs/Web/HTML/Reference/Element/input/number)
