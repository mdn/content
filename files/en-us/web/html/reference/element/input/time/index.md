...
slug: Web/HTML/Reference/Element/input/time
...
You can set a default value for the input by including a valid time in the [`value`](/en-US/docs/Web/HTML/Reference/Element/input#value) attribute when creating the `<input>` element, like so:
...
The `step` attribute is a number that specifies the granularity that the value must adhere to, or the special value `any`, which is described below. Only values which are equal to the basis for stepping ([`min`](#min) if specified, [`value`](/en-US/docs/Web/HTML/Reference/Element/input#value) otherwise, and an appropriate default value if neither of those is provided) are valid.
...
`<input type="time">` doesn't support form sizing attributes such as [`size`](/en-US/docs/Web/HTML/Reference/Element/input#size), since times are always about the same number of characters long. You'll have to resort to [CSS](/en-US/docs/Web/CSS) for sizing needs.

### Using the step attribute

You can use the [`step`](/en-US/docs/Web/HTML/Reference/Element/input#step) attribute to vary the amount of time jumped whenever the time is incremented or decremented (for example, so the time moves by 10 minutes at a time when clicking the little arrow widgets).

It takes an integer value defining the number of seconds you want to increment by; the default value is 60 seconds. With this as the default, most user agent time UIs display hours and minutes but not seconds. Including the [`step`](/en-US/docs/Web/HTML/Reference/Element/input#step) attribute with any numeric value other than a value divisible by `60` adds seconds to the UI, if the `min` or `max` value has not already caused the seconds to be visible.
...
You can use the [`min`](/en-US/docs/Web/HTML/Reference/Element/input#min) and [`max`](/en-US/docs/Web/HTML/Reference/Element/input#max) attributes to restrict the valid times that can be chosen by the user. In the following example we are setting a minimum time of `12:00` and a maximum time of `18:00`:
...
By setting a [`min`](/en-US/docs/Web/HTML/Reference/Element/input#min) attribute greater than the [`max`](/en-US/docs/Web/HTML/Reference/Element/input#max) attribute, the valid time range will wrap around midnight to produce a valid time range. This functionality is not supported by any other input types.
...
In addition, you can use the [`required`](/en-US/docs/Web/HTML/Reference/Element/input#required) attribute to make filling in the time mandatory. Browsers will display an error if you try to submit a time that is outside the set bounds, or an empty time field.
...
<table class="properties">
  <tbody>
    <tr>
      <td><strong><a href="/en-US/docs/Web/HTML/Reference/Element/input#value">Value</a></strong></td>
    ...
    <tr>
      ...
      <td>
        ...
        <a href="/en-US/docs/Web/HTML/Reference/Element/input#step"><code>step</code></a>
      </td>
    </tr>
    <tr>
...
- [`<input type="date">`](/en-US/docs/Web/HTML/Reference/Element/input/date)
- [`<input type="datetime-local">`](/en-US/docs/Web/HTML/Reference/Element/input/datetime-local)
- [`<input type="week">`](/en-US/docs/Web/HTML/Reference/Element/input/week)
- [`<input type="month">`](/en-US/docs/Web/HTML/Reference/Element/input/month)
