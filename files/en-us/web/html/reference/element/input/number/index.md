...
slug: Web/HTML/Reference/Element/input/number
...
A number representing the value of the number entered into the input. You can set a default value for the input by including a number inside the [`value`](/en-US/docs/Web/HTML/Reference/Element/input#value) attribute, like so:
...
The maximum value to accept for this input. If the [`value`](/en-US/docs/Web/HTML/Reference/Element/input#value) entered into the element exceeds this, the element fails [constraint validation](/en-US/docs/Web/HTML/Guides/Constraint_validation). If the value of the `max` attribute isn't a number, then the element has no maximum value.

This value must be greater than or equal to the value of the `min` attribute.

### `min`

The minimum value to accept for this input. If the [`value`](/en-US/docs/Web/HTML/Reference/Element/input#value) of the element is less than this, the element fails [constraint validation](/en-US/docs/Web/HTML/Guides/Constraint_validation). If a value is specified for `min` that isn't a valid number, the input has no minimum value.
...
The `number` input type should only be used for incremental numbers, especially when spinbutton incrementing and decrementing are helpful to user experience. The `number` input type is not appropriate for values that happen to only consist of numbers but aren't strictly speaking a number, such as postal codes in many countries or credit card numbers. For non-numeric inputs, consider using a different input type, such as [`<input type="tel">`](/en-US/docs/Web/HTML/Reference/Element/input/tel) or other {{HTMLElement('input')}} type with the [`inputmode`](/en-US/docs/Web/HTML/Reference/Global_attributes/inputmode) attribute:
...
A number input is considered valid when empty and when a single number is entered, but is otherwise invalid. If the [`required`](/en-US/docs/Web/HTML/Reference/Element/input#required) attribute is used, the input is no longer considered valid when empty.
...
You can use the [`min`](/en-US/docs/Web/HTML/Reference/Element/input#min) and [`max`](/en-US/docs/Web/HTML/Reference/Element/input#max) attributes to specify a minimum and maximum value that the field can have. For example, let's give our example a minimum of `0`, and a maximum of `100`:
...
{{HTMLElement("input")}} elements of type `number` don't support form sizing attributes such as [`size`](/en-US/docs/Web/HTML/Reference/Element/input#size). You'll have to resort to [CSS](/en-US/docs/Web/CSS) to change the size of these controls.
...
- You can use the [`required`](/en-US/docs/Web/HTML/Reference/Element/input#required) attribute to make an empty entry invalid. (In other words, the input _must_ be filled in.)
- You can use the [`step`](/en-US/docs/Web/HTML/Reference/Element/input#step) attribute to constrain valid values to a certain set of steps (e.g., multiples of 10).
- You can use the [`min`](/en-US/docs/Web/HTML/Reference/Element/input#min) and [`max`](/en-US/docs/Web/HTML/Reference/Element/input#max) attributes to constrain valid values to lower and upper bounds.
...
We put it on a separate `<span>` element for added flexibility. Some browsers don't display generated content very effectively on some types of form inputs. (Read, for example, the section on [`<input type="date">` validation](/en-US/docs/Web/HTML/Reference/Element/input/date#validation).)
...
`<input type="number">` elements do not support use of the [`pattern`](/en-US/docs/Web/HTML/Reference/Element/input#pattern) attribute for making entered values conform to a specific regex pattern.

The rationale for this is that number inputs won't be valid if they contain anything except numbers, and you can constrain the minimum and maximum number of valid digits using the [`min`](/en-US/docs/Web/HTML/Reference/Element/input#min) and [`max`](/en-US/docs/Web/HTML/Reference/Element/input#max) attributes (as explained above).
...
We've already covered the fact that by default, the increment is `1`, and you can use the [`step`](/en-US/docs/Web/HTML/Reference/Element/input#step) attribute to allow decimal inputs. Let's take a closer look.
