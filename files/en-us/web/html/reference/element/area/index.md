...
slug: Web/HTML/Reference/Element/area
...
- `download`
  - : This attribute, if present, indicates that the linked resource is intended to be downloaded rather than displayed in the browser.
    See {{HTMLElement("a")}} for a full description of the [`download`](/en-US/docs/Web/HTML/Reference/Element/a#download) attribute.
- `href`
