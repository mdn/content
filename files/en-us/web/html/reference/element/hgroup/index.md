...
slug: Web/HTML/Reference/Element/hgroup
...
The **`<hgroup>`** [HTML](/en-US/docs/Web/HTML) element represents a heading and related content. It groups a single [`<h1>–<h6>`](/en-US/docs/Web/HTML/Reference/Element/Heading_Elements) element with one or more [`<p>`](/en-US/docs/Web/HTML/Reference/Element/p).
