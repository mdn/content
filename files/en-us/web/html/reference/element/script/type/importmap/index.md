...
slug: Web/HTML/Reference/Element/script/type/importmap
...
The **`importmap`** value of the [`type`](/en-US/docs/Web/HTML/Reference/Element/script/type) attribute of the [`<script>` element](/en-US/docs/Web/HTML/Reference/Element/script) indicates that the body of the element contains an import map.
...
The map values represent integrity metadata, identical to that used in [`integrity`](/en-US/docs/Web/HTML/Reference/Element/script#integrity) attribute values.
...
- [The `type` attribute of HTML `<script>` elements](/en-US/docs/Web/HTML/Reference/Element/script/type)
