...
slug: Web/HTML/Reference/Element/ol
...
- `type`
  ...
  - : Sets the numbering type:
    ...
    The specified type is used for the entire list unless a different [`type`](/en-US/docs/Web/HTML/Reference/Element/li#type) attribute is used on an enclosed {{HTMLElement("li")}} element.
