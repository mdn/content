...
slug: Web/HTML/Reference/Element/article
...
- Each `<article>` should be identified, typically by including a heading ([`<h1>` - `<h6>`](/en-US/docs/Web/HTML/Reference/Element/Heading_Elements) element) as a child of the `<article>` element.
...
- The publication date and time of an `<article>` element can be described using the [`datetime`](/en-US/docs/Web/HTML/Reference/Element/time#datetime) attribute of a {{HTMLElement("time")}} element.
...
- [Using HTML sections and outlines](/en-US/docs/Web/HTML/Reference/Element/Heading_Elements)
