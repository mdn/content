---
title: <frame>
slug: Web/HTML/Reference/Element/frame
...
- `name` {{Deprecated_Inline}}
  - : This attribute is used for labeling frames. Without labeling, every link will open in the frame that it's in – the closest parent frame. See the [`target`](/en-US/docs/Web/HTML/Reference/Element/a#target) attribute for more information.
