...
- The publication date and time of an `<article>` element can be described using the [`datetime`](/en-US/docs/Web/HTML/Reference/Elements/time#datetime) attribute of a {{HTMLElement("time")}} element.
