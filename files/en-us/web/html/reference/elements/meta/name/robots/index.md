...
> [!NOTE]
> Only cooperative robots follow these rules, and a crawler still needs to access the resource to read headers and meta elements (see [X-Robots-Tag: Interaction with robots.txt](/en-US/docs/Web/HTTP/Reference/Headers/X-Robots-Tag#interaction_with_robots.txt)).
