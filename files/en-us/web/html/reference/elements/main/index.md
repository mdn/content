...
Browser reader mode functionality looks for the presence of the `<main>` element, as well as [heading](/en-US/docs/Web/HTML/Reference/Elements/Heading_Elements) and [content sectioning elements](/en-US/docs/Web/HTML/Reference/Elements#content_sectioning) when converting content into a specialized reader view.
