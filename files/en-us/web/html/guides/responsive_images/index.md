...
> [!NOTE]
> The new features discussed in this article — [`srcset`](/en-US/docs/Web/HTML/Reference/Element/img#srcset)/[`sizes`](/en-US/docs/Web/HTML/Reference/Element/img#sizes)/{{htmlelement("picture")}} — are all supported in modern desktop and mobile browsers.
...
Older browsers that don't support these features will just ignore them. Instead, those browsers will go ahead and load the image referenced in the [`src`](/en-US/docs/Web/HTML/Reference/Element/img#src) attribute as normal.
