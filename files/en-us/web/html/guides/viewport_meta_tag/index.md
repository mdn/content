...
slug: Web/HTML/Guides/Viewport_meta_tag
page-type: guide
...
Other [attributes](/en-US/docs/Web/HTML/Reference/Element/meta#attributes) that are available are `minimum-scale`, `maximum-scale`, and `user-scalable`. These properties affect the initial scale and width, as well as limiting changes in zoom level.
