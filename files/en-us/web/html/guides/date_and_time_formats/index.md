...
Elements that use such formats include certain forms of the {{HTMLElement("input")}} element that let the user choose or specify a date, time, or both, as well as the {{HTMLElement("ins")}} and {{HTMLElement("del")}} elements, whose [`datetime`](/en-US/docs/Web/HTML/Reference/Element/ins#datetime) attribute specifies the date or date and time at which the insertion or deletion of content occurred.

For `<input>`, the [`type`](/en-US/docs/Web/HTML/Reference/Element/input#type) values of inputs whose [`value`](/en-US/docs/Web/HTML/Reference/Element/input#value) contains a string representing a date and/or time are:

- [`date`](/en-US/docs/Web/HTML/Reference/Element/input/date)
- [`datetime-local`](/en-US/docs/Web/HTML/Reference/Element/input/datetime-local)
- [`month`](/en-US/docs/Web/HTML/Reference/Element/input/month)
- [`time`](/en-US/docs/Web/HTML/Reference/Element/input/time)
- [`week`](/en-US/docs/Web/HTML/Reference/Element/input/week)
