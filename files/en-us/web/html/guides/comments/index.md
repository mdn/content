...
The browser ignores comments as it renders the code. In other words,they are not displayed in the browser and are mainly used to add helpful notes for developers.
