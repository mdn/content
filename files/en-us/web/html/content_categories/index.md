...
Sectioning content, a subset of flow content, creates a [section in the current outline](/en-US/docs/Web/HTML/Reference/Element/Heading_Elements) defining the scope of {{HTMLElement("header")}} and {{HTMLElement("footer")}} elements.
...
- {{HTMLElement("a")}}, if the [`href`](/en-US/docs/Web/HTML/Reference/Element/a#href) attribute is present
- {{HTMLElement("audio")}}, if the [`controls`](/en-US/docs/Web/HTML/Reference/Element/audio#controls) attribute is present
- {{HTMLElement("img")}}, if the [`usemap`](/en-US/docs/Web/HTML/Reference/Element/img#usemap) attribute is present
- {{HTMLElement("input")}}, if the [`type`](/en-US/docs/Web/HTML/Reference/Element/input#type) attribute is not in the hidden state
- {{HTMLElement("object")}}, if the [`usemap`](/en-US/docs/Web/HTML/Reference/Element/object#usemap) attribute is present
- {{HTMLElement("video")}}, if the [`controls`](/en-US/docs/Web/HTML/Reference/Element/video#controls) attribute is present
