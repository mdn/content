...
The **`type`** attribute of the [`<script>`](/en-US/docs/Web/HTML/Element/script) element indicates the _type_ of script represented by the element: a classic script, an import map, a JavaScript module, speculation rules, or a data block.
