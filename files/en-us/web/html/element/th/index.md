...
The **`<th>`** [HTML](/en-US/docs/Web/HTML) element defines a cell as header of a group of table cells. The exact nature of this group is defined by the [`scope`](/en-US/docs/Web/HTML/Element/th#scope) and [`headers`](/en-US/docs/Web/HTML/Element/th#headers) attributes.
...
- `align` {{deprecated_inline}}
  ...
  - : This enumerated attribute specifies how the cell content's horizontal alignment will be handled. Possible values are:
    ...
    - `char` (with text only): The content is aligned to a character inside the `<th>` element with minimal offset. This character is defined by the [`char`](/en-US/docs/Web/HTML/Element/th#char) and [`charoff`](/en-US/docs/Web/HTML/Element/th#charoff) attributes.
    ...
    > - To achieve the same effect as the `char` value, give the {{cssxref("text-align")}} property the same value you would use for the [`char`](/en-US/docs/Web/HTML/Element/th#char).

- `axis` {{deprecated_inline}}

  - : This attribute contains a list of space-separated strings. Each string is the `id` of a group of cells that this header applies to.

    > **Note:** Do not use this attribute as it is obsolete in the latest standard: use the [`scope`](/en-US/docs/Web/HTML/Element/th#scope) attribute instead.
...
- `char` {{deprecated_inline}}
  ...
  - : The content in the cell element is aligned to a character. Typical values include a period (.) to align numbers or monetary values. If [`align`](/en-US/docs/Web/HTML/Element/th#align) is not set to `char`, this attribute is ignored.
