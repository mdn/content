...
- {{HTMLAttrDef("declare")}} {{deprecated_inline}}
  - : The presence of this Boolean attribute makes this element a declaration only. The object must be instantiated by a subsequent `<object>` element. In HTML, repeat the `<object>` element completely each time that the resource is reused.
- {{HTMLAttrDef("form")}}
