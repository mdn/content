...
<p>The {{htmlelement("meta")}} element can be used to provide document metadata in terms of name-value pairs, with the {{htmlattrxref("name", "meta")}} attribute giving the metadata name, and the {{htmlattrxref("content", "meta")}} attribute giving the value.</p>
...
<p>The HTML specification defines the following set of standard metadata names:</p>
...
<ul>
 ...
 <li><code>description</code>: a short and accurate summary of the content of the page. Several browsers, like Firefox and Opera, use this as the default description of bookmarked pages.</li>
 ...
 <li><code>referrer</code>: controls the HTTP {{httpheader("Referer")}} header for to requests sent from the document:
 ...
 <li><code><a href="/en-US/docs/Web/HTML/Element/meta/name/theme-color">theme-color</a></code>: indicates a suggested color that user agents should use to customize the display of the page or of the surrounding user interface. The <code>content</code> attribute contains a valid CSS {{cssxref("&lt;color&gt;")}}.</li>
 <li>
  ...
  <dl>
   ...
   <dd>The document is unaware of color schemes and should be rendered using the default color palette.</dd>
...
<ul>
 <li>
  ...
  <table class="fullwidth-table">
   ...
   <tbody>
    ...
    <tr>
     ...
     <td>A positive number between <code>0.0</code> and <code>10.0</code></td>
     <td>Defines the maximum amount to zoom in. It must be greater or equal to the <code>minimum-scale</code> or the behavior is undefined. Browser settings can ignore this rule and iOS10+ ignores it by default.</td>
    </tr>
    <tr>
     <td><code>minimum-scale</code></td>
     <td>A positive number between <code>0.0</code> and <code>10.0</code></td>
     <td>Defines the minimum zoom level. It must be smaller or equal to the <code>maximum-scale</code> or the behavior is undefined. Browser settings can ignore this rule and iOS10+ ignores it by default.</td>
    </tr>
    <tr>
    ...
    <tr>
     ...
     <td>
      ...
      <p>The <code>cover</code> value means that the viewport is scaled to fill the device display. It is highly recommended to make use of the <a href="/en-US/docs/Web/CSS/env()">safe area inset</a> variables to ensure that important content doesn't end up outside the display.</p>
     </td>
    </tr>
   </tbody>
  </table>
  ...
  <p>The <a href="/en-US/docs/Web/CSS/@viewport"><code>@viewport</code></a> CSS at-rule.</p>
 </li>
</ul>

<h3 id="Other_metadata_names">Other metadata names</h3>

<p>The <a href="https://wiki.whatwg.org/wiki/MetaExtensions">WHATWG Wiki MetaExtensions page</a> contains a large set of non-standard metadata names that have not been formally accepted yet; however, some of the names included there are already used quite commonly in practice — including the following:</p>
...
<ul>
 ...
 <li><code>robots</code>: the behavior that cooperative crawlers, or "robots", should use with the page. It is a comma-separated list of the values below:
  <table class="standard-table">
