...
- `align` {{deprecated_inline}}
  ...
  - : This [enumerated](/en-US/docs/Glossary/Enumerated) attribute specifies how the cell content's horizontal alignment will be handled. Possible values are:
    ...
    - `char` (with text only): The content is aligned to a character inside the `<th>` element with minimal offset. This character is defined by the [`char`](/en-US/docs/Web/HTML/Element/td#char) and [`charoff`](/en-US/docs/Web/HTML/Element/td#charoff) attributes.
    ...
    > - To achieve the same effect as the `char` value, give the {{cssxref("text-align")}} property the same value you would use for the [`char`](/en-US/docs/Web/HTML/Element/td#char).
...
- `char` {{deprecated_inline}}
  - : The content in the cell element is aligned to a character. Typical values include a period (.) to align numbers or monetary values. If [`align`](/en-US/docs/Web/HTML/Element/td#align) is not set to `char`, this attribute is ignored.
