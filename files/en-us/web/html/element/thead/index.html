...
<p>The <strong><code>&lt;thead&gt;</code></strong> <a href="/en-US/docs/Web/HTML">HTML</a> element defines a set of rows defining the head of the columns of the table.</p>
...
<dl>
 ...
 <ul>
  ...
  <li><code>char</code>, aligning the textual content on a special character with a minimal offset, defined by the {{htmlattrxref("char", "thead")}} and {{htmlattrxref("charoff", "thead")}} attributes.</li>
 </ul>
 ...
 <ul>
  ...
  <li>To achieve the same effect as the <code>char</code> value, in CSS3, you can use the value of the {{htmlattrxref("char", "thead")}} as the value of the {{cssxref("text-align")}} property.</li>
 </ul>
 </div>
 </dd>
 <dt>{{htmlattrdef("bgcolor")}} {{Non-standard_inline}}</dt>
 <dd>This attribute defines the background color of each cell of the column. It is one of the 6-digit hexadecimal code as defined in <a href="https://www.w3.org/Graphics/Color/sRGB">sRGB</a>, prefixed by a '#'. One of the sixteen predefined color strings may be used:
 <ul>
  <li><code>black</code> = "#000000"</li>
  <li><code>green</code> = "#008000"</li>
  <li><code>silver</code> = "#C0C0C0"</li>
  <li><code>lime</code> = "#00FF00"</li>
  <li><code>gray</code> = "#808080"</li>
  <li><code>olive</code> = "#808000"</li>
  <li><code>white</code> = "#FFFFFF"</li>
  <li><code>yellow</code> = "#FFFF00"</li>
  <li><code>maroon</code> = "#800000"</li>
  <li><code>navy</code> = "#000080"</li>
  <li><code>red</code> = "#FF0000"</li>
  <li><code>blue</code> = "#0000FF"</li>
  <li><code>purple</code> = "#800080"</li>
  <li><code>teal</code> = "#008080"</li>
  <li><code>fuchsia</code> = "#FF00FF"</li>
