...
<table class="properties">
 <tbody>
  ...
  <tr>
   ...
   <td>The end tag can be omitted if the list item is immediately followed by another {{HTMLElement("li")}} element, or if there is no more content in its parent element.</td>
  </tr>
  <tr>
  ...
  <tr>
   ...
   <td><code><a href="/en-US/docs/Web/Accessibility/ARIA/Roles/Listitem_role">listitem</a></code> when child of an <code><a href="/en-US/docs/Web/HTML/Element/ol">ol</a></code>, <code><a href="/en-US/docs/Web/HTML/Element/ul">ul</a></code> or <code><a href="/en-US/docs/Web/HTML/Element/menu">menu</a></code></td>
  </tr>
  <tr>
...
<p>For more detailed examples, see the {{htmlelement("ol")}} and {{htmlelement("ul")}} pages.</p>
...
<ul>
 <li>Other list-related HTML Elements: {{HTMLElement("ul")}}, {{HTMLElement("ol")}}, {{HTMLElement("menu")}}, and the obsolete {{HTMLElement("dir")}};</li>
 <li>CSS properties that may be specially useful to style the <code>&lt;li&gt;</code> element:
  <ul>
   ...
   <li><a href="/en-US/docs/Web/CSS/CSS_Lists_and_Counters/Using_CSS_counters">CSS counters</a>, to handle complex nested lists,</li>
