...
> **Note:** This topic documents only the element that is defined as part of [HTML Living Standard](https://html.spec.whatwg.org/#the-embed-element). It does not address earlier, non-standardized implementation of the element.
