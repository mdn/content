...
- `cols` {{non-standard_inline}} {{deprecated_inline}}
  - : Contains the _preferred_ count of characters that a line should have. It was a non-standard synonym of [`width`](/en-US/docs/Web/HTML/Element/pre#width). To achieve such an effect, use CSS {{Cssxref("width")}} instead.
