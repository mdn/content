...
Paragraphs are [block-level elements](/en-US/docs/Glossary/block-level), and notably will automatically close if another block-level element is parsed before the closing `</p>` tag. See "Tag omission" below.
