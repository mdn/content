...
<p>The <strong><code>&lt;time&gt;</code></strong> <a href="/en-US/docs/Web/HTML">HTML</a> element represents a specific period in time. It may include the <code>datetime</code> attribute to translate dates into machine-readable format, allowing for better search engine results or custom features such as reminders.</p>

<p>It may represent one of the following:</p>

<ul>
 <li>A time on a 24-hour clock.</li>
 <li>A precise date in the {{interwiki("wikipedia", "Gregorian calendar")}} (with optional time and timezone information).</li>
 <li><a href="https://www.w3.org/TR/2014/REC-html5-20141028/infrastructure.html#valid-duration-string">A valid time duration</a>.</li>
</ul>
...
<dl>
 ...
 <dd>This attribute indicates the time and/or date of the element and must be in one of the formats described below.</dd>
</dl>

<h2 id="Usage_notes">Usage notes</h2>

<p>This element is for presenting dates and times in a machine readable format. For example, this can help a user agent offer to add an event to a user's calendar.</p>
...
<pre class="brush: html">&lt;p&gt;The concert starts at &lt;time datetime="2018-07-07T20:00:00"&gt;20:00&lt;/time&gt;.&lt;/p&gt;
</pre>
...
<pre class="brush: html">&lt;p&gt;The concert took place on &lt;time
