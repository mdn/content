...
<table class="properties">
 <tbody>
  ...
  <tr>
   ...
   <td>Any element that accepts <a href="/en-US/docs/Web/Guide/HTML/Content_categories#phrasing_content">phrasing content</a>. The <code>&lt;area&gt;</code> element must have an ancestor {{HTMLElement("map")}}, but it need not be a direct parent.</td>
  </tr>
  <tr>
   <th scope="row">Implicit ARIA role</th>
   <td>{{ARIARole("link")}} when {{htmlattrxref("href", "area")}} attribute is present, otherwise <a href="https://www.w3.org/TR/html-aria/#dfn-no-corresponding-role">no corresponding role</a></td>
  </tr>
  <tr>
...
<dl>
 ...
 <ul>
  ...
  <li><code>circle</code>: the value is <code><var>x,y,radius</var></code>. Value specifies the coordinates of the circle center and the radius.<br>
   For example: <code>&lt;area shape="circle" coords="130,136,60" href="#" target="_blank" alt="MDN"&gt;</code></li>
  <li><code>poly</code>: the value is <code><var>x1,y1,x2,y2,..,xn,yn</var></code>. Value specifies the coordinates of the edges of the polygon. If the first and last coordinate pairs are not the same, the browser will add the last coordinate pair to close the polygon</li>
  <li><code>default</code>: defines the entire region</li>
 </ul>
 The values are numbers of CSS pixels.</dd>
 ...
 <dd>The hyperlink target for the area. Its value is a valid URL. This attribute may be omitted; if so, the <code>&lt;area&gt;</code> element does not represent a hyperlink.</dd>
