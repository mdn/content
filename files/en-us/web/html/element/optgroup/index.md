...
<p>The <strong><code>&lt;optgroup&gt;</code></strong> <a href="/en-US/docs/Web/HTML">HTML</a> element creates a grouping of options within a {{HTMLElement("select")}} element.</p>
...
<table class="properties">
 <tbody>
  ...
  <tr>
   ...
   <td>The start tag is mandatory. The end tag is optional if this element is immediately followed by another <code>&lt;optgroup&gt;</code> element, or if the parent element has no more content.</td>
  </tr>
  <tr>
...
<div class="notecard note">
  <p><strong>Note:</strong> Optgroup elements may not be nested.</p>
</div>
