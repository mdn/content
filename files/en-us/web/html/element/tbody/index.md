...
- If {{HTMLElement("tr")}} elements are specified outside of an existing `<tbody>` element, as direct children of the {{HTMLElement("table")}}, these elements will be encapsulated by a separate `<tbody>` element generated by the browser.
