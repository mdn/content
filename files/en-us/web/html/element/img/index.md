...
- `loading`
  ...
  - : Indicates how the browser should load the image:
    ...
    > **Note:** Images that have `loading` set to `lazy` will never be loaded if they do not intersect a visible part of an element at all, even if loading them would change that. (Since unloaded images have a width and height of 0.)
