...
<p>The <strong><code>&lt;img&gt;</code></strong> <a href="/en-US/docs/Web/HTML">HTML</a> element embeds an image into the document.</p>
...
<ul>
	...
	<li>The <code>alt</code> attribute holds a text description of the image, which isn't mandatory but is <strong>incredibly useful</strong> for accessibility — screen readers read this description out to their users so they know what the image means. Alt text is also displayed on the page if the image can't be loaded for some reason: for example, network errors, content blocking, or linkrot.</li>
</ul>
...
<dl>
	...
	<div class="notecard note">
		<p><strong>Note:</strong> <strong>Note:</strong> This attribute is allowed only if the <code>&lt;img&gt;</code> element is a descendant of an {{htmlelement("a")}} element with a valid {{htmlattrxref("href","a")}} attribute. This gives users without pointing devices a fallback destination.</p>
	</div>
	</dd>
...
<dl>
	...
	<dl>
		...
		<dd>Equivalent to <code>vertical-align: -moz-middle-with-baseline</code></dd>
		<dt><code>bottom</code></dt>
		<dd>The default, equivalent to <code>vertical-align: unset</code> or <code>vertical-align: initial</code></dd>
		<dt><code>left</code></dt>
		<dd>Equivalent to <code>float: left</code></dd>
		<dt><code>right</code></dt>
		<dd>Equivalent to <code>float: right</code></dd>
	</dl>
	</dd>
	...
	<dt>{{htmlattrdef("hspace")}} {{deprecated_inline}}</dt>
	...
	<div class="notecard note">
		<p><strong>Note:</strong> This attribute is mentioned in the latest {{glossary("W3C")}} version, <a href="https://www.w3.org/TR/html52/obsolete.html#element-attrdef-img-longdesc">HTML 5.2</a>, but has been removed from the {{glossary("WHATWG")}}’s <a href="https://html.spec.whatwg.org/multipage/embedded-content.html#the-img-element">HTML Living Standard</a>. It has an uncertain future; authors should use a {{glossary("WAI")}}-{{glossary("ARIA")}} alternative such as <a href="https://www.w3.org/TR/wai-aria-1.1/#aria-describedby"><code>aria-describedby</code></a> or <a href="https://www.w3.org/TR/wai-aria-1.1/#aria-details"><code>aria-details</code></a>.</p>
	</div>
	</dd>
	<dt>{{htmlattrdef("name")}} {{deprecated_inline}}</dt>
	<dd>A name for the element. Use the {{htmlattrxref("id")}} attribute instead.</dd>
	<dt>{{htmlattrdef("vspace")}} {{deprecated_inline}}</dt>
...
<div class="notecard note">
	<p><strong>Note:</strong> To see the resizing in action, {{LiveSampleLink('Using_the_srcset_and_sizes_attributes', 'view the example on a separate page')}}, so you can actually resize the content area.</p>
</div>
...
<ul>
	<li><a href="https://www.w3.org/WAI/tutorials/images/decision-tree/">An alt Decision Tree • Images • WAI Web Accessibility Tutorials</a></li>
	<li><a href="https://axesslab.com/alt-texts/">Alt-texts: The Ultimate Guide — Axess Lab</a></li>
	<li><a href="https://www.deque.com/blog/great-alt-text-introduction/">How to Design Great Alt Text: An Introduction | Deque</a></li>
	...
	<li><a href="https://www.w3.org/TR/UNDERSTANDING-WCAG20/text-equiv-all.html">Understanding Success Criterion 1.1.1 | W3C Understanding WCAG 2.0</a></li>
</ul>
