...
<p>The <strong><code>&lt;address&gt;</code></strong> <a href="/en-US/docs/Web/HTML">HTML</a> element indicates that the enclosed HTML provides contact information for a person or people, or for an organization.</p>
...
<table class="properties">
 <tbody>
  ...
  <tr>
   ...
   <td><a href="/en-US/docs/Web/Guide/HTML/Content_categories#flow_content">Flow content</a>, but with no nested <code>&lt;address&gt;</code> element, no heading content ({{HTMLElement("hgroup")}}, {{HTMLElement("h1")}}, {{HTMLElement("h2")}}, {{HTMLElement("h3")}}, {{HTMLElement("h4")}}, {{HTMLElement("h5")}}, {{HTMLElement("h6")}}), no sectioning content ({{HTMLElement("article")}}, {{HTMLElement("aside")}}, {{HTMLElement("section")}}, {{HTMLElement("nav")}}), and no {{HTMLElement("header")}} or {{HTMLElement("footer")}} element.</td>
  </tr>
  <tr>
...
<ul>
 <li>The <code>&lt;address&gt;</code> element can only be used to represent the contact information for its nearest {{HTMLElement("article")}} or {{HTMLElement("body")}} element ancestor.</li>
 ...
 <li>Typically an <code>&lt;address&gt;</code> element can be placed inside the {{HTMLElement("footer")}} element of the current section, if any.</li>
</ul>

<h2 id="Examples">Examples</h2>

<p>This example demonstrates the use of <code>&lt;address&gt;</code> to demarcate the contact information for an article's author.</p>
...
<p>Although it renders text with the same default styling as the {{HTMLElement("i")}} or {{HTMLElement("em")}} elements, it is more appropriate to use <code>&lt;address&gt;</code> when dealing with contact information, as it conveys additional semantic information.</p>
