...
- `method`
  ...
  - : The [HTTP](/en-US/docs/Web/HTTP) method to submit the form with.
    ...
    - `dialog`: When the form is inside a {{HTMLElement("dialog")}}, closes the dialog and emits a submit event on submission without submitting data or clearing the form.
