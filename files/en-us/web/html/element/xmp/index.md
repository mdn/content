...
<ul>
 ...
 <li>A monospaced font can also be obtained on any element, by applying an adequate <a href="/en-US/docs/Web/CSS">CSS</a> style using <code>monospace</code> as the generic-font value for the {{cssxref("font-family")}} property.</li>
</ul>
</div>
