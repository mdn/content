...
<table class="properties">
 <tbody>
  ...
  <tr>
   ...
   <td>A {{HTMLElement("head")}} that doesn't contain another {{HTMLElement("base")}} element.</td>
  </tr>
  <tr>
...
<p><strong>Warning:</strong> If either of the following attributes are specified, this element <strong>must</strong> come before other elements with attribute values of URLs, such as {{HTMLElement("link")}}’s <code>href</code> attribute.</p>
</div>
...
<p>Links pointing to a fragment in the document — e.g. <code>&lt;a href="#some-id"&gt;</code> — are resolved with the <code>&lt;base&gt;</code>, triggering an HTTP request to the base URL with the fragment attached. For example:</p>

<ol>
 <li>Given <code>&lt;base href="https://example.com"&gt;</code></li>
 <li>...and this link: <code>&lt;a href="#anchor"&gt;Anker&lt;/a&gt;</code></li>
 <li>...the link points to <code>https://example.com/#anchor</code>.</li>
</ol>

<h3 id="Open_Graph">Open Graph</h3>

<p><a href="https://ogp.me/">Open Graph</a> tags do not acknowledge <code>&lt;base&gt;</code>, and should always have full absolute URLs. For example:</p>
