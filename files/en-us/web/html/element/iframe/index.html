...
<p>The <strong><code>&lt;iframe&gt;</code></strong> <a href="/en-US/docs/Web/HTML">HTML</a> element represents a nested {{Glossary("browsing context")}}, embedding another HTML page into the current one.</p>
...
<dl>
 ...
 <ul>
  ...
  <li><code>allow-pointer-lock</code>: Lets the resource use the <a href="/en-US/docs/Web/API/Pointer_Lock_API">Pointer Lock API</a>.</li>
...
<pre class="brush: html">&lt;iframe src="https://example.org"
