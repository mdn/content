...
|-------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
<<<<<<< HEAD
| {{HTMLElement("input/button",   "button")}}                 | A push button with no default behavior   displaying the value of the [value](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/input#value) attribute, empty by                default.                                                                                                                                                                                                                                                                                                                                                          |
=======
...
>>>>>>> 908bb8f2dad1029b1b554688060c956d739996d0
