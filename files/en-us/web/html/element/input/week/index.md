...
A string representing the value of the week/year entered into the input. The format of the date and time value used by this input type is described in [Format of a valid week string](/en-US/docs/Web/HTML/Date_and_time_formats#format_of_a_valid_week_string).
