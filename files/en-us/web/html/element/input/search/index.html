...
<p>{{HTMLElement("input")}} elements of type <code><strong>search</strong></code> are text fields designed for the user to enter search queries into. These are functionally identical to <code><a href="/en-US/docs/Web/HTML/Element/input/text">text</a></code> inputs, but may be styled differently by the {{Glossary("user agent")}}.</p>
...
<p><img alt="" src="firefox-auto-complete.png">At this point, let's look at some useful techniques you can apply to your search forms.</p>
...
<p><img alt="form field with attached message that says Please fill out this field" src="firefox-required-message.png"></p>
...
<p>You can use the {{htmlattrxref("pattern", "input")}} attribute to specify a regular expression that the inputted value must follow to be considered valid (see <a href="/en-US/docs/Learn/Forms/Form_validation#validating_against_a_regular_expression">Validating against a regular expression</a> for a simple crash course).</p>
...
<p>You can see a good example of a search form used in context at our <a class="external external-icon" href="https://github.com/mdn/learning-area/tree/master/accessibility/aria/website-aria-roles">website-aria-roles</a> example (<a class="external external-icon" href="https://mdn.github.io/learning-area/accessibility/aria/website-aria-roles/">see it live</a>).</p>
