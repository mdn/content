...
<p>{{HTMLElement("input")}} elements of type <code><strong>url</strong></code> are used to let the user enter and edit a URL.</p>
...
<pre class="brush: html">&lt;input id="myURL" name="myURL" type="url"&gt;</pre>
