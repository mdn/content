...
By default, the granularity, is 1, meaning that the value is always an integer. You can change the [`step`](/en-US/docs/Web/HTML/Global_attributes#step) attribute to control the granularity. For example, If you need a value to be halfway between 5 and 10 you should set the value of `step` to 0.5:
