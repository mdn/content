...
<p>{{HTMLElement("input")}} elements of type <strong><code>image</code></strong> are used to create graphical submit buttons, i.e. submit buttons that take the form of an image rather than text.</p>
...
<p><code>&lt;input type="image"&gt;</code> elements do not accept <code>value</code> attributes. The path to the image to be displayed is specified in the <code>src</code> attribute.</p>
...
<h2 id="Using_image_inputs">Using image inputs</h2>

<p>The <code>&lt;input type="image"&gt;</code> element is a <a href="/en-US/docs/Web/CSS/Replaced_element">replaced element</a> (an element whose content isn't generated or directly managed by the CSS layer), behaving in much the same way as a regular {{htmlelement("img")}} element, but with the capabilities of a <a href="/en-US/docs/Web/HTML/Element/input/submit">submit button</a>.</p>

<h3 id="Essential_image_input_features">Essential image input features</h3>
...
<h3 id="Overriding_default_form_behaviors">Overriding default form behaviors</h3>
