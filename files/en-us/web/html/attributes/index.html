...
<table class="standard-table">
 ...
 <tbody>
  <tr>
   <td><code><a href="/en-US/docs/Web/HTML/Attributes/accept">accept</a></code></td>
  ...
  <tr>
   <td><code><a href="/en-US/docs/Web/HTML/Attributes/action">action</a></code></td>
   <td>{{ HTMLElement("form") }}</td>
   <td>The URI of a program that processes the information submitted via the form.</td>
  </tr>
  <tr>
   <td><code><a href="/en-US/docs/Web/HTML/Attributes/align">align</a></code></td>
  ...
  <tr>
   <td><code><a href="/en-US/docs/Web/HTML/Attributes/alt">alt</a></code></td>
  ...
  <tr>
   <td><code><a href="/en-US/docs/Web/HTML/Global_attributes/autocapitalize">autocapitalize</a></code></td>
   <td><a href="/en-US/docs/Web/HTML/Global_attributes">Global attribute</a></td>
  ...
  <tr>
   <td><code><a href="/en-US/docs/Web/HTML/Attributes/autoplay">autoplay</a></code></td>
  ...
  <tr>
   ...
   <td>
    ...
    <div class="note">
    <p><strong>Note:</strong> This is a legacy attribute. Please use the CSS {{ Cssxref("background-color") }} property instead.</p>
    </div>
   </td>
  </tr>
  <tr>
   ...
   <td>
    ...
    <div class="note">
    <p><strong>Note:</strong> This is a legacy attribute. Please use the CSS {{ Cssxref("border") }} property instead.</p>
    </div>
   </td>
  </tr>
  <tr>
   <td><code><a href="/en-US/docs/Web/HTML/Attributes/buffered">buffered</a></code></td>
   <td>{{ HTMLElement("audio") }}, {{ HTMLElement("video") }}</td>
  ...
  <tr>
   <td><code><a href="/en-US/docs/Web/HTML/Global_attributes/class">class</a></code></td>
   <td><a href="/en-US/docs/Web/HTML/Global_attributes">Global attribute</a></td>
  ...
  <tr>
   ...
   <td>
    ...
    <div class="note">
    <p><strong>Note:</strong> This is a legacy attribute. Please use the CSS {{ Cssxref("color") }} property instead.</p>
    </div>
   </td>
  </tr>
  <tr>
  ...
  <tr>
   <td><code><a href="/en-US/docs/Web/HTML/Attributes/colspan">colspan</a></code></td>
  ...
  <tr>
   <td><code><a href="/en-US/docs/Web/HTML/Global_attributes/contenteditable">contenteditable</a></code></td>
   <td><a href="/en-US/docs/Web/HTML/Global_attributes">Global attribute</a></td>
   <td>Indicates whether the element's content is editable.</td>
  </tr>
  <tr>
   <td><code><a href="/en-US/docs/Web/HTML/Attributes/contextmenu">contextmenu</a></code></td>
   <td><a href="/en-US/docs/Web/HTML/Global_attributes">Global attribute</a></td>
   <td>Defines the ID of a {{ HTMLElement("menu") }} element which will serve as the element's context menu.</td>
  </tr>
  <tr>
   <td><code><a href="/en-US/docs/Web/HTML/Attributes/controls">controls</a></code></td>
   <td>{{ HTMLElement("audio") }}, {{ HTMLElement("video") }}</td>
  ...
  <tr>
   <td><code><a href="/en-US/docs/Web/HTML/Attributes/crossorigin">crossorigin</a></code></td>
  ...
  <tr>
   <td><code><a href="/en-US/docs/Web/API/HTMLIFrameElement/csp">csp</a></code> {{experimental_inline}}</td>
   <td>{{ HTMLElement("iframe") }}</td>
  ...
  <tr>
   <td><code><a href="/en-US/docs/Web/HTML/Attributes/datetime">datetime</a></code></td>
  ...
  <tr>
   <td><code><a href="/en-US/docs/Web/HTML/Global_attributes/dir">dir</a></code></td>
   <td><a href="/en-US/docs/Web/HTML/Global_attributes">Global attribute</a></td>
   <td>Defines the text direction. Allowed values are ltr (Left-To-Right) or rtl (Right-To-Left)</td>
  </tr>
  <tr>
   <td><code><a href="/en-US/docs/Web/HTML/Attributes/dirname">dirname</a></code></td>
  ...
  <tr>
   <td><code><a href="/en-US/docs/Web/HTML/Attributes/download">download</a></code></td>
   <td>{{ HTMLElement("a") }}, {{ HTMLElement("area") }}</td>
   <td>Indicates that the hyperlink is to be used for downloading a resource.</td>
  </tr>
  <tr>
   <td><code><a href="/en-US/docs/Web/HTML/Global_attributes/draggable">draggable</a></code></td>
   <td><a href="/en-US/docs/Web/HTML/Global_attributes">Global attribute</a></td>
  ...
  <tr>
   <td><code><a href="/en-US/docs/Web/HTML/Attributes/for">for</a></code></td>
  ...
  <tr>
   <td><code><a href="/en-US/docs/Web/HTML/Attributes/formaction">formaction</a></code></td>
  ...
  <tr>
   <td><code><a href="/en-US/docs/Web/HTML/Attributes/headers">headers</a></code></td>
   <td>{{ HTMLElement("td") }}, {{ HTMLElement("th") }}</td>
  ...
  <tr>
   <td><code><a href="/en-US/docs/Web/HTML/Global_attributes/hidden">hidden</a></code></td>
   <td><a href="/en-US/docs/Web/HTML/Global_attributes">Global attribute</a></td>
  ...
  <tr>
   <td><code><a href="/en-US/docs/Web/HTML/Attributes/href">href</a></code></td>
   <td>{{ HTMLElement("a") }}, {{ HTMLElement("area") }}, {{ HTMLElement("base") }}, {{ HTMLElement("link") }}</td>
   <td>The URL of a linked resource.</td>
  </tr>
  <tr>
   <td><code><a href="/en-US/docs/Web/HTML/Attributes/hreflang">hreflang</a></code></td>
  ...
  <tr>
   <td><code><a href="/en-US/docs/Web/HTML/Global_attributes/id">id</a></code></td>
   <td><a href="/en-US/docs/Web/HTML/Global_attributes">Global attribute</a></td>
  ...
  <tr>
   ...
   <td>
    <p>Specifies a <a href="/en-US/docs/Web/Security/Subresource_Integrity">Subresource Integrity</a> value that allows browsers to verify what they fetch.</p>
   </td>
  </tr>
  <tr>
  ...
  <tr>
   <td><code><a href="/en-US/docs/Web/HTML/Global_attributes/itemprop">itemprop</a></code></td>
   <td><a href="/en-US/docs/Web/HTML/Global_attributes">Global attribute</a></td>
   <td></td>
  </tr>
  <tr>
  ...
  <tr>
   <td><code><a href="/en-US/docs/Web/HTML/Attributes/label">label</a></code></td>
   <td>{{ HTMLElement("optgroup") }}, {{ HTMLElement("option") }}, {{ HTMLElement("track") }}</td>
   <td>Specifies a user-readable title of the element.</td>
  </tr>
  <tr>
   <td><code><a href="/en-US/docs/Web/HTML/Global_attributes/lang">lang</a></code></td>
   <td><a href="/en-US/docs/Web/HTML/Global_attributes">Global attribute</a></td>
  ...
  <tr>
   <td><code><a href="/en-US/docs/Web/HTML/Attributes/loop">loop</a></code></td>
  ...
  <tr>
   <td><code><a href="/en-US/docs/Web/HTML/Attributes/max">max</a></code></td>
  ...
  <tr>
   <td><code><a href="/en-US/docs/Web/HTML/Attributes/media">media</a></code></td>
  ...
  <tr>
   <td><code><a href="/en-US/docs/Web/HTML/Attributes/min">min</a></code></td>
   <td>{{ HTMLElement("input") }}, {{ HTMLElement("meter") }}</td>
   <td>Indicates the minimum value allowed.</td>
  </tr>
  <tr>
   <td><code><a href="/en-US/docs/Web/HTML/Attributes/multiple">multiple</a></code></td>
  ...
  <tr>
   <td><code><a href="/en-US/docs/Web/HTML/Element/a#attr-ping">ping</a></code></td>
   <td>{{ HTMLElement("a") }}, {{ HTMLElement("area") }}</td>
  ...
  <tr>
   <td><code><a href="/en-US/docs/Web/HTML/Attributes/placeholder">placeholder</a></code></td>
   <td>{{ HTMLElement("input") }}, {{ HTMLElement("textarea") }}</td>
  ...
  <tr>
   <td><code><a href="/en-US/docs/Web/HTML/Attributes/preload">preload</a></code></td>
   <td>{{ HTMLElement("audio") }}, {{ HTMLElement("video") }}</td>
  ...
  <tr>
   <td><code><a href="/en-US/docs/Web/HTML/Attributes/readonly">readonly</a></code></td>
   <td>{{ HTMLElement("input") }}, {{ HTMLElement("textarea") }}</td>
   <td>Indicates whether the element can be edited.</td>
  </tr>
  <tr>
   <td><code><a href="/en-US/docs/Web/HTML/Attributes/referralpolicy">referrerpolicy</a></code></td>
  ...
  <tr>
   <td><code><a href="/en-US/docs/Web/HTML/Attributes/rel">rel</a></code></td>
   <td>{{ HTMLElement("a") }}, {{ HTMLElement("area") }}, {{ HTMLElement("link") }}</td>
  ...
  <tr>
   <td><code><a href="/en-US/docs/Web/HTML/Attributes/rowspan">rowspan</a></code></td>
   <td>{{ HTMLElement("td") }}, {{ HTMLElement("th") }}</td>
   <td>Defines the number of rows a table cell should span over.</td>
  </tr>
  <tr>
   <td><code><a href="/en-US/docs/Web/HTML/Element/iframe#attr-sandbox">sandbox</a></code></td>
   <td>{{ HTMLElement("iframe") }}</td>
  ...
  <tr>
   <td><code><a href="/en-US/docs/Web/HTML/Attributes/shape">shape</a></code></td>
   <td>{{ HTMLElement("a") }}, {{ HTMLElement("area") }}</td>
   <td></td>
  </tr>
  <tr>
   <td><code><a href="/en-US/docs/Web/HTML/Attributes/size">size</a></code></td>
   <td>{{ HTMLElement("input") }}, {{ HTMLElement("select") }}</td>
  ...
  <tr>
   <td><code><a href="/en-US/docs/Web/HTML/Attributes/sizes">sizes</a></code></td>
  ...
  <tr>
   <td><code><a href="/en-US/docs/Web/HTML/Attributes/span">span</a></code></td>
   <td>{{ HTMLElement("col") }}, {{ HTMLElement("colgroup") }}</td>
   <td></td>
  </tr>
  <tr>
   <td><code><a href="/en-US/docs/Web/HTML/Global_attributes/spellcheck">spellcheck</a></code></td>
   <td><a href="/en-US/docs/Web/HTML/Global_attributes">Global attribute</a></td>
   <td>Indicates whether spell checking is allowed for the element.</td>
  </tr>
  <tr>
   <td><code><a href="/en-US/docs/Web/HTML/Attributes/src">src</a></code></td>
  ...
  <tr>
   <td><code><a href="/en-US/docs/Web/HTML/Attributes/srcset">srcset</a></code></td>
  ...
  <tr>
   <td><code><a href="/en-US/docs/Web/HTML/Attributes/step">step</a></code></td>
   <td>{{ HTMLElement("input") }}</td>
   <td></td>
  </tr>
  <tr>
   <td><code><a href="/en-US/docs/Web/HTML/Global_attributes/style">style</a></code></td>
   <td><a href="/en-US/docs/Web/HTML/Global_attributes">Global attribute</a></td>
  ...
  <tr>
   <td><code><a href="/en-US/docs/Web/HTML/Global_attributes/tabindex">tabindex</a></code></td>
   <td><a href="/en-US/docs/Web/HTML/Global_attributes">Global attribute</a></td>
   <td>Overrides the browser's default tab order and follows the one specified instead.</td>
  </tr>
  <tr>
   <td><code><a href="/en-US/docs/Web/HTML/Attributes/target">target</a></code></td>
   <td>{{ HTMLElement("a") }}, {{ HTMLElement("area") }}, {{ HTMLElement("base") }}, {{ HTMLElement("form") }}</td>
   <td>Specifies where to open the linked document (in the case of an <code>&lt;a&gt;</code> element) or where to display the response received (in the case of a <code>&lt;form&gt;</code> element)</td>
  </tr>
  <tr>
   <td><code><a href="/en-US/docs/Web/HTML/Global_attributes/title">title</a></code></td>
   <td><a href="/en-US/docs/Web/HTML/Global_attributes">Global attribute</a></td>
  ...
  <tr>
   ...
   <td>{{ HTMLElement("button") }}, {{ HTMLElement("input") }}, {{ HTMLElement("command") }}, {{ HTMLElement("embed") }}, {{ HTMLElement("object") }}, {{ HTMLElement("script") }}, {{ HTMLElement("source") }}, {{ HTMLElement("style") }}, {{ HTMLElement("menu") }}, {{ HTMLElement("link") }}</td>
   <td>Defines the type of the element.</td>
  </tr>
  <tr>
   <td><code><a href="/en-US/docs/Web/HTML/Attributes/usemap">usemap</a></code></td>
  ...
  <tr>
   <td><code><a href="/en-US/docs/Web/HTML/Attributes/width">width</a></code></td>
   <td>{{ HTMLElement("canvas") }}, {{ HTMLElement("embed") }}, {{ HTMLElement("iframe") }}, {{ HTMLElement("img") }}, {{ HTMLElement("input") }}, {{ HTMLElement("object") }}, {{ HTMLElement("video") }}</td>
   <td>
...
<p>Some content attributes (e.g. <code>required</code>, <code>readonly</code>, <code>disabled</code>) are called <a href="https://www.w3.org/TR/html52/infrastructure.html#sec-boolean-attributes">boolean attributes</a>. If a boolean attribute is present, its value is <strong>true</strong>, and if it’s absent, its value is <strong>false</strong>.</p>
