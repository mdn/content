...
- "`street-address`"
  ...
  - "`shipping`"
  - : means the given street address is where to send the product or act of service.
  - "`billing`"
  - : means the provided street address is where to send the receipt of the purchased product or service.
