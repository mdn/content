...
| [`compression-dictionary`](/en-US/docs/Web/HTML/Attributes/rel/dns-prefetch) | Link to a {{glossary("Compression dictionary transport", "compression dictionary")}} that can be used to compress future downloads for resources on this site.                                                                                                                          | Link                    | Not allowed                                      | Not allowed             |
