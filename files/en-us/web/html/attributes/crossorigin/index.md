...
<table class="no-markdown">
  <tbody>
    ...
    <tr>
      ...
      <td>
        When resource is placed in {{HTMLElement("canvas")}}, element is marked as "[tainted](https://developer.mozilla.org/en-US/docs/Web/HTML/CORS_enabled_image#what_is_a_tainted_canvas)".
      </td>
    </tr>
    <tr>
