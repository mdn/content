...
<p>This page lists a number of impressive web technology demos for you to get inspiration from, and generally have fun with. A testament to what can be done with JavaScript, WebGL, and related technologies. The first two sections list playable games, while the second is a catch-all area to list demos that aren't necessarily interactive/games.</p>
...
<dl>
 ...
 <dt><a href="https://github.com/kripken/BananaBread/">BananaBread</a></dt>
 ...
 <dt><a href="https://maximumroulette.com/applications/visual-typescript-game-engine/single-player/app.html">Classic Platformer </a></dt>
 <dd>Canvas 2D game based on `Visual-ts game engine` - physics based on Matter.js </dd>
</dl>
...
<p><strong><a href="https://www.crazygames.com/game/bullet-force-multiplayer">Bullet Force</a></strong><br>
     3D multiplayer first-person shooter.</p>
...
<dl>
 ...
 <dt><a href="https://katan.io/">Katan.io</a></dt>
 <dd>HTML5 and canvas implementation of Settlers of Catan.</dd>
...
<dl>
 ...
 <dd>A planet with orbiting asteroid belt.</dd>
 ...
 <dd>Rainbow-colored particles, falling like rain, bouncing around on a terrain of orbs.</dd>
 ...
 <dt><a href="https://codepen.io/AshKyd/pen/zxmgzV">SVG isometric tiles</a></dt>
 <dd>Generating isometric tiles with SVG matrices.</dd>
