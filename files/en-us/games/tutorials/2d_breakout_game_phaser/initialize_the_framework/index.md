...
2. Choose an option that suits you best — I would recommend the _min.js_ option as it keeps the source code smaller, and you are unlikely need to go through the source code anyway. **Please make sure to use Phaser version 2 as that's what this tutorial was written for.**
