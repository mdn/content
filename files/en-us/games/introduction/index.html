...
<p>The range of games that can be created is on par with desktop and native OS counterparts. With modern Web technologies and a recent browser, it's entirely possible to make stunning, top-notch games for the Web. And we're not talking about simple card games or multi-player social games that have in the olden days been done using Flash®. We're talking about kick-ass 3D action shooters, RPGs, and more. Thanks to massive performance improvements in <a href="/en-US/docs/Web/JavaScript">JavaScript</a> just-in-time compiler technology and new APIs, you can build games that run in the browser (or on <a href="/en-US/docs/Web/Guide/HTML/HTML5">HTML5</a>-powered devices like those based on <a href="/en-US/docs/Glossary/Firefox_OS">Firefox OS</a>) without making compromises.</p>

<h2 id="The_HTML5_game_platform">The HTML5 game platform</h2>
...
<h2 id="The_business_case">The business case</h2>

<p>As a game developer, whether you're an individual or a large game studio, you want to know why it makes sense to target the Web with your next game project. Let's look at how the Web can help you.</p>

<ol>
 <li>
  <div>The reach of the Web is enormous; it's everywhere. Games built with HTML5 work on smartphones, tablets, PCs and Smart TVs.</div>
 </li>
 <li>Marketing and discoverability are improved. You're not limited to promoting your app on someone else's app store. Instead, you can advertise and promote your game all over the Web as well as other media, taking advantage of the Web's inherent linkability and shareability to reach new customers.</li>
 <li>You have control where it matters: Payments. You don't have to hand over 30% of your revenues to someone else just because your game is in their ecosystem. Instead, charge what you want and use whatever payment processing service you like.</li>
 <li>Again with more control, you can update your game whenever you want. No waiting breathlessly for approval while someone hidden within another company decides whether or not your critical bug fix will ship today or tomorrow.</li>
 <li>Control your analytics! Instead of relying on someone else to make all the decisions about what analytics you need, you can collect your own -- or choose the third party that you like the best -- to gather information about your sales and your game's reach.</li>
 <li>You get to manage your customer relationship more closely, in your own way. No more having customer feedback filtered through an app store's limited mechanisms. Engage with your customers the way you want to, without a middleman.</li>
 <li>Your players can play your game anywhere, anytime. Because the Web is ubiquitous, your customers can check their game's status on their phones, tablets, their home laptops, their work desktops, or anything else.</li>
</ol>

<h2 id="Web_technologies_for_game_developers">Web technologies for game developers</h2>
...
<dl>
 ...
 <dd>This simple API lets your game take over the entire screen, thereby immersing the player in action.</dd>
 <dt><a href="/en-US/docs/Web/API/Gamepad_API/Using_the_Gamepad_API">Gamepad API</a></dt>
 <dd>If you want your users to be able to use gamepads or other game controllers to work your game, you'll need this API.</dd>
 <dt><a href="/en-US/docs/Web/HTML">HTML</a> and <a href="/en-US/docs/Web/CSS">CSS</a></dt>
 <dd>Together, these two technologies let you build, style, and lay out your game's user interface. Part of HTML is the {{HTMLElement("canvas")}} element, which provides one way to do 2D graphics.</dd>
 <dt><a href="/en-US/docs/Web/HTML/Element/audio">HTML audio</a></dt>
 <dd>The {{HTMLElement("audio")}} element lets you easily play simple sound effects and music. If your needs are more involved, check out the <a href="/en-US/docs/Web/API/Web_Audio_API">Web Audio API</a> for real audio processing power!</dd>
 <dt><a href="/en-US/docs/Web/API/IndexedDB_API">IndexedDB</a></dt>
 <dd>A powerful data storage API for maintaining user data on their own computer or device. A great way to save game state and other information locally so it doesn't have to be downloaded every time it's needed. Also useful to help make your game playable even when the user isn't connected to the Web (such as when they're stuck on an airplane for hours on end).</dd>
 <dt><a href="/en-US/docs/Web/JavaScript">JavaScript</a></dt>
 <dd>JavaScript, the programming language used on the Web, is blazing fast in modern browsers and getting faster all the time. Use its power to write the code for your game, or look at using technologies like <a href="https://github.com/kripken/emscripten/wiki">Emscripten</a> or <a href="http://asmjs.org/spec/latest/">Asm.js</a> to easily port your existing games.</dd>
 ...
 <dd>Lets you create high-performance, hardware-accelerated 3D (and 2D) graphics from Web content. This is a Web-supported implementation of <a href="https://www.khronos.org/opengles/">OpenGL ES</a> 2.0.</dd>
 ...
 <dt><a href="/en-US/docs/Web/API/XMLHttpRequest">XMLHttpRequest</a> and <a href="/en-US/docs/Web/API/File_and_Directory_Entries_API">File API</a></dt>
