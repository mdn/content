...
<p>This page lists essential core techniques for anyone wanting to develop games using open web technologies.</p>
...
<dl>
 ...
 <dt><a href="/en-US/docs/Web/Performance/Optimizing_startup_performance">Optimizing startup performance</a></dt>
 ...
 <dt><a href="/en-US/docs/Games/Techniques/WebRTC_data_channels">Using WebRTC peer-to-peer data channels</a></dt>
