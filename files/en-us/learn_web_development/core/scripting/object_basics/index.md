...
<table>
  <tbody>
    ...
    <tr>
      ...
      <td>
        <ul>
          <li>Understand that in JavaScript most things are objects, and you've probably used objects every time you've touched JavaScript.</li>
          <li>Basic syntax: Object literals, properties and methods, nesting objects and arrays in objects.</li>
          <li>Using constructors to create a new object.</li>
          <li>Object scope, and <code>this</code>.</li>
          <li>Accessing properties and methods — bracket and dot syntax.</li>
        <ul>
      </td>
    </tr>
  </tbody>
...
Now open your browser's [JavaScript console](/en-US/docs/Learn_web_development/Howto/Tools_and_setup/What_are_browser_developer_tools#the_javascript_console), enter `person` into it, and press <kbd>Enter</kbd>/<kbd>Return</kbd>. You should get a result similar to one of the following lines:
