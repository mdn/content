...
We are applying a style to our [`<h1>`](/en-US/docs/Web/HTML/Reference/Element/Heading_Elements) element. What will happen to other components with `<h1>` elements in them?
