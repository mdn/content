...
3. Let's add in an HTML form that lets you enter a new todo item and submit it into the app. We need a [`<form>`](/en-US/docs/Web/HTML/Reference/Element/form) with a [`<label>`](/en-US/docs/Web/HTML/Reference/Element/label), an [`<input>`](/en-US/docs/Web/HTML/Reference/Element/input), and a [`<button>`](/en-US/docs/Web/HTML/Reference/Element/button). Update your template as follows:
