...
<blockquote
  cite="https://developer.mozilla.org/en-US/docs/Web/HTML/Reference/Element/blockquote">
  <p>
    The <strong>HTML <code>&lt;blockquote&gt;</code> Element</strong> (or
...
<p>
  ...
  <q
    cite="https://developer.mozilla.org/en-US/docs/Web/HTML/Reference/Element/q">
...
<p>
  According to the
  <a href="/en-US/docs/Web/HTML/Reference/Element/blockquote">
...
<p>
  The quote element — <code>&lt;q&gt;</code> — is
  <q cite="https://developer.mozilla.org/en-US/docs/Web/HTML/Reference/Element/q">
    intended for short quotations that don't require paragraph breaks.
  </q>
  — <a href="/en-US/docs/Web/HTML/Reference/Element/q"><cite>MDN q page</cite></a>.
</p>
```
...
If providing the expansion in addition to the abbreviation makes little sense, and the abbreviation or acronym is a fairly shortened term, provide the full expansion of the term as the value of [`title`](/en-US/docs/Web/HTML/Reference/Global_attributes/title) attribute:
