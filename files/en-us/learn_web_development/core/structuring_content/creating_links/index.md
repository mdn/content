...
A basic link is created by wrapping the text or other content inside an {{htmlelement("a")}} element and using the [`href`](/en-US/docs/Web/HTML/Reference/Element/a#href) attribute, also known as a **Hypertext Reference**, or **target**, that contains the web address.
...
In fact, the email address is optional. If you omit it and your [`href`](/en-US/docs/Web/HTML/Reference/Element/a#href) is "mailto:", a new outgoing email window will be opened by the user's email client with no destination address.
