...
- [`allowfullscreen`](/en-US/docs/Web/HTML/Reference/Element/iframe#allowfullscreen)
...
- [`src`](/en-US/docs/Web/HTML/Reference/Element/iframe#src)
...
- [`width`](/en-US/docs/Web/HTML/Reference/Element/iframe#width) and [`height`](/en-US/docs/Web/HTML/Reference/Element/iframe#height)
  - : These attributes specify the width and height you want the iframe to be.
- [`sandbox`](/en-US/docs/Web/HTML/Reference/Element/iframe#sandbox)
...
<table class="standard-table no-markdown">
  ...
  <tbody>
    <tr>
      ...
      <td><a href="/en-US/docs/Web/HTML/Reference/Element/embed#src"><code>src</code></a></td>
      <td><a href="/en-US/docs/Web/HTML/Reference/Element/object#data"><code>data</code></a></td>
    </tr>
    <tr>
      <td>
      ...
      <td><a href="/en-US/docs/Web/HTML/Reference/Element/embed#type"><code>type</code></a></td>
      <td><a href="/en-US/docs/Web/HTML/Reference/Element/object#type"><code>type</code></a></td>
    </tr>
    <tr>
      <td>
      ...
      <td>
         <a href="/en-US/docs/Web/HTML/Reference/Element/embed#height"><code>height</code></a><br /><a href="/en-US/docs/Web/HTML/Reference/Element/embed#width"><code>width</code></a>
      </td>
      <td>
         <a href="/en-US/docs/Web/HTML/Reference/Element/object#height"><code>height</code></a><br /><a href="/en-US/docs/Web/HTML/Reference/Element/object#width"><code>width</code></a>
      </td>
    </tr>
    <tr>
...
There are many other technologies that involve embedding external content besides the ones we discussed here. We saw some in earlier articles, such as {{htmlelement("video")}}, {{htmlelement("audio")}}, and {{htmlelement("img")}}, but there are others to discover, such as {{htmlelement("canvas")}} for JavaScript-generated 2D and 3D graphics, and {{SVGElement("svg")}} for embedding vector graphics.
