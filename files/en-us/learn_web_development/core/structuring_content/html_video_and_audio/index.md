...
- [`src`](/en-US/docs/Web/HTML/Reference/Element/video#src)
...
- [`controls`](/en-US/docs/Web/HTML/Reference/Element/video#controls)
...
- [`width`](/en-US/docs/Web/HTML/Reference/Element/video#width) and [`height`](/en-US/docs/Web/HTML/Reference/Element/video#height)
...
- [`autoplay`](/en-US/docs/Web/HTML/Reference/Element/video#autoplay)
...
- [`loop`](/en-US/docs/Web/HTML/Reference/Element/video#loop)
...
- [`muted`](/en-US/docs/Web/HTML/Reference/Element/video#muted)
  - : Causes the media to play with the sound turned off by default.
- [`poster`](/en-US/docs/Web/HTML/Reference/Element/video#poster)
...
- [`preload`](/en-US/docs/Web/HTML/Reference/Element/video#preload)
...
2. Link to the `.vtt` file with the {{htmlelement("track")}} element. `<track>` should be placed within `<audio>` or `<video>`, but after all `<source>` elements. Use the [`kind`](/en-US/docs/Web/HTML/Reference/Element/track#kind) attribute to specify whether the cues are `subtitles`, `captions`, or `descriptions`. Further, use [`srclang`](/en-US/docs/Web/HTML/Reference/Element/track#srclang) to tell the browser what language you have written the subtitles in. Finally, add [`label`](/en-US/docs/Web/HTML/Reference/Element/track#label) to help readers identify the language they are searching for.
...
4. Give both of them {{HTMLElement("source")}} elements so that browsers will find the audio format they support best and load it. These should include [`type`](/en-US/docs/Web/HTML/Reference/Element/source#type) attributes.
