...
You can use the [`width`](/en-US/docs/Web/HTML/Reference/Element/img#width) and [`height`](/en-US/docs/Web/HTML/Reference/Element/img#height) attributes to specify the width and height of your image. They are given as integers without a unit, and represent the image's width and height in pixels.
...
> [!NOTE]
> From an accessibility viewpoint, captions and [`alt`](/en-US/docs/Web/HTML/Reference/Element/img#alt) text have distinct roles. Captions benefit even people who can see the image, whereas [`alt`](/en-US/docs/Web/HTML/Reference/Element/img#alt) text provides the same functionality as an absent image. Therefore, captions and `alt` text shouldn't just say the same thing, because they both appear when the image is gone. Try turning images off in your browser and see how it looks.
