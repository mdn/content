...
The [`start`](/en-US/docs/Web/HTML/Reference/Element/ol#start) attribute allows you to start the list counting from a number other than 1. The following example:
...
The [`reversed`](/en-US/docs/Web/HTML/Reference/Element/ol#reversed) attribute will start the list counting down instead of up. The following example:
...
The [`value`](/en-US/docs/Web/HTML/Reference/Element/li#value) attribute allows you to set your list items to specific numerical values. The following example:
