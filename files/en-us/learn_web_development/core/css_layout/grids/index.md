...
When you work on a production-grade website, it will probably be laid out using a predefined grid system (12 or 16-column grids are common). This might be created by one of the senior developers in your team, or defined in a third-party CSS framework of some kind. The following example shows what a simple grid system might look like.

[Download the starting point file](https://github.com/mdn/learning-area/blob/main/css/css-layout/grids/11-grid-system-starting-point.html). This has a container with a 12-column grid defined and the same markup we used in the previous two examples. The grid is defined using the following rule:
