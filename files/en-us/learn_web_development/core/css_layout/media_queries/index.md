...
There are a number of other options you can put inside the `content` attribute of the viewport meta tag — see [Using the viewport meta tag to control layout on mobile browsers](/en-US/docs/Web/HTML/Guides/Viewport_meta_tag) for more details.
...
OK, we're nearly at the end of this module. Let's finish off by giving you a challenge to test your understanding.
