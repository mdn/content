...
This element formally defines a form. It's a container element like a {{HTMLelement("section")}} or {{HTMLelement("footer")}} element, but specifically for containing forms; it also supports some specific attributes to configure the way the form behaves. All of its attributes are optional, but it's standard practice to always set at least the [`action`](/en-US/docs/Web/HTML/Reference/Element/form#action) and [`method`](/en-US/docs/Web/HTML/Reference/Element/form#method) attributes:
...
To define the default value of an {{HTMLElement("input")}} element you have to use the [`value`](/en-US/docs/Web/HTML/Reference/Element/input#value) attribute like this:
...
The {{HTMLelement("form")}} element defines where and how to send the data thanks to the [`action`](/en-US/docs/Web/HTML/Reference/Element/form#action) and [`method`](/en-US/docs/Web/HTML/Reference/Element/form#method) attributes.
