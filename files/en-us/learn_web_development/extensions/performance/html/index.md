...
To provide different resolution versions of the same image depending on the device's resolution and viewport size, you can use the [`srcset`](/en-US/docs/Web/HTML/Reference/Element/img#srcset) and [`sizes`](/en-US/docs/Web/HTML/Reference/Element/img#sizes) attributes.
