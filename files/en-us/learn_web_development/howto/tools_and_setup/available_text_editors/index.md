    ...
    <tr>
      ...
      <td>
        You should already know about <a
          href="/en-US/docs/Learn_web_development/Howto/Tools_and_setup/What_software_do_I_need"
        >
...
Now that you have a good text editor, you could take some time to finalize [your basic working environment](/en-US/docs/Learn_web_development/Howto/Tools_and_setup/set_up_a_local_testing_server), or, if you want to play with it right away, write [your very first web page](/en-US/docs/Learn_web_development/Getting_started/Your_first_website).
