...
and should specify widths of columns using the [`<col>`](/en-US/docs/Web/HTML/Reference/Element/col) and the [`<colgroup>`](/en-US/docs/Web/HTML/Reference/Element/colgroup) elements.
...
To mark an image for lazy loading, specify its [`loading`](/en-US/docs/Web/HTML/Reference/Element/img#loading) attribute with a value of `lazy`. With this set, the image will only be loaded when it's needed.
...
Make the JavaScript scripts such that they are compatible with both the [async](/en-US/docs/Web/HTML/Reference/Element/script#attributes) and the [defer](/en-US/docs/Web/HTML/Reference/Element/script#attributes) attributes, and use [async](/en-US/docs/Web/HTML/Reference/Element/script#attributes) whenever possible, especially if you have multiple script elements.
