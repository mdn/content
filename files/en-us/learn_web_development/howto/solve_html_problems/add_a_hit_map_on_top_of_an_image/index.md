...
You insert your image [much the same way as always](/en-US/docs/Learn_web_development/Core/Structuring_content/HTML_images#how_do_we_put_an_image_on_a_webpage) (with an {{htmlelement("img")}} element and [`alt`](/en-US/docs/Web/HTML/Reference/Element/img#alt) text). If the image is only present as a navigation device, you may write `alt=""`, provided you furnish appropriate [`alt`](/en-US/docs/Web/HTML/Reference/Element/area#alt) text in the {{htmlelement('area')}} elements later on.

You will need a special [`usemap`](/en-US/docs/Web/HTML/Reference/Element/img#usemap) attribute. Come up with a unique name, containing no spaces, for your image map. Then assign that name (preceded by a hash) as the value for the `usemap` attribute:
...
In this step, put all your code inside a {{htmlelement('map')}} element. `<map>` only needs one attribute, the same map [`name`](/en-US/docs/Web/HTML/Reference/Element/map#name) as you used in your `usemap` attribute above:
...
- [`shape`](/en-US/docs/Web/HTML/Reference/Element/area#shape)
...
- [`coords`](/en-US/docs/Web/HTML/Reference/Element/area#coords)
...
- [`href`](/en-US/docs/Web/HTML/Reference/Element/area#href)
...
- [`alt`](/en-US/docs/Web/HTML/Reference/Element/area#alt)
