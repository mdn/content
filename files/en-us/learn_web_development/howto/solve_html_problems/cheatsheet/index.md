...
> [!NOTE]
> Because this cheat sheet is limited to a few elements representing specific structures or having special semantics, the [`div`](/en-US/docs/Web/HTML/Reference/Element/div) element is intentionally not included — because the `div` element doesn't represent anything and doesn't have any special semantics.
