...
- [SVG](/en-US/docs/Web/SVG) for creating and manipularing vector graphics.
...
- User 3 might be visually impaired, and using a screen reader to read the web page out to them.
