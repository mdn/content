...
- For a start, it is designed with univeral access in mind — its basic state is accessible and linkable. Some of these basics are harder to achieve in other environments.
