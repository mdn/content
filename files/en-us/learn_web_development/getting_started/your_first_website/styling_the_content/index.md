...
> [!NOTE]
> Scrimba's [Write your first lines of CSS!](https://v2.scrimba.com/the-frontend-developer-career-path-c0j/~015?via=mdn) <sup>_MDN learning partner_</sup> provides a useful interactive introduction to CSS syntax.
