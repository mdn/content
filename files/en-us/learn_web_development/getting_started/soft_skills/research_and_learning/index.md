...
- **References**: Provide information such as syntax and examples. Focuses on allowing developers to look up information about subjects they are already have some familiarity with, rather than learning about new subjects.
- **Tutorials**: Allow developers to learn how to use new technologies. Tutorials are often step-by-step and aimed at beginners.
- **Guides**/**How-tos**: Also associated with learning, but tend to be less beginner-focused, and often aimed at solving specific problems.
...
- When have a problem with using a specific tool/product, consult the official documentation first. It is surprising how many people do not think to do this; official docs are often geared towards beginners, so people with experience may not think of them as being suitable. If the product you are using is the web platform, the _unofficial_ official documentation is MDN, so you are in the right place!
...
- Don't just rely on one single source of truth. Cross-reference different sources, especially if you are not sure whether a source is trustwothy or not.
...
- As a follow-on from the previous point, you should engage in reading tasks or small research projects regularly. Set aside specific learning time to spend on acquiring new skills.
