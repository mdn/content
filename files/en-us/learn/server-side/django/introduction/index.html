...
<p>In this first Django article, we answer the question "What is Django?" and give you an overview of what makes this web framework special.</p>
...
<h2 id="What_is_Django">What is Django?</h2>
...
<dl>
 <dt>Complete</dt>
 <dd>Django follows the "Batteries included" philosophy and provides almost everything developers might want to do "out of the box". Because everything you need is part of the one "product", it all works seamlessly together, follows consistent design principles, and has extensive and <a href="https://docs.djangoproject.com/en/stable/">up-to-date documentation</a>.</dd>
 <dt>Versatile</dt>
 <dd>Django can be (and has been) used to build almost any type of website — from content management systems and wikis, through to social networks and news sites. It can work with any client-side framework, and can deliver content in almost any format (including HTML, RSS feeds, JSON, XML, etc). The site you are currently reading is built with Django!<br>
 <br>
 ...
 <dt>Maintainable</dt>
 <dd>Django code is written using design principles and patterns that encourage the creation of maintainable and reusable code. In particular, it makes use of the Don't Repeat Yourself (DRY) principle so there is no unnecessary duplication, reducing the amount of code. Django also promotes the grouping of related functionality into reusable "applications" and, at a lower level, groups related code into modules (along the lines of the <a href="/en-US/docs/Glossary/MVC">Model View Controller (MVC)</a> pattern).</dd>
 <dt>Portable</dt>
...
<h2 id="Where_did_it_come_from">Where did it come from?</h2>
...
<div class="notecard note">
  <p><strong>Note:</strong> Check out the <a href="https://docs.djangoproject.com/en/stable/releases/">release notes</a> on the Django website to see what has changed in recent versions, and how much work is going into making Django better.</p>
</div>

<p>Django is now a thriving, collaborative open source project, with many thousands of users and contributors. While it does still have some features that reflect its origin, Django has evolved into a versatile framework that is capable of developing any type of website.</p>
...
<p>High-profile sites that use Django include: Disqus, Instagram, Knight Foundation, MacArthur Foundation, Mozilla, National Geographic, Open Knowledge Foundation, Pinterest, and Open Stack (source: <a href="https://www.djangoproject.com/start/overview/">Django overview page</a>).</p>
...
<p><img alt="Django - files for views, model, urls, template" src="basic-django.png"></p>
...
<div class="notecard note">
  <p><strong>Note:</strong> Django refers to this organization as the "Model View Template (MVT)" architecture. It has many similarities to the more familiar <a href="/en-US/docs/Glossary/MVC">Model View Controller</a> architecture. </p>
</div>
...
<h3 id="Sending_the_request_to_the_right_view_urls.py">Sending the request to the right view (urls.py)</h3>

<p>A URL mapper is typically stored in a file named <strong>urls.py</strong>.
In the example below, the mapper (<code>urlpatterns</code>) defines a list of mappings between <em>routes</em> (specific URL <em>patterns)</em> and corresponding view functions.
If an HTTP Request is received that has a URL matching a specified pattern, then the associated view function will be called and passed the request.</p>
...
<h3 id="Handling_the_request_views.py">Handling the request (views.py)</h3>

<p>Views are the heart of the web application, receiving HTTP requests from web clients and returning HTTP responses. In between, they marshal the other resources of the framework to access databases, render templates, etc. </p>
...
<h3 id="Defining_data_models_models.py">Defining data models (models.py)</h3>
...
<div class="notecard note">
  ...
  <ul>
   <li>Python supports "object-oriented programming", a style of programming where we organize our code into objects, which include related data and functions for operating on that data. Objects can also inherit/extend/derive from other objects, allowing common behavior between related objects to be shared. In Python we use the keyword <code>class</code> to define the "blueprint" for an object. We can create multiple specific <em>instances</em> of the type of object based on the model in the class.<br>
  <br>
...
<ul>
 <li><strong>Django introduction</strong></li>
