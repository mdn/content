...
<div class="note">
<p><strong>Note:</strong> The format of HTTP messages is defined in a "web standard" (<a href="https://www.rfc-editor.org/rfc/rfc7230.txt">RFC7230</a>). You don't need to know this level of detail, but at least now you know where this all came from!</p>
</div>
...
<pre class="brush: plain">GET /en-US/search?q=client+server+overview&amp;topic=apps&amp;topic=html&amp;topic=css&amp;topic=js&amp;topic=api&amp;topic=webdev HTTP/1.1
...
<pre class="brush: plain">POST /en-US/profiles/hamishwillee/edit HTTP/1.1
Host: developer.mozilla.org
Connection: keep-alive
Content-Length: 432
Pragma: no-cache
...
<pre class="brush: plain">HTTP/1.1 302 FOUND
Server: Apache
