...
> **Note:** Selecting “Public” will make *all* the code you submit public—including your database username and password! This means anyone could theoretically find your code and make changes to your database. You will want to either select “Private” or, if you hoping to show off your library project, configure your database so that it *only* reads from the environment variables, and does not have the database URI hard-coded in the app.
