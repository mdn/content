...
1. Download (or otherwise create) the file [populatedb.js](https://raw.githack.com/mdn/express-locallibrary-tutorial/main/populatedb.js) inside your _express-locallibrary-tutorial_ directory (in the same level as `package.json`).
