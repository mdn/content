...
>   It's better to use [`const`](/en-US/docs/Web/JavaScript/Reference/Statements/const) and [`let`](/en-US/docs/Web/JavaScript/Reference/Statements/let) instead of `var` in your own code, but the generator's code is left as-is for consistency with the _Express_ documentation.
