...
tags:
  ...
  - server-side
---
<p><abbr>MIME</abbr> types describe the media type of content, either in email, or served by web servers or web applications. They are intended to help provide a hint as to how the content should be processed and displayed.</p>
...
<h2 id="Why_are_correct_MIME_types_important.3F">Why are correct MIME types important?</h2>
...
<h2 id="How_to_determine_the_MIME_type_to_set">How to determine the MIME type to set</h2>
...
<ul>
 <li>In Firefox
  <ul>
   ...
   <li>You can also go to <strong>Tools &gt; Web Developer &gt; Network</strong> and reload the page. The request tab gives you a list of all the resources the page loaded. Clicking on any resource will list all the information available, including the page's <code><a href="/en-US/docs/Web/HTTP/Headers/Content-Type">Content-Type</a></code> header.</li>
  </ul>
 </li>
 <li>In Chrome
  <ul>
 ...
 <li>Look for a <code>&lt;meta&gt;</code> element in the page source that gives the MIME type, for example <code>&lt;meta http-equiv="Content-Type" content="text/html"&gt;</code>.
  <ul>
...
<ul>
 <li>If you're using the Apache web server, check the <em><strong>Media Types and Character Encodings</strong></em> section of <a href="/en-US/docs/Learn/Server-side/Apache_Configuration_htaccess">Apache Configuration: .htaccess</a> for examples of different document types and their corresponding MIME types.</li>
