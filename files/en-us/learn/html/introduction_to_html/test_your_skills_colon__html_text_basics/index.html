...
<p>The aim of this skill test is to assess whether you've understood our <a href="/en-US/docs/Learn/HTML/Introduction_to_HTML/HTML_text_fundamentals">HTML text fundamentals</a> article.</p>
...
<h2 id="HTML_text_basics_1">HTML text basics 1</h2>

<p>In this task we want you to mark up the provided HTML using semantic heading and paragraph elements. Try updating the live code below to create the finished example:</p>
...
<h2 id="HTML_text_basics_2">HTML text basics 2</h2>
...
<p>Try updating the live code below to create the finished example:</p>
...
<h2 id="HTML_text_basics_3">HTML text basics 3</h2>
...
<ol>
 ...
 <li>Write a post asking for assessment and/or help at the <a class="external external-icon" href="https://discourse.mozilla.org/c/mdn/learn" rel="noopener">MDN Discourse forum Learning category</a>. Your post should include:
  <ul>
   <li>A descriptive title such as "Assessment wanted for HTML text basics 1 skill test".</li>
