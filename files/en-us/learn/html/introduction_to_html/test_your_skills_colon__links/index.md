...
The aim of this skill test is to assess whether you understand how to [create hyperlinks in HTML](/en-US/docs/Learn/HTML/Introduction_to_HTML/Creating_hyperlinks).
