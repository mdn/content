...
<h2 id="Basic_sections_of_a_document">Basic sections of a document</h2>
...
<dl>
 <dt>header:</dt>
 <dd>Usually a big strip across the top with a big heading, logo, and perhaps a tagline. This usually stays the same from one webpage to another.</dd>
 <dt>navigation bar:</dt>
 <dd>Links to the site's main sections; usually represented by menu buttons, links, or tabs. Like the header, this content usually remains consistent from one webpage to another — having inconsistent navigation on your website will just lead to confused, frustrated users. Many web designers consider the navigation bar to be part of the header rather than an individual component, but that's not a requirement; in fact, some also argue that having the two separate is better for <a href="/en-US/docs/Learn/Accessibility">accessibility</a>, as screen readers can read the two features better if they are separate.</dd>
 <dt>main content:</dt>
 <dd>A big area in the center that contains most of the unique content of a given webpage, for example, the video you want to watch, or the main story you're reading, or the map you want to view, or the news headlines, etc. This is the one part of the website that definitely will vary from page to page!</dd>
 <dt>sidebar:</dt>
 <dd>Some peripheral info, links, quotes, ads, etc. Usually, this is contextual to what is contained in the main content (for example on a news article page, the sidebar might contain the author's bio, or links to related articles) but there are also cases where you'll find some recurring elements like a secondary navigation system.</dd>
 <dt>footer:</dt>
 <dd>A strip across the bottom of the page that generally contains fine print, copyright notices, or contact info. It's a place to put common information (like the header) but usually, that information is not critical or secondary to the website itself. The footer is also sometimes used for {{Glossary("SEO")}} purposes, by providing links for quick access to popular content.</dd>
</dl>

<p>A "typical website" could be structured something like this:</p>

<p><img alt="a simple website structure example featuring a main heading, navigation menu, main content, side bar, and footer." src="sample-website.png"></p>
...
<ul>
 ...
 <li>{{HTMLElement('header')}} represents a group of introductory content. If it is a child of {{HTMLElement('body')}} it defines the global header of a webpage, but if it's a child of an {{HTMLElement('article')}} or {{HTMLElement('section')}} it defines a specific header for that section (try not to confuse this with <a href="/en-US/docs/Learn/HTML/Introduction_to_HTML/The_head_metadata_in_HTML#adding_a_title">titles and headings</a>).</li>
...
<h4>&lt;br&gt;: the line break element</h4>
...
<p>Without the <code>&lt;br&gt;</code> elements, the paragraph would just be rendered in one long line (as we said earlier in the course, <a href="/en-US/docs/Learn/HTML/Introduction_to_HTML/Getting_started#whitespace_in_html">HTML ignores most whitespace</a>); with <code>&lt;br&gt;</code> elements in the code, the markup renders like this:</p>

<p>{{EmbedLiveSample('br_the_line_break_element', '100%', '125px')}}</p>

<h4>&lt;hr&gt;: the thematic break element</h4>
...
<pre class="brush: html">&lt;p&gt;Ron was backed into a corner by the marauding
...
&lt;p&gt;Meanwhile, Harry was sitting at home, staring at his royalty statement
  ...
  hazily and sighed; "better get back to work then", he mused.&lt;/p&gt;</pre>

<p>Would render like this:</p>

<p>{{EmbedLiveSample('hr_the_thematic_break_element', '100%', '185px')}}</p>
