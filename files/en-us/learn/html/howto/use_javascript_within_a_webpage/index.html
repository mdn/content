...
<table>
 <tbody>
  ...
  <tr>
   ...
   <td>Learn how to trigger JavaScript in your HTML file, and learn the most important best practices for keeping JavaScript accessible.</td>
  </tr>
 </tbody>
</table>

<h2 id="About_JavaScript">About JavaScript</h2>

<p>{{Glossary("JavaScript")}} is a programming language mostly used client-side to make webpages interactive. You <em>can</em> create amazing webpages without JavaScript, but JavaScript opens up a whole new level of possibilities.</p>

<div class="note">
<p><strong>Note:</strong> In this article we're going over the HTML code you need to make JavaScript take effect. If you want to learn JavaScript itself, you can start with our <a href="/en-US/docs/Learn/Getting_started_with_the_web/JavaScript_basics">JavaScript basics</a> article. If you already know something about JavaScript or if you have a background with other programming languages, we suggest you jump directly into our <a href="/en-US/docs/Web/JavaScript/Guide">JavaScript Guide</a>.</p>
</div>

<h2 id="How_to_trigger_JavaScript_from_HTML">How to trigger JavaScript from HTML</h2>
...
<h3 id="Linking_an_external_script">Linking an external script</h3>

<p>Usually, you'll be writing scripts in their own .js files. If you want to execute a .js script from your webpage, just use {{HTMLElement ('script')}} with an <code>src</code> attribute pointing to the script file, using its <a href="/en-US/docs/Learn/Common_questions/What_is_a_URL">URL</a>:</p>

<pre class="brush: html">&lt;script src="path/to/my/script.js"&gt;&lt;/script&gt;</pre>

<h3 id="Writing_JavaScript_within_HTML">Writing JavaScript within HTML</h3>
...
<h2 id="Use_scripting_accessibly">Use scripting accessibly</h2>
...
<ul>
 <li><strong>Make all content available as (structured) text.</strong> Rely on HTML for your content as much as possible. For example, if you've implemented a nice JavaScript progress bar, make sure to supplement it with matching text percentages inside the HTML. Likewise, your drop-down menus should be structured as <a href="/en-US/docs/Learn/HTML/Introduction_to_HTML/HTML_text_fundamentals#lists">unordered lists</a> of <a href="/en-US/docs/Learn/HTML/Introduction_to_HTML/Creating_hyperlinks">links</a>.</li>
 ...
 <li><strong>Keep animations subtle and brief with no flashing.</strong> Flashing is annoying and can <a href="https://www.w3.org/TR/UNDERSTANDING-WCAG20/seizure-does-not-violate.html">cause seizures</a>. Additionally, if an animation lasts more than a couple seconds, give the user a way to cancel it.</li>
...
<ul>
 ...
 <li><a href="https://www.sitepoint.com/javascript-accessibility-101/">James Edwards' introduction to using JavaScript accessibly</a></li>
 <li><a href="https://www.w3.org/TR/WCAG20/">Accessibility guidelines from W3C</a></li>
</ul>
