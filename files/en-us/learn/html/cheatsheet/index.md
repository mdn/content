...
> **Note:** Because this cheatsheet is limited to a few elements representing specific structures or having special semantics, the [`div`](/en-US/docs/Web/HTML/Element/div) element is intentially not included — because the `div` element doesn’t represent anything and doesn’t have any special semantics.
