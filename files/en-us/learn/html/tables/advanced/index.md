...
There are a few other things you could learn about tables in HTML, but we have really given all you need to know at this moment in time. At this point, you can go on to testing yourself with our [table assessment](/en-US/docs/Learn/HTML/Tables/Structuring_planet_data). Have fun!
...
You want to get started with learning CSS? We recommend you to check out the [CSS Learning Area](/en-US/docs/Learn/CSS)!
