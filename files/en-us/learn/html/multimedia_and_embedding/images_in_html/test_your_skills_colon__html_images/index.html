...
<p>The aim of this skill test is to assess whether you've understood our <a href="/en-US/docs/Learn/HTML/Multimedia_and_embedding/Images_in_HTML">Images in HTML</a> article.</p>
...
<h2 id="HTML_images_1">HTML images 1</h2>

<p>In this task we want you to embed a simple image of some Blueberries into the page. You need to:</p>

<ul>
 <li>Add the path to the image to an appropriate attribute to embed it on the page. The image is called <code>blueberries.jpg</code>, and it is in a folder inside the current folder called <code>images</code>.</li>
 <li>Add some alternative text to an appropriate attribute to describe the image, for people that cannot see it.</li>
 <li>Give the <code>&lt;img&gt;</code> element an appropriate <code>width</code> and <code>height</code> so that it displays at the correct aspect ratio, and enough space is left on the page to display it. The image's intrinsic size is 615 x 419 pixels.</li>
</ul>
...
<h2 id="HTML_images_2">HTML images 2</h2>
...
<h2 id="HTML_images_3">HTML images 3</h2>
