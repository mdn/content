...
- This method is only suitable if you're using the SVG in only one place. Duplication makes for resource-intensive maintenance, Unless you style them using external CSS (selectors) instead of inline CSS in each svg.
