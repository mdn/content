...
However, issues arise when you start to view the site on a narrow screen device. The first content image below looks OK, but it's starting to take up a lot of the screen height for a mobile device. And at this size, it is difficult to see the people within the image.
