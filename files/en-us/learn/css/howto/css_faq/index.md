...
Style rules that are syntactically correct may not apply in certain situations. You can use [DOM Inspector](https://firefox-source-docs.mozilla.org/devtools-user/add-ons/dom_inspector/index.html)'s _CSS Style Rules_ view to debug problems of this kind, but the most frequent instances of ignored style rules are listed below.
