...
<p>You should learn the basics of HTML before attempting any CSS. We recommend that you work through our <a href="/en-US/docs/Learn/HTML/Introduction_to_HTML">Introduction to HTML</a> module first.</p>
...
<p>It is also recommended that you work through <a href="/en-US/docs/Learn/Getting_started_with_the_web">Getting started with the web</a> before proceeding with this topic, especially if you are completely new to web development. However, much of what is covered in its <a href="/en-US/docs/Learn/Getting_started_with_the_web/CSS_basics">CSS basics</a> article is also covered in our <a href="/en-US/docs/Learn/CSS/First_steps">CSS first steps</a> module, albeit in a lot more detail.</p>
...
<h2 id="CSS_is_weird">"CSS is weird"</h2>
