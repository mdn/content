...
<ol>
 ...
 <li>Be comfortable with CSS fundamentals, as discussed in <a href="/en-US/docs/Learn/CSS/First_steps">Introduction to CSS</a>.</li>
 <li>Understand how to <a href="/en-US/docs/Learn/CSS/Building_blocks">style boxes</a>.</li>
</ol>
...
<dl>
 ...
 <dd>The <strong>CSS Media Query</strong> gives you a way to apply CSS only when the browser and device environment matches a rule that you specify, for example, "viewport is wider than 480 pixels". Media queries are a key part of responsive web design because they allow you to create different layouts depending on the size of the viewport. They can also be used to detect other features of the environment your site is running on, for example, whether the user is using a touchscreen rather than a mouse. In this lesson, you will first learn about the syntax used in media queries, and then you will use them in an interactive example showing how a simple design might be made responsive.</dd>
 <dt><a href="/en-US/docs/Learn/CSS/CSS_layout/Legacy_Layout_Methods">Legacy layout methods</a></dt>
 <dd>Grid systems are a very common feature used in CSS layouts. Prior to <strong>CSS Grid Layout</strong>, they tended to be implemented using floats or other layout features. You'd first imagine your layout as a set number of columns (e.g., 4, 6, or 12), and then you'd fit your content columns inside these imaginary columns. In this article, we'll explore how these older methods work so that you understand how they were used if you work on an older project.</dd>
 <dt><a href="/en-US/docs/Learn/CSS/CSS_layout/Supporting_Older_Browsers">Supporting older browsers</a></dt>
 <dd>
 <p>In this module, we recommend using Flexbox and Grid as the main layout methods for your designs. However, there are bound to be visitors to a site you develop in the future who use older browsers, or browsers which do not support the methods you have used. This will always be the case on the web — as new features are developed, different browsers will prioritise different features. This article explains how to use modern web techniques without excluding users of older technology.</p>
 </dd>
