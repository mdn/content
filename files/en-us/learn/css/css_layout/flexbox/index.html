...
<p><img alt="Image showing the starting point of Flexbox tutorial" src="bih741v.png"></p>
...
<p><img alt="" src="flexbox-example2.png"></p>
...
<p><img alt="" src="flexbox-example3.png"></p>
...
<p><img alt="" src="flexbox-example1.png"></p>
...
<p><img alt="" src="flexbox-example5.png"></p>
...
<p><img alt="" src="flexbox-example7.png"></p>
...
<p>Next, we set some flex values on the {{htmlelement("article")}}s themselves. Take special note of the 2nd rule here: we're setting the third {{htmlelement("article")}} to have its children laid out like flex items too, but this time we're laying them out like a column.</p>
