...
<pre class="brush: css">@media screen and (max-width: 600px) {
    body {
        color: blue;
    }
}</pre>
...
<pre class="brush: css">@media screen and (min-width: 600px) and (orientation: landscape) {
    body {
        color: blue;
    }
}</pre>
...
<pre class="brush: css">@media screen and (min-width: 600px), screen and (orientation: landscape) {
    body {
        color: blue;
    }
}</pre>
...
<pre class="brush: css">@media screen and (min-width: 70em) {
    main {
        display: grid;
        grid-template-columns: 3fr 1fr;
        column-gap: 20px;
...
<p>There are a number of other options you can put inside the <code>content</code> attribute of the viewport meta tag — see <a href="/en-US/docs/Web/HTML/Viewport_meta_tag">Using the viewport meta tag to control layout on mobile browsers</a> for more details.</p>
