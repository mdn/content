...
You can take a look at the reference tables of pseudo-classes and pseudo-elements below for direct links to the various selectors in this Learn section or on MDN in general, or continue on to start your journey by finding out about [combinators](/en-US/docs/Learn/CSS/Building_blocks/Selectors/Combinators).
