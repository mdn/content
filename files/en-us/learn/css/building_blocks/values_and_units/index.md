...
There are many color functions available using the `<hue` component available such as `hsl()`,`hwb()`, and [`lch()`](/en-US/docs/Web/CSS/color_value/lch), and even functions such as [`lab()`](/en-US/docs/Web/CSS/color_value/lab) which let you work with colors based on what humans can see.
