...
- A Contrasting color for the text; make it readable using a black text shadow.
...
2. Write a post asking for assessment and/or help at the [MDN Discourse forum Learning category](https://discourse.mozilla.org/c/mdn/learn/250). Your post should include:
    ...
    - Details of what you have already tried and what you would like us to do, e.g. if you're stuck and need help or want an assessment.
