...
<ol>
 ...
 <li>A basic work environment set up as detailed in <a href="/en-US/docs/Learn/Getting_started_with_the_web/Installing_basic_software">Installing basic software</a>, and an understanding of how to create and manage files, as detailed in <a href="/en-US/docs/Learn/Getting_started_with_the_web/Dealing_with_files">Dealing with files</a>.</li>
...
<div class="note">
<p><strong>Note:</strong> If you are working on a computer/tablet/another device where you don't have the ability to create your own files, you could try out (most of) the code examples in an online coding program such as <a href="https://jsbin.com/">JSBin</a> or <a href="https://glitch.com/">Glitch</a>.</p>
</div>
...
<dl>
 <dt><a href="/en-US/docs/Learn/CSS/Building_blocks/Fundamental_CSS_comprehension">Fundamental CSS comprehension</a></dt>
 <dd>This assessment tests your understanding of basic syntax, selectors, specificity, box model, and more.</dd>
 <dt><a href="/en-US/docs/Learn/CSS/Building_blocks/Creating_fancy_letterheaded_paper">Creating fancy letterheaded paper</a></dt>
 ...
 <dt><a href="/en-US/docs/Learn/CSS/Building_blocks/A_cool_looking_box">A cool looking box</a></dt>
