...
<p>The aim of these tasks is to help you check your understanding of overflow in CSS.</p>
...
<p>In this task an image is in the box, it is bigger than the dimensions of the box so overflows visibly. Change it so that any image outside of the box is hidden.</p>

<p><img alt="A box with an image which fills the box but does not spill out the edges." src="mdn-overflow2.png"></p>
...
<ol>
 ...
 <li>Write a post asking for assessment and/or help at the <a class="external external-icon" href="https://discourse.mozilla.org/c/mdn/learn" rel="noopener">MDN Discourse forum Learning category</a>. Your post should include:
  <ul>
   <li>A descriptive title such as "Assessment wanted for Overflow skill test 1".</li>
