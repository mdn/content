...
<table>
 <tbody>
  <tr>
   ...
   <td>None, but we encourage you to read the <a href="/en-US/docs/Learn/Common_questions/Thinking_before_coding">Article on setting project goals</a> first</td>
  </tr>
  <tr>
...
<p>When two computers need to communicate, you have to link them, either physically (usually with an <a href="https://en.wikipedia.org/wiki/Ethernet_crossover_cable" rel="external">Ethernet cable</a>) or wirelessly (for example with <a href="https://en.wikipedia.org/wiki/WiFi" rel="external">WiFi</a> or <a href="https://en.wikipedia.org/wiki/Bluetooth" rel="external">Bluetooth</a> systems). All modern computers can sustain any of those connections.</p>
...
<h3 id="intranets_and_extranets">Intranets and Extranets</h3>
...
<ul>
 ...
 <li><a href="/en-US/docs/Learn/Common_questions/Pages_sites_servers_and_search_engines">Understanding the difference between a web page, a web site, a web server and a search engine</a></li>
