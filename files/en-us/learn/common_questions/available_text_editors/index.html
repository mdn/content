...
<table class="standard-table">
 <tbody>
  <tr>
   ...
   <td>You should already know about<a href="/en-US/docs/Learn/Common_questions/What_software_do_I_need"> various software you need to build a website</a>.</td>
  </tr>
  <tr>
   <th scope="row">Objective:</th>
   <td>Learn how to choose a text editor that best suits your needs as a web developer.</td>
  </tr>
 </tbody>
</table>
...
<p>A website consists mostly of text files, so for a fun, pleasant development experience you should choose your text editor wisely.</p>

<p>The sheer number of choices is a bit overwhelming, since a text editor is so basic to computer science (yes, web development is computer science). Ideally, you'd try as many editors as you can and get a feel for what suits your workflow. But we'll give you some pointers for getting started.</p>

<p>Here are the primary questions you should consider:</p>

<ul>
 <li>Which OS (operating system) do I want to work with?</li>
 <li>What kind of technologies do I want to manipulate?</li>
 <li>What kind of basic features do I expect from my text editor?</li>
 <li>Do I want to add extra features to my text editor?</li>
 <li>Do I need support/help while using my text editor?</li>
 <li>Does my text editor's look-and-feel matter to me?</li>
</ul>

<p>Notice we didn't mention price. Obviously, that matters too, but a product's cost has little connection with its quality or capability. There's a big chance you'll find a suitable text editor for free.</p>
...
<p>In this active learning section, we would like you to try using and/or installing a text editor of your choice. Your computer may already be installed with one of the editors suggested above (e.g. Gedit if you use GNOME desktop, Kate if you use KDE etc.), if not then you should try installing one or more text editors of your choosing.</p>

<p>Try digging through the settings of your editor and read the manual or documentation to see what its capabilities are. In particular (if possible in your editor), try to:</p>

<ul>
 <li>Change syntax highlighting settings and colors</li>
 <li>Play with <a href="https://en.wikipedia.org/wiki/Indentation_(typesetting)#Indentation_in_programming">indentation</a> width, setting it to an appropriate setting for your needs</li>
 <li>Check autosave and session saving settings</li>
 <li>Configure any available <a href="https://en.wikipedia.org/wiki/Plug-in_(computing)">plugins</a> and investigate how to get new ones</li>
 <li>Change color schemes</li>
 <li>Adjust view settings and see how you can change the layout of the views</li>
 <li>Check what programming languages/technologies your editor supports</li>
</ul>

<p>While you're learning the default settings of most text editors should be fine to use, but it is important to become familiar with your chosen tools, so you can select the best one for your usage. You will learn more about customizing your editors and tools as you gain experience, and more importantly you will learn what features are more useful to your purposes.</p>

<h2 id="Dig_deeper">Dig deeper</h2>

<h3 id="Choice_criteria">Choice criteria</h3>

<p>So, in more detail, what should you be thinking about when you choose a text editor?</p>

<h4 id="Which_OS_operating_system_do_I_want_to_work_with">Which OS (operating system) do I want to work with?</h4>

<p>Of course it's your choice. However, some editors are only available for certain OSs, so if you like switching back and forth, that would narrow down the possibilities. Any text editor <em>can</em> get the job done, if it runs on your system, but a cross-platform editor eases migration from OS to OS.</p>
...
<ul>
 <li><strong><a href="https://en.wikipedia.org/wiki/Syntax_highlighting">Syntax highlighting</a>.</strong> Make your file more legible by color-coding keywords based on the technology you're using.</li>
 <li><strong><a href="https://en.wikipedia.org/wiki/Autocomplete#In_source_code_editors">Code completion</a>.</strong> Save you time by auto-completing recurring structures (for example, automatically close HTML tags, or suggesting valid values for a given CSS property).</li>
 <li><strong><a href="https://en.wikipedia.org/wiki/Snippet_(programming)">Code snippets</a>.</strong> As you saw when starting a new HTML document, many technologies use the same document structure over and over. Save yourself the hassle of retyping all this by using a code snippet to pre-fill your document.</li>
</ul>

<p>Most text editors now support syntax highlighting, but not necessarily the other two features. Make sure in particular that your text editor supports highlighting for {{Glossary("HTML")}}, {{Glossary("CSS")}}, and {{Glossary("JavaScript")}}.</p>
...
<ul>
 ...
 <li>Auto-indent code based on indentation settings</li>
</ul>
...
<p>If you like <em>lots</em> of features and your editor is slowing down because of all your plugins, try using an <a href="https://en.wikipedia.org/wiki/Integrated_development_environment">IDE</a> (integrated development environment). An IDE provides many tools in one interface and it's a bit daunting for beginners, but always an option if your text editor feels too limited. Here are some popular IDEs:</p>

<ul>
 <li><a href="http://www.aptana.com/">Aptana Studio</a></li>
 <li><a href="https://eclipse.org/" rel="external">Eclipse</a></li>
 <li><a href="https://komodoide.com/" rel="external">Komodo IDE</a></li>
 <li><a href="https://netbeans.org/" rel="external">NetBeans IDE</a></li>
 <li><a href="https://www.visualstudio.com/" rel="external">Visual Studio</a></li>
...
<p>It's always good to know if you can get help or not when using software. For text editors, check for two different kinds of support:</p>
...
<p>When you install a new text editor, your OS will probably continue to open text files with its default editor until you change the <em><a href="https://en.wikipedia.org/wiki/File_association">file association</a>.</em> These instructions will help you specify that your OS should open files in your preferred editor when you double-click them:</p>

<ul>
 <li>Windows
  <ul>
   <li><a href="https://windows.microsoft.com/en-us/windows-8/choose-programs-windows-uses-default" rel="external">Windows 8</a></li>
   <li><a href="https://windows.microsoft.com/en-us/windows/change-default-programs#1TC=windows-7" rel="external">Windows 7</a></li>
   <li><a href="https://pcsupport.about.com/od/fixtheproblem/f/chdefprogram.htm">older systems</a></li>
  </ul>
 </li>
 <li><a href="https://osxdaily.com/2013/08/08/change-default-application-open-files-mac-os-x/" rel="external">Mac OS X</a></li>
 <li>Linux
  <ul>
   <li><a href="https://askubuntu.com/questions/289337/how-can-i-change-file-association-globally" rel="external">Ubuntu Unity</a></li>
   <li><a href="https://help.gnome.org/users/gnome-help/stable/files-open.html.en" rel="external">GNOME</a></li>
   <li><a href="https://doc.opensuse.org/documentation/html/openSUSE_113/opensuse-kdeuser/cha.kde.cust.html#pro.kde.cust.system.fileass">KDE</a></li>
  </ul>
 </li>
</ul>
...
<p>Now that you have a good text editor, you could take some time to finalize <a href="/en-US/docs/Learn/Common_questions/set_up_a_local_testing_server">your basic working environment</a>, or, if you want to play with it right away, write <a href="/en-US/docs/Learn/Getting_started_with_the_web">your very first web page</a>.</p>
