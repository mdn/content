...
<div class="note">
<p><strong>Note:</strong> Alternatively you can find a number of contrast checkers online, such as WebAIM's <a href="https://webaim.org/resources/contrastchecker/">Color Contrast Checker</a>. We suggest a local checker because it comes packaged with an on-screen color picker to find out a color value.</p>
</div>
...
<div class="note">
<p><strong>Note:</strong> The use and even the existence of <code>longdesc</code> has been debated for quite some time. Please refer to the W3C's <a href="https://www.w3.org/TR/html-longdesc/">Image Description Extension (longdesc)</a> for the full explanation and thorough examples.</p>
</div>
...
<ul>
 ...
 <li><strong>Online tools.</strong> Yahoo's <a href="http://smush.it/">smushit!</a>, Dynamic drive's <a href="https://tools.dynamicdrive.com/imageoptimizer/">Online Image Optimizer</a> (which can convert automatically from one format to another if it's more bandwidth-efficient)</li>
</ul>
