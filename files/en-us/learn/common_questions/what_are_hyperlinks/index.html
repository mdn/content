...
<table>
 <tbody>
  <tr>
   ...
   <td>You should know <a href="/en-US/docs/Learn/Common_questions/How_does_the_Internet_work">how the Internet works</a> and be familiar with<a href="/en-US/docs/Learn/Common_questions/Pages_sites_servers_and_search_engines"> the difference between a webpage, a website, a web server, and a search engine</a>.</td>
  </tr>
  <tr>
...
<ol>
 <li>{{Glossary("URL")}}, an address system that keeps track of Web documents</li>
 <li>{{Glossary("HTTP")}}, a transfer protocol to find documents when given their URLs</li>
 <li>{{Glossary("HTML")}}, a document format allowing for embedded <em>hyperlinks</em></li>
</ol>
...
<p>Links stand out from the surrounding text by being underlined and in blue text. Tap or click a link to activate it, or if you use a keyboard, press Tab until the link is in focus and hit Enter or Spacebar.</p>

<p><img alt="Example of a basic display and effect of a link in a web page" src="link-1.png"></p>

<p>Links are the breakthrough that made the Web so useful and successful. In the rest of this article, we discuss the various types of links and their importance to modern Web design.</p>
...
<dl>
 <dt>Internal link</dt>
 <dd>A link between two webpages, where both webpages belong to the same website, is called an internal link. Without internal links, there's no such thing as a website (unless, of course, it's a one-page website).</dd>
 <dt>External link</dt>
...
<p><a href="https://en.wikipedia.org/wiki/Search_engine_optimization">SEO</a> (search engine optimization) is the study of how to make websites rank highly in search results. Improving a website's use of links is one helpful SEO technique.</p>
