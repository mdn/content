...
<dl>
 ...
 <dt>website</dt>
 <dd>A collection of web pages which are grouped together and usually connected together in various ways. Often called a "web site" or a "site."</dd>
 <dt>web server</dt>
...
<ul>
 ...
 <li>The different sections (science, math, history, etc.) in the library are like websites. Each section is like a unique website (two sections do not contain the same books).</li>
...
<p><img alt="Example of a web site domain name in the browser address bar" src="web-site.jpg"></p>
...
<p><img alt="Example of Firefox nightly displaying a custom Google page as default" src="search-engine.jpg"></p>

<h2 id="Next_steps">Next steps</h2>

<ul>
 <li>Dig deeper: <a href="/en-US/docs/Learn/Common_questions/What_is_a_web_server">What is a web server</a></li>
 <li>See how web pages are linked into a web site: <a href="/en-US/docs/Learn/Common_questions/What_are_hyperlinks">Understanding links on the web</a></li>
</ul>
