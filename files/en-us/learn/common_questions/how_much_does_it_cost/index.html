...
<p>Many editors are free, for example <a href="https://atom.io/">Atom</a>, <a href="http://brackets.io/">Brackets</a>, <a href="http://bluefish.openoffice.nl/">Bluefish</a>, <a href="https://www.barebones.com/products/textwrangler/">TextWrangler</a>, <a href="https://eclipse.org/">Eclipse</a>, <a href="https://netbeans.org/">Netbeans</a>, and <a href="https://code.visualstudio.com/">Visual Studio Code</a>. Some, like <a href="https://www.sublimetext.com/">Sublime Text</a>, you can test as long as you like, but you're encouraged to pay. Some, like <a href="https://www.jetbrains.com/phpstorm/">PhpStorm</a>, can cost between a few dozen and 200 dollars, depending on the plan you purchase. Some of them, like <a href="https://www.visualstudio.com/">Microsoft Visual Studio</a>, can cost hundreds, or thousands of dollars; though Visual Studio Express is free for individual developers or open source projects. Often, for-pay editors will have a trial version.</p>
...
<p>Editors can be free (<a href="https://www.gimp.org/">GIMP</a>, <a href="https://www.getpaint.net/">Paint.NET</a>), moderately expensive (<a href="https://www.paintshoppro.com/">PaintShop Pro</a>, less than $100), or several hundred dollars (<a href="https://www.adobe.com/products/photoshop.html">Adobe Photoshop</a>).</p>
...
<p>For audio files, you can find free software (<a href="https://www.audacityteam.org/">Audacity</a>, <a href="https://www.wavosaur.com/">Wavosaur</a>), or paying up to a few hundred dollars (<a href="https://www.sonycreativesoftware.com/soundforge">Sony Sound Forge</a>, <a href="https://www.adobe.com/products/audition.html">Adobe Audition</a>). Likewise, video-editing software can be free (<a href="http://www.pitivi.org/">PiTiVi</a>, <a href="https://www.openshot.org/">OpenShot</a> for Linux, <a href="https://www.apple.com/mac/imovie/">iMovie</a> for Mac), less than $100 (<a href="https://www.adobe.com/us/products/premiere-elements.html">Adobe Premiere Elements</a>), or several hundred dollars (<a href="https://www.adobe.com/products/premiere.html">Adobe Premiere Pro</a>, <a href="https://www.avid.com/US/products/family/Media-Composer">Avid Media Composer</a>, <a href="https://www.apple.com/final-cut-pro/">Final Cut Pro</a>). The software you received with your digital camera may cover all your needs.</p>
...
<p>If you want to install an (S)FTP client, there are several reliable and free options: for example, <a href="https://filezilla-project.org/">FileZilla</a> for all platforms, <a href="https://winscp.net/">WinSCP</a> for Windows, <a href="https://cyberduck.io/">Cyberduck</a> for Mac or Windows, <a href="https://en.wikipedia.org/wiki/List_of_FTP_server_software">and more</a>.</p>
...
<ul>
 ...
 <li>On the other hand, you'll need a high-bandwidth connection, such as DSL, cable, or fiber access, if you want a more advanced website with hundreds of files, or if you want to deliver heavy video/audio files directly from your web server. It could cost the same as low-bandwidth access, upwards to several hundred dollars per month for more professional needs.</li>
</ul>
...
<div class="note">
<p><strong>Note:</strong> There is no such thing as “unlimited” bandwidth. If you consume a huge amount of bandwidth, expect to pay a huge amount of money.</p>
</div>
...
<p>When you want to publish a website, you could do everything by yourself: set up a database (if needed), Content Management System, or {{Glossary("CMS")}} (like <a href="https://wordpress.org/">Wordpress</a>, <a href="https://dotclear.org/">Dotclear</a>, <a href="https://www.spip.net/en_rubrique25.html">spip</a>, etc.), upload pre-made or your own templates.</p>

<p>You could use your hosting provider's environment, for roughly ten to fifteen dollars per month, or subscribe directly to a dedicated hosting service with pre-packaged CMSs (e.g., <a href="https://wordpress.com/">Wordpress</a>, <a href="https://www.tumblr.com/">Tumblr</a>, <a href="https://www.blogger.com/">Blogger</a>). For the latter, you won't have to pay anything, but you may have less control over templating and other options.</p>
...
<p>It is better to go for paid hosting rather than relying on free hosting, as it is possible to move your files easily and uptime is guaranteed by most paid sites. Most hosting providers give you a huge discount to start with.</p>
...
<ul>
 ...
 <li>Is 95% reliability adequate, or do you need professional, around-the-clock service?</li>
...
<p>Now that you understand what kind of money your website may cost you, it's time to start designing that website and <a href="/en-US/docs/Learn/Common_questions/set_up_a_local_testing_server">setting up your work environment</a>.</p>

<ul>
 <li>Read on about <a href="/en-US/docs/Learn/Common_questions/Available_text_editors">how to choose and install a text editor</a>.</li>
 <li>If you're more focused on design, take a look at the <a href="/en-US/docs/Learn/Common_questions/Common_web_layouts">anatomy of a web page</a>.</li>
</ul>
