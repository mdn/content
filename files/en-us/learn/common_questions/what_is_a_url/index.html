...
<table>
 <tbody>
  <tr>
   ...
   <td>You need to first know <a href="/en-US/docs/Learn/Common_questions/How_does_the_Internet_work">how the Internet works</a>, <a href="/en-US/docs/Learn/Common_questions/What_is_a_web_server">what a Web server is</a> and <a href="/en-US/docs/Learn/Common_questions/What_are_hyperlinks">the concepts behind links on the web</a>.</td>
  </tr>
  <tr>
...
<p>One example of a URL that doesn't use an authority is the mail client (<code>mailto:foobar</code>). It contains a scheme but doesn't use an authority component. Therefore, the colon is not followed by two slashes and only acts as a delimiter between the scheme and mail address.</p>
 ...
 <img alt="Path to the file" src="mdn-url-path@x2.png">
 ...
 <img alt="Parameters" src="mdn-url-parameters@x2.png">
 ...
 <img alt="Anchor" src="mdn-url-anchor@x2.png">
...
<p>The {{Glossary("HTML")}} language — <a href="/en-US/docs/Learn/HTML/Introduction_to_HTML">which will be discussed later on</a> — makes extensive use of URLs:</p>
...
<ul>
 ...
 <li>to display media such as images (with the {{HTMLElement("img")}} element), videos (with the {{HTMLElement("video")}} element), sounds and music (with the {{HTMLElement("audio")}} element), etc.;</li>
...
<h2 id="Absolute_URLs_vs_relative_URLs">Absolute URLs vs relative URLs</h2>
...
<p><a href="/en-US/docs/Web/HTTP/Basics_of_HTTP/Data_URIs">Data URLs</a> — Data URLs, URLs prefixed with the <code>data:</code> scheme, allow content creators to embed small files inline in documents.</p>
