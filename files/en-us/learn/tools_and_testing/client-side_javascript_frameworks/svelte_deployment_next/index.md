...
- [The Joy of Svelte](https://www.joyofsvelte.com/) is another video course for getting up to speed with Svelte fast. It focuses on comparing the different ways Svelte can simplify your components and state management.
