...
<pre class="brush: html">&lt;div class="stack-small" v-if="!isEditing"&gt;</pre>

<p>Next, below that <code>&lt;div&gt;</code>'s closing tag add the following line:</p>

<pre class="brush: html">&lt;to-do-item-edit-form v-else :id="id" :label="label"&gt;&lt;/to-do-item-edit-form&gt;</pre>
...
<pre class="brush: js">import ToDoItemEditForm from "./ToDoItemEditForm";</pre>

<p>And add a <code>components</code> property above the <code>props</code> property inside the component object:</p>
...
<p><img alt="The todo list app, with Edit and Delete buttons shown, and one of the todos in edit mode, with an edit input and save and cancel buttons shown" src="todo-edit-delete.png"></p>
...
<pre class="brush: js">itemEdited(newLabel) {
...
<pre class="brush: js">editCancelled() {
  this.isEditing = false;
}</pre>
...
<pre class="brush: js">&lt;to-do-item-edit-form v-else :id="id" :label="label"
...
<pre class="brush: js">&lt;to-do-item :label="item.label" :done="item.done" :id="item.id"
...
<ol>
 <li>
  ...
  <pre class="brush: js"><span class="blob-code-inner blob-code-marker"><span class="pl-s1">isDone<span class="pl-k">:</span> <span class="pl-c1">this</span>.<span class="pl-smi">done</span>,</span></span></pre>
 </li>
 <li>
