...
6. Now if you load it in a browser that doesn't support [Fetch](/en-US/docs/Web/API/fetch) (IE is an obvious candidate), you should still see the flower image appear — cool!
    ![](fetch-image.jpg)
...
> **Note:** There are some 3rd party options to consider, for example [Polyfill.io](https://polyfill.io/v3/) — this is a meta-polyfill library that will look at each browser's capabilities and apply polyfills as needed, depending on what APIs and JS features you are using in your code.
