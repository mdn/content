...
2. Set the `fruit` variable to that item, then run the code between the `{}` curly brackets.
3. Get the next item in `fruits`, and repeat 2, until you reach the end of `fruits`.

In this case, the code inside the curly brackets is writing out `fruit` to the console.
