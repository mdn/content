...
// shopping will now return [ "tahini", "milk", "cheese", "hummus", "noodles" ]</pre>
  ...
  <div class="note">
  <p><strong>Note:</strong> We've said it before, but just as a reminder — computers start counting from 0!</p>
  </div>
 </li>
...
<p>{{ EmbedLiveSample('Active_learning_Printing_those_products', '100%', 750) }}</p>
...
<p>{{ EmbedLiveSample('Active_learning_Top_5_searches', '100%', 700) }}</p>
