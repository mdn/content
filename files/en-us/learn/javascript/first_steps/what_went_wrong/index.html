...
<ol>
 <li>Go to the tab that you've got <code>number-game-errors.html</code> open in, and open your JavaScript console. You should see an error message along the following lines: <img alt="" src="not-a-function.png"></li>
...
<ol>
 ...
 <li>Now if you try to enter a guess and press the Submit guess button, you'll see ... another error! <img alt="" src="variable-is-null.png"></li>
 <li>This time the error being reported is "TypeError: lowOrHi is null", on line 78.
  <div class="note">
    <p><strong>Note:</strong> <code><a href="/en-US/docs/Glossary/Null">Null</a></code> is a special value that means "nothing", or "no value". So <code>lowOrHi</code> has been declared and initialised, but not with any meaningful value — it has no type or value.</p>
  </div>
 ...
 <li>Save and refresh, and you should now see the <code>console.log()</code> result in your console. <img alt="" src="console-log-output.png"> Sure enough, <code>lowOrHi</code>'s value is <code>null</code> at this point, so there is definitely a problem with line 48.</li>
