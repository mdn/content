...
3. If we look at line 86 in our code editor, we'll find this line:
   ...
   >
   > If you are using any code editor with an extension that launches a live server on your local machine, this will cause extra code to be injected. Because of this, the developer tools will list the error as occuring on a line that is not 86.
