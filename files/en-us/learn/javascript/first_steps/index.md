...
<ul>
 <li><a href="/en-US/docs/Learn/Getting_started_with_the_web">Getting started with the Web</a> (which includes a really <a href="/en-US/docs/Learn/Getting_started_with_the_web/JavaScript_basics">basic JavaScript introduction</a>).</li>
 <li><a href="/en-US/docs/Learn/HTML/Introduction_to_HTML">Introduction to HTML</a>.</li>
 <li><a href="/en-US/docs/Learn/CSS/First_steps">Introduction to CSS</a>.</li>
</ul>
