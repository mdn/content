...
<ul>
 ...
 <li><a href="/en-US/docs/Learn/HTML/Introduction_to_HTML">Introduction to <abbr title="Hypertext Markup Language">HTML</abbr></a></li>
 <li><a href="/en-US/docs/Learn/CSS/First_steps">Introduction to <abbr title="Cascading Style Sheets">CSS</abbr></a></li>
</ul>
...
<ul>
 ...
 <li><a href="/en-US/docs/Web/API">Web <abbr title="application programming interface">APIs</abbr></a></li>
</ul>
...
<dl>
 ...
 <dd>Learn JavaScript for free with the EXLskills open-source course that introduces all you need to get started building applications in JS.</dd>
