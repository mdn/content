...
<p>Now that we've looked at the fundamental building blocks of JavaScript, we'll test your knowledge of loops, functions, conditionals and events by getting you to build a fairly common item you'll see on a lot of websites — a JavaScript-powered image gallery.</p>
...
<table>
 <tbody>
  ...
  <tr>
   ...
   <td>To test comprehension of JavaScript loops, functions, conditionals, and events.</td>
  </tr>
 </tbody>
</table>
...
<p>To get this assessment started, you should go and <a href="https://github.com/mdn/learning-area/blob/master/javascript/building-blocks/gallery/gallery-start.zip?raw=true">grab the ZIP</a> file for the example, unzip it somewhere on your computer, and do the exercise locally to begin with.</p>

<p>Alternatively, you could use a site like <a class="external external-icon" href="https://jsbin.com/">JSBin</a> or <a href="https://glitch.com/">Glitch</a> to do your assessment. You could paste the HTML, CSS and JavaScript into one of these online editors. If the online editor you are using doesn't have separate JavaScript/CSS panels, feel free to put them inline <code>&lt;script&gt;</code>/<code>&lt;style&gt;</code> elements inside the HTML page.</p>
...
<p>You have been provided with some HTML, CSS and image assets and a few lines of JavaScript code; you need to write the necessary JavaScript to turn this into a working program. The HTML body looks like this:</p>
...
<p>The most interesting parts of the example's CSS file:</p>
...
<p>To give you more of an idea, have a look at the <a href="https://mdn.github.io/learning-area/javascript/building-blocks/gallery/">finished example</a> (no peeking at the source code!)</p>
...
<p>Alternatively, you can add one event listener to the thumb bar.</p>
