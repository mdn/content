...
The earliest method of registering event handlers found on the Web involved [**event handler HTML attributes**](/en-US/docs/Web/HTML/Attributes#event_handler_attributes) (or **inline event handlers**) like the one shown above — the attribute value is literally the JavaScript code you want to run when the event occurs.
