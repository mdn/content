...
<p>Before starting this module, you should have some familiarity with {{Glossary("HTML")}} and {{Glossary("CSS")}}. You are advised to work through the <a href="/en-US/docs/Learn/HTML/Introduction_to_HTML">Introduction to HTML</a> and <a href="/en-US/docs/Learn/CSS/First_steps">Introduction to CSS</a> modules before starting on JavaScript.</p>
...
<div class="note">
<p><strong>Note:</strong> If you are working on a computer/tablet/other devices where you don't have the ability to create your own files, you could try out (most of) the code examples in an online coding program such as <a href="https://jsbin.com/">JSBin</a> or <a href="https://glitch.com/">Glitch</a>.</p>
</div>
