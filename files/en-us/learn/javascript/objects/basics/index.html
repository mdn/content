...
<h2 id="Object_basics">Object basics</h2>
...
<p>To begin with, make a local copy of our <a href="https://github.com/mdn/learning-area/blob/master/javascript/oojs/introduction/oojs.html">oojs.html</a> file. This contains very little — a {{HTMLElement("script")}} element for us to write our source code into. We'll use this as a basis for exploring basic object syntax. While working with this example you should have your <a href="/en-US/docs/Learn/Common_questions/What_are_browser_developer_tools#the_javascript_console">developer tools JavaScript console</a> open and ready to type in some commands.</p>
...
<p>Now open your browser's <a href="/en-US/docs/Learn/Common_questions/What_are_browser_developer_tools#the_javascript_console">JavaScript console</a>, enter <code>person</code> into it, and press <kbd>Enter</kbd>/<kbd>Return</kbd>. You should get a result similar to one of the below lines:</p>
...
<p>So far we've only looked at retrieving (or <strong>getting</strong>) object members — you can also <strong>set</strong> (update) the value of object members by declaring the member you want to set (using dot or bracket notation), like this:</p>
