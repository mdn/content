...
<p>Alternatively, you could use a site like <a class="external external-icon" href="https://jsbin.com/">JSBin</a> or <a href="https://glitch.com/">Glitch</a> to do your assessment. You could paste the HTML, CSS, and JavaScript into one of these online editors. If the online editor you are using doesn't have a separate CSS/JS panel, feel free to put them in appropriate <code>&lt;style&gt;</code> / <code>&lt;script&gt;</code> elements.</p>
...
<ol>
 ...
 <li>Write a post asking for assessment and/or help at the <a href="https://discourse.mozilla.org/c/mdn/learn">MDN Discourse forum Learning category</a>. Your post should include:
  <ul>
   <li>A descriptive title such as "Assessment wanted for Accessibility troubleshooting".</li>
