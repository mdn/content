...
<table>
 <tbody>
  <tr>
   ...
   <td>Basic computer literacy, a basic understanding of HTML, CSS, and JavaScript, and understanding of <a href="/en-US/docs/Learn/Accessibility/What_is_accessibility">what accessibility is</a>.</td>
  </tr>
  <tr>
   <th scope="row">Objective:</th>
   <td>To gain familiarity with using CSS and JavaScript appropriately in your web documents to maximise accessibility and not detract from it.</td>
  </tr>
 </tbody>
</table>

<h2 id="CSS_and_JavaScript_are_accessible">CSS and JavaScript are accessible?</h2>
...
<pre class="brush: html">&lt;p&gt;The water is &lt;em&gt;very hot&lt;/em&gt;.&lt;/p&gt;
...
<p>You can see some good example CSS in our <a href="https://github.com/mdn/learning-area/blob/master/accessibility/css/form-css.html">form-css.html</a> example (<a href="https://mdn.github.io/learning-area/accessibility/css/form-css.html">see it live</a> also).</p>
...
<p>You can see a good, simple example of table HTML and CSS in our <a href="https://github.com/mdn/learning-area/blob/master/accessibility/css/table-css.html">table-css.html</a> example (<a href="https://mdn.github.io/learning-area/accessibility/css/table-css.html">see it live also</a>).</p>
...
<p>As an example, we've written a quick and dirty client-side form validation example — see <a href="https://github.com/mdn/learning-area/blob/master/accessibility/css/form-validation.html">form-validation.html</a> (also <a href="https://mdn.github.io/learning-area/accessibility/css/form-validation.html">see the demo live</a>). Here you'll see a simple form; when you try to submit the form with one or both fields left empty, the submit fails, and an error message box appears to tell you what is wrong.</p>
...
<div class="note">
<p><strong>Note:</strong> WebAIM's <a href="https://webaim.org/techniques/formvalidation/">Usable and Accessible Form Validation and Error Recovery</a> provides some further useful information about accessible form validation.</p>
</div>
...
<p>You've reached the end of this article, but can you remember the most important information? You can find some further tests to verify that you've retained this information before you move on — see <a href="/en-US/docs/Learn/Accessibility/CSS_and_JavaScript/Test_your_skills:_CSS_and_JavaScript_accessibility">Test your skills: CSS and JavaScript accessibility</a>.</p>
