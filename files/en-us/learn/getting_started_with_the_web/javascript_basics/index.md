...
5. Make sure the HTML and JavaScript files are saved. Then load `index.html` in your browser. You should see something like this:![New H1 heading element created and rendered in DOM using javascript](hello-world.png)
...
![Final look of HTML page after creating elements and adding DOM Manipulation (user interactions) using JavaScript](website-screen-scripted.png)
