...
An example of this is the character limit seen on Mastodon when Tooting. JavaScript, including [solutions using `maxlength`](https://github.com/mimo84/bootstrap-maxlength), can be used to provide this.
