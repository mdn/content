...
<p>This aim of this skill test is to assess whether you've understood our <a href="/en-US/docs/Learn/Forms/HTML5_input_types">The HTML5 input types</a> article.</p>
...
<h2 id="HTML5_controls_1">HTML5 controls 1</h2>

<p>First let's explore some of the new HTML5 input types. Create appropriate inputs for a user to update their details for:</p>
...
<h2 id="HTML5_controls_2">HTML5 controls 2</h2>

<p>Next, we want you to implement a slider control to allow the user to choose a maximum number of people to invite to their party.</p>

<ol>
 <li>Implement a basic slider control to go along with the provided label.</li>
 <li>Give it a minimum value of 1, maximum value of 30, initial value of 10 and element <code>id</code> of <code>max-invite</code>.</li>
 <li>Create a corresponding output element to put the current value of the slider into. Give it a class of <code>invite-output</code>, and semantically associate it with the input. If you do this correctly, the JavaScript included on the page will automatically update the output value when the slider is moved.</li>
</ol>
...
<ol>
 ...
 <li>Write a post asking for assessment and/or help at the <a class="external external-icon" href="https://discourse.mozilla.org/c/mdn/learn" rel="noopener">MDN Discourse forum Learning category</a>. Your post should include:
  <ul>
   <li>A descriptive title such as "Assessment wanted for HTML5 controls 1 skill test".</li>
