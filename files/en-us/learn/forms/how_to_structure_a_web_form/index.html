...
<p>The flexibility of forms makes them one of the most complex structures in <a href="/en-US/docs/Learn/HTML">HTML</a>; you can build any kind of basic form using dedicated form elements and attributes. Using correct structure when building an HTML form will help ensure that the form is both usable and <a href="/en-US/docs/Learn/Accessibility">accessible</a>.</p>
...
<div class="warning"><p><strong>Warning:</strong> It's strictly forbidden to nest a form inside another form. Nesting can cause forms to behave in an unpredictable manner, so it is a bad idea.</p></div>
...
<p>Many assistive technologies will use the {{HTMLElement("legend")}} element as if it is a part of the label of each control inside the corresponding {{HTMLElement("fieldset")}} element. For example, some screen readers such as <a href="https://www.freedomscientific.com/products/software/jaws/" rel="external">Jaws</a> and <a href="http://www.nvda-project.org/" rel="external">NVDA</a> will speak the legend's content before speaking the label of each control.</p>
...
<ul>
 <li><a href="https://www.alistapart.com/articles/sensibleforms/" rel="external">A List Apart: <em>Sensible Forms: A Form Usability Checklist</em></a></li>
</ul>
