...
<ul>
 <li>Smashing Magazine has some <a href="https://www.smashingmagazine.com/2018/08/ux-html5-mobile-form-part-1/" rel="external">good articles about forms UX</a>, including an older but still relevant <a href="https://www.smashingmagazine.com/2011/11/extensive-guide-web-form-usability/" rel="external">Extensive Guide To Web Form Usability</a> article.</li>
 <li>UXMatters is also a very thoughtful resource with good advice from <a href="https://www.uxmatters.com/mt/archives/2012/05/7-basic-best-practices-for-buttons.php" rel="external">basic best practices</a> to complex concerns such as <a href="https://www.uxmatters.com/mt/archives/2010/03/pagination-in-web-forms-evaluating-the-effectiveness-of-web-forms.php">multi-page forms</a>.</li>
</ul>

<p>In this article, we'll build a simple contact form. Let's make a rough sketch.</p>

<p><img alt="The form to build, roughly sketch" src="form-sketch-low.jpg"></p>
...
<div class="note">
<p><strong>Note:</strong> We'll look at how those attributes work in our <a href="/en-US/docs/Learn/Forms/Sending_and_retrieving_form_data">Sending form data</a> article later on.</p>
</div>
